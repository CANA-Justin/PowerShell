<#	
	...
	===========================================================================
	 ...
	 Filename:     	Azure-DSREGCMD-Leave2.ps1
	===========================================================================
	.DESCRIPTION
...
try
{
	...
	Test-Connection -ComputerName $computer -ErrorAction SilentlyContinue
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAcnlQgRCf/sqKq
# yg2E1r82r7EfXAQe3YcYRNMeGiZjOaCCF2owggOwMIICmKADAgECAhBz0HdolQdJ
...
# CSqGSIb3DQEJBDEiBCCnKZd3BRRnJJcKTQyeVeJk/g0ATEX7FL0Ki9L9DsFdPzAN
# BgkqhkiG9w0BAQEFAASCAQApThZF6QI+AmWzzT2ilBgs9YnOpK+v+DUhnJHeuT5X
# r0paRm8jqhzGuyJw+dPbX2NljvflpRUmgUqyx4KssDJXl0q4FDh4YLvN5g7voYl/
# mKllN5koD5GqlNESY7JEwxOsqmJt9t99zjOYz9R3JlmHfAedsQmQ/6ENSY3C99t5
# oULRq5i9R1gkKAMsjIwfrdTs39DtSilk5NyPsBferdZrI6yI5Uw9Qw7kmLG5Mogc
# H79LIc0OuSNjGX11Y47jXE6ayUtb/2C3zfpvA1UM0/ACnmUTPLUAqfCiUdSMN1ao
# Djdsmhjiq3E5kmMa6R1w11Sw8YVVa+aqDmmP5GrOVUYVoYICuTCCArUGCSqGSIb3
...
# MTkzMTA0WjAvBgkqhkiG9w0BCQQxIgQgj7sEh2mzM7/LCLHPI1mnSrcGNEgNXrt/
# erNVsLo+z+gwgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGHBBQ+x2bV1NRy4hsf
...
# LSBTSEEyNTYgLSBHMgIMJFS4fx4UU603+qF4MA0GCSqGSIb3DQEBAQUABIIBANi5
# OO0tdVU+NiLSL8Lp1Qq1eFzWhnZkJs9uPMA/Frv0+3zf8AX//kckzfhlkUsMXeLG
# W0zi/7OUNLWP+4omlhw8eZZJP3Ym56OJ7zMzUTCbIH7wxWdlg1bY3k8FQYBvEZWY
# YEM9tMjb4zA/m9af/1gEd14PjRGtb++OWrwX2jyWLjR0nfI9pTo6wtItqRX781/Y
# fA3nwgbiQ01cMAtHpTe+SP8asoFwmOL9oz2+Jmd6ZU/W/mtQDi2IOkQeqUSaBPC3
# Dol9ERuwG1tt5BSun8vzlWneKEYyhBTyc7MSaeVQWz7JTdCGkx2y/Nf8tAi6Lhnv
# tTpg1XrQ4NUdhPLVKWM=

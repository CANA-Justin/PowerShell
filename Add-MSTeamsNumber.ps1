<#	
	...
	===========================================================================
	 ...
	 Created on:   	10/04/2021 9:23 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	Add-MSTeamsNumber.ps1
	===========================================================================
	.DESCRIPTION
...
{
	Write-Debug "Module MicrosoftTeams exists on system"
}
else
{
	...
	Write-Host -ForegroundColor Red "Module MicrosoftTeams is not installed on $env:COMPUTERNAME"
	Write-Host -ForegroundColor Green "Installing Module MicrosoftTeams on $env:COMPUTERNAME"
...
$username = Read-Host -Prompt "Users email address"
$usertel = Read-Host -Prompt "Phone Number eg. 14035550123"
do
{

	[ValidateSet('y', 'n')]$InternationalCalling = Read-Host -Prompt "Allow International Calling (Default:No) [y/n]?"
}
until ('y', 'n' -contains $InternationalCalling)
$telprepend = "tel:+"
$tel = $telprepend + $usertel

Set-CsUser -Identity $username -EnterpriseVoiceEnabled $true -HostedVoiceMail $true

Set-CsUser -Identity $username -OnPremLineURI $tel
if ($InternationalCalling -eq "y")
{ 	Write-Debug "InternationalCalling eq $TRUE"
	Grant-CsOnlineVoiceRoutingPolicy -Identity $username -PolicyName "DRTEAMS" }
else { Write-Debug "InternationalCalling did not eq $TRUE" }
if ($InternationalCalling -eq "n")
{ 	Write-Debug "InternationalCalling eq $FALSE"
	Grant-CsOnlineVoiceRoutingPolicy -Identity $username -PolicyName "DRTeamsLocalVRP" }
else { Write-Debug "InternationalCalling did not eq $FALSE" }

Grant-CsTenantDialPlan -identity $username -PolicyName "DRTEAMS"

Get-CsOnlineUser -Identity $username | Format-List -Property FirstName, LastName, EnterpriseVoiceEnabled, HostedVoiceMail, LineURI, UsageLocation, UserPrincipalName, WindowsEmailAddress, SipAddress, OnPremLineURI, OnlineVoiceRoutingPolicy, TenantDialPlan

# SIG # Begin signature block
# MIIqDQYJKoZIhvcNAQcCoIIp/jCCKfoCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDuFrvCwY4NHc4z
# OLAQkvid5RjcBCUk4CXhT4ryCeZKmaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCATMbNGg1ifRP6W1mpwpqSnWI2a5UdA
# tUODZdecnIo6MjANBgkqhkiG9w0BAQEFAASCAQDIJD/cwm7Q33QEVKqJE5BBulf2
# Oax+92bOnTns2j7BeVry4kFmNV22nW2/xYwJn8APMolNTWnwluOrDOvbid1cqPBV
# en00OaK+oYIlOyNLac/1j0zRQTRS76PvIHJJ/gGHMxlrpn//3xF2cuSuJU350HhA
# xYInIwRiok03fOZwbfPQHPPrK836P9UxnM6O5vehiSbQdK35T/zulRvWjvAg0glU
# 6WtMdOuvSnSCQ/hk4BQkZA5rzyDEE1NNZdCt2kS6iOAZ7pJXjVqwc+EanBCbZooS
# 6CE8GseqCra3owV8yTapfw2u+XrWWQnCpVYuK2PWtBL15GV5gZHFJ+YXXQyYoYID
...
# hvcNAQkFMQ8XDTIxMTAwNDE5MzcwMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgZhqSFuZ+bg51
# BUtr2rJC1o0SOMEmrx8pPmzRsn/DGs4wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCiHDN64JWXjVWmqwy7itY8vylsdM9jgWYb1meBRKOo
# 5cqz8iE4x0cGekmzyMKf39c1VwHjn+oVvtLA+Rgmau8dpbBreNkGSZZ7Rs+mlEY4
# cYHpxrnO4zDwuFDt0njBVe8IdsxK0hVHwY2L0vdC2WZbpeC/weRM9Is68YnNBjss
# JNuD96rwi1MlWafNAe3XGTVkIXpIH6c99f1Ba54xuVbHSlvybQTnrYIiod+XehLJ
# 8ZbwKmITLsdjimgVtNe/BPB2/zU5JRuGWlggO01AyjVUqEdH+LY5/KsnkTNfkOJy
# bQHvuuax5y23c1lbmTILCWCsG/dQInYoCNtIlqxiwpNIG1lfInlNm5BzTQkTdp0u
# SBC4riUUmeC0RANVpeL7ZMLUkecet0ZhburLoYAVEpLKxcIJDYhXX55Yzjmt60id
# 2kmVGJ+jev34fYqZm9vcsQRydJ9T5+AYWc095ZFOYn1Q3F1hufFAInnxBogRYPnH
# l1uusW0EcXt6ye80P5MgdAQ=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	12/07/2021 8:26 AM
	 Created by:   	Justin Holmes
	 Organization: 	
	 Filename:     	RanchBarnHand.ps1
	===========================================================================
	.DESCRIPTION
...
<#
	...
	.EXAMPLE
				PS C:\> Add-RanchBarnHand $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA1iQxmTAd113mL
# BxBgdDHxFhZNxc4lK0ixWh9sPmYBeKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDiqrKb3V0sW3C9JqgZWY3dEDoqwM5R
# JRJtBbCcHIlGBjANBgkqhkiG9w0BAQEFAASCAQAb36pS9qoPDrZZHisohMGHmOZq
# Map5ELNgvX1EvEiLn1o2UF7ZhD6k0PLUVWMcIAn9Er9aDLvg0d+kERFobW0dHRnc
# Gb8m+D2kZ2uxn+/l7C1dBM57r1Pv+NA9a11cOanszdV6vY3g7xDzpnrg5Xb3qgMs
# AxXlN5I4AzQR5d9PuqtCJceVMJ2WUiFzg9nt+95GLnhzrpToiXaVO9Wyj+hgD1ot
# 1rW59L0poYU42z4sWVJzxWrmIazpmXLe2wSn2CRBwcRIuK0GtyTWeCCVw8JlLlzf
# ExMeKS15FBRvcvY0VxLTGEGAQH1k4A0GUJPr2JpO5IceOo3CbwbDKzyUNiwnoYID
...
# hvcNAQkFMQ8XDTIxMTIwNzE1MjkxNFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgreeL4CDIIQTv
# THyB1HRUC1e3cv3bLxjqmSmEkucS+30wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBW2YOLwlCpfl/XxE+4NywTTi2WxAPiWckcrGm1BjHl
# 3mr+eoJ7i8edbmVJ150hyqOuAz39auvTwSHJSI63lHrHD8fUJFVf/fnK8kW2A3Jk
# MxvvBXwKCUWd+Ao7Z876qdlliPpan6VFkKmWKNOAQhJESPo3x8SE6o5xWfxeZuo/
# qrAX+SxIuu5dTCMZpiyLB/jlgq2Xu8tJm5Taq6qts3P2iiWTbe39cDZ70vRVIDVK
# XbvUtYcMMvz91/cX5qQfAZtv0EiBCAbUF+8n+blswegUj0ZBoqHDfZeeQgvAqYGI
# 1kZXPdHNMUTutIUAQWeCN5lyv3lYT3ITawZeqUlplByJLwPTDBUr9ck0YVmXcqfI
# lPvXMP/Hipidy5kgsoKpqWbVkWOb4y/X1SGBKNBbeOnL2e6JS5ZaZzdnWDshtszM
# lSD9Ps05FD99sWou9v4DtE9e4nI9xvyR+318uh9SXwATLpS0GPDSYkr50q01yCCv
# R7/oZr/uU86+Xwub8br5mvY=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedEDCorpOffice.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedEDCorpOffice
...
function Add-LimitedEDCorpOffice
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedEDCorpOffice $Username
...
#>
	...
	$ADGroups.add('CANA Construction Proposed Tenders') | Out-Null
	$ADGroups.add('CANA_DSMM_Sec') | Out-Null
	$ADGroups.add('Weekly RFP and Tender Schedule') | Out-Null
	...
	$ADGroups.add('Keynote_Sec') | Out-Null
	$ADGroups.add('Monday Meeting Team') | Out-Null
	...
	$ADGroups.add('SimpsonRanching Info') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDCUN1psodtSRzz
# yGokWuSoHwFQi2WSzQWdQ0aKC3Is8qCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAgDqbqL2wQT1bzZH45go187uw068yC
# Toqp1Z5k2LTFczANBgkqhkiG9w0BAQEFAASCAQCzPQAiAH8Wtpz60/Z+H+CNEdzw
# tr2qbTzNRAFBLdV7M76CGrnayatYOf60WFZFRSLIKEq1AuJs2ZVAIBRxBQTjLVgx
# SiBafHe7z+v/Tbyv5R3MMOXFnjUnN3Ay7FBwrmjRzxruiODJrtHil4krR6IW/znB
# DLrjh6ILPzuSqt1eOBKaCpNaqDRV5f+oCsJ1T6169vwUYVQI6lKbLtPsiMI/owRQ
# R5xoXxr5ZNmEHgZHCNamMgKu5/7unUY4WTRTsCUyi4nX6rakNgh6zR4MVXSB+gVh
# MtBGRp4apFgUFuBN6NkhjxSGjKreitaEhn8ltpn/9CQXzxCO+KBQTXzj4BlKoYID
...
# hvcNAQkFMQ8XDTIyMDEwNjE3MzM1NlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgQa8BGiN3Soh+
# CbU1D2omy7rBAwvUOnnIn5DGAxzbt1owgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDRiJgoh8YQai9sJLvKewMqpE8Pj+m0g5tNFsY+bCmQ
# irvpQMUuvR6Do/Y70y1qRjFVuWI4FrDBb/lQfXJAgx6ZHnoQ8YxoULQ/gLTxu9IE
# pitPZBd6RaOxx5ZBZArmEK+6xkD7aHzOpkNAHAD6Xbukiqqh9et0LQppLmnUVTP5
# O/fqUL9ov4EG8zr8vp1shqmDjZbIDs46MF9BCwv3jG7P/SW3P4ghdXzjDTxTVsfr
# dcrzvaZRVlBa/QiFYR6JgEXa9xZQO/LDvdWf35Tl7nxGcMvxqt6gnqeNuLm0DaT+
# McWjIRfADgb/TTcYwWp/Or3RIW34DROqrQSe50hhZv3lTiBJhfSLegb7M5VMVbWf
# zEUcTjtsfpPpq3k6ksNmNwwBkVVwnNaPCB+izO+QLSYxDd/tq6U9svXeazcB/07o
# l/h615m/OjqrYyrUJOkv1q8Opsbtuycb65tJ8r1HouX6dVkesSejyKGnG+tiYO1s
# lKw+HytCmsjnE/lbhMx9VA0=

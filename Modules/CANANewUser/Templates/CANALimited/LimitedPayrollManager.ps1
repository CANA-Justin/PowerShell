<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedPayrollManager.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedPayrollManager
...
function Add-LimitedPayrollManager
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedPayrollManager $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDZbx2a780TFcuB
# DlxuWqTw2jxeoLTpZ/w3/P4VtDvGa6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCChhDbHE6o6Xj1anBy3dTPvJOWXSqrK
# FcZ0ICuP53NwezANBgkqhkiG9w0BAQEFAASCAQCaRODg4wOAtkGB8YkwTlNZ06H7
# BWbv8p0BgSzlwKi6OxhpIhUVA9I5aTcpKYopsem2yh1IPTnPeKKJ0Ggp0hqSgnDk
# 2zvxfn3VqvNmvQ1V+iCco4wQ/PNgHwZ0cy9agyGDxTZzouHzPC5WFfoM3q6h+fY7
# 1rcYZ6c/N6oAn9OifHzI4HI5e82xhaeb5vSToL/WC4avuJJpO7DN9Ca3Fea9E2FA
# EXSCBNFYQgu6K+NgAbaF8nGjZtqpo5/2/PXuL0+yGpoC0CQFod9qgZP6unPpbB8o
# 8QGKfcRa98yIQkH0X2lQgs5XjWcHsZkRIYJTVJJtFNArNgMrLOr8paVQdaRLoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYzN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgchijBcSXFenT
# c7GmICooMWFAn/jOIhGPegjj66p1pn4wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBk+fOr9gohoFTydBvBxbht4K48n70OkS8cTuLbGFUc
# CfMFJCKMaIDrs5xzjoQn4XW6bnAhCIhojs5mkBfVwJN3GNEf8g69b3WPa/CwFLcA
# qwMc3j/cecCdJuHe6k/FH0jucJcVhHRgQJdji0/eLSLbky8jqlgprhD88CvQbV14
# ebto4UoLtZEJMijpJLSiembHipwIuYPou90QVSmJwxucpjAWSQKdfW0vPductW99
# 4Lwu/41j2GSv9/1mqmM72A0+ZYTY1ccQ/6IJgSvFb5BUhUS92SGlEonmlrzbq4l1
# s4JPd7WxTOM5D4TNBW0QQ3We26TDjtYboS5j3RW26MD0VDvLrGT9F4X7hpLNxe13
# 1WTtZsn4XWmexhNJoR032m6bzjxvKiV+/uwFrhYPXcfhnVS/VWgbNirQBiUdQIAk
# kh2L3D98FciOWcMc/Fo22YjOBx6XjFKZ5/c/GAhqdl3gyDgu8Xb1v0YMOJFBOkPn
# yGCZeFtu9XyBcmTBv9KeQec=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	26/01/2021 11:27 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	LimitedVPShepard.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedVPShepard
	
	.DESCRIPTION
		Adds the user to the groups defined in this function Add-VPShepard
		All CANA Limited                                             
		All Users
		All Manager Services Users                                                   
  		Drive J - Business                                           
  		Head Office Users                                            
		info@sheparddevelopment.com                                  
		iOS Users                                                    
...
<#
	...
	.EXAMPLE
				PS C:\> Add-LimitedVPShepard $Username
...
#>
	...
	$ADGroups.add('info@sheparddevelopment.com') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB5A6XPqH98g0ge
# VbzPTwM7QHe4MzW+7tZn2Z4NgRL936CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCC8/lalWOiWyw2ZhirWF4GDzQaehjIK
# KFVook9wCGTF2jANBgkqhkiG9w0BAQEFAASCAQDWzLbPdfNIcmFoqvasi2LV+Rqt
# w6jdDM7EpulnVI5aliLf5u532bI9rjL1s8msQnJ30dfKbvm+x6HAOQHPrq9vd5cL
# q7vTXEDyfcS5LBsR6p23GHsQVHFb/I6ZH3xuzDe97k8J20I5fi5Bk0r/1iP6lyj3
# HbxTkIJqJnHJcOhRcL38z5DA04httiiQwZt1auhcuGHEY48JzKMxmnIzwVz6Y0eL
# 5vXNxxIO5qw59xHDUQEN244vvz4MOhlVcy5LodfSDVfppOH5qCpBaIjMPBiW+Uwd
# 8MEopiEl4foGep/iFxJ4U4GOPD9LGg4cF7iJ/RDB4y6ehW7l+a/uuXjWkmmUoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTcwNFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgbDklGn4+QKeo
# zceUtw3XKUwtOIqVYvHxZnWap8bGY8wwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCmhmTM6uDmTeAt/1AcO9Y3KjrBjJV+T1Z9gvSKHJ44
# xo6cfQ6RV5ZZLrvjRCn/ifguuKTy0/GtdixfCXzLmk1I3vR0GvZRPh9nLRBAmQe5
# OsJmZFrv1yemFs0TzHtXAHQE6r1UbKmjmzd3Z+q6wTsRhH/BaiWS2AJg5i6gilwR
# tq5HhAecChfjkbftGRvRt2iOR0evVGHwLxDdCPwYl+vlY1g/Qsgj4Xf7nkR9QjQX
# OeQRTk0ver+VGtRaiLrvDhrtRZNKmAkBlukfYODW07QbjDqBx4/e8cIfGcdF6Wf8
# lDI9br5M87Xcc6Qb44nW32h3PhUTAdgznTHKDwmzEGmIUC/TXksREULUP+ZPxkLi
# aIFw3809tZB9Q3wHpIBbzQXaDz5D+vUMYGEipfosEEEzkacrnvuC0FhpnPxLfoM+
# Duguu+9lCbEWEZGD5GC4AWFUoUg790Sppoql8KWiAP5oj8QirIiMWNFBlPYiyEew
# wTC7X8W/R8nBy4Q3YFOzbVU=

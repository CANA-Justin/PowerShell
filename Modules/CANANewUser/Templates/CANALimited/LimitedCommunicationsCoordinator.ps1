<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedCommunicationsCoordinator.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedCommunicationsCoordinator
...
function Add-LimitedCommunicationsCoordinator
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedCommunicationsCoordinator $Username
...
#>
	...
	$ADGroups.add('Group_5c88a471-4368-4091-ae55-1222965d26b9') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB5wHL86EVKJE3t
# 4ieOC7uXYS/MfshyN6E1XWUz0cWATqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDOl2vsLCLAvDfR1mz7x1tJDrc7IzHk
# Hr+zdHePi8hF/jANBgkqhkiG9w0BAQEFAASCAQBUKeDZocxzRdF1E4dH1+p77+o3
# /IomLKX1zpo3tRuppcTe2biYf7lSK/7kTbezxPUBVcvmcxg1uxIY28bKotgnpFNf
# Bu8NEDfJ0OggI9G/rWoU29/UY8Y2kouxm6DrEGutcURbDynCc/mu8a4DbkJZsuZd
# //j6vSO00PcDiBX1Xeco4RYRf7b270Rf4uGWglrp49Gi5WB87nyduROg1zUc6VOR
# JVAkuC7Qr1CYybwkCplyyTKwLmAqHDA9UMd/JizNJiQ8Hqo+rfeRe2XNRD9C1+ou
# FOsxL3cwriCsJWzv1uOY4HbJANSuHQQP/IAAXEp7UCENs6qf8hki3aBGPdXQoYID
...
# hvcNAQkFMQ8XDTIxMTAyNzE1MTYxMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgh3r4a2MnJuK1
# FmRr8fCjvCcbHtGAG6pIrgmhIosnRXIwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAJ313mr7m4QSXu+LzqGRd8TFjixM0tCX+UAtpmD4I4
# pLJOaMA9n7S8mDz8xl1keOb3AWuuuFQK1RqzF3zxTS9zsyburVA5lp4hdY3tkh3L
# yh0cF9sLBJErdXrtKK2yrgu7Lse/+0Ust8bWWpk2jcqw+d1g9TQeDhEZ6i467P7p
# fpU8Uy2lRzdLaZ424e5+OSdmkrlHiRXBfF88gcsfn5yq+i5qAkA7/AFt2oeH5VAu
# b70L7zYqPGaIQzV8a8LOXWhhYacxJXSoUQIWXR97apckS5HFVnDnRzzcHmQyYWLM
# IhqnaLRsCSefi34wHzhOkRherY2EXr6nwCzVmhf7qrhrl2zIKgluQa9oGrzEFrvZ
# QwisMj2J2+ZmFjoEjqpXFhXe40alE9Qcxko7iVos3RgxXpJcyH1oCJ10vUN4G9Lm
# w0iqyDax0ZOb7LkEwS+R4KEamd6Fg+yVqdlYFGin1StUP27hvJtNNZtxLuUnWO7C
# Djp03bPA+C5URnKCUJ7FExI=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimiyrfSafetyAdministrator.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergySafetyAdministrator 
...
function Add-LimitedSafetyAdministrator
{
<#
	.SYNOPSIS
	...
	.DESCRIPTION
		Adds the user to the groups defined in this function
			...
			tfa.Utilities.Project.Estimate.Read
			tfa.Utilities.Read
			Viewpoint Users                                          
	...
	.EXAMPLE
				PS C:\> Add-LimitedSafetyAdministrator $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBHhLJhBKUocGTC
# XxT+L8kPOdp4lwhX/BEcxAMOWMFMa6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCVA6XOPTMWxIyrcGK79AWbzVucJW4d
# gW4CurjXeHLjejANBgkqhkiG9w0BAQEFAASCAQBcej2R76FKpVrWuGzrnBYK2iw0
# RlrXRZtcBwD4I2jxV/tHZd6QCORLsACz1U3+08UcuDmVvnJwh8yW6va1kkA33wLI
# si/6Qa8XuzYXVFspXi4WxNNXFG5SfPlErodpU9hMKEV0SrHqkXCBOomCcy1gntlj
# cL5t3bxOSDKIAObe15BBWr2RGXlQAxQRYtztz6Nnik41kD8RkmpNN+p5qzjiOX8g
# 8gKw7Nu2hH9Y6XGqyWCYk5/vsYg9/ekEAHJ/W5A+O/iwKJfPnsA2jF959bG0SqqG
# 8mpTUBc3P3qwPkuZzkTBI3vRHR9TJYmw5xe22jQhPcddChboRThUPqFgA0mRoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE1MTMzOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgoc7MaS2bFjV6
# I7DmT32qN0uBcyuafe2ms7FsDeyjjXwwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDJcn6Et/k4X3CkXzD7bhVqItyVmSAWG0SQ+zfkyuo9
# A1HDzhopztyklZfRsxBGhk2oEZtcr1KJpAVNgzsCv3/HuPGg26HmcS8eAmy8S3kc
# bOyacAdl7vg2pmKBYhppaPgcv0HxSGsaHzJ9pQIZTqNEYiWxwImLDwxEvgRSHFYG
# U5iP1mrYxNLqEAIfsDRheU5sRs9nv4H0JURUzmkt3XYfE2900L+S5PXAOD/v8NIc
# 0S+xHxYrFOCihEe2MIX9Yz6YIBt5zRnJSCN5NwbCmJaWZFyIFvX3wDnaqJ23kBM/
# qR9hkNrpvUsarQ4NapdUbUDvQVJ96/ckwDgs9FNylDVq2+LlQI1W/P+nZXuJ8AX6
# R5rlPr9BpdiuXARqyHtTEh+VTZX0IFLvzsKJ6ruyiQS4jlaD9VazZ4c+HKvRgtJ5
# MDIszoKvXcqoic4IR3tQknUdSFI+JwRxQwdQsk6ld140t3kCsTFmQhjLoFx5K2S9
# gJbGD/AM9vA1e2dRTLHVgtM=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergySafetyLead.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergySafetyLead
...
function Add-EnergySafetyLead
{
	...
	.DESCRIPTION
		...
		tfa.Safety.RWED
		tfa.SafetyHVU.RWED
		tfa.Shared.ContructionEmployeesTrainingCertificates.RWED
		Viewpoint Users
	...
	.EXAMPLE
				PS C:\> Add-EnergySafetyLead $Username
...
#>
	...
	$ADGroups.add('SP_Safety_Manager') | Out-Null
	...
	$ADGroups.add('tfa.Shared.ContructionEmployeesTrainingCertificates.Read') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA9IzFZiiyyX5OY
# HUCPhYdNFvx4RSTgmmoy5qqT4yIIf6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCC9NoJJJo/dcEQRLX+RpL0rDztjOoCp
# WLpsnefoRE2CjTANBgkqhkiG9w0BAQEFAASCAQB+puZYKz65EZq0HOQfmh7Hd1kQ
# vNes7MOiMlqLiiq4mL7n+MEkE7d410+KEQtACFCw7q9OQdXaZsU6rFkylcZ6gLc9
# OfVGNII+uPq3+vLAMcIOYmm/65Y3GYCy9ZdHKhso11O8mfA8JXf7HjLrPX5z3T9f
# 323SbNhSa8yD2pkzFjEFWnoDjXXyI+bd1JeWf8BZfh73f3VKNAU/u43chbOkTZYg
# 6GPqs610pQLcqn5lADOmAM84q5KD7qlpkto2yNtkGe6Bzd/lYjmbKcLAq5EwwtT3
# 8YqdptwF79GeosaH40X/CFkY1zdSstcL+b07Ouv5McP7jzemeRD71ignQlRDoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTY1OFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg8/a6iLR9PB4E
# iTkXsYNmrEIeTJ/Cyw9PYzJx64e+D9AwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCIqUo8swjdm+D2/20dEmMwdw7gFv6zinsDyFQHXtAq
# M47sHbIWE8DAKR3fVgs1EytMVQzRRHmgU7DDltW0W1O3KU0QzMhdajTQPvReK4kp
# yxGeY6U3yd5NyOXrHNx2Digldw4eFdw4bfoVNlj3FFJb6uU20JJTi42SghxbOyMt
# +CdXy8Ibtl7hGFFjY+GJkleUPcwuKZc0t/kg4iHFXdBEygt2eHblAKrZC2wnyjS6
# NAFBuNmzTmim5AHOvXs5j6tmeWCD3AT24kLPwUWg8ODIF9R6+5W+T6g3plSvbeln
# 56w/cUqGdH1rFlIuWjopIZVfHwDD6TaVb+MTAurs17MiAl9l9N34977ZpofvI2Hz
# GUUhDJOKPRi5JsJfnTRiUwcZ0sUfj9QZRrShbdwtdyCCPLnQ6ER3ErKRpkBU9W7U
# zcQAsdbHNueEod3pCh6UC69Pe3oFKcugW53zfwI9LQqbZLhEp3hb70ELM1mlJElq
# yElhowWP4uAsZCSF2guGSTE=

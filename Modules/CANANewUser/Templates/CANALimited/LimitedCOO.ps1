<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedCOO.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedCOO
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAadzT0Z3BqwQsT
# 2HepBz13grA5qXgRD3BpibXAmhNW2aCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDNqoKHjBpbuZ2+K/+P9ca5ikmAdrJM
# f0QAPz7im6rShTANBgkqhkiG9w0BAQEFAASCAQA3lsew6p1zXhzjuydgm+rXlUd+
# FHgao4xHQNQGW5yjDXsaDChEoK1ovgQvLLAJyG4YThmqBrkQFMN80/ba/Ud+mUjM
# Mdkb/0bt/MNOnhO+NOyKRmYkZFaTau0Cikw26gGlL2BRDeBoyV/vfU+ufbiyLPzt
# QQkTWWYfN+6KMKY5ZAbuT3dupeZNxFWD6BeNrT8HbZryM+vVJhk5mn3abKtMZp8M
# llZxC2KUziLEt8O1MPuCnqRmPIIGuHrTpRtpZsJhjC4AndABofw33epTGT7xRcFs
# TB4tfN2XC0Zui6H0jbplzSlgfNZ4X8LsA9p8baF7cZiRXpobG+9qo+EmMNQVoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYxN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgSdn6O8Q+1C6y
# K8ToU+Bsysmd5M7lIv1f4v8S73rdt0EwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAxpBfoixYPGuC5UXXx0XuUKBorWafFOZF7IZtkBOjq
# oqlvYXl0CJq9SjDU8LgRCz5w/DnHHABsqiMUp4KIgumWsu1LVb9RzdcQrwdBdgYu
# roFxwPvgYuQ8xbtGyhvEoNFJZAT3+D4HVcPSHaK0viwBReUki5GEQKzIZKV6fjmC
# d7F+ZskFr9erGDrnCyHvEsnWsb30LiFQRLeND06WEd4QCdhrbv0/6QvOqjZDLuOv
# RLX3C+BebYKKnYwiIfbLDx68u//YxJiKOIHFrU8YJhNmXfqVgUOhsTfHodVjxiva
# SUFMH/rv3gQcnsAsqQrv0Trut8bNjReY55Ezmi5SfZ3tebR8v4bJjueKm3jSb3fD
# y3JukQSMDV6qaEhDs8gWIAtSww6PsGQh4BDzkYxSf19Yxkj0aGPB9qFbGKD0wlzw
# Nzx3GQLWUimYwo40P+4yfcKQwRdz1l/i7KjdA325HhJmXU34FGavoVUvVRMFjvm3
# hMLTwipZsyZl5uqQk4/IhK4=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	08/04/2020 11:27 AM
	 Created by:   	Kevin George
	 Organization: 	CANA IT
	 Filename:     	LimitedITStaff.ps1
	===========================================================================
	.SYNOPSIS
...
<#
	...
	.EXAMPLE
				PS C:\> Add-LimitedITStaff $Username
...
#>
	...
	$ADGroups.add('IT Support') | Out-Null
	$ADGroups.add('CANA Construction Commercial') | Out-Null
	$ADGroups.add('CANA FWC Users') | Out-Null
	$ADGroups.add('All CANA Limited Users') | Out-Null
	$ADGroups.add('Est_Sec') | Out-Null
	$ADGroups.add('IT_Sec') | Out-Null
	$ADGroups.add('Printer Access RM140A-West - HP 880z Secondary') | Out-Null
	$ADGroups.add('Printer Access RM140B-East -  HP 830Z') | Out-Null
	$ADGroups.add('Salaried Employees') | Out-Null
	$ADGroups.add('SP.IT.Contribute') | Out-Null
	$ADGroups.add('SP.ViewpointERP.Contributor') | Out-Null
	$ADGroups.add('SP_IT_Staff') | Out-Null
	$ADGroups.add('SW_FM_Users') | Out-Null
	$ADGroups.add('SW_Viewpoint_Users') | Out-Null
	$ADGroups.add('tfa.ITStorage.RWED') | Out-Null
	$ADGroups.add('tfa.SoftwareDistribution.RWED') | Out-Null
	...
	$ADGroups.add('XenApp75_RDM') | Out-Null
	$ADGroups.add('XenApp75_Viewpoint_Prod') | Out-Null
	$ADGroups.add('XenApp75_Viewpoint_Test') | Out-Null
	$ADGroups.add('SW_Viewpoint_Users') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDQ3dMRYpKdYnJ2
# 0wR79UmjW2hNRsdhMorf17R9Nru8cqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAVpuU7ZGtqNvc+W/zcwLJ9tQq/9zxC
# 8FG6zD5xSJ42UjANBgkqhkiG9w0BAQEFAASCAQCrQIBEulvFYZjeTwJbbsTORS36
# TCLM7sbK6Q4aNkg/eucoFYG3D9Ov9/CofpsToE15AHqWb9RlRClyxKu0uGOitKYM
# Y/eI9Njm00xQ06Qqu0Cm68TSgByzOolpcQBQmGpRHZCx32Zb1be3CeGx9z7OdbLb
# +lj1L6Lep672jRk6ZjXoHu/+afz/FpDiHP7H0GfV9QUqv2kwXXKRejPZmkIq76B7
# +nbFOySmMLaTxXyXanC7PT5KJuAFJMerwAJ8MRjDmKiB+zmWw9p0ZiMRxrXFc4MC
# JPCxu1te5tP44dGO+SIdpRDtKpVuYwewGMM88M48PnH7X9dz29edrlRXDIoNoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYyOVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgPuysiUTIl9Gj
# jcrBXDrN0GpEWXGT9eAb+141jvJIh/kwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYA3L3UgKfe8lWe0vAmRCvOG5UhKid0KIbuE1ZG0gSgc
# GYMXDPcOoxgCc1i4o8ZhlaQRozIPkrE4p0LqEWGfwg0wVvgKR4T67c8x+cGnzg9c
# kmFGC/dBBtmxZIuhBboJL3IYSuH6+cn5UGBl+Ds+K53smSWQv1CdRg0en/NYjk40
# HocrV5iUIV45NufdPKVWEL623p8VwnZDVrAcmxWH8PvwPISYe4KkzzESx1jGfaM/
# 3B7CzvnLkKKE7LaLphKiniYsh4f+vsBZ4U5Bmar/RjYurcNsEt/yXgTDrbQhouhY
# RreBwr87NpLslW57vAwrq5VmlFIuWCkkGNWwjofomt6dcuOUy6RUs7IppNfDbQfo
# xxQb8ekjUQSEN9VZk1EFS9exM4vKy6gGi0oGWofVJFZnHE3tofAr6cJFAWF3IT04
# aHI+AlzDT81cpF5BTtcLkivd0PUtg1z4GPFjO/QeAY0GiV7tKHw8GBDDSyXamjfQ
# IIiCyMj56EFIn9YIkRmvViQ=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	04/27/2020 11:00 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	LimitedReception.ps1
	===========================================================================
	.DESCRIPTION
		A description of the file.
#>

function Add-LimitedReception
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBMEkV9DTlLgCv2
# ZV2CPCRs5p8TL56QrYxAXkaS+HXWVqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCADRKjovEm0tk+Ax89h1Fk8JCgJEzIx
# K4gsYjHhC3rKdDANBgkqhkiG9w0BAQEFAASCAQBVMz2BsYfhBF8E13+/iyPZuHFq
# T7+gom8Y84ayfq7Vxn8dP+/9KzNvcasZEYsxwFs3hNJU8P0uyBS+fWl99uZ/lzGi
# XMPslfJFak7eP/Fu7yP0R9My8TN2ZtEfAPSg5lZo3VNNbxlaAURRw4h74lFM7kbE
# +i4BVWGGHh9dJRFh6BX+jRVzW493EeNY1qar2BMyrJ5s3+QTgD7QLiTua4E8wuhe
# 1CnOwhPfFSVthekafaQDGWAWtEGeQcqSJ6cOKdJZjsHAeW0E10XZ0MxsWg48OrqQ
# 6xIbNWicCJos6pbzBPx+KCrdQjZqbROaNGVkXoa5PgDvYmVI/FUp2+5ZpryToYID
...
# hvcNAQkFMQ8XDTIxMTAyODE1MDkzM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgnl/HnJ9iUOjl
# RwhG4djzJytOqshxSxcOW71FnIqq6K8wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCt/hnIJ4+wyMyDYAdoywaUvuWxXEjQn7ZURlXkLh4x
# mk9w2hNo01tibttXQBd+hg+R57clZLSKvwwAuMHO0Y9VEaMTt+aSm3HfFtL3GXae
# 2DsdMK9oeIoY5sU2DEkBGvRvyrQAaSlkiDwTeNFoap/3Troe97dQHw9uoC/oZSFW
# vaQaNMIu2M3uDS+jA4zYBrcd0AfPpv4CDMgp5+JnjJg0kGbHYsdFzrt7ViHFWMrR
# QH7EjeXerpir+4CFfDHxK4mQ0Bw0Sq5NrEPiVL/0WX+zfysqP1O15KLzbw1QcWWM
# DUNIwTyf+dHku22kzT9zlLlp6dZohIzcgU3iDSiQ9gYs3Lan/U4aQyeyf2BK+/GP
# 9661ei29qLozoBow2TLF/fNA9+OJEuzDEpESo2/OL6y865Agea4MwUvmtU40+XOt
# 56PGEp5r4vbHenMiZRMAIl4BR7WCnmTQ6VD3vCiGZBSRNaO5xlny1nDK5aQS0dkM
# b6xtnnpQ8h5Xq60khN290Is=

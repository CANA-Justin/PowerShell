<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedExecutiveAssistant.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedExecutiveAssistant
...
function Add-LimitedExecutiveAssistant
{
<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		tfa.Estimating.RWED
		tfa.Exec.DSM.RWED
		tfa.Exec.ExecutiveTeam.RWED
		tfa.Exec.Jollean.RWED
		tfa.Exec.RWED
		...
		tfa.Shepard.CorporateMatters.RWED
		tfa.Shepard.RWED
		VPN_Access
		Drive J - Business
	...
	.EXAMPLE
				PS C:\> Add-LimitedExecutiveAssistant $Username
...
#>
	...
	$ADGroups.add('Legal_Sec') | Out-Null
	...
	$ADGroups.add('Shepard_sec') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBmJkDYUaci9/y+
# rpY0fLOfVK+MlV7gGGmrynYRZl9S3KCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDFn65yLMGTh/TqsUiXBbbpmPBGIjCW
# IfFYTD+C/RLUgDANBgkqhkiG9w0BAQEFAASCAQBHreDJYY5VBofOEx/NRh7Fz37k
# 8qXGCPgd9ulHDls35oKyS9g8Szf/f5ElOpyRAGHxAUcxBRZ+gqDQ7wtGgAM4Ysr/
# wyLfv4TXg8I5SkdstaueIv/DhObapuApRZ9uMICMZ5rVg6KvyNt8JcLckZ4jIzjF
# DpvpDQzSsIlqWKobSZrTZklQmYNoX5PQY6c6973g2Ozu4Vy+G80VR9XtdSxKUXSW
# BqUzPdHAcx1nxEU9uzbFvF6QaIU65QvYTdLbGtlAWhGOUYelRBhpkYC81nH3WZJk
# HwjsYFsIlv3D+/JnO0hcjf/Htg9We3++GYC+Z6v4ww5eB7JWAnnntZU6DxAGoYID
...
# hvcNAQkFMQ8XDTIxMTAyNzE2MjIyM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgBahEL7r/vUxq
# 4BuyorF59zh3VJajfmmxz+MU+VWygdAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCqifR3l7/RVEFIS0o7t32/4GqnLQJtboHpvkgitbgT
# Sj7FY0aEUHy/6fC7NYN4uCVAn4haKxbz6NxjO36I2VSttMjQtaTBD8Rpwqgsg0h3
# l7hkdpq+6gsA37jPwuOvWy/OWTXNNu5rm0je8mnco40AXkFGUh+t5QD6E4WTfC6o
# /mI/uy+FyxZESl3VJf1cAIKPzCwe+zTOrXFYj2emUZjmjlZkHGLcNg5ThAVpPY0e
# hF1wV5QEJEJ/C1DGck3mgub5SMqxJzFsVOw4Vu7ep17GWC8Ahr0VPQucHTVv/N5G
# vYIgRXCywlfVw2kh+cqiRB9RVUdzoLqsham5yhwqDPcCa010h09+kNeEZ7vL8PAw
# gTVGLpcMXdDyvseSW6zLgybVcqCZNOR7yfQpn06nJw0z3mSyb6a4cjXKLdVOjdgq
# J8Fdlk03U1Ltn75AFzUi0jEQW77o4kAG+rWzm2pBBmkvh621KkXcBVUFHcLxZk2U
# CaitVTgCzeg/B2YagkesdnY=

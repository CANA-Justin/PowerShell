<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedHRTeamLead.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedHRTeamLead
...
function Add-LimitedHRTeamLead
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedHRTeamLead $Username
...
#>
	...
	$ADGroups.add('SP_HR_Confidential') | Out-Null
	$ADGroups.add('SP_HR_Staff') | Out-Null
	$ADGroups.add('SP_HR_Managers') | Out-Null
	...
	$ADGroups.add('VP.AutoImport') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAgP2D29MF/+wO5
# TGJDC80cF0K9IXblkTJ71MRZme6uiKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCezGpPtmWHZKgD1dA5u4tT7CIYazss
# PlQpuqo+2faIaDANBgkqhkiG9w0BAQEFAASCAQB9GsBz+YseSRHbgEeKmaVxHnXJ
# i+eqDz7Jd3+WI4+ChuH2mu0V7Zkh3W/VCS2miLMvV6wINQ8CXxyEDuq403t28lke
# G8jIbhb8PiZweCPTwG6/VCKfSHBfVUeIEkYpQ3fc1ITYWSqpzt2PwuTUS0zuVfib
# ogEC/WjV7RnAlWe2cL2yaOgs9QTs0hi6qmlO7tK/e7jfymT0WR7ZDPgKoxeQDOMV
# hWVqHw/2RqkmzNJlB1VK2SNhsGLzT7k0iVJh6zc+p8bx+lVKC2fguEEcvw2q9qV6
# BMDp/hJLo3tDgHDZHj/WHB3/iuWbE24uhhtAr6exjvVsFlez0Y69kPL+iOJeoYID
...
# hvcNAQkFMQ8XDTIyMDEwNTE0MjQyMFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgeJzbW65A5Yzh
# cf9fdpF13ZJLhaF9KdJ696MrSYmHpkwwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCPtCnIhxgVw1/iyEErEYexGAO/wZOBypwsXV6oqPYz
# XMY/lblUn1R9uKxVltrHxXRF93OiuECSZREcGVnW2XS7pR1nGRx3cpXkG+g8gmra
# 2VrY0O2SlMNuqA5xvIii6mErKoiftRM1cU/zlAwGYdZDZFaQ6xpU8J4Lo/NbKKjW
# xbwSTzX9YqCuDGscnoTgtLYNNnquWNktb02YjgDZ6UoA6aXUOfB/QvV7uNrdq7Hv
# t5wAzjQXLr+3YxUxI7tvSgUpNSOxm6eMK4sp1TwOeZ8JTe3chmpbshYCsgOBvX7q
# bmgiq5eRQyW3zJK9pNm6Xdv8Xo+sgCt6ZFJsO+aCuw4MpbiP0Wm3zA0dBzPWZ/OA
# i3+pQusSKq0rReTFBWo0THhdzgCcZJcD27gA+b1rF2qFm4TWTV5kOItST1Qp6Ah6
# hQxSfdhecgkibRNieAQC2M/Lv/a6P3CaGJ41Nt2+xa8ymhQBTln4lQeM38uVjgAa
# ckbGWInLiNaqlM43pAVUORA=

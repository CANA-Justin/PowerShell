<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedAPCoordinator.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedAPCoordinator
...
function Add-LimitedAPCoordinator
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedAPCoordinator $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQ9jqEnxy48M56
# ze6AeaCHN50hvqRM5ixy7CbynuxvJqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDyRfg8F8LHnmyy/ESZ9VYmrGfvSTyx
# /Cizu+joLXWxmDANBgkqhkiG9w0BAQEFAASCAQCbqlRKe9WwvB14ym/0QNHJS3Ku
# Q0nRdH6K16Ik7lIKkqQpto57mgEnn8EP+5Sl6iKBEMksV8022qOzB4BYN8NPD5j5
# Bu64Yt3wzTLALmHFeyFLAKss2mRM2uJJ7auP+DfizF2DFD2xs4wwSkYCbDMDqwqA
# 5Y828zeJhR10nEpwOFN5pAgzjkeTlXfRFxHFXRxjlNCEHpu7wN5deRhFaIDlUwmn
# 7FZLR55hATp6jAYH8l5n99UcvjnXXTJ08/tYdVtOFvnmIRH+baicmKPumro+nvJs
# AUsfiGKvBYv0NsOUwYVYCSkk809Cf+lWEf7qDr4qqWaoDCsXjEcdDgwpA6ZYoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE4NTg1NVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgV07xb4yKvrsc
# sixfO8eX+J1QDM4+zOqEG2DHJCHm3DUwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDe+sBtNt3mAWmQUmTs+ozWGEPZ19QPNDbUNR4jQxFL
# p0rDy4KGFnyLiQKhUIHOgoE4Li1UjugkXh7SzA7AUtiv3LXqPBP1ohawk8AuHUas
# ouKzRKj6ooht1bxsQiN5CXeADPM/tgGdFVYdVGBrzN2mhgnMbWQUmKbDsw0k8dBm
# wPDNihGhD5WVjPyXQMoJPhOKPZb5vCaHAfIYwwqzBJldGaeeyplYA9UAyA9wtArr
# bVQBHr3/XdgeDZASbhj1tY3bZv6keIOovA3nNOhmR9PZZlAQnolkwq1pf+3d/kjl
# 4Z6bIJ341VkNbqha8Ejq0ZSpXpexDpQLJ2sC63v/j/IOwimIgGcUiQIQPmMFhs1N
# UOwiZb+q48yuQa8ZUIYw7Q/NyPBE1A3BNENFwlDdFUKDhHR27j5+ySyFZaBBkrQR
# OTwW0lV/nQvZOAwUy4RH7qcc3VoUbCZ+OQl8bDvcv+d3wcLzULeohjgkn6shCu8l
# JpXTFKQQZOMv09gz5AvtuCU=

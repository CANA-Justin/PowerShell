<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedCommunicationsAssistant.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedCommunicationsAssistant
...
function Add-LimitedCommunicationsAssistant
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedCommunicationsAssistant $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCZHMb5gmvppEet
# DJpV2ge8OBZgmBVnOb0Xpesftk1pOaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBFCoBGmGtbGxaY0UXM4xEaahi5NtCw
# 2RESkbzB8TFtxzANBgkqhkiG9w0BAQEFAASCAQAY29owkye/PEHCAnAXzlb9exis
# CG2jbSLdk8FMbJtJ3iR1SVfaKhAtXlR6YSxYyFrmpfh42oE4Y1lSH1BsjGYJezEk
# 1okUKOZ+vh4Zljo0aqVEzxHyuLpvVyZexlMOaT6W2kWA4nVyGQ9OmOZX2TGDvfgA
# ZOTxsYuvs2z3U7TcHpjzZcSFp4D3COUIj9G/XiZM18lyZW4FxFevnlS1mcPYGcy+
# n6hgQmWAeB7KyIPEzE6F/4Z7KPJ1v/oeqDBKOup0tOf2MggMkJvRedjthPfeg3Nw
# PizoBFkqIi9KW2hs32D05TZiSseYqvFFKC0psXkJWer58UHXO+L039mD390poYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYxMFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgr2GVLrl4cmbG
# 2uQf3WBfqSx8qechYUFi1UJgtptblgkwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAm7+8b4GJU2pPC+IYhGu+zUPn5bFGMMXUy9G7oCdOX
# UC/3xnlKbF6nDXUff4Pl+IHeQr43VEMX893E4Va1ZpsCLhSqvgRx7+e0Qr+JQgg8
# ybFOVVBNKxMSvVQAT1GNR6TNOARC/N9gDNK6/5VudwYkWrdL1sVh80DicHRL9ZMo
# g4Pi+4tX66gtMMKzy2tzaoeaUb4d6qrXNr7dVBYi6boMD28KdKXM/SLxU1XfIX3w
# 8TITLkARmkEfcQRkW/xyzlhruK4QSs1jVKZBUBvDE3vg+t0bg5VGMFomcIAG3MBj
# BbIuwksX1o4u0Tv1TZLGkJ/l01WjkNSmIErzSdP8hxJnykC3rE8FH8DFneAHvU/6
# fBdP3evo8yKBMOt6Bu1nUtyZ0VIkVOg2Ca9y8lbxsuXeryz8FlUBQZaM3KT+0+3M
# rKsPZTP1/brezJdkSmx06ULA4v3AgTvGL6eyjy+nbYXKATfC0buYZiPYExVRXAHm
# aqerfW0t7fzRjWJPPZXW+L0=

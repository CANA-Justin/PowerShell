<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedAdministrativeAssistant.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedAdministrativeAssistant
...
function Add-LimitedAdministrativeAssistant
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedAdministrativeAssistant $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCdq0qLA7aEe04c
# GXyw9mof2kT0jRwpuSnrxYMWJovjf6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCPUV9JBaiZFTa8wZdB5gn/k0nEDXpH
# fKIcUdF26F+K+TANBgkqhkiG9w0BAQEFAASCAQAN3vooQFF6+3axhC0P8UtcpWfU
# 1H14kQWWTWqy7rLw1p/2P4Qt64kYbvt3STTRK6jlx0ADqnZnyBpI134FyN02cphD
# 1zJ+DLqkQIwjsZNbI4Z9ndVDVr+WfffmnKr3H+sIRKIjCWWAZ/YTQ1CprkCB0Xg0
# qRiOTAAjKxD6ByVUwAuzNsSJeaTOlMK3w9UY5E0XLPkaAbmJNNxRM/PYk6yCyruL
# G9rQygx9i2mJ6vmtOwUQSi++TMMwbyiFbT+AGhnBcPYlEV93VDed3dYO8R2GUNUQ
# 7kz11y4buZaflrxgFjxfgh84T6yISP6rfJr6zfYWlCXqOHyi5EbgoBltXQswoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYwMVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg71xgDGOXlIkE
# J9iOkulGnQxHlgKavRePCZR1VqiwwG8wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBhMNw/u/NIYfYgNYVAXbrK8PX9/nQFYd/VpJBzKlum
# tlZUwlpjD0x6ZRXvQBoSB4AAAq78Th0bejpo9MWTsiZSVVxMNBjvUGQdHf4DeeKF
# vt5kCOgnCl9XYy2/lJXDBe9KmnveJHBxKHI6cpy8S5SkT4b9VDrPvGdtpV2uhgYv
# xtUUbR44rpMlSbo0/nhBB4Q8vByIHjJIVqBfQ9g3BZSkF83gGbw6yPMMLoK6W0HH
# 7oaQKx7uzoeSNFL2EplrdV4x2TK0A/zxdU01VgBCh1xOaLeHowyvSbfImomrMH3P
# T84lCHlI7oKnmnrI9DrLDL2X06NIwu8QVe4jGoKFZqDEd7Ost+MEGuh4NcsVLEdx
# mfspypx/gNL4v0djPAaiQ8TPIP41s5KmJraXx6nUVlxi8LJVs5cXejRA31gNM/ar
# gG5e+jdzRS/RvdHLZ+w46XXk4Odc8bahSgue6e/RvRnN5Ec9M67wX6XXMid0+UpO
# 46Nnkfq34NyBFYtkfAF/rv4=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedPresidentEnergy.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedPresidentEnergy
...
function Add-LimitedPresidentEnergy
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedPresidentEnergy $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBPVCG8f49H9GMc
# PnwWu8yJl5ZmjY2IW3JfiBZFlS+ivaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCnK2NT5/5Hf0+OJ8a9aJOIDa0cPP5k
# qg+Mb+TH6nJVMzANBgkqhkiG9w0BAQEFAASCAQB1evWekXfUPXuFKLwcqQfudbhe
# 0VvJyg41+aKeItTkeJT8ToOZhOGvftXmj9rgJ4JNp3NMAMtphchAOmOjSNiBrg/2
# Jn9tnkU0X+C+u+UaUDNn7GBusqdRL4lyQL6tN2060jcajv3HO6Rodu7J4qYcGGOA
# 5PItEw7U2wMK8p6oVJB61+bT1lBK7GpePt6uZkIr2h3vg7XImERlWdkJr1nDaao9
# iMr9BQftrdmWiZ92lT/52mvmOfoCliPI+RcJNQVeakQI82if9FpfQMRMLhDGd82v
# QjBwmB/8KCv5+D2/6YWKkRwHaL13TnnaFJB54+3z8e1F3pLM9aTJUiHcCOfdoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTY0M1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg7tD60756iJPs
# 4MN5AlgDbyKQ1EAXA/dEUdjObLMzRQQwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDFGkElNKht4e3dBhKvcpKaBPnE5Bqtq17MqS5aNJyn
# nbRAFDuvyGNN60Bz5a2kf1yZuoVdKNyZWtbkzwtrG0TPHMimLA6TwFd/Ihzr7sfp
# JdxVTe1XUGAKBRadRO95nZv8Q8MQlD2flG0Enod0jfOGE/4fLE7FcKUMuAVsL9s3
# RJnQyiupjz+Pjiyv0BAfDZpJQQJmjE7PNXYOBCgDv3el68aT+bn7LOAANeVU2bca
# wlu9OuP0GMK+G8c0fexGJznBpJfKGoNHELs+pkOsuQYBtYlSXt89i1csPSo7A2uS
# kSh1csp/5S6uISqiYvKtsR29lk8voMCfydIX8b7EJHL9kU4LkB/JInoUnfABMzUq
# Fs04VX4OLki6foZB4usoqACQyTK87wBHW8ai0bmi0NVHzZJVqx8YNiVBbHyqYFTb
# 3ulUEISZpUBOGe/pSCxnFq2viijzq1hrwb+dLI/35KBvZ/TOEwqLAck9WSSVQov9
# QEsK3RuHrEHAwH9FNz1y7Iw=

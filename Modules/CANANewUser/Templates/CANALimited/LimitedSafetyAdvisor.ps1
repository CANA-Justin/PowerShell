<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedSafetyAdvisor.ps1
	===========================================================================
	.SYNOPSIS
...
<#
	...
	.DESCRIPTION
		Adds the user to the groups defined in this function
			...
			tfa.SafetyHVU.Read  
			tfa.Utilities.Read
			Viewpoint Users                                          			Vista Viewpoint Users
			VPN_Access                                         
			XenApp75_Users
	...
	.EXAMPLE
				PS C:\> Add-LimitedSafetyAdvisor $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCP9axYXSI0RTmw
# 6m2sL+OWxNpc0VKxRjjWDrV3Uq5IQKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDgEkXUuliP7/4kayT1ljEh178WgrWe
# 2DPqNKhMBT4yHzANBgkqhkiG9w0BAQEFAASCAQBlWrkZwWxF9HKMv21Nc8o836Ws
# YzCv7b5UmRko/jbR1vToIOXSRykmRuBuqpRIv+eLQMTBMvM7aPHTD8BUH9XKh4wB
# GToK53gQ8YheDqhE97wn1pbF2yo1pzruT9rybg8JBT6yjS2oJHkijA9pCoIODUqN
# WI5Ac300+tJs3N6+mVp6W/KayM34UbyiLAS2ip5OyNzbfHAuNHQ0JGWSA51T/D47
# 27dPCgVcNbVytP1l2OpZWLuL5AEcGI9aGIKwNWFuAfkI3OnJZFp2EiDQUgupcWB6
# OwZ9pCA6obHPYs+9zbdy8Nw6X1pFhAjxCBuivuLmZXhLgkqoCJbjQk53pUL/oYID
...
# hvcNAQkFMQ8XDTIxMTAyODE1MjM0M1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgLPCmBveQ0lXi
# CvRE5WhKfRzOnlZrDGiljoHggooRrQAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAhKVXBDdELOP6HVa/YkSwNnqQ7A0bVRSK9Hl2LIh4p
# 3ms9QBzOMvDtYEdiN2hbj/MVdfwloeI6gC3uYB7XV/IKhSMVzs00atRhlahoHpao
# 5ajzhIn2+6Pu0MjOkFMjcRgeTgz7fuULqZHhVcxzvPm4fBc5MYkL5QB8xWvTYOAc
# l9vH85C8ZYBfIYMT0fat60nz9NlCdK+Y3obv8ZxFDAnlpgjOAdPNVwMmJQgZqwzP
# wUU6Ztjg5Psc4wtErVfYz6mrIpa+rTLufW3PBHDHl/UxVThFq4DsL1/heYr/QAgr
# X/SBHOfU3SazEiEjmwuZozil2RKyoVEhD6Q7IJG2tqfwH3aq9oJNE6UJtcIzekYY
# Dklq/mkkl9lXqtqaZTDZLof4Da7XxXTVzZ7zimPUkyaHV/Wm3YK+HHIsc9I1vU9O
# nxZXzLoQE9hXmWUriSdRjTq3WGUA1C8PCW/iNgFppqEDKLRzKlgbILnGTxYPdjSG
# OjfTVcUk5cnc8xscZVo5XGQ=

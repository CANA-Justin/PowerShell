<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedARCoordinator.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedARCoordinator
...
function Add-LimitedARCoordinator
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedARCoordinator $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCA/T3WXlqNfIpx
# vaQRfq6RKtzWbrL7S1u/ZVuAXqK1bKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBiWU6/FBMf+wPjm2pzAbS75CE9XzP8
# yGPFYLkH1lPAgjANBgkqhkiG9w0BAQEFAASCAQCcdH9A3+T3Dr97sihqME4QFCgW
# 6ylFgPZdHWI1UA3CguJ9yciYV1jhqPwdBIKLro7mahnKjqs/tM8lJTddmM6tio5F
# pBa6OukcJZ9p8/odfCEQvTb5RO/tg6BSJYy/fv/z6rIdaoibEkCfMOiQJnRP+SPm
# 4Hvhh+rloRwzHAbMERauimP/Hiy52v/Oj5qsgtgTj99d3ZjfLhGVnmDNEZMb/MJN
# TrBgSbGeMGleON7ixJ3nwHaTx/67LHMXV53tNKtqpSaiJd5uAAjF9Q8dmVM/5q9p
# O5cKCoUJPlXY8r9KGI7miig56YJyyNn0n3ufhWuhdhUSsAudLsLvxnBR3r7BoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYwNVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgHhpCzkEfz6uo
# e1PHDWkK5DjP1gAZFNOoL84Sf6J1gqswgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBJRZg4bP8ngKiL1fO7E7ydU8mw46R75Usg2f9nRsYM
# 5NBkEwWhdtTKcaAkGSwrdSoi/aFRq58vD1DcSOeCsXuVhOglqvzDIym1GqmUx/M2
# fc0Cu7vpc3dxtd0/YJGgUM58s9ytAYfeX1/Hd/H4DKkASt/OLP8phgy9zQRIEjz/
# 4s4dXBnO6RsqQsXZedXrYuyNnByxul7ULwnWVAd3imTOnTKH0QB/1eARpzEseMsH
# IP7PPzvVBWZKNcvrYG2t/MjvEGLgu41JF0mBNAdF8w9JPRradp90CmQQfQ9//KV8
# Px7dnGaaDCNUiG9GwFu/fG00KKbSC3ArFztfrNwxvmFaNBW5ipAihYHIWUMJScYN
# gGIUbAP1knqZx6LQGt4gJTxFKk4ILNFYha6V6R3ws+hBOiF8K5Ae6voiZmnDlJqg
# udbHf3J8LG/nG+cgtz6S7C3v4BHmZXoPz6lPNsMLIlJff/VEwQMpIA7MxeSkBQR7
# ChWZy6egLOqYOfkywxocEZo=

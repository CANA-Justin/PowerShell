<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedCommunicationsManager.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedCommunicationsManager
...
function Add-LimitedCommunicationsManager
{
<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		tfa.shared.projectphotos.RWED
		VPN_Access
		Drive J - Business
		Password.Policy.NonExpire
	
	.EXAMPLE
				PS C:\> Add-LimitedCommunicationsManager $Username
...
#>
	...
	$ADGroups.add('Calgary Next JV') | Out-Null
	...
	$ADGroups.add('Group_0f30c1d6-d9e7-4462-8709-efe154309588') | Out-Null
	...
	$ADGroups.add('Group_44f202d5-bfc6-4934-873c-8721bc516364') | Out-Null
	$ADGroups.add('Group_6c0af341-fa96-4e41-9f3d-d5bb6759d2e7') | Out-Null
	$ADGroups.add('Group_6cfad621-6c13-4c14-bfc8-66367ff47297') | Out-Null
	...
	$ADGroups.add('Group_b70d1517-ab1a-45b5-bc76-3c1a4bc100d1') | Out-Null
	...
	$ADGroups.add('SP_Communications_CRM_Contribute') | Out-Null
	...
	$ADGroups.add('SP_IP_Admin') | Out-Null
	...
	$ADGroups.add('SW_Contribute_Users') | Out-Null
	...
	$ADGroups.add('Website Comments') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC7XT+/EN0DEk9l
# ft/kA5sq3QMacOlmuHM4pGzmuMQIZaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDp9wqgHLlB88xRYeCsomSoBM8VYx4q
# kr4L20X2XsK/DzANBgkqhkiG9w0BAQEFAASCAQA5PBklIm/5nPo6V98/m35BhOMu
# cQwVEfMJNEeUOxx4tYOtlXkiKFeAxA5nbdD0dN52XGyI9NRfSNkmBvGhiEs5wd8j
# JlN4C7rxfPGOyIXgAawwtIQxFlKRxd9OMjt46ZCUzXdNBzrhNxlb2EbsrUgcjyMq
# SFKraJLwvenmnsLZ5JjpBK7gRetbhPsu3oOJVpGIPWXMk9QN2BLJ0CEci4+b5nB4
# dg4ZDBCAxQXwRdYSEan3XNElrsexiskmWwzvqdVlexB0lcP5F1pB0U6F8sPEAp8a
# YnkvuNNoQKtdrecwfAINJaxtC0PLERya3jp+o//BI7VLHfeQ2yWyV66V+fqroYID
...
# hvcNAQkFMQ8XDTIxMTAyNzE1NDExMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg8C6V6We0z4Qk
# OFLqWU7dpLLMTw3KUJtcqUt0gevt/+IwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCqumrfkSHhWmIywTeBVTyAAXyLRtGB1SQWamUfMRgD
# VJ826m39v7vcRaxtpGz2JOiqecBfx/XOWYwpkg0AaecwwJZIpZZ81KJsAfajt8uS
# HwHrKXxcme6xM6cByqVfNgZnHyrBr8GBNJJNW7NhBVZmjgwAoaZ2o6bqASgYAHhk
# O3qYTRM8u7MfxqwLCaQfu2UZS1pXLEiZuoSwOOh1w7PMBwdoHdnZlbq/p2LaW4hL
# QhrN74T0SwjtLWmpFKcOsG2Dy96mL+cJ1ZQgyoMJcympqteZuehLCwTbpSs9hx64
# Kc2fpqcCXs9I4Y0rzoYzfSdbwry5EkBzf8qTOFYv1qqBuefKGg5u+YdioAihIAAa
# cJCmgSYQSQPUs1s+qHeXBt2vBDEa0lItJNw1+TaKcHPvfeu7I3PbMwTgGL3PwMX7
# gKRuCAZxAEYvJo8H4Nyf2tNpqUAwum+6JfNPd4sjwp77tLNrvAxj1cuFT3AFxNh6
# HM6A4yqAL8gCHr/WnyQznYo=

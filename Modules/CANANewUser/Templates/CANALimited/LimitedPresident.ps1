<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedPresident.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedPresident
...
<#
	...
	.EXAMPLE
				PS C:\> Add-LimitedPresident $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDsBQVeu4Cg1IL2
# G3UUhGG3y0dfJmAlAUqOePIDuafFj6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDcupDwodpu2mCBge2oEBaP+NdYLx4G
# DfulRrcdxCurUTANBgkqhkiG9w0BAQEFAASCAQAl42l6+7MXABZIXc9G9SZsEaLj
# /G/y6w5SALIp5YfCh20H+iXHMCA35TPjGwVpuInXcUH/8WaUUVL4bSfCuchURuiG
# KeW2U/LGyURx/q/0vmnBCbLwhe4XVt5hmzw26Gr7SkFdac8CB/FkPxhSlHN1Vayr
# 8hA7GhFkDJ7s6SXs6dkbgtB63i0Adg3ytUo3YuOUOtaOQeO5wLZMtsZyzC5i9AMz
# fmcwTJ3k3ftqNC0rtFOKRk8B1PbYmuKKs1sCjwlO4SSq8NuyF7hNvSeNXrianhvV
# 2S1WRXhrVE+qDaTtsQbd41VWmkhjX6GYOyvCOg9g075LvrYa+dD/+EUTrI0RoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYzOVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgtnTgMNUxEpkM
# St5hpWm1pY8xN8MqrCsLa0dwMSI971swgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCHcPis2JX4CaJ4lN7LCfuUBpDw8x6sNlJUiFWrYfC3
# h1LmRuyMYPxaYPN9meyRcp6h5SBglhix4Y5g+2vmCDtc7EETXzzYPHbFIx4c7+qU
# K2oAQLwdg2UnvMEIdeuWaBPpWqRCzEvEf5w4/NhxUKp4Wo7Va8/ZropAxs8/PuPO
# RH4juTlxe8evdJVZZI74TmdO0bjzAMKyxX+W6tBjtw3HzV1nqoDxiCbTyjQ+H429
# B6gzXRQ1myafxFR7tm/y5ZMG/oYIShUnh5oJsPkVLTiOr6KKPM6T1w9PWp6Bj2Ka
# KTT+x319jar1KDgtbwQA0xrf3zhTRuavBULUll6J0UyGpbLmQ76/1w4wfa6NPkVn
# BrdB9Vy//6iA85zMIjxpU6WBXtTHueGzXtDfICLTESF3mp1hXaL8Co9zMCqP1ZsP
# lRNn2y5c24Em96n94+5vSL2luOefOdIeCSHQBqW5q0l2VZfp5Of9+UPPKjGq12a7
# 6DFG2V+I50LPurx6jhYZiOE=

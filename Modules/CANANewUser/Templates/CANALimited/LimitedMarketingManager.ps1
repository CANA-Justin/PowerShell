<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedMarketingManager.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedMarketingManager
...
function Add-LimitedMarketingManager
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedMarketingManager $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAEqH5OOoozLpSF
# xNvK6WCMiLJwv/TVduQy9crL29exiKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBrRCNaDzeqxrrsFpd+porg9rN5tuEn
# MAX0LDvCcb+O5zANBgkqhkiG9w0BAQEFAASCAQBSwozmNiKbX3eSU8P9UTgwu3PL
# lWJPFhx++tHLViUQyhsZJ6ioi9QngelRtPCNBTEzvg6ZlzvglAaXLAORHPEbLihI
# XcAlxL8amuVZYcwsfbkZPOk9607VOt5Yq/r0tntWZmMAH8zXlgjE422ppasUgVHl
# ZrFfHlDu5GTC7G7hLMH4elta+7Cla01tNgJwszOKOwH+7fZO69/vba9zYHsxyi37
# Dbt3Xji4VH67mmy/7iTM2UATTTRD+VGZviVJwT3BKJyQ9X6f/7Qcc2pijeNsopLO
# OBhXfB3ZRlVAuu87BfhFHM8tT/SMiZONg81guDLqNoXsCAdqOsGuQRnEtjvYoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYzMVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQghpOAvWufh5an
# BW0A15MB8kbW1m3E0ErU6xPl1LOfSJAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBnoF76ODofuQmhg/wQMybDmlqVgXp7GSZFgZLXDkrp
# WDH1pZrmyRw3jjoHA38keo17G5gOCI89BQZvAVdTlV5F3DttzCuKdAcyDlmXG8Qy
# Ae1jkehobGj74vxIi4sp4ML1un1ZWm2zFnaY1tzwgtNUn763ocgboNQEokj+nL2b
# cFfp9URWNMVGWtDpEWazc2/JLTyX+eA0SQZRANP2yu7R/ODNNvqcqbMiXr30qP/j
# /yWKJ1Q7sMWOpfzcouRQpm3vYJSz85BPnEfa1oVDypuG12S5zwHqAzsidI5uBvDV
# dgtMzgox/D4ksm4DUu/acLV9LmIKJvmmqQ8bil7WQTVDyGPdvRFpAIe8uBNrFvmc
# YakJG70Kpscwg0xSicaFjunVvZb7ThHOfz9URQl3Sw1A6T29AkCyUbVstt1OGSvA
# O+/+JmwPnai1kx9p4nmV3cYGHBCtN56WR55a/fSs222Lkt1TIeS2y92SAL8GAs7j
# XrPfBfKKFk+5oUoH45v7Nvs=

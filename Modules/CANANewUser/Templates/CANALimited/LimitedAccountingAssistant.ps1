<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedAccountingAssistant.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedAccountingAssistant
	
	.DESCRIPTION
		Adds the user to the groups defined in this function Add-LimitedAccountingAssistant
	
		LimitedAccountingAssistant was not assigned any securtiy groups by the company group.
		The following is from the LimitedAccountingSupervisor
...
function Add-LimitedAccountingAssistant
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedAccountingAssistant $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCEZ2MWwSPC+rTi
# 4M4/J1eohokjSyIKt0RH31PMeEg5QaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAPjPhU2DJm4ZXUOYx8M3S3rbt845E+
# YpwHc7jUEc3ExDANBgkqhkiG9w0BAQEFAASCAQBxuDAm6uMPNMwRs7+dFOYb7Wel
# 2jJHWTF70rgu+KdM98/0iGu+h7k5Ezp+kCFRTqeG11mNWhLQ6QpfVZ110l9pVK4G
# jRGjFdztSBUpSVTGCaP5X3EVkC2OYqa8hha+CkTPiEql5c1uu0w/IFJFUE9CtCbV
# VjhRejj7kf+BTG+tsHPd9+nG0Dy+Knn3IjOk1E6BUKzFM2ZwemcjTAjcDBlIQ+J2
# rND6+FOu+k2QWc5pm62B0rxuDiaUy4s8C/sNYR16HrCJ1GZA9t1yd8pVHbh+sVKw
# btQ2WkaHuHkMeJ5oSrbGa95ftCYMZxGQNhOxHoRPcLtE9B8CHps5+7FJs80aoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTU1N1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgOn/07eYxQhFP
# jnXg2sVJuxIkiPhvBgSDYYPm2kGjNrswgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYB15E2Xa3Y0XJvnZ9DKPtead9JSU8vRTpwTPXVTiRjk
# sVwbuIt6DpzwbqDSj2Wt7+Wf05lJ0/6pAM6c9Pzhl6VjxAdzbfn3ogy1AB59767R
# e2IIhjAfECviG1H+lcmUtvBrqcRxPo3QZOUmsgbx9FFtnoY7WcJoUwJHCX6CIGca
# yslaUG4OAaXh+LdzknP+LdszK4mViEX+0cxX9t55YRdHquuKVZrC5PTroSDba5qY
# 6I20f5MxkSdCZ9eWM0JLY24rW1urlGEgCxOrHaU7rr5cDj55sPRW6twb7vBbYxa3
# LljmjcT/po4tbngUHRM838N1HsqQL7L2am/gyHca0NjgLXNUQQa0uEg+Jk1Ef4oj
# b8hiHqbG/0cX3Zrwyx5Wpk5XdAjVf7dOGbM+JFEuNAggzu7I86dYgeWVMncCnOyt
# ORevIF6c+KOa+3V2ZDYOyHsMEubN2QUa71h5xO8KCTMhevzOMCV6gLv9SkVMjMAv
# mvSwYCJnU9tH35KX+xksRlI=

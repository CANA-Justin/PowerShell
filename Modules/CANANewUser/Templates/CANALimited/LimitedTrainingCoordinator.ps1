<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedTrainingCoordinator.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedTrainingCoordinator	
	.DESCRIPTION
		Adds the user to the groups defined in this function Add-LimitedTrainingCoordinator 
#>


function Add-LimitedTrainingCoordinator
{
<#
	.SYNOPSIS
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB8fp9GHS0Mx145
# su12kyPTLvKc9Eg3Y6O9GNLZjFzyz6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCfns6HP+ll53GdM2DWsr+CBPie8gLl
# 3jPXeeOGyOvQ8jANBgkqhkiG9w0BAQEFAASCAQCRiO4p1EeQqmnBTShbxoTqhhhO
# Oa7UYlIWkaxIGWcH6x87CFKMyjnjr5yQuJs5tWQ6rqdqWWmarowJvp8P16ss6GEx
# R70LuQCwYD3LtJqxGrdC/QcrAtN9YG4K7ZLn6U/2U3oJqJ1d99/C9j5LMTvQEET2
# 2LOxZNagbXkm4VYI4ystRC9oq+ORjlbrXKWXjN5K2LZ65R4XfwuuegCbfHy07XlL
# larNPQXoZ70XYWoRYiMg5IcKwylU3YZJsMJcPD71y7MZ1NFx97vDoEVj8Ok5DL1i
# 14u0Nwc2goeVhSK1aKWr2qpSWAp/AzLvFpCQj3EVjSoih9kPv6Hxy7tXPyy0oYID
...
# hvcNAQkFMQ8XDTIxMTAyODE1NDkzMVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgsnK42wgoFyTL
# M6o5VZ3aejA1p73UbT5K/Y53bNL+UxIwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAYpvOA3ovux+z6FoNh4opny5BKQ1IohnqOVFpJ9/8g
# 7AUW098qQhvn1nfZEv01zitJSK0YNqhJx7wVhAAUa6h8ftSc60cajTBJpNLOHnNJ
# bwTuQOkJeU1MJH41TunLm3EVTWjr8sIkz4oAZ26X6l8D9ELPOyT1WxPNMatA45AF
# p4nQ4uijem6ohyWNiXAT1DBUQV2hu/PPkbONYsIl8u1iL2wbJoZ0k1tnLk0M+KHg
# 3akQKVxsDT9Z9LQXDmXm8Z3w8A0qAl3kl4zJKMxHRYij28HFnrNDq1C37Zue2cmK
# J49kOP/XmkZwehzr9HMyz0QIHVPpuGBf+1VyaxAeI2uPstO5U/VJB6n8DtNxCxl2
# tvSX5zVSzP5GjyNbVHuAOxY9L+H276drtgKnn/+vP3chV42/13PA3at9jwx0XisM
# YUGTV4RC8oR69y+HZTK9Sy+1C+ECcyC2GNqqN2okpZVH4S7DSRcf+/44CUCr3Fgx
# WKP9qVYY1BtHWDTNuGciG9c=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedHRAdvisor.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedHRAdvisor
...
<#
	...
	.EXAMPLE
				PS C:\> Add-LimitedHRAdvisor $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBs2i5UYFVl1swT
# DWe1DHO5lgzX5K9WtEg2wv6W4oLGsqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAqsrK8wf5lNJg5r7vsQwYTmT/1VYlm
# rn4fLzkWdWe13zANBgkqhkiG9w0BAQEFAASCAQB1J/WFxJWKToK4+vh4kmVjYis9
# 9bOQBmtYimdzMcl7eMdSTfl0eLKsowyQ9M658shHKos1JokCl86LXykCnKdalKQq
# Eibk+qT9k70GPNcnrTXlcqTiSX+vEW/kPl+eJu/+tSGLowfPLNrx+nmpSldhRPt/
# DmqF+0v/qmF+66oHKU9CB65pFzRAupvNlW2O4lhixxr1PjaKBG6Cq0w4YA251Ulp
# gPOGuKYSSXIoWKi6N3TKgFO7+A1UyPxoGzDsy265LpzmSXXwz/pfyDr9zitwaIVl
# fZVj5cFwv65Fh/bQCup/8wlzNKVunu1vFXkTuelzHFJTOc9W85Gtc31mGNPXoYID
...
# hvcNAQkFMQ8XDTIxMTAyNzE3MTA1MVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgSSY8IdqCu1fq
# QFHhMCcNGFUCA/oqlyWXbTOydPjy9WUwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDT3p2TetRSPTer/7W8KEjJnI6VR7Qg6i8b4H0IjsXa
# SabnEkZHIMkxJ00d25ih8JVaFMMa694svhPzTBydPeyGt4WP+0QHsoNkSYJZgkLs
# AijIDLb52M+a04crZEXcXZ12G3oK4GYmSPLKe7xoCwCMmu1vTsumGnxK3z2qsUsn
# i78NRJvp3aJ5J7UL/heeGR12p/ll7j2yOacShRziA6bNY8r0fHlrITNi+5WtFoPK
# xOsK00MbJB6WXArUm+eChIhsqXqMBIwDX4W7B2pOMAjaOYSrrjW6J2M4nvZ60xh7
# OYKkseGvtAfT6MPOwcJZJP+LFBdZB4tVk8A8Z1opZV4Te7+arrLOsfBBaYnT2DM6
# 3lHueUKHDMVFnuTN+yaQtcBj7r78xVvIsHivc8abNHOm8W2o9S3PJtniqrvN0aW0
# Lv0Pm/AnY7CmeEmSfVroOxYxpMOe8eg34CsmyzqCvOYfk67LO9fvs9BKVFCY8tIX
# +HUHFOxM/n58KpTaTePTr6U=

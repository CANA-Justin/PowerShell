<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedHRManager.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedHRManager
...
<#
	...
	.EXAMPLE
				PS C:\> Add-LimitedHRManager $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDQ5rXMa1rpByfd
# plAllE42ASuF5f2kDgHR3/9WKtzdCKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDFu57W3Q9Im55I9aKgOVymYwj52R7k
# qcGclk3g0ws9XDANBgkqhkiG9w0BAQEFAASCAQCXoUhafm1RveXZIGFx/8PKslfv
# +4JfGdxBalMjParFAs9BtHJKhQB0PuqL3VgFwYnaUY70CiTdcghJe7NkBFYfdbTU
# WFGRanikUyl5KW3TEkipCAd5Ki0P8cPf1FONwiYVVf9gDMnA4BBk+9UVed38eV5h
# XlwQagwyrjMGGH4z2LcyP8vnS69674jTNDNQgzk5S4Ih6BPFIf4TyB3FtegUUtHx
# fA5myasUBln1LhEiHsDyF/jF4MyCIRkmSiKkaFolJMWpPpmv+1+b2gKetpvjq0tD
# HPV5wZq8SwQSHHgpmmBa9B4JYz6NYKG4rj8gy3HfwDfSwg7XIaLwBEfj8mHyoYID
...
# hvcNAQkFMQ8XDTIyMDEwNTE0MjQ0MlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgv2LoPrp5Is25
# gX2wzBkrqeuPZUcdX47v0bvCG3PQgscwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDJARAZzS4k966HLt3YPlGmTCHQe0PwaaY12OgUtH6G
# V5S5d8Kswe/Ju77ae8Pxq5uP1rXzFssahbOaUfigBWtrMgmcs+yl9T9ZZnxl2nGF
# Bd8FDjdK2rmchtPaAmXiL+oTAvs645prVQPM5ekpVVGODI5hjXa5zREnuaompEsD
# c8B1rZ03tLDB69/WgF7muPKYSzs21FFMNjsDNslpNelWJJJOheoZJhDNJjGqktpo
# 7k5K1VCzUNWhGfTt7p3+2I+0BmalMHmtW6jNfCtjfqXzZIh35y4OXwi/OKi7aLrF
# XaKUdjsvbxW87Aj6N9jUVZvIEHLYlQzndXi2OBmf/K2l6sR0jx0jnTw547wjhIZh
# bvV5rJ78PenLv3HIgPLzAXsp/2Hqi65n68uyI1J8EShvBL7F3/pY0XJlNWaS+quT
# GneeU8OygcYjudD4IFm0+i+eBW1OBxjodtmHMRG9kSX6M3lQmQRK94qGC+SKYJAT
# VnMfl4fBzQfKw74WkQjFvao=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedProjectAccountant.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedProjectAccountant
...
function Add-LimitedProjectAccountant
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedProjectAccountant $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBP09P97PDHT1Km
# LjdPpRXabP2twmcB/litT6SyxgxDZqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAJKwIIbPaEg+SvPfoflTn7l822ktDR
# Wn/3ksutr4P4dDANBgkqhkiG9w0BAQEFAASCAQB/foB29sEQfDl/kN+W+WUwXmKF
# /2nMRRC7komrhdqgTeolWPhfyZhNU5TJd+e5lF/4aCEGwu5ewU9uSa05HIcwZiO5
# s0vqbPMzzC6H81w4g/VgR9AB91Yfia3tPnI7040W2sWS1mrYVZCrvq4udbbRJQOY
# z8WmOUnCCZekz9pSiWZi5TjFtl2bXUyCidISBLN63y2Kx/eCFaIurSDgnDRGY8hy
# o/FO9//VJ3JS/LVNUelgLrwT8b3keUtNWe++hTaZocAf+xwNcjvTbiujy88QsNf5
# aI6+BHf8REfEgYf6ZHAc5Vc2ZtpL6PTZax/dX3quA9EqQn47c6BTc07b4UkYoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE1MDMxM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgEwoFXfmpeBiT
# Vaem0r9WNFKGj5uqRLJgSE31vGA9nTowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAv3aEUsUBpIymC8nHe9G6vl9jgNnTSXGgiXUCIfCOf
# eI364y6h/Jdp0OOOBw1J2DS7f5EwyrrOG8GRVSXLgALvrLRrjEGaRT6ZNrJtHgFl
# nwW6HK9YSRO9YNjmOfIZXa7q2hRRMC6ggkIc3rDjPEVp6DvN+200g+4huP8+s9r3
# DxPrM1WOqptglTivgXlH4rCX9Vmnv/TnB8Z4iIrQ6mjzOxWAk0nGWENdUsirD5eT
# DeIhAZlW9A+gqWwl2b2i/Apn4fUesfgBNgUFC0Gi3sACx0pdyvp/InJ5WLKkR80w
# 2wJtisaqBsjYPCmP56l7xtelBkE/GYUb+gohOTRxctZxTsrbCj9vMyPZQs16Jr1Q
# 26eEseu8yngiP+ZCaJy0Q+Tzt++iI8cAjjfcvvW7ZlDhmEhq0oZZCp5rU6ojdUx+
# r2Ow/wyRsGa+4Rp/aw1+kM4NWmNdD63OCsDMLvGU3NZc7FjDm2kLOt9lsU0yceT7
# X8bnpo1/nDz4uHxIeLnyRQ8=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedPayrollAdministrator.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedPayrollAdministrator
...
function Add-LimitedPayrollAdministrator
{
<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		tfa.CHVPivot9.RWED
		tfa.CHVPivot9.Read
		tfa.HumanResources.General.RWED
		tfa.HumanResources.Payroll.RWED
		VPN_Access
		Drive J - Business
	...
	.EXAMPLE
				PS C:\> Add-LimitedPayrollAdministrator $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCArE47xQfHGx0YU
# hwhao/EzuJ+s7pSp+J6CKL7Qzd8Z2aCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBizYS2k5YfkZ9cvPUrQTnHfTzfqJVq
# AMIoS5oth0gozDANBgkqhkiG9w0BAQEFAASCAQAg/35HAz+feLGylzjo9KMpq7EL
# xlcJQvJTYkh8EXm4DmszU2+hZZAKtLK+aWrrZD5u/aaFwpf0byhWpwq18irpm7vu
# uf7/bAOd3Y5CwHar0Rx8jeXYAPrBsLqsXiELev/5r3ZIEd3cMSInoT3MucZfmSss
# I2MtXCHvYpcCxFXUmlXGGlrxc+2FtqouaRjHSel6Xh8zgt+k510Sy9ZuClA97yGe
# BBzTVDtyApeK/7fcekv1BqD6ko77FAkzkLb+epl2s1ZOIxEvq2acMhPi7vIGL2aB
# rRLCbrZ1Qh8uNK6yZ+BiYcC7Ry+rSWnCucreqgUD0Zzvot+WskR7GaI9kebAoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTYzM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgP4bfu4rRCxG0
# aPS+vfiS7xW0TMy3GUqse0NKtQ8qzMIwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYABIiO1sUiJG7mhCV8o/e3eQmblZ8HBNJRNwNcYVj9X
# S0dM0d/ZGTjLu+tYAeqmLVuT9Tu6H3urN1QIMIW3YT1ZmcXiGsCbWkFF3jaMoZ2Q
# Xc75fA3C/dpWIHIoSQt7OQ9Nnf2OUG7U1nDGwxmntclkOMJBF36RNKYBDFB5yHhd
# j3nqBubvytxY305zrhYKpbdxoWRJvY9LkZr/cTtm8qnhrIsSf3hqI6V11xVs8EzW
# /ZiaxOenEco1fOOCAD6zpTETutGR59CkYI9So4OyFDWb7dlcvgwbA8I76pGpRBL0
# hO7f+Czg9nuvTP0XGoNS/wciIwFhPSCxWAN2kAnbPQs8bbowsxkabW4MkdaRNdmc
# dmxIZ4FwrTpYjvPXE+dQHjaXaMMyD4upeK6Wc7yuXPhxXUISWCky9sOrWtk14zOx
# vDy9RTmYjJ7ohiwkwsT5CzsQoicppjMm/tQzWEbm3MhiHTph8Vm/7JNmpzQg/hPy
# y0f9JB06OqGhwQKzlDmcs3k=

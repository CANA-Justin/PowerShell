<#	
	...
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedHRCoordinator
...
function Add-LimitedHRCoordinator
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-LimitedHRCoordinator $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCvdg7YfA0nrl2u
# Ru1POSvPQcp3TpTQH5je7xKXf6+AGqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBVEvf8A7y3IW2iGkG8XzB18VGyKlVt
# PesXorfiI+HD9jANBgkqhkiG9w0BAQEFAASCAQC57Z6yvD0hyLWzZChvyGFJ+af0
# +KtO/Y+XZTYbM2QUgRICNi6ab/zKLlMk5xbxdJLVJ0rDp8JTGVx9peXq02HmJB0W
# O27OaQ4Ibu6pv5h0vZraLEJ5CtlssLTsDMTb0nuBM85TEsewZgzqvINyLJIbUhFx
# /bxXa8A7F26A4Bj7I8B6UIWHhJ+8sq7hbwUs0AhWjYS4kV+ok6PIat6e0UAucUSu
# MGxpe7BPOE2bgEhiLpl0MJ7CgFax4PDw+S+WOZacXIrMQZvGTolzAOPmUbCvkypJ
# WYWrljj/AROSbCKpQgt2jttVKHsuqPlZ3hKKDFjg6yWrE9P47PUn07pVQrpHoYID
...
# hvcNAQkFMQ8XDTIxMTAyNzE3MjczNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgzAlNlk+Bb0Aq
# Wr9x9ASFw9AJSEHWIYDWHCx7XhQBtN8wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCsaHZmCrIMUMJPi8dxpT8EXPXu2IxvCNAwHtLXaGSp
# rTt5qHuMIs1RMKL8p7oRSiymzBnMA3B41UBACaGrWjh/C+okEPs7gN2BKl5wirym
# UgFclN4XvgSceuuvdTDmrmQP4q1SWjD+nxeJHCxUVj3HMH7VgSaw4b14gch7O1w6
# hHQZp2l2ppJiCdukYpqWuzbzKtGHGsGjzZQjxiYZsHTYOFd0g1IopCEUaMOYvLac
# Jr6sVe75+TPHz/wczyUZ+nzBw4jxAJkM6L+fyRcH01jhtl/gxp3oYPXbNYib5fnI
# 7TatSRK9Jg8bUFT5OjnSPJO9F/BRHL5RZEiupR0+69rwPPxRTFnE1vts7Neo3XTe
# hHspquHpqE8MvmBO0z9Ys3z4CHSBpcSDQ2ao3Uov0CdI/PTwPdDGeay6ScIXIF1h
# B92AXSNQtw746MupifF2Zid9aiopRYRRpG50bUXEFWTh0d4YnYeKeibk6b41VXLG
# iYw2/UL24X86u25VJnZ3QEM=

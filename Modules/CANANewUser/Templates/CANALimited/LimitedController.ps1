<#	
	...
	===========================================================================
	 ...
	 Filename:     	LimitedController.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-LimitedController
...
function Add-LimitedController
{
<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		Acct.Budgets
		Acct.CANA High Voltage
		Acct.CANA High Voltage.Controller
		Acct.CANA Utilities.Controller
		Acct.CANA Utilities.Proj Acct
		Acct.InterCo.AP
		Acct.InterCo.AR
		Acct.InterCo.Finan Acct
		Acct_Eq
		Acct_OtherCo
		Acct_Users
		...
		tfa.Accounting.CANA.PR.RWED
		tfa.Accounting.CANA.ProjAcct.RWED
		tfa.Accounting.CANAHighVoltage.RWED
		...
		tfa.Accounting.InterCo.FinanAcct.RWED
		...
		tfa.CHVAccounting.Database.RWED
		...
		tfa.CHVManagement.MonthlyReports.Read
		tfa.CHVManagement.RWED
		tfa.CHVManagement.Read
		tfa.CHVManagement.WeeklyReports.RWED
		tfa.CHVManagement.WeeklyReports.Read
	...
	.EXAMPLE
				PS C:\> Add-LimitedController $Username
...
#>
	...
	$ADGroups.add('Acct.CANA High Voltage') | Out-Null
	$ADGroups.add('Acct.CANA High Voltage.Controller') | Out-Null
	$ADGroups.add('Acct.CANA Utilities.Controller') | Out-Null
	...
	$ADGroups.add('Acct.InterCo.Finan Acct') | Out-Null
	...
	$ADGroups.add('FWC95Approvers') | Out-Null
	...
	$ADGroups.add('SP.Controller') | Out-Null
	...
	$ADGroups.add('tfa.Accounting.InterCo.FinanAcct.RWED') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCmI1LQBgP0jChE
# eTDJOsyVE+9u9CqWOOKIazZycFhLbKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAOMsYoDMWExot305IzC71aIcE/QAWA
# Ib42Bcli9EyTXDANBgkqhkiG9w0BAQEFAASCAQAu203CHt3ReLIoEE+OB4LiQjtf
# aoDVhPTXU0ESWojBSkU6kgYISWUnx5R/ZoG208D9K/xntLA6/E+wCKNdzF+rpJFb
# V4eVYzOVyOl1pBcii2QcUe8JDcSp+M07nK61b/uO78rVgjDOPDEJEeHq54y8FNci
# CCYwihhNzuP9qLvTam2mUFWG5qtOCfDd+82QbX9fQWwmMvt52quBvx2/QfEdAz2l
# TgD2XO5OHNb24pyGeJIZ9NgtdQuOk9eL13KAoLM2NQ9Q4Ubm2khlf3VJtTERL7J7
# rS3HEmi2+FV/yivYlX1PW0PVzW2Cl+pjeyz2IrUfsfychi+jdyVy7YeRhS8VoYID
...
# hvcNAQkFMQ8XDTIxMTAyNzE1NTcyNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg2XnCw/aFlJGq
# KSCwr8wdCPym9sdwqcbdYmXCevtY9fgwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBD9T7HXAZszo6P3BoCUOiMi6XmDBC6LDnOMR/+Hp47
# SYu+QvPbBwiVBJ/yF8ywzVNOu5XfHwTrVSv42rc76k1V+Zww6tiZ5Mt+BK0rDf5/
# miPbO4q1Q0sHao7AWtXclTzat5aAvae1Fzzl3aleUeaoLCH/k5GOUtYfjasfgx2d
# 8qX1HE9CEqE647XTOrmL6w8C7Qskw5r58q/8Lt3JCPgIUGraoHSIFhmvKDurHwvl
# m8wPZJxsClA+QKdg6FUWTCQ6o8geV0f1v5sPlNmTKc5+dbjsLbUyG9kpfk4Fc5jp
# qup0+KYPWZKf3TX7n/9BNqVv7QjtjhrSQq1cttLAb0gjBs5GBcmC6xKysizF5HRB
# C7Lr016Np3OjTWFqRKlNw20nxHgJHFev/PsLF4EHeCSH80LLjvU3nLp+Sb3d2y+H
# u7YPQK1bDzeUcsmkT9gCi+q7ut1fAfe4ZVNgX1EylYmpl+tLDtkmtMAqGMqLKCDP
# aHBJytCr64zOffqmDlzNNBk=

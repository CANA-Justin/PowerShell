<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150ProjectDirector.ps1
	===========================================================================
	.DESCRIPTION
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150ProjectDirector $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150ProjectDirector
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('CANA Construction - Senior Construction Managers') | Out-Null
	$ADGroups.add('CANA Construction iOS Users') | Out-Null
	$ADGroups.add('CANA Safety - WCB Compliance') | Out-Null
	$ADGroups.add('CANA Services iOS Users') | Out-Null
	...
	$ADGroups.add('Group_3f96f2c2-2238-4a94-82fe-103c829bdffe') | Out-Null
	...
	$ADGroups.add('Group_6ea82df4-8ae1-4582-8b6a-241343139b5b') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDU7BFIA4OHGBW4
# ryMFOlEgt+5im3JFa+zTV+gUdNIiJ6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDjE/jhwxXQi5eCvNwGB6Bwz4ZJoiyk
# eQ1DJcGh4Pf1DTANBgkqhkiG9w0BAQEFAASCAQABo2MzPEf3kPCwbT60jAmA2tS6
# LNYDX0foxwl8aNdQMnzkYws1XosHHnDdeduf6X/2gT5KAodU8tUDgAz8nYcwVYJu
# 3gKvHuOgtdkoSePgvXI3vSemRgBy3JfzDjv1rx09klIUrgKeokKSpnK4TSxUFmbB
# XYlndxkCLxCsplhUIRGzDOoFie7QVOOEZiNQY/64K2ueNXhBac4jqanj5ddzq2Tp
# v9IUw0AmVZL4NvDzNf/xaibPgbHu4fs61JQQ9D+8KZlezra0bd7UT8IjYxEgKPNj
# VPk8uxrpbD6sOWSZUdLBcOiXt37GoBaeKgJw77d+CraXRmlT7HSg6aGeCDv7oYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE3MDIxMFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg/sUM8yD8jR5u
# 7mNVriuSWm9BA2xnfttSHm4niFurTCcwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAaWiO/UctAI+gjoPRkv5iuK+9IrjF3BBzU9I/BmDWh
# lm/xgAiSyCqAr7Sbg5DOo5SuSkKG+nJwTKivN/k3OXbjnBWtAnIoFG1Tr0rlWe1E
# 3ES5Ojsw9R8MOwoMJV1VOro4T6HiNdd/XF/zwIM2aP7y3OlOggv6QrgeCpyFe6Gt
# WDWtK+dPRiBf8p4xQp/5HxT5PxWsj5Ipd/K0csMPvhY4BUZemws0xP6qFj9Z+jPv
# 3eniE/U7zlbuJLZYOmJJaL2eSKf7RlSYOLpmD3J9yLD3Hr+x1DuENfFXdP53lsDZ
# 7zAD481uTQP46t0bzT26cxQroRopTc95i3sxQxXoCw6dBOxegYT4kEbVXkMXDJVb
# 2j8RzM2uum0z61N5ze6UCwzW4b4idhS+jEGi4UV37z9fL/KU1FAGDkR8Wqb6NTQQ
# C4MtZtX0RsrB/9lMO55/tv6Fk6iltaY0Rz8ntKEzSWURTzUAW9YbHXvhZol3uoaT
# VIkRxwF6ZeT+fQEhcQZh3uU=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL250Intern.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL250Intern
...
<#
	...
	.DESCRIPTION
		...
		Head Office Users
		All Users
		CANA Construction - Interns
		All CANA Construction Users
		iOS Users
		Domain Users
		Est_Sec
		Printer Access RM407-4th Floor Kitchen Area - Aficio 4503 Def
		Printer Access RM439-Construction Tender - Aficio 6002 Secondary
		SP_CCCL_Staff
		SW_Viewpoint_Users
	...
	.EXAMPLE
				PS C:\> Add-CCCL250Intern $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL250Intern
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('CANA Construction - Interns') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAlGgCtobhM/WaL
# bGZ+ANzY9xf7YDBJzbZ4Vb87AZOMpqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCA1ufRd7CVgB8MTi+zKPqPef0L7+86P
# OyF1hGl1RwQQ6DANBgkqhkiG9w0BAQEFAASCAQB+3NdSDhjvCCIoTGZfOfP/3EZI
# Z21RD4OJwlgWIqeIKez5+z8ctG0WNkerE6zkNwXJNdeisS2B+RC8iWc22eiQKyCe
# DDIBABncZa4sHxpbFkDrcegvVKf1XUXYjtzqQrtHbBj10ukVjo0r4LbVIVpzCfpy
# 2A+KpaXAN/NiOPk/+QYUydIA9NQO5nDSF2rQGgi+uCzfSbv77YuoS1ouc4uqvQfo
# F4XEQpA/AlBcmrYRt+Aa3T+13nTcgsZjgNwhMk3HsED3iCU+SzbEbCtVCTaAMzBe
# M+xByuJ7/i4XBOBhZd9g/yOrSH6X3UlKrfAYKtunYwoy/AyYDbH813G6vXHpoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MjM0N1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgLUrr0C177ZA0
# ZookIWa8YOHm4C92KmgeamIIMcz707EwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBhT6ImvjIo2iNbnElVtPXXVnO6Vi9HUiD9IHRy5ofj
# 8yewRQO5OC8ykJYLCUb36U+pdJmWQV4qZ/8cdx7cy+phEPBUNZNgtSKDuStWvmMa
# DdEHDiqCv71Z2hDpbbbQRbFoYN92kErgL7wmA5CHHYDB7SYJwV1sNBFtUBViver5
# 6b+XvhHwa0BlbdE14r2lN/NnpJpZzIAypSLcotN59vEcZtYpODEGI97wHPeyg1pQ
# nFlA+OSj/Hl1sVYaMVg7+UZB2eP0sDDC8CQlwoxDYCwCwjzRdArZgiuszJ9ZuYi0
# MX8X5e/9pJXNHvHmnBEDDJadIs2nOVB2RwDsySXeFQip9i9Iai67kUcq9jRKwPl1
# jT4PXJk+oG1CFjOwuoNsdhL7iRmyYD8UzcR64amajO38Q+gc3Iy1zMEzVulDxvEm
# IKLms+N/FFflNZIESxABHEIfPF02moNfUolbACXqmCUVmIoqiin5GVlMFxqDOSDA
# qj6EQF0HsrQEP3jnu5t76DU=

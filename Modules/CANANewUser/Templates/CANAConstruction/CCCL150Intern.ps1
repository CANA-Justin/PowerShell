<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150Intern.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL150Intern
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150Intern $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150Intern
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCsejkQXE0LpMLo
# ywViC31jgCAUeege8zv27aLgu0ehMKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDEEV/oFpUTwRa4DopmqcXLUBBR/XWx
# 7xZHXRhI9p8eQjANBgkqhkiG9w0BAQEFAASCAQCDk/P9+xq2PF23k4jLwT25lAdD
# utFkmPpS2xReYMncfC4vXO7A4COjFEMGtJUJomb0ZdknbegS78d5ReZ8QCpKFPN8
# /U5/q0XviB4YVBxNLJvE+CfKAe0v//yQOxericegyVFghs7jWzp+3g1GD8YAy96Q
# ofLpmgktaXjX2ZPvMI+0AmRNUZ5p0a8aslsXXxj4ig06Ldj2zo1Shh9DumrUGsvG
# MTCryu8c01wZJU3QFqPIDDojD3ME10Vti/zgt6/WwrxYUBdjGrcr2nx+27iDDcoe
# x5U10JXMfLQ7sVo/YguBwIjbs+HI0CpSsPDUx+zNVU8HGCXGqPNMfMCN1zywoYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE2NTIwM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgOcZxKpVawgrH
# P/C64P4d37PHThjzNrBzPRGP/u1kP3swgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBvAlEBVVClWb8oBSAvuAxSeosmMcz7oHSNPv1c/pvw
# iPP+1GrPyYkYAoakFIb/U/Im6w1lMPGw68/l2gEoKli1bJk2jdZtLUoTVonHmJ1Q
# ZEX1LeR9VlA/WZIEANU1u6tN1KF6ZyGeETqwhA7hkvQ4aX4DuTcIdavlqswcxPPi
# 25Lv9JzMdXdA9sB6BNw6oA48u3ohpk4ZDn/SM6vekbJ7AkjbjMR0hq8gLwONpp+c
# B5FWbxpZL4NVdVbYBTvXH8zIc3i95tHS9lfVPqLCkcHbBivilzLWkorXwy2LQoBv
# D5Jn1USm7uL/bXDGCkzw122TWg2306s83JzQDqU6oXWSC+T7hlmhenghc6RzIxCA
# o66tQDnMGeB7eVx1PBCXA1eDTNfl1Ccz4FeKw8wReKrdmldpRoiISsVYcJ3r6ZQO
# kl3PqyZI0KmPTGoCDgBMOFUFVQm2FIpKtAKrgsGwllVoiNiNXVSqp/tA+GPNCqgS
# EquvFMK3/yra/XtN62M2mQE=

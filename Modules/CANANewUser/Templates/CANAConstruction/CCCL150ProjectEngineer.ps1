<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150ProjectEngineer.ps1
	===========================================================================
	.DESCRIPTION
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150ProjectEngineer $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150ProjectEngineer
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB9Y3QfVaDtQ4Nq
# EfUuawI4kyNixz/1WnnChJ49p/tC/KCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAHbUaBRsBgu8sSfT5DTzNGvbF4+Bbk
# gLJA0igTEiew9jANBgkqhkiG9w0BAQEFAASCAQASaOlM6zOfyCybiiOrS7sWmFxq
# kWnf8/3vSLdsPIloEKLZAkXhPtXpYzp/osjT/2u7AuEMPhRofB8KQGNIxEywwldK
# qphRP8rAYTqzA6BnMjwVOIKtdSWpsc5cdnzNT69Nmv7x37JRx8QDjFf1REgZ622I
# 9bSIjX9Xiq9C1o0oXNYYenkrtvtqHaO0fya9F7nzXizuecDC/YqFDCXTvvdM3hfs
# 0lUb+vCiPnxuSCzCoF1FWLniDcZQX6wO13GX2sAEGb9PYhKQ+nZXaJ8b+qQskZRH
# bAmAS/tubF0xhAeVM24ljqYXNozjHgsOtdYhP+9bmUs5SXjPjnFDwSUNDMjIoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MjMyNFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg9KvsfKJkGUV+
# uh5ScGX9BHQvo3f/qbsP5f4pSIaDFvgwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCui29Wi70ALNc+KHFjqbcVpekrUwaK3u4YILd2CNks
# egBiYqyPmQZIDub7S08uuvSAC7Zi5l/uZxzkEmUu8/4MAAH+IkPZEI6lOpTtsSoy
# ry+tvjTnALzkTzRYSlr6RV+Ubro1CsUlbwvnrVkGqcSKO/2rg9jQUi5wYYt/lfDd
# xjtgvX9aWkgjVxsdYCxEtZ80AiB8mfyGMQJ9zefMeaprDtYw3mRSigyJauIdB4rt
# ZYTS46xuHH1hqARv2pYY5Byv2zgHJPOZ6AqQ/0uhHiBS5vHwV8gJ7/LHgbKDNxuO
# F/ociInXjKCLOhq3whU4jJW/c8yGK7r5t3i4udm69ZfmL9wd0vlFjBvkM/X8UxN/
# V5dbx4OnKqZdeZNeSR2/sYNUWFRm9w64e9appYOMcBWO30G61zdXIk8tql/0z/hW
# kPBqD8JNG5cIQs2BoxZeOrnel7N1Wo2JC0hcxnrgrXtbzjOi0mRne4HOYinTnbDD
# UVzjtvDSwbJb8XFG+4x6vPw=

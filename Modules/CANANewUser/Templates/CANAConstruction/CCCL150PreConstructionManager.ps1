<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150PreConstructionManager.ps1
	===========================================================================
	.DESCRIPTION
...
<#
	...
	.DESCRIPTION
		...
		CANA Construction Estimating Team
		Construction Lead Daily Summary
		Construction Opportunity Daily Summary
		Domain Users
		Est_Sec
		Monthly Forecast
		SP_CCCL_Managers
		SP_CCCL_Staff		
		SP_Construction_CRM_Contribute
		SP_Managers_All
		SW_Viewpoint_Users
		Salaried Employees
		Viewpoint Users
		...
		XenAppUsers
		Xenapp_Primavera
		tfa.Estimating.RWED.CCCLProjectJobs.RWED
		tfa.CANAOperations
	...
	.EXAMPLE
				PS C:\> Add-CCCL150PreConstructionManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150PreConstructionManager
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBgC2Jr3vR9ZlcJ
# 6pLzN36/ufhHGhxDaPBOYdOYkZaO3qCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBUFipqzFxQaJ251y3SdoKap/fCQDGu
# FJfMW1K2Y9WxOjANBgkqhkiG9w0BAQEFAASCAQCdFXp7DO1oVj0rzRIia/dJzJup
# 77BvDtn1Gvn+h1XfgBNtVVwURwwQiwHZ+S/6N5cPtSBF4QGBf4BM9dVh3nTXO0N5
# lSrfoeZuXym/qVPqvrHYE6POrprWw8eN9VRGu2JCDzSbk8hkgWOZmaUVn8sZh2dU
# eZgZjH7u3hst674XT3ntrbU8fbS/7AHJyR2y4BBa/oc4PGAC/2X+fUuh0yT7GY8/
# 1lBOdN/C0STQwFkjbGJBUTB/Jne5uJAqUHHMrcOuCq5o+Yf/k7gb1SUP4jiHGFCc
# zZO0P/nBo9HmeHGIIn1xJslXU8UvmFGty1JGUEYqMpVzAaeYf3EKBXKPdadYoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MjMxOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgAGax+vNpcTW/
# r1P2BkhFx4+u8l5ZBrFUwhCMUqXVD/owgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCDkbU/+aCy4RMfhDbP0xAfzYme5ZKIKUCqlCF7BXVo
# xNdDW44tkgDy2jXuWXMJn4NbrbMUBgYoBLSjStZXJEQ1B4Mc1J5sZMeXNM37onSt
# CGBXFEfV9b8mD811ixCLuhKvJnqVQaqTajCf3cHn0F7w4InBFjxBs80rIQkmRDOT
# cYW+Ef0eFm0546OcCVmJJYM+Z+M9vvFmUpFALJUVnDeuHL5e4JKCqGC5sLiSDHAf
# SyMoVkTGS/UGoXMHYnajq0JxFTjj59QocPtT3dyQ1+M14fof+LwX0umCavY8/CI0
# L0c3C39xvwp0ziCzAS8Pa0wDx/+/q1jOUvzIo/U9EKVuOHsj7r1kI7Z3b+k8M38D
# ZKrv/aq5HRswxHRWSH49i3bQP1G5soclq7uzaZoeij3F9LQal2HfBqD0A7jtxVWb
# SJ4ilf4KUDbdS6KY7QqIFQ40pom/ohSgm5p9X3eLSSagDxjoUNDp+n6STzE8lxok
# ab6+YtOcCGkQNvupTWUwhw0=

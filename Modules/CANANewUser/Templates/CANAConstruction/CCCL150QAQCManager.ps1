<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150QACQCManager.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL150QACQCManager
...
<#
	...
	.EXAMPLE
				PS C:\> Add-Add-CCCL150QACQCManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150QAQCManager
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvRsG0PW50QvLF
# 4O/RnTnHSLcIPxcjBUxHSMfhHTmiuKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDpiASqaFC5lyddYEX2/cj4KuBluelp
# iVwodYAFN70hDjANBgkqhkiG9w0BAQEFAASCAQC6Xd2U1DKMKFV+K3bsV+oo0MSU
# M8W1EfA5P+trle+2x9Z95s6VqVFA3sYIMi9vRBza1XzdjNv6S50y9zsm6EI4EVFv
# kYBgbtKpFhwtJ0LeOn8ZEhnerMy7r7lHFkvSJ1xftSOJPoWMli7txrcXxMjbFclr
# wI7GYuULG7TsQKRF1fLNsKcgIrNscbGsBg+TEIoLyYVLAkaopdAKD20+OOrqoi7w
# wapk8hoqwitY6QKo0JQI76xABV71m9/QecjPFMJ+fyOLLOAbVqN6T6Jw9MjWwPRK
# 9V3MjHhAHtSx0H4wk5C0TQYMtydmylp6N3geGy7AhfhFpvmfhpHBv11JvAXPoYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE3MDQ0NlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgUcEzwNqQdqI5
# 7AT/UzhCLWCYozfHygZfZdQzcFiRmCkwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCg8x9LwpSoVkwfRhodK+j4x/U6V6er0u3icxGvN3Jz
# zK+0AtnHcvw4fYdZtnWZ69ogQ65/zWoYzR2WqQmuONh35/CKX8z35kwOynTEV44i
# HoaINTF7PwVRH5lA5TzKfR4iRCIKFclUENSZ0rYs2gIyvQZ6hT7HBwMrp4vBH4Xa
# 5qbSHJc94qX33GthdwhYcC5lUeQrvsrkMRTmkkFfu1tpBhWrmtkSc17++pRi6b3a
# vtziuGAi3TXLQEWvBYHBZJXGPKSYn2GZ0wV4uw0gcipeCgbf4PTAIvH/anHKBjpw
# YkzM1JMMBow62Inm4CP2WvQqFLuXk7WlO5qR3PR+YB84S0nCAPKtiphzCSZftYRE
# /Yv3+3kgc6x9mBye/4+byCGJLHhYKlscmssNQmr01knv44ZJxWih+bp39YfsR7pD
# 9TToElGidP3MX8UDICsX5GZ1uQjPw7Hb+uT8HAFT9sKGEah1xOc3wT3wFrJwlDx4
# O8nBUIIMV5061fGBVnIHCmg=

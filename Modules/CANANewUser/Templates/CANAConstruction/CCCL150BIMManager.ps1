<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150BIMManager.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL150BIMManager
...
<#
	...
	.DESCRIPTION
		...
		tfa.Estimating.Dragan.RWED                                      
		tfa.Estimating.RWED                                             
		tfa.Utilities.RWED                                              
		tfa.Utilities.Read                                              
		tfa.Utilities.Scans.RWED                                        
		tfa.Utilities.SimpsonProjects.RWED                              
		tfa.Utilities.SimpsonProjects.Read    

	
	.EXAMPLE
				PS C:\> Add-CCCL150BIMManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150BIMManager
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('Drive.MapAllCanaDrives') | Out-Null
	...
	$ADGroups.add('Signature_CodeSigning') | Out-Null
	...
	$ADGroups.add('tfa.Estimating.Dragan.RWED') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAwn4Z0zldYA14V
# GnGXSjmsbj3jWC2TKlUGzL9jsNx0rKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBmjVDCIr2BTjrO/5ZET34q7ddBJGoY
# Sr1tziWpnhI5HjANBgkqhkiG9w0BAQEFAASCAQCyI69BhBf0ukBQ1AJFbi4fBECs
# JULYV+kLd8XHYyGoU1fYy54RDepOiGBRTNnTr1Fs9zqCo9BIHL/F8kBXwUCCSgZH
# Z/056hChQa6wZxdyEj1ALGF0NqBzRzAfP04yPJ02Vhba/bJFlhVZKHVzvUFWeQy9
# I8T1fUbLxd/+gwT9OFy+nJ2Vz/LnZY3EIhQmJYgVgPCV7Wr+xZYdShimxAQ4JFpF
# 29tybD+n5iBfRa2wdycJ9VL7BUN1MDxKyPgGw3Vhz2LgtbSCV/stKwLTB+fYp1K6
# FMD39f+k4KxHZ40Blj4/IurzCeeOhA+yinTOjVEweISvbNQIcyaMVHJf0vSjoYID
...
# hvcNAQkFMQ8XDTIxMTAyMjE1MTE0MFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgmc+4/3wqCSXj
# kKkJYunpgJnB5RmnLmSgHFDGe3BXW6gwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBCbawOI+bvBDD0SyHMTOhq22j2MoYcJ7fgZNkUXTX4
# XDihgUYoN97xKAhi0W5QSeZglk7dsJPa8n3yapeFoCzcrtkmp52JWV7Q7uacoAQ1
# ll2UWmJgU5MqhwPR3JFoMcho1ztu6it9fjXe08/j84R6gkwUMagSPoxi1+7euvIy
# uXjiza7AH7dbW4h995uoRknSe3CSx2Q1ZKBUyhL+3iLWcMUKH5ljUJzr9LGthqFj
# b9iYzcHp2t5ab4b9vha6zwqzjrGrpDs+xyhYcUIdj0KE1d8OOiQ3I4i/EafwiVb9
# M2eti//MavkTABwYz76xEeeuHeH0EGz7s/dQnMODnd3ttb7y8FyrmKyyjhgR2vJr
# 1aa6hzb0qUuVb9grlrZxi/bZmOx9DEkyk6OOUJ3SEu9ooJEycrB5jRyf8jp+DIL5
# tMfOyAzEnVnygTT+DeSu0BWC0HTvi9ERRbW/ZDD6bNH2vzPiC5V6C0z5WcCzN0dY
# JvktZ29ZyM67MmfUVpcuQFY=

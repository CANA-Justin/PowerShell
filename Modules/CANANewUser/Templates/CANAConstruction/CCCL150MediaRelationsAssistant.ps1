<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150MediaRelationsAssistant.ps1
	===========================================================================
	.DESCRIPTION
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150MediaRelationsAssistant $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150MediaRelationsAssistant
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCACEd9jz8UJMz6l
# UhjCDPovWD/AMaiQoTk7q8JgFJ7xAqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDtN8YAl1lzglS3qoXXgtP7f9iKCo/4
# M0LPz8kS+dY/PDANBgkqhkiG9w0BAQEFAASCAQBvThY4erxN7PR+0ZLGpEDcuNJE
# Dyo8BD4fLMoT0lnRGJCs75ePRQDAuDM8nbBeyWoxTrsNgvem0vK2irc1owufNyZ5
# WuTQbV/5waKVuTHHdnSguMPjbYvJXs0LNJDwGwGN8QKYEOev+/wD9+olt0Hfst15
# T53A8s8d6gKeJTnf0Q8eFwR9dRzgJGd2GqO3DTQ9SNM1+82ndcufPV6kocSunSdR
# bNpGBaj9M4us2vCQihR6CkmqyucwLQ8tfnTLJRHkysGL0hgQT6oJKZV/ttcDdPt2
# 2lBJn+GAZD/q1DIP/ZUwLQFFt/3tlWXGYWeYWuX+Q/8eUCGzRJn73jWg5tKBoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MjMxNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg18rLFYiAwfbT
# cuH5SN9FZj9ym4BcN22PXwmag9Xw38IwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDWhvxpQCToR4NVFAcHsjhsQNRHxLsqo3Xo92h8Ina0
# tqk0lf2Gp+17rKGIDBsMtzVOvcpCrs9cf5leFqYzN1w2Kfn38emrym3Bu3rsT4og
# GbhBdtZqM2PI3iBkuVExrBV1K9RCOlSG2oaRqMcWlkoUgSCOuv1ejTbN7gBItfat
# neslYdmgbmrp6jdeKsb60l4dCiST17HlPQu6WXSDSK7gh70i/s56IPuULuHGYc0f
# Y7VO8UuUvoSTJlYpE5Y30x3IQ3KDmAT/H9c2+Lb1SoiSVKbZU9IuYleBdq3lGa6l
# XtlwAquLFG4P3kR3bmi++vliI6OGweNY75sXCZzEx0dZvmJsZafALlv9j6bM0mS0
# X0aEm6aQnp9j44PzH4XW6J2dIKF4I5trJ0QE5g1GG9k17MgyPI/z4ECxxEMr7SBl
# rA0gZgOnh/zyF/0Fk5Uq/Dp/spKyFj4PsOaGJnv/5GM4Y/3MqHrdQcizgSsTnpF2
# 3jMHOZLWmSGQ5NXNrX48sxQ=

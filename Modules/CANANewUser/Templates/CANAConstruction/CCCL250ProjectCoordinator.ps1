<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL250ProjectCoordinator.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL250ProjectCoordinator
...
<#
	...
	.DESCRIPTION
		...
		CANA Construction - Project Coordinators
		iOS Users
		Domain Users
		Est_Sec
		SP_CCCL_Staff
	...
	.EXAMPLE
				PS C:\> Add-CCCL250ProjectCoordinator $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL250ProjectCoordinator
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCJy2Jgrshxs6E1
# 5/4BV3If+UUSnM61VPAtrcJ5d0+qZ6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCBOrXNYcTPbIIBIEKOZl+wPbRGxaRu
# QTmZpqtn2uWZ2DANBgkqhkiG9w0BAQEFAASCAQCMsOkmXa+LaikwjpJjUIIxACDH
# uUDZnYltylOBTb8PyF9KYTL+koqKWDLUMNtD9Zewg2PWYM7In4btU9toDVJoE807
# S63oZzs0sOC6cHTP6LnAxi0OYYPPZ9Xd58viY86hqPgtJCxJXu6zH4pom7oVrO4l
# AtXcwrjOYaSrVx78dJArBMeoWF8dy3zhBCNg0tpi+xNwGkxU/uzHBVU4vE8GbE7D
# Fwwz0ENe9zXbDfSv6kCtY7FzI6quosS0DPAqRNaokg8L9sLNGG4MbZM6wPFOJVf7
# m9Hdz8FZQ1ssbMIVCCZXnoHaR7wu//Hn5M8CKMhfVaehsYJ9SeGf54u+WUzHoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MDI1NVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgaoimTFBPkLqQ
# /3ogZBO7AlCnYhX7PCWW8osXrWRSQOIwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBlSPgwZs4oIEvY8PMBFEV4j1bHDxXtkpetwKBLrOY1
# SlqS0QpsWOVFqvPuQfDw8LEFl9buZzW0s/7zE3XOxWtONbvg8Niuqe5wKW9wwnWm
# BPj3ZPeTxgbFwdsOmxhiEn2ampooy9i5k94po8F2N1CqLBvLIRKypCJHcLiuJDB9
# Yc0BvBk7nF4tHknkYnfI1V/LmGfhgXJvRq5eERQH6OGolARKj+WBWRRNUYI7e+id
# bWZ73Yx/OqSlfLrw1CGYhDw27ORuYaprNcMT03PzJ97UcMqB2Tf5pxPlrduo3PrL
# DaH+KE3my4K4Dr+hEjMoqiN2vfTEWh430mtwuyj7pcTRMWn5aMHSeh+3TpoWeRo0
# oPX+7eoShm5pG3i3OfrCAxMsq52avNQazsAGWja0cny/AojaOocYWRFxmgtmE8jZ
# YxOUUtuZ1DKoCVbTqNpDArvrW90QbsQML/HHXeVVqTL5nyrw7ZRBgN6TW68FLRTc
# g/0xikma4HaD3saERMxaZM4=

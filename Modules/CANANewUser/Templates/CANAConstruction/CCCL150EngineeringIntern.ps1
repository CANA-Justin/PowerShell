<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150EngineeringIntern.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL150EngineeringIntern
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150EngineeringIntern $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150EngineeringIntern
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAP8DtDGLoNIqFg
# SxcM0uWkRZnGEdHyVAAamIMzVRg9FaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAu9WIkJnvr2tAf5rV+0yHjx5vfdOsn
# IUyYi98rnvUknzANBgkqhkiG9w0BAQEFAASCAQB9TraWCJFR/4CWFu3/N4Vpz6qU
# r7zkdc2qCPtr19aqiw5nmA1SvqOcbZqQdXixOzs9Nm8tNl+0rEeE/mQnHGsBjxBE
# 3+qyXgvJm0r0plu/wd/mMXgLa35cesP4vq7v8TEztn9Htht/7PWGECAN0Tz3nN9G
# dCI+SqFwN+GKSAtuFaStUdazh/GDhWZRrdDjEhXAfMrjphLX2EaVPgaVZ9vTEeEx
# ugTo9zLdQ1CwX5aPmbrhVuK0hAbHm043pXJZgV9s4kMZpsjOX0om70uebhoimfDt
# VszzryJIYK17Xr1nmp7LOqtr/vSptdEtP8ur4rqKcLXBbHbeVG0SvT8AlCTroYID
...
# hvcNAQkFMQ8XDTIxMTAyMDE2MDI0OFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgYyl1Uzmyo9bu
# 1DGvfNkE82+p69vvsOuZ+wQqgKH4meAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAW1COMzIUqIeUhhTids5nOrr6Spp3M1LqYoK4trEKZ
# UlHcB/Zt70lfbK/RfHb46p94VeGJkTW3uFn/NjzXPa6Vp5M/R3qtKYwL/prchNG+
# za6Ah7aG+UFNEITNa1d0QLok8CN7wygpfwx3Zoew1YI3it13dSOD+jD4Nykzqxr8
# NLQsnN/psiEiokLB9tEr1OEdnr8Uyn+7KUovCy2HNEmE0xjAtfPqETisW2KRP3H/
# 5fwZOPMaViOPxex7L7cTpBtFxzjGVJyLkxpm5ME8iBlfhoyA8+JGNxSa4xvPvkcP
# hDPKKhaReKZlkGSxTt7QFWLNYhlV9XuM8t3buIErIcdBLclyZZiRMfhHgfrwoWJE
# sgPVEFHsVFyFABH4OZor8/JzZj/oedy9P3GI3HBIxMA5jQyn55rhGULTPhOijZC3
# X2MUEPmXULrzKQQJ0SeGJxGlytaSTeOiJTSDIZ6n7R3MrdHnVEQfD+3gVsn7/m+z
# yhRWYvkvROl8pBkFDh+EAIA=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150AssistantConstructionManager.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL150AssistantConstructionManager
...
<#
	...
	.DESCRIPTION
		...
		Head Office Users
		All Users
		CANA Construction - Assistant Construction Managers
	...
	.EXAMPLE
				PS C:\> Add-CCCL150ConstructionManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150AssistantConstructionManager
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('Kingswood.Project') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAnBcAdY4mEz1LU
# e4lZUzJmms3Xg6ZrXwhzwARk5DWjOaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCaBGfqW9AmMMK2zPKr2DHlrfO24g3w
# dknj4poB21tbATANBgkqhkiG9w0BAQEFAASCAQBDvLONVNCM8Qos8qZPVC689Ysa
# t8QJ4fREKWGhqlJOddNB5WAZBeG0Diown8WwCH+4sBhJkA65Lo6kUfmEMdnVn8DU
# Ii238F4UhNR+jCiU+AVb70TDd2/Xqf7JaRzIcV3gOV8qquhdnK7WpmaL2RPYXTMa
# oqSGVxBV93u3rposJgcFCOq2YUxXryfKF+t7rJ7FhbPf7Hu7IEBJTC65hYoD0kCJ
# xgyD+IbBd9JPerEx0zE/ByWz8SX4U+h6Rix32nPoMX7Wh7LsnIk/4+s1bFHeYBcD
# 7yiVG/6PMjBKzqloqcXMJVEiRKyirTGKzzcJzGUMVA9Zgz1K4YW+tZa87/s4oYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE2MDIyN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg0JjZ98iw7z5e
# RufCOjytcIDAuwgIFQr7n5cD8GB4ilkwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAMd9HEFMNTBYsC8Kp27I6S4eFtromluI8iNdHWD+NF
# K+UMlKIzh516uhJBP6407R1dKaSLmD02qC9cEuCA85TH+0XJtU38kGTa9U8/Fpao
# V2NPqL+T1TERF7z7kd0Z+CEjaw5l1+glzPJ9W9wqPix1gktNcV5W7uAMQQDYp6tK
# CEG+Z0XB04GvxUJGZ63xUXwgqnib0+/R0XLrAEp0skvJAS0eTgcyZICRLuQBe1go
# 7xH8H3dkU+T34Z1ky0UAUNbwZbkFlvgtZVJKbGrRJBG2RxXsWo4uzZ4lHpRqDwh9
# oVa+noSfBzPwFZkdIm6LXHi3Y+eRRothyg55bOUWCQAv8qhryix+SM4VlhnintgE
# 7DbZUB5PoFRWrdNNkM1WjtYJyIibaBHkijaAM8RO2/2jenEHCtqgP4bsVpVJgwKM
# /cXAEC/uOwN+3M09tkVwf87I2uonimTNk4dXKTE1fkmGB35xCxzyFaJqa0frhga9
# ech6UJ2ADt7UOwmrx9JEXGo=

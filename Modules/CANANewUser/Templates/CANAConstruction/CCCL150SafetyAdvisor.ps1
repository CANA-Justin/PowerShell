<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150SafetyAdvisor.ps1
	===========================================================================
	.DESCRIPTION
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150SafetyAdvisor $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150SafetyAdvisor
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxSTPq+GnpSCQU
# E23LwqrOGA6pVZcuGtVE6xQtXDdmOqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCC3QmDVJJE3FVlKppOX2GkKsSJ5+bdG
# vAqu0V0WpEMpXTANBgkqhkiG9w0BAQEFAASCAQCa3lf0KdTHyNYs0PqR+7lxmdLe
# 1yoNct0xu/GUEK7NMJrPu/RQomTAaOtIgbLSSAdfBOvyAQ0QJcak2al4uzUb05PH
# icv1y0ygSmJ1iWm8RxYF4YO1EZazsf48qacY5AK7VVo7N1+2u4z+4DRg5Gnm65hO
# Jz8adgo+QGcgFR6Njg6IYU0jRdeL0u4jtEKRmHR2ZZPDpJzi3QjepimyquK8wb6U
# efQpztyshbt9UOhNhO9b3tgdr/ZJ3Ype78tnCixEX7iqHqIq9DkwzfgUw8A99Xmb
# JnSlxQrh4AJ9CSLunbzkQcLJd/6OCOG1t0n0K1k28jFc6yPnINl7Ca8RawjzoYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE3MTMyNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgYqGXgdkUlBoL
# 3DnZLdBxsloaKF1RTDVvyeXdUz6h01owgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDPZKnhuGk71d5onbDDgNYgCjXudBP7K3e+j7t9Bk8M
# ovlg2x3JDEXFYkXdKFNIbkQ5x0Q2J1xhQX0VPvyYbWv4W6217bpzSXbuQeQZsNxD
# P3hOCwKIFgo5s0Uywc8ieo+ntSh3DV/ce68k9GqQFMK2rj9cw73JUP9eWBA2wYWn
# 23jJRiJz4IoOhJwd5vq3iVs0l1m1tn7OrcOLgIDfbfuULfqw73v9k/kaLFtcY3uO
# V9CGh9poNKJNiNPtuECN2TFQBhaj9RrrbMngRePknMJfeVYPS8R2V6KEsJ+nGwVT
# grIKgjwJL8EEvWUTxw6HkQVX3vR8/B/JMMji5V9fOXHbc9ExWD7C7zBFr7w+24uu
# ncwCzTLJI2RGeE24UJUXvBAqPtMb7clA28xdx10MEKijObsk2tMrqSsiw6F18Mze
# 7R3mNsT+OpYo5GxbSE1kLGaAkeAUr6xyTGHTEL5TdPOF+hk33ktD4kYT+sRirqef
# nbUIFLykNTR90ZRAQXbdkY8=

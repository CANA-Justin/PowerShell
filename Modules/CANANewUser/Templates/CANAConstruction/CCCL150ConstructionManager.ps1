<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCLConstructionManager.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCLConstructionManager
...
<#
	...
	.DESCRIPTION
		...
		Head Office Users
		All Users
		CANA Construction - Construction Managers
	...
	.EXAMPLE
				PS C:\> Add-CCCLConstructionManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150ConstructionManager
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('421PMInterface') | Out-Null
	...
	$ADGroups.add('Group_359dfedc-8d35-4122-b010-459e531f8306') | Out-Null
	$ADGroups.add('Group_4792f749-a299-4e6a-b36a-83e901473511') | Out-Null
	...
	$ADGroups.add('Group_8cc5cde0-426a-4fa8-817f-82734ab84454') | Out-Null
	$ADGroups.add('Group_a55402ed-7a8b-4553-b73f-c3f04a8162bf') | Out-Null
	$ADGroups.add('Group_b5125d2f-851e-49c4-baae-e97911ac136e') | Out-Null
	$ADGroups.add('Group_b5200ba9-73aa-44c0-bfae-3b8830de2fe1') | Out-Null
	$ADGroups.add('Group_b7bba7bb-bfcb-4ec3-8264-482fcb5a818f') | Out-Null
	...
	$ADGroups.add('Group_fb372b06-16fa-4fe3-ba5f-ba772ee467bf') | Out-Null
	...
	$ADGroups.add('Prn_CCC') | Out-Null
	$ADGroups.add('Project Team 660437') | Out-Null
	$ADGroups.add('Salaried Employees') | Out-Null
	$ADGroups.add('Shepard Station Building 1') | Out-Null
	$ADGroups.add('Shepard Station Submittals') | Out-Null
	$ADGroups.add('South Health Campus PRU Team') | Out-Null
	...
	$ADGroups.add('Xenapp_Primavera') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBZHcKoiLJbnbXG
# hJEEV/SVWFb1isolwmzl/c2pWSeeFaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAzpbxqJpgCPN1nwoIZbE+FVGugRdOa
# Md8yAz4aeoE4azANBgkqhkiG9w0BAQEFAASCAQDF6+2GzzOsqLl0/7WKTgDW81NT
# wlYz46lIOLSwM9lOFkNlufxxSXcW+G+itwyn5z0CwUMf36YQL/4W13Hmqwf7DMVI
# 1+6f6aOs0Nu7llhoep9FT9/IPdqRFcXYokeXHiRMqQNOQesl6R94P0WoRnMbFEpa
# M9UXb5LS7cWx8+RX1Ab/GjnAsRs9e+RdZ3ce0uxZ4TMQ+sZnLlVQ9cFFhalMVr6l
# 2eJ55W1qvNBxHmoPsYu8OAlHLHQq7VoCLkr7jaT1kyfwesaDl4S+HWdwwtOtsZwz
# Jew4b5Wi43T1fF6IvTkW41dfwjoIfp1vvhZcXCnNIqr1WbZro8v42xMOwmffoYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE2MzA1NlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgcwIziZWxt/rB
# DCKVPAob3a5F+KQwmqIE1nsF8bY91qwwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAYuABRyxOGUEQ5kEQWMP6JHWjxPIkJGYuDnjK9Sf6k
# Gflvoe5yX422metqsO6xL9uAgnmTtZwyYHvm5rpNOny7pQ6lUlcZ6iJOUKSwW2RD
# mtblcj1hhgce8pwQPifMqHu8JkeY3sfeYnOTM1pyoV27d9Alaoph9R5K/ycbcVp8
# 0N08vAmqmJlAifSPruirv75Km7ma0PCWGKrFB73hGVFI+dPbcOMEnfpWBEhxM03H
# 2r7WNmK8ETox2qh3q9DyquSiDD2LOf8z/Xi+JyIfY1iTOanc+9LtIPawEsnlcBFC
# hk5eZe7l8Mu6PvTPdQV3uyKs1jzU+EnxaxMH/T40Fd8u6Mh6AabSVUz4bkS9uq2d
# miM3i5Y8a6F2Uvast9+6WhocHP8OKiWUlfdy0XH8fTnceS21+OGusgjVXuws3Dpo
# OJCoueevj6Mmkr7/wahY3BGlxkSLvgxH4G5dDiunY1BSUjc6+BdfrThp+y7PRoUj
# XMDuC+lQyRXzfWxh4SD1vEs=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150AdminAssistant.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL150AdminAssistant
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150AdminAssistant $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150AdminAssistant
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('Allowed RODC Password Replication Group') | Out-Null
	...
	$ADGroups.add('SP.CCCL.Contacts.Admin') | Out-Null
	$ADGroups.add('SP.CCCLCSL.Admins') | Out-Null
	$ADGroups.add('SP.Construction.Contribute') | Out-Null
	$ADGroups.add('SP.ConstructionEstimating.Contribute') | Out-Null
	$ADGroups.add('SP.KnowMatrix.Construction') | Out-Null
	$ADGroups.add('SP_CCCL_Admin') | Out-Null
	$ADGroups.add('SP_CCCL_Staff') | Out-Null
	$ADGroups.add('SP_CSL_Admin') | Out-Null
	$ADGroups.add('SP_Construction_CRM_Contribute') | Out-Null
	$ADGroups.add('SP_FormsTemplates_Contribute') | Out-Null
	...
	$ADGroups.add('tfa.Exec.CANACorporateHistory2014.RWED') | Out-Null
	$ADGroups.add('tfa.Exec.Chimo.RWED') | Out-Null
	$ADGroups.add('tfa.Exec.DSM.RWED') | Out-Null
	$ADGroups.add('tfa.Exec.ExecutiveTeam.RWED') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBFuv0zAsDQXduV
# GG9U+W8Y0ceCAZ+hmCq2H01p/XRmoaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBZ1UfCEXcSEwn59rejjj2cWvIjnXe4
# FGZ38pkzhg6/xzANBgkqhkiG9w0BAQEFAASCAQAMYntVtAAQD2ALwIlkBsC+jTzR
# UhlPaX+qobLEwhArmdpoc9dovGlv9La4yVctu8H6brBy3phHfge7VYTsqkjHZj7J
# aeY7XglyIbAS45TNwl8eLAgKtdnzWn1JUlH/3BaQG2GxWHuOlDbYR2gay6/dKd38
# QB8Ut4oBQUzbV1IXn1Ttxn3V6s28GqyW2NpHMlrmH+A76rMBjTU17dQS+YWhz3vg
# /SQwr/ZLtKpGT5B0nihz/OLW4ME+IdKAFJxJc5JzZ8raHPqtSMcZyScOassgc198
# 8W2aFdO5yPuL80CHKrmT9XGly7K9mZ0cs1IKbBxM89UM+7lWUnG8qqfL5BeIoYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE1NDE0M1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQga4lUYAWywG1/
# Huh70sau0PBsrujHSaWC0vbIJete8fswgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCid28OTyk60HR8lUHF/UDz5V9HWUu2NLIrM8lrBy3S
# Wb756hrGNSt6tMNTRM11o1VArS8PPLvFfx9BVfw0zbJWBPubR4cTzUdfxug7XGdt
# lJDzJpev3KW7dj++uEpH5cQllEW4w3nG3UlHRtjeK3qDfJ+CXWGV9URfxl/7xMnx
# h8IImNqbOYDtXAzEpBLLp84FuwxgulBsQqrVaqmlZ49L26rSdUDWtMPtQjs2kW7k
# YEl0FsMJxbYkDsoSBsmV3FYBWRNknUElkzfpWfnTxUhcPt1A6l80sfOWq4qBAqm3
# 7CyFpmrZhq/LiM6SwxDeuvNts2OOiU6mS1HqqL/9KaBJGyEYZLqr/AfxEXQZtTW0
# BV2yGmeiFZxragxkD1ImYiJWPvHbPbwjZ++ATYQkq4+0HqwsXnzoYHqOjbdXxSci
# e6N/kdJ+7LrO+O5AkN2+pc6lgH4Jm7K8MlybNEDF1jjLycyu7IItQrimXDdBAtpx
# Sscxi4zv6EXceg/JE8fCuwI=

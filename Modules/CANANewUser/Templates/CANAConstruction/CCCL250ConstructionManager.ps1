<#	
	...
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL250ConstructionManager
...
#>
function Add-CCCLConstructionManager
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('All CANA ReNew Users') | Out-Null
	...
	$ADGroups.add('Group_16a125ce-8c75-4202-97fa-211912d58514') | Out-Null
	$ADGroups.add('Group_29e2416e-1de0-4c3d-b872-ee854f35f79d') | Out-Null
	$ADGroups.add('Group_2a072122-ffc0-4bf0-9e54-1101e513857c') | Out-Null
	...
	$ADGroups.add('Group_83c8a3a2-c76f-40bf-bdf4-2ec7623256ee') | Out-Null
	...
	$ADGroups.add('Group_f045cb14-e910-454c-b328-8afd6a73a239') | Out-Null
	...
	$ADGroups.add('PBI_Procore_Analytics_Develop') | Out-Null
	...
	$ADGroups.add('SW_Planswift_Users') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDREwN4x7T95jdW
# 0fSw6kti+nvXc+G2F4S1TbOCBoq7YqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBthOJW1vLQcDg2zG9bvz2wx1SGx/on
# rPr3kxIIs8epXTANBgkqhkiG9w0BAQEFAASCAQCXWIUBnABw3CS1RfugFDqIe+MV
# 4TMp+gRuTZYfciWndBDljpv+LEotgRXHLnWWAa0kkrFAQKmTzbJ8v/fxgxrFh3PD
# UhUn6B/SHNfu+BDUBRVzPlF78rCZ3tRGaK2Cuh5/mI5Qg78UmBwsV6k5DLQBEyNM
# y+mVWdZ/zF1CFT9hj8Ut91LbLD7mKZOJqCU98hTPl8BiN6S8Ph+4tecEHI4ka03C
# bVo6cc3gkpu8YJgtww0512AAdihedBkeV9KLg4NtV0r+h1f6yZqWK38wizM9pG12
# b9SJyFv2/Of1O7tLzxSCDgeGdneC7DluGRLELJuDEwqtzU22802JiIUVbpA4oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE1NTk1OFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgDPjyhaeHa8jI
# 8VyCVxvRoH4qec4SC9UE/QkWgk2/W0kwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCpBUdg6RT4ENc7MKeZSI2azx6kQxo4UV963SZvf4eM
# RO0U19NOhb6/yahlkflDVJSlnlbPCBgo2Okyyql/au3OFwUZLgnV73mlFcwFsBmD
# 4yQiqqyFqWe5g0FEl4k5AAPzbDjnmeqe4eMJhtST/tYIE+cArcYCbNLM0WzYKeo4
# Bju0OSHF71gYxEy6QFI/0hAdbzTy/MrT0vw54Yi5C8YR4SoW0zcyWYmKO1jlM1H+
# kf+jl1Y3a5sJ1M9O6UgtdIfWlbBOFCXJM6ZaaBkzn+z3GL2GMM+q/EZnI+Y/MD3B
# vQMiwb+R2fzpt7ABYiqqOlr57axnmNh3rhH36d2PM/e1T2JSLkWHM2WMCiLo09d9
# cDGUkI3TsyN0ArTBljl8X75oNaiMBQ3GB5TFIQNv8cnRDrjvLvUwrWQ2d3o8XUiC
# nDGYyjiKv1OvnTbo3xtrIoda9X7ypxgkbgITFZmKzNRXesajIYD+1h1SJe95g0c+
# DlL8RfpCrrYcKwZAATqAlwo=

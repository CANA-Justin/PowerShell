<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL250SeniorSuperintendent.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL250SeniorSuperintendent
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL250SeniorSuperintendent $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL250SeniorSuperintendent
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCwh1xWqhDJaXoQ
# HplHtHMeEXaw6XT5P31Y45mX19KsxqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCARziJdUMDdMhBNIKJQirgdEmWXY+CT
# 049xiJt/bZKOKDANBgkqhkiG9w0BAQEFAASCAQCi88BAy8Pe+lQ2YAMdFcI8UtMm
# FVeE2f3hB0h3oiD4umh1o6Nuivjl+jynxvkL4QLN3J4Yc4rf3ZPTvN4vNzh1TdVi
# Nh2L+Paxkznl9bLzmzBPs5sM/HWswB9zGl9qQA7skvNjkakmZ0OW8Khn4gaiFj3q
# HyvjX9CLeXnPqcIif9TQ9jloSdEB7Y1jeKLmcqmYr+bPCuoGgUlVJy0pJhI0L+ZZ
# D09oooGNfC3X6b89XVX5WpEexhvl79X4e6CffZ5RF3I/WCWMCPwgAH7Z68K1hCkK
# OFajKkvCVrYK1Bovz827Hz8q02EYhL+2w7gqG9vozII0c6JvbeQeQtTMf2BJoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MjM1M1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg+hMo20QTSSqB
# GUmw3E+8mss61dztTfg7Pub2h/jwnEYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDD/aBz52xkrQCQVKyEz2iCwjP2UwKca0F3STcHrkT5
# hXVPlmCk7ROJayBXCVP5ndV89Uf+WHAbIADsAjiX7gF1/W9vjJgpjWeffrD0V6kp
# AMMOyqbNxqynRrgMKfhTGS7F59YyNnHWImjBUxdZnikO/JATv50R7J/M2Zcl9QDO
# 4NGMGYaeLmLSuz03tABn0Z6B9ia5Q+4L4hpdbAn3wUK1uvHbhLZiFpUBZCDJ8TeN
# NHx07273oGnIJq1d83LVNrbAVUX4V3WIhpmaQvvlR+b15JAyvJKwe6QESHk1idYM
# 3wLVwxKybMK+y9EBI6ECNektJ59sPVtS7P2tBiZkSZvXeXuKf0G9xeH8uDMK4Gds
# NZlNuvfXNyeHjqg11Qy3Cq3PcRtYcuC0DlM+fvtiz7uIYXZMzWF0AUGwHOnADS/v
# WMsggOJChQU2Sx+kBN4YW5GYKT5Pngx/dyDDfw6Gq3buvIBIkNUXRu5SAbG/enn/
# eehuru71wXF7PRHMsFpMWF8=

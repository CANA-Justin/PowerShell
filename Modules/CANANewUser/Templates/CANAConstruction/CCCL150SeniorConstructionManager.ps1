<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150SeniorConstructionManager.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL150SeniorConstructionManager
...
<#
	...
	.DESCRIPTION
		...
		Head Office Users
		All Users
		CANA Construction - Senior Construction Managers
	...
	.EXAMPLE
				PS C:\> Add-CCCL150SeniorConstructionManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150SeniorConstructionManager
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAdzIzJPRl0LRQa
# yrq1kSQHSDPvWNTOF47QskoRkw3up6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBuIY4KeanQyyhBIBwXc7FO7JWX/weK
# y/2z4EIe5ETdiTANBgkqhkiG9w0BAQEFAASCAQB6BBSxZB1irsYw0OyE80A7GoVJ
# i22u0IHUGD+sVOLe4zL+cg9GV6uTR5RN3ryACzjIKH/oMHfro3qwOka31/nRHOsS
# +MisrrThL/ANRrFvlQ4NqvJdXzkhsE8Xq0+CQ52phNClD8MgfcrQkgQxUTlaL6Qq
# RJvX7eR7bWf9bzpU186UCjmcROeZsnO89Fb/uY5NMlefcxKzohHXw/61QlCekSUw
# YUITwWKbqYsuUq5OOLb9ZBarbkNbZ3b5/pA4ey6uAvpDS4MSKBQ9mLYUUAP3JyiA
# IRvOJNsyrlOInCRFIbIOIjWXuE7K/QSPSLBTC5ibYn01UWCJbl6Be6tEQXHxoYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE3MjQzNVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgtgJ+U8SudTB0
# wvSFVjvGbt0L0J0VLS2a/Cf8SuehsU0wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAejAGcfPHqEaGk7vZHkcP+Oa6z6bgwQS+RiO+J0BO4
# GJJE2Hna/UwWVJOoPApLo1RWc+5GOgW01fqa8Ej++L4vOmAkuDaBcM2vV3We5U5G
# hTMUxrPwIy9R4h79NU6NYX8NKNj8Rqw2yzlagueVTphfa5vM7C43U+b4gslBP5O6
# lSFnLmeEG8hsOLDNplkQfZ9GDNnBtHNgaxqsASVZuDKKBAUWe4okcRlTabg00Z0e
# c1RlKH4WIisWg0f+VTKkt3pXRjRSW/7zMY4I1fFtObqdzNCv4U5h7LmrPsjCvSSX
# S0Zc+bumEGudRE1nUyWjKxhwlDMnmCEimm+Zy82mbJgSDrwlulB2NROnltBVn+BP
# vQNB5o57hmlecGVGL8aF7JQ2JD8AGW0LYhBAgGs7zrGSbo5v2IFT2qHUa+8ofcuG
# Lhkj6B84+mLXsE//E2X3+NFlsnC9iae/p5UoPruScNj8VfMnWi8wdgwNSia4kRPa
# DQBYz9unzgMoftGbMn+Apr4=

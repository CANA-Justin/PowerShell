<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL250AssistantConstructionManager.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CCCL250AssistantConstructionManager
...
<#
	...
	.DESCRIPTION
		...
		Head Office Users
		All Users
		CANA Construction - Asistant Construction Managers
	...
	.EXAMPLE
				PS C:\> Add-CCCL250AssistantConstructionManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL250AssistantConstructionManager
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('CANA Construction - Assistant Construction Managers') | Out-Null
	...
	$ADGroups.add('Husky ReNew Team') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAto36Z0CHAznE2
# imrLQAe4poDm9m+e81fCJyEAwzuWMKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCA3qX13e89AFzVX4P6W5G077+3PhhRR
# o84xlUh0YUnbPDANBgkqhkiG9w0BAQEFAASCAQAUpIQXS2ullpQqSFl3GD6Z0PWb
# sQiLpX4cNI8tA3Yu4qEVzkZu/eheTQjKj2HaYDm0fcrv0x47SoOJHZGCvZMe94s0
# PiPKLoCfO9jNrmBIqgcvEFPffOzmJco+A4dHHNMyauNKUavqNLkpTbM5SyuE48od
# vX/MFBJhRp1moBNq9T55XjLueU7LQPgqPnImeAw+1nPBMW+lbROPrYP81ExEhIn4
# 7Kj4Fn5M3c+/zMHRldws+Bgi5HKZTLHD96qaDL713iBCFnakcyo5t4QKYd2CxAhn
# P7tCRAIx64PzMBd6t1toqn9+KyqQyKRurJi8pb/y1wpUIlKthbbnFoz2mvcboYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE1NTQwN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgPtJ9ATq5nRCJ
# vXJgyMeNCFFbpBqk7y8S8oT/Is9UYAEwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDKuErCVGbFx+h9WI58bc6meprwtT5hNhmIRlQQ7oSR
# drqsvXE++aazrcPfr8WTIC4tdvpPKWqMq1mY9DYOBoOiQFdQ9diHNhL9zKDoiKWj
# tQIbkUCNuQH6PalNFmlcOoLqUb07YhWo28YTwlKxItQOpsWHN3+dqmwWQUzLIY29
# HpdyDWjnj1TrupwWcIgIJcEOvVrX17uR/kYerhmK5CG5qUE1sWJ/kff+zldfULIa
# 9sbX+Ck6zONZWHGUkyyKeux6WfyWi5MoY+VIQMQX0J8tiPsi193M5yDlx+jmTbxL
# S887z3WTxOGwsmNkJSbOVLEYqM5bkFVGqeHXjcECIeHbl5C8KiZGFT3r88ULpdXO
# 2skK8JFMkpyhePftfyHHpq1tqTSKWkYenFBSUKrp/hgTrenHGRKvjBiB7Z8j5hLU
# szUqxph1CgiZArUbaIVHVPQ8rCTesyDFS5Ug/Oo3DwjxNGTNc0an4HBrgwyIGL0l
# f78d4kqcdLXJOhRl7CLMV8E=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	CCCL150ProposalWriter.ps1
	===========================================================================
	.DESCRIPTION
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150ProposalWriter $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150ProposalWriter
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD4vPVlVWY7N3RS
# ryaZ6WsZMvpznjuQDX3LezFcRvq9GKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDC60Uc1PlsI4Hc8kUpQStD3zGgXQfi
# 5shAamV7x777QDANBgkqhkiG9w0BAQEFAASCAQBnrsXUam29lsi+swfyYUPTY+b6
# u1iJcyMQaD8U0JC/0akMT1xHZVGoDr0AMdbBmQ6q5lmAy/vPchemIkgzhaUN6+H7
# 2het7vyAy2diVbVadplQ1hVP/uIPuJnvMJBkLKQfHPGEde070Z70X3GKtwnGUm1T
# 1Ggw+XNuHV53EQQCnV5EfHTgy6dBtAFVhZ0HQ3vYn7CmI557NmYEen34hHYV+9aR
# pn1p2h5A3cwsFn0I5PDbO/lgfWT5lLmBqqBE5XS0LEX1rvdGT+gI76Td7zHD/RtV
# lp+DXweqIMr6SX94xUKMtS/yVemZy8VR4eN3M8Aq9LnKLJJPt9RlKFFSvQHLoYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE3MDgxMVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgUtCsS7dfIWn8
# 6MYLwq2/jKbQuswBs89z+cHVt8E4e4UwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYC2CXuttUFCpnU3p18HYwdooezxcKb74nuJHdVxPSuX
# POPg1HvMnJmjZLLlN7LMlumu+kBvPlGKVSrjUmycsWrwBtbskhJBYWsSP4v6VGvE
# KEg/S90utQVKrENLRxYqeMaY+3vtNRmHM7KpREO50ADZQO0jExnkrL7KYoc6zu8L
# ywq768T/JP2OxQczGmiIdIU6qxAIwPOeRYHppuAP179/VKcarN+bhTXSDl4+Nnz8
# Fmz2PAZbNGeyvoLLJgO37SRNL65XXagRbIH9jmooB5QbCYKz82Q6j1HauEhbJdPb
# baT5Ek18ddrCZcNX/LHvBpOD6kUPmTa1+nOsvyzXDgLOYmdldTQrBsz7W/E9TNAj
# iw3P2iH/wwMN3zqRyg1ERizWEpGR1Fe2N0zhBsE7x1FPgAcIseNlhvkU3vmZuqhq
# Be/zxWIt8HMdaH/HSiC1kyZQvFlZLZ8q34PXhruFHxdyxF05lI0rw4AHputPMgI+
# zZ91ctJU+RyjZ/X8k375DWs=

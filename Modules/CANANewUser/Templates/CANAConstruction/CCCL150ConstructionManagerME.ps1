<#	
	...
	===========================================================================
	 ...
	 Filename:     CCCL150ConstructionManagerME.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-	CCCL150ConstructionManagerME.ps1
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CCCL150ConstructionManagerME $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CCCL150ConstructionManagerME
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCUJkxSGEneXJIx
# artI/qSz9rMho6Ji4P/O4H0uTVSpjaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCC3V3e59RtyFcJzpAwLCGQFuRAskvn3
# lf40fOOPAZcbcTANBgkqhkiG9w0BAQEFAASCAQB1MZukFzPeZAVGMnZp676WOMQm
# 2BB3qjnsMMD/+xl3KSsw01j4z0S/cjOUR+P8QNIREtguzBBS+qfJi+yreWaH/jw4
# M/XSsk4vHLBOPurO6w01QHuxlkplrSC3hk7kUpC4pPMXxArAIF0w1dj7M9Em+W0e
# sha0P2O3DCW7AGevfL2x8SfhO4V6zUcQb+mLz9FIe2pLu6pQhqcT3mOiCopcnZzF
# Kf4dOTJJj20s6PTZmYbBcAQcXZX+jJRLoYR9xaEMwwkb2n9CT9aQdAtGvniEwFc3
# CHF37dME2ZJp6EZfPHT7wlBCjPb9bOVqHTBqbrYclAfGI49XNK1/9ScocaVAoYID
...
# hvcNAQkFMQ8XDTIxMTAyNTE2MzQyMFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgUPX66jvJ3FTA
# tNxiiuoN0l/QJt2zMSUAdhpfC4fh7QAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBHISqYIYj9c9T5CFDTdHC2B3xyrnnaMwONh4bWV4dH
# 6jY2PQPpaaV0YqJ+Exq0XLtNBEOVhfkaGWkeRa03mA7/+Y8tY8VpFz6Ng10uiqEH
# 6CB0yD8j69SOlQu6kM5n3eJslqZz7Ilmwrj128Tal6XDEi7lkatyUg784PTE8/wX
# AfLD2b+bMOMHoej9/QVsmXKv3OK0JkFI91DYd16aMu9Hho5Qf3xzvE6rfzCFN+34
# rXHgt0049iamgCEMDzNBRF7GdUfryj/ReO1rwVbVjuwbjzF7AGuvYfu9qbuzZ5qA
# wcpaq9Daqz5yUMRX0BowZDTu0FRWtg0//RPGQlp0uKa/cfWJCQDcWAmm0rDaVas9
# V5QotnkHNLk/KKYrjrZlIqrgj/Di5sH0kSvifzG7n/TztkD6diCHayQRxBxrI+6+
# dUxCFRsaUOIyj2B3/M+fxlaZDhpeRfL2kre62E0++dUnM2n/SolAJwLpJcmevSxa
# gLRq7IPPktSV5hFyjvYNplI=

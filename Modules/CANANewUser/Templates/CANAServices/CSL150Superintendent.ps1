<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150Superintendent.ps1
	===========================================================================
.SYNOPSIS
...
<#
	...
	.DESCRIPTION
		...
		Head Office Users
		All Users
		CANA Construction - Superintendent
	...
	.EXAMPLE
				PS C:\> Add-CSL150Superintendent $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150Superintendent
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBTzQXzo2yRUFv/
# G+MYjYrUyMVGIoJ71PQ4uhz8GaDBy6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBmbk/AV3eQjb/DfL6Y0zl4K6ypHahx
# q9tatNiBxnVxkjANBgkqhkiG9w0BAQEFAASCAQANsgmVy+pvx8Y1EDShlREiu0aa
# KILpVXY8naOEQbWmx3DOqUMisSCAsaKIILPty5NtvplvsaJaNRsGn7mvlUCusW3z
# SFIBaujMFLIEC9CjhrfoCtGAJQDnVqdI6V+NRdxSro4H1NVe/5xR/XqqLp+cn149
# w5B7mXcRW/yBi6jSQxzm/Em4kqrTxc9tOlONd1j4y2MNT8ZA56BvnrgyHPD39fsk
# dgFRNq/obfyO7WGMYJUFs/cpu1RHCjGPRWzXf4acnTqyo481pG45q8Jk1TQHpqpO
# mji5z2nXwgKWvxzz804pQIGxtmU5/6C6Qbvqe9bs7bv5lL5Mp6aNpvzECUMgoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE3MDIzMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgWCDzITqi4+73
# f5hdUQtZlZKL+053P55WeuEpaZ7uZMAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBnNAitFDG+HcH5YZTiVeYpkODUaVHSl/0g2POcP7jn
# RAwTikg7cfnFllPZwCGf2RlO1Rz/7fO8WG6L+PD0CuGRvhwCVYcHi3gQmFxfUe0c
# U9XxoiWSKbXz2qUI3HeaxB+HGwosD0j69KJkXj+vLrJEdthYZ4+8jlCi63Nh35Y5
# o/2Oov1tq5O7RTz+NMw5BYo/8KhVotjnfHvpbMuvx21KMEGQiVZClYXV2j8wHK+E
# /cltqdaAosRLv8cCcjqp0trk/NjeTZXvqDFsTYvCCU9QN+mmfLUSQCcV7/XsvhSI
# bp/5V0ublxKf6laOMfkzZBjnnU9TKnL5BYco4qCFr0HBcaPw9oa0Qt7q5b973lHu
# xW5hIO8HlN7bZLwGsdCKwZV5THQCydy3XCMONv9G3AIZAgJ1aj7InHVA5vHNdinp
# GSfGlkMh+jdmHOgPKke+FDiW+WfTdaRLNCdKvN7IYIkE5fPABiHottcd8TxqTzcg
# FdBFia7cDxOeSpZgKxYFF+c=

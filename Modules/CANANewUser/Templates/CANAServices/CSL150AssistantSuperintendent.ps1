<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150AssistantSuperintendent.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150AssistantSuperintendent
...
r
		...
		CANA Construction Superintendents
	...
	.EXAMPLE
				PS C:\> Add-CSL150AssistantSuperintendent $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150AssistantSuperintendent
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBKIYYAEHbV/1UC
# N+bDrbvtdpIlpVCqSCjOQ94628t1eaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBPqV6bUdfFfUvrC31U1FLzCecI6vrJ
# pVhRQMj5QyqAhDANBgkqhkiG9w0BAQEFAASCAQBbbpsgTufwbpVw5CpFQuRAud1i
# S1MMnFDmaM/4uYsK95bG0uMf5AaYO8MC/zj60/bXe8CHPmTPheXX5rsYDPd6P/tY
# 67cFRi50p901mzHAXDZqqIkQK5lKlET6U8wCmFhSGCEjLsu5dJgvR+EyWtIgv5EG
# ptkfpP+aFPeskbSiinCOQE1WMfPazo6r9N657zrw0xtHCxaekV2UUOoex8oexeYo
# 3jke6D8mDnmVMojggcWt87nTmUsGwD6iyPIxpTLDHt8GLdzBu4ZJxnBNOR1kOgRP
# EQYhUkySeanoztGC4z60jE0DA1hSlH5PlffrKd3x5zjU3BIMKo66ZimRckHBoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MTgzN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgT5X9rAQE1Prw
# hST9IntQ/E6GrvY6et2wa/x1DBu96LAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCBiv98m5F2BGSfpvSr3hNUS4urdr4ADtzlP9jE7cqK
# 0wDfVxpS30k1BncsdrZBmhnXSdfT8zGOEkK1iYAxyOvTloDaarM5ihZerjD3FVTR
# Mr0cMe5lATlu/62QChX/MQ/CmkN5QTRlslccQMJIZhqveMjmfDwdwqrdKCOezY6C
# +hHkpeTT1oWZ9D9sHJNlx3IA5donlOzpuWZinuTTGwq3+bAOintueo0DnDBJ1byI
# lLicfMkL8nG4FKChVP1hdBFYdVu3KSpt9zBok8WSsKdAVfqz/r5mSYnswrliWU9S
# yvn0ClKWKnPGqUWdTOcbr3FX5kyDX6UZAqTqKdLmP+S7xRrlqGARQuCdhKSDOZ+I
# oEiyS5VPYrRolCzGwqjfS+MkbdrxJMWTaDXb9tUyrej1fEGRUAEut5XAR4RyAmhb
# 7AUvhkiwMIsKnQ82/EJu45YDo5XthqeuUmiEIm+uyWqswNcOm2iPyNZSBoJJplq1
# d2Yer55FosDtPMl/Wa7MKoA=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150Operator.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150Operator
.DESCRIPTION
Adds the user to the groups defined in this function Add-CSL150Operator
#>
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150Operator $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150Operator
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDyWzUN3GOrMkew
# Kayj9H06Yn/ZLSYRs6Tg1uciUYpEiaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDr/c8/3f0y//NQ2F9jVquRBTo8j5vI
# 2qzos341mkFe7zANBgkqhkiG9w0BAQEFAASCAQAJOGvoNaVvBoDi2POFenbTxfna
# g7Hja77xxrSRyToF0tnlqFdjfqVFHeTvQwF6O/DtgDLRUi0HH7lKgobHQBZ51nrs
# RwfgKOWG5K0HZrFy9HFDn1Qv3yBEtvw5Q1AHo8z4e1wFI1Au0d7CQAFV32Tkr6sf
# fSQqmNEq6a03p2rqE0DjiJwqaWBlB1xnicko56Yt0lQXg0yVaiaWgJJjOOhqMSRW
# Zp9tThuW70i9hKvcT4qMIHl/zsfHDR2aQ+wKd9xyysOT6NIdxmq421AKi/5grQ5d
# Eel7+IlolIld5JU6tNISc+HofK2w/4MWsY2XKYPSrlwZH/7Uz+LU2r8DcZ3koYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MzUyN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgj9itgfAYaoaY
# vG+Wbm71xJT6yxRsMYzf3NewAaoRhL4wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAiBfus1S7bxf2PFDcYsl3IR27VX6XSIgAvO2ZRbj4b
# we6BuqVa6OsWBuI2VpLwiiUFbR1VvDioYNr6PIZIanp1gIj826NPb/3ESuqqzhrv
# Jggs5w0hqXZhHks0yrqX2OZfnld2NvxtCGqZ7QNPZ9ygR/vlJECV/Tr1cQMOTVOe
# Y4/6PcVM6d/1HGaUz0/pYIKVecWZZ393kbx2Vm/tksd9FG5fCSr9fYyij1I32BAh
# GUVi1VT2aCeOPn/i0tM7+NlYP5DngQrwmw41bpEZETAmQKzC4wcu6oxfGy4Vr/V3
# v5UEvdQMmS4zMonKgnecyhV/L7BgQeZWT4ZqhMDlJTuBPeM0zmB+/wl8SB2/xbRd
# X5co8+iS76yuxp89KRC+78ZzrgGPxK1oA+wOEXLPEIU01zGx/huKYb7HYutOC8lc
# ZJ6q4ZqVAbvu9wpxe16yuU/p/sURHhs78+0Mas/FG5hIuwcxIBT/5VIQtm349oAP
# 6UIMDRVBgV5rAcIdRLVjevE=

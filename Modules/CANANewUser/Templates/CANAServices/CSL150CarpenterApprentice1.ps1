<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150CarpenterApprentice1.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150CarpenterApprentice1
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150CarpenterApprentice1 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150CarpenterApprentice1
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBhTeVqV60dV4h6
# DWdc3/NJtGEWDORxFz0cflNhQHOnZqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAe9vpw3VC7e86d31WIW3S/R0IcWRX7
# WpUBTNppb6qRHzANBgkqhkiG9w0BAQEFAASCAQDWfp/3fL1YDeSTnx+GXbWBlbVO
# +6uS+m6ww6Hf8nfTCf08niLuz7pdXSR6x/EhbyUW6enoUs345trQAfPgP+9qZi12
# p4S4gKqUWLdGKmjBZpCCAjHMNpw9zMr3LTMdFdvr9zqKinFNSEXk7g7bBESapyls
# OTsvoJGMiFZaqISLf0W9lk7jecTuvo3K+8iYVGYjjfnM+AfYzXtG3/kJHsKOa8R7
# +wmKSdNbaW6L1eaORoYQU2Lsmcy+5N7RDbb4Zaq6Z1WETBg8t8ixJFUFdeoMnnxK
# 6PEMaL7mHqpVocHRDq7aL64GM7txm3PnFdlcl8dQthXh5DrS+g9SmcfQyh8koYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MzMyM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg9GzZtCSFOVsL
# ijvh3MuNXGD6/4YG6KSBe07jWJJqn5wwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBkqQqrrqUqUnEzv8G0GDwxZLXmJvzLe0wqStfLCIFj
# jBZ2QQxu6YygxQCndeK9Qd4SnVNeApap4XfshzUYVay08YKR2GzDvbY5ByvSa6To
# q0PueRjQip4yWjNxvhV5tmTrhOi6ksk7tPMmAsvhcDa8fMRCtuK1AiBPW92VLsuL
# ENUEIV2rYMRtQOpCrLehvglUXv+tuT1tp3j8B5tl3mYJoxWqXAXWx53mYxKeId6g
# ctC3RkJr9sHGxxa+1JIaakBsUnTZHURiPXwUO9FeijFi5kYBjc2PSnfgFBHUjpd3
# Y1Ke8oZs+gzuCOKkufmxHb7Zvn0gAlp5gy3z/e46CMYEShlNYR9oAfAF/huc8slR
# Amvmw1G4jncZWDE9AfOtZo6rh1uPgYPLRN95NgnnAmKOEU4RQbDadGQHmo/t3/UK
# 8k/YGiBripZ5PCPXJngwx749DI8scynlovMH/1fotzK6KWqXicQs+BORAyr8c5Md
# ntVOjc+WC+4o6pA79tSQpfI=

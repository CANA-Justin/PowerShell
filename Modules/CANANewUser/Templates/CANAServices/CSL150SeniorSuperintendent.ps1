<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150SeniorSuperintendent.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150SeniorSuperintendent
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150SeniorSuperintendent $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150SeniorSuperintendent
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('CANA Construction - Senior Superintendents') | Out-Null
	$ADGroups.add('CANA Construction - Superintendents') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCZbuua/zi/DZhl
# OEi8X80lvnOqsjlUocUNBSFM2q/di6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBZtKmJLMr5shj8pQlYFStFgMY4rrMG
# 4fuLGVuWRCmYIjANBgkqhkiG9w0BAQEFAASCAQAMOEvfWKXRr3Nk3AfEg0fNpVR1
# pMph55I0A6+xARFGEJAmfZNdMw6KEkUdDVAQuvBLFLFVJOWj1YxbL/+UwTeWgpeK
# qP+HMGKrsSm08njGCMsM+ZL2DAvLO2V6R79vVEgzGfuAgLG/90BxyGrQ/bu4lROM
# gPpDtSWvxmq0hxnBkFakAoQy8RVth5AaxUp96JIK01EwPHycntqiEm9mcgznpLq5
# HvUWoMIuTbyU671CSo8wU3MhKz6keKpJHrzeP7L0VPPXztQwUVEUGXg3elW9TD5u
# QmAeBQVR/9mq46lERcBYV2fv5LnFgxNUgU2vB0pnYuGReDgReRVaA5UCHkVZoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2NDIzMFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgN71tHDxf9q0X
# UkllxYgH4Ql0doXqvlcwCXl7GUMZNEAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCk4jcv1FRj2y7+1glXfxgEzpd5EqJ4wGjbb2llby1j
# 6BcWF1Yn53MJa4mU49IIo3C0jkUuJqlK9GI2CLa1EYiAd/sfAq0o89SuggeiaqEX
# dswat9LPjQl0kPjSOe4wgbK7UXwtjk6UEVLtJUh5JNjF843B/mGlQ7JqoToUXYXt
# XyBa9sfPbIyHenObScy5LQKQSg/oEIHvU+OdvJ5W6le/vDsk/ThmS+QtbU/rB76c
# +5KO0IgVPYzs8OoE+yf25PLXMXJTPbi7nyPMUTFLZ6mgk2jHArA82qOpf8rflGBz
# r0k5LXwNxQC8ks5Bxh1QFuQTFF7ouGyPp0kiCLLpexPgDwjKIQh0uwJnrJrMiz9p
# 9D269GU8mLJpsJTe7KdnBOc3fc7rGGJjq+Kmsa7xGdoPTrzWKEMuD2ZetwkndKIA
# 2NQdsBzu6BH/2TkGbWNwZFDqlptOG3wsm/Mg661KIzhMXsHYKqUYS4bzd9XwTJ2B
# /IzyMW4OFbYrNiKCc8IHwdk=

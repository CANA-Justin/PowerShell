<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150Journeyman.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150CarpenterJourneyman
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150CarpenterJourneyman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150CarpenterJourneyman
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDC+Qy158Sn/ReP
# bu4oZn6Zspl6uS8KvA7CSUMbGOPebKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAsGOooalekyxZiEsY0ZmuzUvCaF/6h
# nmu56J0RwKQ9UDANBgkqhkiG9w0BAQEFAASCAQAK0X6LRsIROadpo6KMvmkQ/WUf
# wWsIaH6H2Np5g/QtpTYg6xr4Jr4ULi9T7z6HDHoWlBrmaB2dvziv+3T+mirXxfno
# HT8bIwABJN8+V55vFBJj9viy0IWFIyAz3qbPDf1wXx4MeruuCd6V1XUpv2m8Ii7X
# bv912acoJtF8iYwCBu/37LvWi6eNBREQ3iX3wBnAYeiziVWzrJQ3AvmopKYvPUNp
# /UCLjhPGjXMlNDWVXQzgAyZXzqxCv34OQ3dc5mYnWoSQIumjlj/NWpNIaaxigKgz
# UscUMul5Gwsdmp+kxSJj7MAgYwiXMDidxSJ8+TCBye38tehwZq1WzWjyCrZ4oYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MzM1N1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgXSB9XUukLdKp
# cilUEMz/TFcd4h8b8Bk+zwpSvGKGBOwwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDJjA1N2OKIggNPTs2kBsgoFfSPRaHErGCMuiI0CfrN
# ewKcZNqJn8rYhBwurprjqdn/5GI6mxyTqepJq6Ooq9mfzP7wsym7sa6Qp6wHjbZC
# cDY8ZceAyBLu1n68+Wi0RRIkmmy2hbgL1wDMPUKdrQWkcUV/CyU0pjLKFc62/xb7
# drcaHqpsykORVqnK4l2BH4BQLcQBYMH5ds3hjuVWB2jGbmxD3zTbpolhtk6XGUmh
# SPJq/4xJU/Hiz5P/qnPInI/Y2EVwxsotMJVex7c9aPpPbRS9XtQ995/TbOxRJ0XY
# ztv7vSUg4j8VHfSkPHsG0HQQgMK95Q3ajLL5ho8ijSrMqQ8f+k0iZmc9f5Xq6+s6
# ckmLSrfTFMNOD+AumCAuQ1Y1K+arwxQYJQoy74bkHuHeuVVHY1Ct7My86bZ9X4v8
# JT6PpfglgG5sJKL3ZiTfYJf6gOKboqvJ+miQ+jEhGbtbjrTGniQODCCC5EjJnXSy
# mA86Fxfk2cZ482W5P2aykeM=

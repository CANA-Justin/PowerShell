<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150CarpenterApprentice3.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150CarpenterApprentice3
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150CarpenterApprentice3 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150CarpenterApprentice3
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCn6BjHCrmeBKaU
# u74+jjZy3U/dHk7Q0oywLLJtpLPCPaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAGKNi3Fbcrs96KcyDTL2P/Tyr0dQTx
# 3yiIDWlOSVvBCzANBgkqhkiG9w0BAQEFAASCAQC1FAJmoDP8A4V5zsW5uhALyh8v
# aCtlKwQ8lLie7cM+V+Mo9bbyLoGXcJNdnhmiaNhUaTBxw2Yfcf+TZupSAC3gedr8
# Gb6M6tGYbgE65ZCYp+XM8GBZ3wG4+2V9LaYS4hhhpDQMBfgaqKOsQjqiKn5LfLI8
# +PeZysPWvSFfnGtDrXg8FU3D4wnsrq21uWYyxASe39mARIQ8kTxiRFwgXqytZpJv
# BsUT9cQLJE0xyHvAT/JJkrpRjK2yPl/VmLpxVOi9X6+lik7xo0ZsswZNezx/tg+7
# vldYJBTHJ6HKWX8ftREYG4a7Kq9NXEiBbt/2RsIZWE5901GiV79++PEfUukFoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MzMwOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgF10+6LyClZX1
# z8VN0fgzEEbY/Xf2YXz1yepLMv5zorUwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYARuA1PFAjtmwP95igKY+y09mdKMdV9+p6fd/C8v7FR
# WqLuNiygYaU2T8ABPoI8cWv2ZPCHZWA6/lXR7XA+dVNFRisYpIzy2dmIR0ycEI29
# QRM5n+oQTmmOn+b3BH6bPiSHhEJiDQTksw2EX4Qg1QfYnyd4eUsRwGWqFquMrKA5
# 0P8I9uAb/5iHcDJmjaRRNLF27nhBlSW7sFGmKn7kJvrqKspGAsljbaIYJo3MqG95
# 3dP4Y6H/3VoL3u0Nnj/DX4dUVQXoVA6Npiq/TEHJFxNz+JqnG+9WOkAqXYQQjri9
# 9Q0isNB7fOCQZPRH+uoeRWDoaakC6Ax9LslBiS23sCLvxMLZXNbQDHcmyh8kRRpI
# wiqqOXnh7LCgzoMi6cUhLg21RwO/tB5WHmXBFVfNcykp7ZLgK9Lbt06jS+LDdA00
# D/yXyq0fZ5evPwqNgM2jMUzMaI2BPL8yGZjldGHrqcxYvERJdNLZXE2iJHtrRAVG
# z8KsJQ7VJ5RkHKbKe7EOjpE=

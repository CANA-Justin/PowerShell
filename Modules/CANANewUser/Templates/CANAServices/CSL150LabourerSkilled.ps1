<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150LabourerSkilled.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150LabourerSkilled
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150LabourerSkilled $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150LabourerSkilled
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDKVPeoAV65dXZC
# 3G8d/W+A3HWb/k/HMuK/Xvwf6b9vnKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCB9jDvj/VkOAhHPAM30nzIsZwIlm81J
# V9IaVVVa3YoZ2DANBgkqhkiG9w0BAQEFAASCAQA8AeZmsJtpU41bzcuLp/7NUFu/
# WeguBsKxgcgXOscJbaQpp+8nGiLQXOMevhNmbLLYWZunng/FGl8l1NZzWRmiUIX9
# k7Su/JBKGibQAhX1f3OjAwRwAnch/Npnk8rOpksgK8hqY1UopDIQs9nXanCBMqfW
# 4FH5XjprgizM8P54a9IlpvrF8wsv7rCMdIbFauBzdFFRqjLL1j+E4Nswu7llQ24/
# gRdjLklzth4OANaAXwp4i0Bj6g1yqPZMg3QVUw6MT2H1W7/teVdQaNXKeklgDMQO
# gicMIjoQTO3zPOsK5XIur+cFrfSOmtXLzfnGJRdMLHYdhKDBQF/0nXHORG6RoYID
...
# hvcNAQkFMQ8XDTIxMTEzMDE2MDc1MFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgC9H++hHXsfuJ
# uq/9Xt7pmLxRp3mAyskN/QB5zjalhA4wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCbNQxWHvbT4WuQnu5CR1XzM1B1XxcBH+kkvub8D2m5
# MTTBIVhrxahJiwsExTeEcz5CbxW8ZgSGsX6QImsZaoIjs0Cqo4EL1C73pHKA+r01
# UNi62XTVEz56Kab7deGL7XjlylPbLK/OsxPXXIDqgIYd9QtPY5YjSdrAWrcUQfK6
# Gm2oJE0KhbJmx4omGACH/MkSk2VXIwWNan4Yo0yYhejuroLxbkTRW1Uk305u773t
# 8lan+z/cY3caSE/50c4Jo/xruowCIT65RmRHnxYf8BrP1KSYKorRhh38Cdb6/04q
# aJ/+Z1ovUf/4u26hkEKR05veN3LSN9jQYr9KiYMsjSZULnAC/thg+u8iWmhvD6BJ
# lFOstASK6nVwWw7bqPdr8YsZ1fjAN74NibcXDur4gm/DZkF94jFXlp2O2S9pjK8Y
# SaRpwlGn8QuPfaqCO1M5cspS6Gec9+TI2lOluNjjgqmONj6KqHPDwLT+oKoewNqJ
# KT8OavhwbpBXaBptVd/uZNk=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL250AssistantSuperintendent.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL250AssistantSuperintendent
...
<#
	...
	.DESCRIPTION
		...
		Head Office Users
		All Users
		CANA Construction - Assistant Superintendents
	...
	.EXAMPLE
				PS C:\> Add-CSL250AssistantSuperintendent $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL250AssistantSuperintendent
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('CANA Construction - Assistant Superintendents') | Out-Null
	$ADGroups.add('CANA ReNew - Superintendents') | Out-Null
	...
	$ADGroups.add('SP_All_Admins') | Out-Null
	...
	$ADGroups.add('SP_CSL_Superintendents') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAb2H8iOdm1tKHD
# UenqNNcpBEAas0ZYod6bKWoefsgd66CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBxpR+WQmRUXsTjf33vn1nDz6u8Bya/
# DNWZ287gFjtPdDANBgkqhkiG9w0BAQEFAASCAQDZ8ThUBS7FP2OaJ2Y49SZOkDAt
# mv2fZuLQhPd178IEbpzuKbye9rC2TsZGOmaLxB/bEl/vBjlnN6Ot9a+Oin83oVKq
# 8UNzuv/HDUUVd8pTF2cXYUCBryX5bbgikClSU7dUZkmM7dstrIZghvpE+JJV5+Go
# 4/DGWGIeHgFWooUhW16eHrpYUxsIyOdN3kH8i2din+LYax4pBAhiMFJNsd0Ryizu
# scdCigIWLP0z0LoJrQ7oogfB7wgoUz5gvJgWnGOQrUDBcJvC44bCdzFXwe+Wgesx
# cyexfhl1UfpkRyJZqtQG8uQnCCtrPpBOTmbtWSfC1MF+jwsHhYhD15xAa/kEoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MjM1M1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgwnW94ZlemPcD
# N4Tf+Aft960d7HfrjE5mjBxhXEjH83cwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAHZVkSnpbiv4Ab4DrTtAxeuA4o4gAAYV85QflVTxmj
# wx5byonWsQHm1q3O2RUDJnsQEArqoTbocPaP4dQOWLu8oc678hH3HKqWhKvIxGtL
# yQPikgProJQU3YfKnmTdWvdR6d1b9t4zVB99okJI8txlx8skH9B20XDpbEAaJvVI
# WKDquSlZYpNGDr1DMp4u6JVhjDKzJXW+ouukiTTxM8ug3zcAY/I5+v+QbCOaoAjj
# 62t3PeloAgfoUiQ2wnb01ulSR+oNDa51dWrSqwglk0Z0netrrFXUEJR2kWnkRxOq
# vR94ZxeYAnOQFmKaIRjh1t2I9LV4g9kKxcDGo/JqpsV2TJ8ySCMbkNKI3U7O5lYw
# L/ArAQidzF9Pbi5qFwEI+YvFmYIFFHTa2vK8Xn7OpvJKSgTUDX5CF5cgsidvSwJ8
# c6nDtnY62EP2MbQX0Cri5Kn1QYQM/pBuvOwTJuTDIDnfKtCjVa8QpyWq+mtSdcvM
# SqDk5avruq1hlWXPuPTjrMk=

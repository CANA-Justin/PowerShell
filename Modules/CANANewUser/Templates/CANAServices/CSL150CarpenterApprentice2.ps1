<#	
	...
	===========================================================================
	 ...
	 Created on:   06/23/2021 8:19 AM
	 Created by:   	Kevin george
	 Organization: 	CANA IT
	 Filename:     	CSL150CarpenterApprentice2.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150CarpenterApprentice2
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150CarpenterApprentice2 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150CarpenterApprentice2
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC+aKfSOVAQogxm
# aAgUkEk9fhduj0FpVSFgmOAAxZnXUqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAQykoeaEg6zJqlsX5z/GW0eUKSD7Ix
# zkmWGd8kn7wQYDANBgkqhkiG9w0BAQEFAASCAQBxP8yEFHhgXlVd17j8bkdpF0bt
# g/Xef3Fp4Nh0G05SsE8hQ3C2E2zPIPFURxrJVnl2HuHdk7JfB2Q83DAVJeCDRFrT
# nrCwvb128kP9RieMsih6j+Lh/2QPNTAB+BTHUQutIblLwgBHF83wvPwnTpxO/mPg
# wvYXvBC+PX8xmU3LfNqmJ7PNyqzZQaW9ee+SQd0q1Vx2SJI8aSXN1rYB5MizcA8F
# Ixx27p42Y4rxEVNupsu3t0YJXHO7KjX6/XJOa/cRrclzywdjjg24nyvBl7BoO/C/
# h8ZIjMJb1GCO4CAmkxekwqUyBZjlyaTkyM8LcXvLNwyTP1jCyW9+9iNbYMecoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MzMwM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgo2pebeP3ZLvT
# bbkn9Ci/3tpv1PRk8+n9cPKItI06TakwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYANu21z4CWzDg8hSMMsV4GCtMaEmHhXQGvSZQxe+Jyx
# eIuixnTGp7tEfuSaFQiaTfvlCXH8Co9aB9mWadlGhop05NwX9+hmZFAhadkdWH8Z
# Wo1tFrhA2XXNIHZHQLE8rO/VMmNZ83GeLEaVju2xj8Z29wJPBk4Cn+d7pnML1H8x
# gTPV0DBy2ZDhcz+j7MT6fPZtgc5tZZYgJ04e2BJMF56TWRdT2roO8S9Coe2tr6O9
# OVfEJa7MClXFKDBSuGF/u9icjoHhaw/yqwSM8kuYopTO73xnTy+4/IO12MNA8LWO
# A/BIrOZj9GSdQlEYn1LDPeX0RtcAIrGxgPIIph5UEu0E3jD3JxNEm3FZt+h8F7gt
# BowwKmo67ZRswaQQ1R0HLQwpDyQaypQXPjIrTFuKz1V1nPcz8tb9+JTYQ5OfMdJz
# 6FuVJugZTlHxqdUEzcKxFUGxidyl9PcSSiLkbWUEmtHJdMY6gA98pg+hPNqs1s6a
# ny8H/JHtr8JCxMpn8z3qKZM=

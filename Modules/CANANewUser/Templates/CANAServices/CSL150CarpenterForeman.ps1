<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150CarpenterForeman.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150CarpenterForeman
.DESCRIPTION
Adds the user to the groups defined in this function Add-CSL150CarpenterForeman
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150CarpenterForeman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150CarpenterForeman
{
	...
	$ADGroups.add('CSEA Board') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB38Md0wj4unVfJ
# SWNNkeDBrhfmcIKeMly5KtYWdHIw0KCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCARKfgq3o4QFm2hZ84Kgyo4J39E5QGn
# OOt1+Ee9eNI3szANBgkqhkiG9w0BAQEFAASCAQBGNJsDBjNnaMQeoKI//kkySrRa
# BFAKz5jjDGnc2LZY/LQSpLQCYE8J4xzlqnbWSqN7FB6V0wSmkqqlV8WHNsev1Uxr
# H6zqiIbgUs4+tLc2kEM6eOSFgG5v3z/VtNXsU0bDkIzsU1orhF8Q+3bGvNKnc8aN
# 1GcaSYDTQqs1KBHWgSLN16IWjury6Z8ZXEj6QaRRw89g/HeySgOUYpEfoFW8lz3g
# INFn3fEBlzsq37mJuGK8gvpituAzdqd1ulJ6QFxXXZUuDpdrOH5YYgP/XKEQvDmk
# cswA87YMHIHGvKOK1U3IOeaxyjQ9F3rBFfZZecUfZMxIDK4eLF8jfUUorxB5oYID
...
# hvcNAQkFMQ8XDTIxMTAyODE3MTI0MlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgJGXK5vT1Yk32
# lO8l2DUymEmKFEG4j1DaD3JMfjsve+UwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBSzaN5teVea4AncP8PhER3liGjC6nN96e1F3UnzPyF
# o/OoWfSDOGqpESNTIbzi0y8mYMDflpuhCg9Is1KPjxr0MRPxAsPwUmfhO6+CH6ux
# pLhKGmHOo4fX0wwFmXDSfw/dZDOlCAB6jD97oPJNVkmgSc7TWoYBycpq33OMEyVF
# FNMSbepMHExXUINt9hnOxr3N6SJRAIKo1RrU091zDzXXL6LMAF9wBVHcODM1KKfZ
# 0ELfvW7volS/J5nNTkjEQiZfgdW1wrhhtJ9nXSyzkDQNHdtTnVtvNr9cQPRFvTFt
# BxytQ4PZ3ZlTlxIUWanCbP4L6g04uWO/jjRsiQ/iBxHgfAFbYV+Wp12Gc/s2Ja8S
# hVJ3M6xuMNq5DO1MgCe9rBKGBvTM14E7gL9YvwiQ7OU2EWkIwgbFZ7ojUtgKUAlE
# 1Dytargf6UGgjSyz9q8xyZS+ejJ+rvI6DjSwU0ffTrVQNNJLH3/fZSrIBC3SmDeO
# JpWXc4bpdeqbt8cHuVMoTKI=

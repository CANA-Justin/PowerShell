<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL250CarpenterNonTicketed.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL250CarpenterNonTicketed
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL250CarpenterNonTicketed $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL250CarpenterNonTicketed
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('SW_Viewpoint') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCQ0oWLfF2WMUOJ
# Ddzw282b404T9AYCeAYqsXK3bQJoxaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCfz8XaPc2OfVArR46VnbWASxaIkzG8
# RQg/h8qcHfq7UzANBgkqhkiG9w0BAQEFAASCAQAjT9GfzHyOlTLD5d2aF94NSfS9
# QFYXxg+jafW8Bj9Cl60X4FQhZq6yI0UYWlDzMIHT7QdYxzvBO5BbsH5Y/6IibyAd
# xyX9wjUaUqW9iAxeJwKtsrYieLYGHAo3scWgIi35rnaSSZWVcjerK1NEClnHCgt2
# hSMpyqE6cXkE0MZ/mfIluz316AizbIpDOKF3QoKu6x1ja4c2I1Z1DC7ZYrXiuTJs
# HpnM3EglPbIJsBifUob/XSfObXJ+kOoS9gsmYs/4q/mf2Cpr95EcOfclF6fcBugP
# Mvwo7ggHWITeZuUBjEDF6DJ5kQamrUfzRIFYVZTO4zGwzUSSYCbq8Gowx1YfoYID
...
# hvcNAQkFMQ8XDTIxMTIyOTE0NTY0MFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgPcb6ES6ThnBx
# dd/soUNWzPOMhOi1CcUnavuntBBaUQcwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCZYIIKpkLpKAXhqYRegI49gOShK/kDQLkGpffEOHF1
# CjI4dyRLUNsDh2T8Dru8wddWwjYtvgRnFwAGEUBcP5Uyx4+0vgGspGEkK6f1kARk
# 5FNjDETBccKtWarj/lfOPQ7sw0vQO+HuHQclxitOsRC/tNu2m3glu2Xxx9/ADO3N
# ZKLGLIxgd7W8hKjGs7RayP/7oyp+HGkHOhtZ1EQN9LRNpUsPulXuGVeg3HijBR50
# n8mA5RakIJpgdslE3nqAo440CXnWL4PDkkg3Hf15bm5QfKlePKmbnB/oEfZEePwl
# qIExdfK+1qDS57FexY6AQBNwi2ivbIrxhK5oGg37vK6jpZ7sFjhaQWIEWOoldgHS
# B6um1RWSt5uwxS+P1jeMWBiAaNh2tMW3ftSAL+5sIcBkXrAdIkXxuVJkueFaYBby
# p2APvvvaIPTqdNFucYc2dGphxVmSu+fvu7voK3Nxo8Hri8b1wBhH8iEu+x472Zlm
# N/U92VY4zkAxDUQErMAeUXM=

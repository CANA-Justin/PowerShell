<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150CarpenterNonTicketed.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150CarpenterNonTicketed
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150CarpenterNonTicketed $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150CarpenterNonTicketed
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBecGK11MnPECMA
# vRDFa8M3z7dy/eToOgRBOtu3EPf7UKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCKTeZquozoqgi4M0A9MncY9UqaAEtR
# qVLtMTPyiRydjjANBgkqhkiG9w0BAQEFAASCAQBhw7/JoBIiZSa8hbyoUmzupfav
# dP1j+QBvVzVbUV/zNcyBNzPmwHTMyFRVgGDCZNBCGzR0SjW9IA/MEzQjKnFAvEGS
# zz9CKDRQjQGbOoT/w/DTrAaoWt1PFf/i9LMbuKWhsB7vraCWYY0hXbnS6Qbnn/qv
# PQJCzQDjZiQ83uJKmoFo0gHOi5Tyq3X4MRGNwR35XW8yd5GxBLiW5WXrtPNr4Jdn
# PrXU4frkGrUYxZVVOnB55mo5ThF3j7UHObPyaBBZyUsEkI0XGAyqIvwNjDpfhCW5
# zEsiWh0ZCfmetCOOjt9zbBP5OzfoXsaxFMjFSW6uB5C94AWx3Y5SgpjB5Lg2oYID
...
# hvcNAQkFMQ8XDTIxMTIyOTE0NTYyOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgtp0VZ8Q/mTlJ
# FaKBUmN5yhZKGb75zhx0nkgcrR/ZmWYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBSE0IV+V9OZ3E5W4JCzrakj9A0S0GgJnqE+E9oFjgL
# 2vWfZJQW7IbK36457JpNjoSq40T8Y9MKE0E285cxalMmWlZohUgueAkNFn1mmzSk
# z6xDyi4YP+cEcL1w77C7kHomeEPePb1sLMjAKOvag4f8QLjdOgZL4g1LGIRRl8j2
# EQ5jhL0+BSiGSA7HR3/622Nwo6E5kzwYi0j96ACn5SE07PyNwIbn4S147rFhUxNZ
# EzDqFUPMAaxhhh1qu0b/cMgg637mR3WN7dJHS2Il59XjwKS7A/WDrCROnZY7V/FQ
# OnDbfah4W/b002l+61TO1hs4D3AvZu/bGTRIOeB07ecGBSQkDEq9hS/7MAxC0jQc
# XTTFZUpf7Ley1BBkYhzOgWg0AOFypdKW+Jy2M8lOSTVh2TlV446fN0a8NiLzEh7i
# nR+f+iVoaGlUe+wTEL6kEhiLxPYszrQuG+arlS/dXxuEgFg8sYht5eWnFRI38mlY
# ySoGYadivy2wUjhpOl5u1hw=

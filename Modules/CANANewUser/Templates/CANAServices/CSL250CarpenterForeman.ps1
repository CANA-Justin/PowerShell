<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL250CarpenterForeman.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL250CarpenterForeman
.DESCRIPTION
Adds the user to the groups defined in this function Add-CSL250CarpenterForeman
	...
	.EXAMPLE
				PS C:\> Add-CSL250CarpenterForeman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL250CarpenterForeman {
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAgbL/KErMjk1Pz
# ht8ERHElsCwn9pLiCmoCyUdI8wwTh6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCKSJqg2jWjI2c6XWem94FAQ6dCJbZ2
# 36soG688BeuTLDANBgkqhkiG9w0BAQEFAASCAQAJCsSBcClG58QZiXlXxbhN1h97
# Q6fSyteg2zfFmUEwFqDhVWrj8FxRgqFHskDq5Ppy8PGEAPJVbrGSmtXyM5xXymeg
# VUPQIq/arDp+UzRyN2SPe6fDc3pXhPaW5XcP2jHXbj4WorAda8ujAYNXZLOLh59o
# vbClFX/TT/sMTytDYOdZAtgMnWEwXeomzqvRO88yICU6k4r/Q29Y2efIa148Lw7J
# p4U9im0wVf9eqx4FY9PicKvubRXsWXodaqQHzY96Y+0oE62d2oUrRK4K72TgnX39
# 2JIfSryNbXDXBkfLe+YUjmIy9bm7EOk6FKzSDSDqLViVuSOOyEAUrI+sRblloYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTQ0MlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgttq7kjgGiWU6
# hhwLD9PlRWal/RDbqN2IyVjw/NxYzQgwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCfKZO03wxIVtY3Ec9i/9BOG5QKGMvFbN6cgOVBuCe0
# BolMFa62CBrT28UCj1dJzSsVrn70JewyErAALOtTgQyvg+0hlkQzvD0c2INi5cZH
# tBf6YDDy49Zuz9nn5hZRQGbD9fNi1QFa6+QNsaDcNMU1II+xkRLwh7fuZo9/wNQT
# RAR3x9NYayT0QONXr6WrvkNUMb3/fPWDP+HJMK/1k4lUXR9t1nxxWNdkLmX8J+OT
# pajEkBqG61wYYE0GKFkdJNcGnk3Rm6ZQKDamp4k1dRxYxqHWhLtK3qOMzyn10JtG
# O1Rr8/EdSmrMxnAaXEzYzIEvjB4bcm3BaMNLu6eHBRYC5Uu1U5BPCnMX3htO584l
# Dh+BKqjDneEnWZz9Nf6QqXwHp2Dv4FBDywcV2/jJZiIaLCwWuGMcyAZZ82VWi3h5
# MEs+6uNPIsiu0rEQXaccPd1nr1X1ANHOSfGZGn3h4vuCe1R0CuIrelCM1xgH31zJ
# OUxZtcQOZZrGvBiEE2hnwuY=

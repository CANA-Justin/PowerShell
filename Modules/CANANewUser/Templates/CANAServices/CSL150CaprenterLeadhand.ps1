<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150CaprenterLeadhand.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150CaprenterLeadhand
.DESCRIPTION
Adds the user to the groups defined in this function Add-CSL150CaprenterLeadhand
#>
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150CaprenterLeadhand $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150CaprenterLeadhand
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAnPbIgEJOwV5IV
# a6BeAk4+DAlraEOdMmpqtBFqW3/psKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCCPXEjS7FG945XqqSHKV1CctLoWqPX
# jBCMa+V/THs8GDANBgkqhkiG9w0BAQEFAASCAQCmsZFCYJvv7lhbtv0RMnN2g1l5
# ELfqrGV/MWQw+aiCG9eg06LxqRLVNGyxZOLDhLWDz+zD07i+wVpXj8XwaLE6LM3P
# lU9iHgEX/v8UXV9DhpkVHv67QJrk3Avaiir/iDsDgMD+1LDZLG6ChBlblSXfOJ2H
# Qktbq/QYn3CzlDPt9vNVJNzcPFycoa3WweYiFiGmhDT5t7plW5pyJVwI9JxlfSiI
# bhW2TWH+T4w95jYv8u4YYvc5/iNgmaELi6ukPwFUWxgZOTBCVpm3TkZppSWmDrdQ
# 64tD8gVMyU+KWF2SoqGPkZAf/s6UyGfeQj8XJUE9JgLdter+BiUjpASnwydwoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MzMzM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgQFyu9HdpEUkU
# NUKxYdqxend+J1TbHeTw+QJvZnEYqBgwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCDJTjpPdWX7d8WOywnR3FWzCwuFjv3rFUtWByQEJ47
# O4hgVEpS1k+kIra0gJAQ/+XPfV1dLkFCnJqgSrlOpi7T3RFPJB+h+vFrMKQKfBnW
# W7FuuXQVC7ip5OVA0qdzHkgiAfk7qe0/Yg9CNQVVrefIHF0tWUgri7/NLMvhhvj4
# Ahv7NvwTZ/g1P425/ac6wxalGX+0J2X3mVfo6fYGSUhmdmAlEpI3CTOM+7wYGU4a
# FF3rApvEdjzDVRlURfGjeaQTYbKkam7OZ6D2WSwOoOj//SNs//Iruuj/76QUyjqa
# r8qwLJKnNxGuRwj/AtviHY6Re68SomA0dXavAJqeJMHNWe3lTCgmNdNdnz+C0SWI
# 6UT5moLulVqSpcSEJF8NsiVquGKEWW5Asy2ZtBuxdJAPE2+dgCmXwNLxSj543EYF
# iNoGerJ7Gel9weFURu49QjQnncZrerr7u9oS4+b7bBEjw1VxAknJn7e29LRgryMK
# 2LrVMvo03l6dWiL1AisQjqQ=

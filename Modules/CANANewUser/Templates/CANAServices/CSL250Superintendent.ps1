<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL250Superintendent.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL250Superintendent
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL250Superintendent $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL250Superintendent
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCcnspUTspX2F99
# 49rOg3uzYuldrNRCKYaIw3q13Q4ryqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAepvOQZsWJRqGZzkukSp5axzuYLjq7
# OKBDcnuSL5gS7jANBgkqhkiG9w0BAQEFAASCAQCrCahGz7/eIqM4/nwa3yB8Ck8D
# QaRGnKPKZwiEbjSkWdmRCMPjnAWvhYblusHdHXlX+zXdO2NGxMR/n2vEg5IO0o7E
# 2JE0wHSmblg7Jd3HJcgWjJi4+W1sO+K82YWS15Lqk10Vr0p7iovS7zm692bqN3CN
# prnZDlXix8JBUFiREUE1RbhimdLboHOevghvphpiUDngmK7BMpjIJly3Ci15M3MZ
# 88yvcLaDKBJodAz0G29GlbCBgIlcg9GBTgLzl29OZBcGnl4b9ip5C2oEIC0OKiAn
# CFaQbc8NmiXKXZfVWo+rf+yn+n3TTkZGVcP7UJeYqMadJDIneoVVqY+Z+ly7oYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTQzM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgqspybT2dXkXS
# npzd66p5KgZJaQmOnPOG/sfbqIxvFHswgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDWtLPffgk+K04g4tewL1L+Mh8tL34tLlARl+047CfE
# oknoRUULc5RQtusUoVsgIYQmOhRlPzeGvJ3jqg556qvlW9nkMWGdPsL672selfgp
# Ys0TY28A4WnJUU9ln8kB1gDAe3XOXm7ELEPvVusbikYMgNHFUJp1DHkHmuePUTnw
# ah3RQ8JP20KWUHREjW3bkGeuBuEDIjqOcC8YXgs5ci7CJQCsWVp6o2CrNdsguMrK
# wp3A6l76N7/w3eE/Co67a9oDXhwKPRgkudmHSdX1m1NYBliiSfIfkYRBxeca2ynp
# mztesLyMqxNA0fCCRXc4RZBNDXRw3qUTr8JisqmUCJ4QOs6Ida4/HZrXMgYBxKHH
# 4of0PbkxtH9yCVqco47uRbjoG3ChlIiiKvKQ1s62mcEUIwlKVoHx9rmb2klLtLR/
# dLILTlt6TLWeiJXD8ceT+rSUv32Q9i0gNeZmNLE3lSBJfx6E3YgeuvTgjHHXok1+
# GBfvtnxJEN7YlFt7d0U+ml8=

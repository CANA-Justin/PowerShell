<#		.NOTES
	===========================================================================
	 ...
	 Filename:     	CSL250SeniorSuperintendent.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL250SeniorSuperintendent
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL250SeniorSuperintendent $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL250SeniorSuperintendent
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDTA4v5C0CD1zhu
# CiRwRudS8hKHbIDbHtZXPKR55d+wnaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCupWDDbRhke0c7Bd6W+1e1kM38oPlg
# eHjpYP0mn/vwpzANBgkqhkiG9w0BAQEFAASCAQDZIz/N3joEogMCOYJ/Lv15tn1f
# nDBPZWI6xP4/qdAj0A1QxSUf0GA1gtIPaWG45joIgrg+Vki7WINbs7gcLavacl+j
# 67vRMhmzbYcuKBUVEwadk5UFcpVjQEgJrPnPgdBzRBVlNuiGjVyJzBzcXKic8kAV
# OV4SLFHKHrY4adU1dK8EZ0V+xVVSjVz4Xg+sFW+RrTsHstkHobQ7AMLYaSKbmWhs
# /THWK8r5FRDbb7gkX9Z7sygvtggFnGiC+nxpGkKb5v48mjyWdALZqLQAoBSDgtdx
# 8g63CvWyVdjLeo3qHFYHGBc8RsaFS1oi4ZjGYxDuSM2N3IG/E+cBFHDHBhKYoYID
...
# hvcNAQkFMQ8XDTIxMDkwOTE5MTQ0MFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgiXL/kB/f+mKi
# HNt5X3Pr5XYsPjRhl/ModecQEOZq/1kwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYA6RjQz6rnCGJH06e4Uufy6K5V39Y8H+x+4yFYzJ5WX
# 2KTIC6z5/369Hm37X6bqnhp270F+1gcFBH8fYqH/i374I0vAitVzOm54soBiJmq1
# 8Y4ttPcrZVfn9m6ox0+IV0SDNa6a4Vejr4vGv4N/di3LRSClbpLkphQ6usUWA9qN
# TIwp+c9IBjWmIuBdpIotQwHxRO4JvlrgSOSDc5z2hGtEEaDSGzZwSD8wvIxPmvwB
# EGGgfrix3mIohmEorPTHWiwWo1V/zQ5dpcG6lZqL7673ZZOGN6jlsOdtXLs48Onc
# KYrVdpb280suX2ONwUK6tiTNOdv7h8H/mHrgxscxNebv5873/E1AFPJ9vsqBaAWc
# Ea76bn8A9FinQErl7F2RvCHHFdecapwH8Jt6fV3cg3usgxJA22TK240GGtTlKCTO
# IoVpnzrjFs0ZG3+qReb+0hZbvWYNOYqvjfcN7OinRkXjt4izUbL2jCqpXke4JZg9
# eC2lI0bEGesMyUOK0ZdWzy4=

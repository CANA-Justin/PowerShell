<#	
	...
	===========================================================================
	 ...
	 Filename:     	CSL150CarpenterApprentice4.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-CSL150CarpenterApprentice4
...
<#
	...
	.EXAMPLE
				PS C:\> Add-CSL150CarpenterApprentice4 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-CSL150CarpenterApprentice4
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCACGQuODN43l+WH
# pXLSSChCd6LwWcgcH1IKp4kyEeYkc6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDn6DPzPhesC0/P7Wnz4CnVgl7JHGEY
# 777b7wiql7OOdDANBgkqhkiG9w0BAQEFAASCAQDTRYdmGIsAdukpZhLaZTUiG8is
# ahTSGNqwgwGoaFbNO50c6POGt4pYbv3lf7/21zzq3C/D+w/oODXgA356+WWwixY+
# cwXogzta2EUtmTCdzKxOBU1vYLZjbYm+MhazaE3GmLORScmkbp2ENEpvUEFOp0Og
# BN1chZLSUA2NShEoXQV6MeY+Nus6Moy7y53JiRiUYVtUJNJd9k14XbhFGhjCaR7a
# FMB/qy/keiCEvLyAApNUFM66s0HRUFfNfzRqcKJg3+AzbOog01xEjJoCjx+UwUBF
# tA5eMPB5AjvvBcBKp3TjVgyWA0X0AwarYowwFCl6zsCr1KWWb/rNMOraKtvvoYID
...
# hvcNAQkFMQ8XDTIxMTAyODE2MzM0MlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg9VX59SwI0+0J
# VhYnpiwvJKspAEV5kJi5bNsVh7djZJowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDd4sBrFufA6fKHME9QpASn+VqnwHwRY/0bBSErZHhR
# yfLPEblBoHQrE6/rt1VHmkoQpc2kIeabd9efe94/ug884gN2aIHi4jtvHY2h56En
# jJGQsScq1lg4ZvK9d6xXgmuL78hwxCjg/TakvIE3N0tDzWCXdSq9uzfNG8ddGa+e
# nJIZHOEcJ16OBMdFIZ2Za3OAsmmGYqe8F49qTMvxR6ILLWbqzf/RRu25crkFvAPq
# Zi/+CZ4ADuZYNtx2QGZSf687mIsjk34vrFgZ3WGJ4zLC1WwqqXXqrMBXC2PPDhVT
# nI0aRu27KRNotzLtt6j2dVk4KdRrmbvpU/A87dGkFsj0jD4lE1m0gGDEFm6Mp5Wz
# W5EnkpHVfJov4xSjaLQsGIgjadUgqxtj4gPq6XhrDyhnyQOG6GRhMT2+Z1isko/S
# AsIHgsf9CZywetiMmdj2F9aPIEctgmCUdCRrnkfU27XO8fOPbnGFWMYnMZPA4anY
# JT4n0DV7gJ7lNQfgc+iQ92Y=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	04/04/2019 1:59 PM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergyUtilityWorker.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyUtilityWorker 
...
function Add-EnergyUtilityWorker
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyUtilityWorker $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBXwQOIpI6TX96v
# nqH21EZF9F2/5KhDeL2af2kcxJrr7aCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCBwS8dZsrXfFkKSthp+ZDu776qr66o
# xVPOnYBJIBukzjANBgkqhkiG9w0BAQEFAASCAQABlK46XKqlxSJl0lX8zkqFUkzZ
# 8RUB3Hbn6/qqWzncL4q9fnbJ9ze8s2A2D2Jm5s6O6CM3fetJberUswzuZVfi3Mj+
# 3qc2g5qP7G4hRbPuaZX5wrot/5+4HdLolmdvemiIt2/Zbo1F1rISQn52kXNCCaw2
# rgpOl/xFpgSOxuS9D5pniEZz0k3a+/zcXKi3cDLJidcgb0J08aMOZGW5nAA7J9H5
# /Omxxw/AUrARxNpoq6zImqujK2FpPOGFyf9rKfxW9e6y1RIALdOlSgIuHwT330jl
# FWhBMMfItJmAHEu4R3zCJpkEE+AqIw+HLFAIubWoWnjbDpgV/PqO4X8UE1N7oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE3MDEzMFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgCNjQPz2Y9yf9
# XMINwpgHIyxMQDF/jwG2ovb47EV6frkwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBXWVxTjrxYheYjgWrdtC5lTH165By9ISAR+K3ChYDU
# 9iTyHVFLZ18V6LhdJuU9QYkzJjmwQscvyque/iGxt2f6lsqlQ2OGfBDWCqYYknLe
# Jv4D5DFB9i02xtazlnU2rzy1uvIrxnfmLoL0LeakxnIrFEUKJGHRc8JNc+MdgWbP
# clm4+J0eXqOJj4/Wa8DxlNqVi7np80IFflOmcKNkZr31J3Q7FAuvsAru1C2BIIwr
# D2DOAkWK9PKZL4uA7wTAk6qXNndBDLBj8RxvX6mhOc51WgzVscth3zdJfqD3aQWX
# I55LgQLPdcA15ZeJllUBRD5zacgj9TuVxJGHkR468/7yELXZa+SH49sirtgLWeSS
# 2Wygc3GypjZ6AAyXyV5014usPR4atULRIqiZdtCTdigpmm80Rg6O91taYm4dYq2h
# VOrIjg0meUkNFMV/IYwP2Dq8qg+ujtkZ8O2FyvcIsQ2IUgyW9A6+bCOCCH2iexdA
# 0qNWHRs0kld28zToLyvIJog=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyProposalLead.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProposalLead
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyProposalLead $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyProposalLead
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAo5m8Eyjko3YAt
# oBNUkjINsEL7aFiaGYRveLaDPVxeLqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCD54x7+D6JmsAcvoMr8Iqd9HksMqSIB
# +cf8fVhcynQupTANBgkqhkiG9w0BAQEFAASCAQAnwnNRSUsjrECEGuiZWMSAaaRM
# IxbABAuQCDnnP1CBZtio/Ti1/7gbVjR12qwLoeg1ZI6yTz/afyIyrSx7tVwGUACn
# 9AIiuzaPiKSp6VWD8q6dSBZ6EYloPb7QJK6flULrjYQHAeTniFYLHFiFcLiMLwbP
# aHvu/n2702Xbl95gFs2pLE3T+l0Ci9GN6fuuw6GsoK5JDlfvOtyGzJ5uTuAtWxKo
# 1OGQulY0bmoa0F1/hDd2VJsVHyrjFjbxQp8JmA5NofDdzntGj3N9FrGPgo3gdyck
# ycT/VzV8jmP4bTD0KkhhcRaqUwlcUnOTjM8yeq/jIjwiS64Int/eldv9ZIvVoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTYyNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgCYt3qUwC3alj
# 89V2dV+v1+G+EfxwiMSjicAbXXDKHL0wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYC6xUXq0yrQIKIBv9wLZMC9ZmHEATf1HaI1yoKBlzOn
# xfaEz+Xi70OzFnDWPLDQu/8woHb0TyUv3u/QfVVdpxBTKrV22duwojF8dhoBehiZ
# /ov9qgw28MIeGgPjnyfhu/fAULkX/+x2ePeqQg5wgkZgwzVlFAQls2X7sVgi+0cu
# 8K0qBZm22Iz8Z3uxqM50fzpkPksHfUJy462Av2rR0i84itZ1t2Q+HKSEa6HIZINI
# FMlKsFGfQ0+k0hz9FbCKUDs08Bgylci0CwrKXGAAI1EtOyF+p8L5VZFSwVCFFNZ8
# /ru6pfEWdzLf5OaJNUbzXiMPFois0gLJdv4toRHX13O85OdGZXvesjwWDjW+n++U
# fm8+vlpserTgfaoddXG6jPBlCm8sOnPuduqZ8yX3eE9obvqIJuyoioJ4joch4r6x
# mEYJN2bDUunzsOzIxQikVo3SL27RF3ruyjsQlbHTV7CasvjEeRpEGOgH62SzxbEe
# 7YKnZW/ZZluqGmvP/6RXiWA=

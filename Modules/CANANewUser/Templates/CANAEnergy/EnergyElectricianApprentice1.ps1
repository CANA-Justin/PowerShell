<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyElectricianApprentice1.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyElectricianApprentice1
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyElectricianApprentice1 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyElectricianApprentice1
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDCD158n7BWX1z8
# sG6HoCzJRUxGnpNvnrdeM5H7xP7iyKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBnoBw/oYFAx6AMWRLPuSJjK9BPgg6G
# gmqugfy8M+wzsTANBgkqhkiG9w0BAQEFAASCAQBeWHw8MjaxQSmSSAFdOqGEHJNK
# LY58khb8ae26q60gtH0m2UUkryMxaaAl5tSuIJUpf2jiNiDErMNlJ1c3huiHwEnU
# tkqxpiibS1LF+EtYG2xSNXMiEsbgId1QHa60K2/qkkPQiFvEyY7VX0o2W9DyeWz+
# MZ9Nli+Rj7Q70sJyFgOFOR8J7jM3hXScO00P2R5JAR8wQuo+Op7WTyPBC5X6NaPn
# qjUrGGUiawNhV+Eng/Diq/A0Vuo9OvXtxXU9p3XSZDZNv2Y1ypc5oP1ViXbOhn6e
# hwWkg6mNv3XDYZOa9IbFFBeScleU7HHomfEBUQz2W3uccY9nSNO8NQHy6GxxoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjcwM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgRg0p74S6tcBc
# rJGxk1FEvfezh+bETW8nPT7DsDZmvpQwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYByKXMrCUPOyka2iFOtoYtFojGIEkKXSKeThxLICOIn
# dtXkQAXnxNEip02aJ5qYK+2sWXlW1OSVldSiwABssIaxSBhqPjyyLsWQGHHVH8Gc
# 4YSql7WaOqIRdeRNS6ScgYWSCjDdLXSDArfEdgxbfgY63Y2Xf+/f/wO0fnnGnjSC
# T3H2idKghpQsTHph+NiWglLOuuU2Zry1cXl/Negcow5rc2LYZX4IxWgGtdbyGoWU
# FyoEMtTiGwgA9e0pssuX4Hyn/Gf3hiNT7693zjCCrgyVEX9s42ZO7ZRUwlC4VC/6
# 13p8nk48ewaAEO6cddh7VFqD5a+JIwk/nYKwi4Dt1cWkHmGHWMVzhvYRVU/reUMg
# qqAikJ8MmNE7i/2jDxJdVJ4XoJ8RjUwqNY/bg4wxtC7gB2cGjO6DLBbKDni4nXwN
# zFtg+o7lELJOGtpoZSB9L07EaHbUPsJePpCyY+lEJnXHKi3EescDMPm8lWqmpo38
# 3n3yDsvZMEHQfGbQ/W57PdE=

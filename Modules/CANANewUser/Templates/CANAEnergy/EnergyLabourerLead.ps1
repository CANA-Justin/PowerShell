<#	
	...
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyLabourerLead
...
<#
	...
	.EXAMPLE
				PS C:\> EnergyLabourerLead $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAlyTe7eqhKDfe+
# ep+ghYdAlySc2XVOYKqTpcQ1vSN8UqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBoxzkBuIP5iKsPzDSYwyY5iMZBKaDK
# l3srQCLaWH2NLjANBgkqhkiG9w0BAQEFAASCAQCUKSrMqEpq4BpLnGBkrHrQH66m
# Txf7ZGf+4FERh0hJ9cmSSP2iam+XoMzMEGiBUHH5XEH1MIEU6yDUkI+/YDVKUhNg
# 3hbtQnw+HkPchprvM2AWhrhi8tzH9apPNEmBSF+/htSSpNWoRAEoPxFltpwfPs6/
# WexKSNeW0gFEDr4OdrC+6GEbZOfkrxSIwdz/7PNG5vh86dvibI2buyUFyY8459Bx
# rr2CkaXLfN7sre/VtWTGvvIOiku2ZBvNwjaQeYJGncvbB2z+9CW5jDQdRGe3fql/
# yINpW3L8JkKAd0iQus3nmOYNiOkaUmQUcZuafpHkUpLuQPu1mdMqRhDA8eJOoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDYyM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgJRlHddBwOURV
# Cqom4JZLQc9undfCvZHxW+6WD+ryd4AwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYC532rw3GAcc0khw5rsGlrDfWQGft+MxeVuF7u7MAfI
# y8+LlvJtJrM12EIzNyPbwdEDeNxesW9/DupTbcOIsz/U+CMJ4BcifJhXQoHLUN69
# ZIzJIilGT/cem8jtTC8bK9EF6L1OCUbEqrF6kSt62bsMyR+DBQWDsUsQZIWeOhMG
# 8eAs7qpzEGEC+cxaXV28WpOp1c1aLyzfdKJPZw5r07Y5ciHhFZXXXLnoiL2e5qhU
# AWrQV/QY8U/XbDN/v5IipANA9le6AcJxtHKmmcoPSzbHa4DIlIPvgJP8PE5IWOBr
# TENGqiDUiC9y0dXI7zWUC2+lr8SWk2xywiijiFiE0BfYZfYbX/0oH8340rjAsuuS
# mtg1bK7jBaiM9TaGPllwPg+Vv+BFWm8eevy63Bv8yb5cLjb6YVEVfK8K7O4Etzu7
# vUY5K8GD2naLXU6MRgUyQtyI14+B2Wyh7u7IzLRTgeZixZAAnf2EoiVixlSI98xd
# M/Kr7gJbdV4ROrgVzHWqXvo=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyExecutiveAssistant.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyExecutiveAssistant
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyExecutiveAssistant $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyExecutiveAssistant
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('Energy.Script.Authority') | Out-Null
	...
	$ADGroups.add('PBI_CE166') | Out-Null
	$ADGroups.add('portal.DocuSignProduction') | Out-Null
	$ADGroups.add('portal.DocuSignTest') | Out-Null
	...
	$ADGroups.add('SP.CCCLCSL.Admins') | Out-Null
	...
	$ADGroups.add('stfa.Utilities.Project.Read') | Out-Null
	...
	$ADGroups.add('tfa.Utilities.LessonsLearned.Read') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDKDChSR+pDUf1a
# vf6bW+SXoq1N8PyTbEV/q/rNAN5xPqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCC56ATvtlZ55U/HCaInJD6oQjIXJ1k4
# +1MCUkEhfORafTANBgkqhkiG9w0BAQEFAASCAQBX+Xu7sVjSHbW7J0F3J7ybw4Jq
# dlvFMuVnti9pIpL/oitYg8uwbzCYvim9HyNAi3ogM2GTy1RbHNNh1eaMIoAG8QTe
# qKcYdsAc9LDAXg1QpWCJBWb6fZegHwldvupKDaTzgyoVsQPQ0cDHnDyPi2TGjjl/
# LUAFiqJnrMB2TeDkdBLb6OqNNQ9t02T7eFZ5lXYcKg0Wf6PI9pFg3Z/4fLy3FhaQ
# y7NffXRQmO01Pp2CP8FVmCplwn4EVjBFKzswnzgBzd2wz8fQTTPCNA09p28kQhCC
# bcK/SBzDdQyrw/82G4Vn+p9uurtNbwdRf6biVhfp+Mc5LIBuB5W0nbgYzLNfoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDIyOVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgLA7hpouca4RS
# 1pVAgpY1+th/2gf6khcejlTvzBKJXQUwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCygXrk/or6ycpujhyUUlkKKNStnfAbeiAcVM9PcfhM
# OSYpCLEe/b3a6eh5auI1vwEdn7Wlrt6gaoRSKD37f1iLUCM12CJ9+IqZRz+QtEdS
# /lGjy+BrUKeqpica792whxU43zfum4znEWNaAuZmWkIkHGaAUEZjlh77lvIek4ir
# CK1vFfSDPKODFJuPUMtZv8p4PAfFKTQA4DZv+cdXClKwm8+yUToSXd9z2WD6fzpm
# /1aSd9X8dt6SXwAchsCylk1pZwNBSOMpjRnv8dBgda9EEYn4pdc7fkMxzMfT0x7S
# oLH/uiahbqrLXFDBeKzPugNVMuatiTQlHdMEBnq/m2HezsMDFQETJvpldxeh8hLI
# J8zzMGz0fu0HtxQefI725xyz83KCurwdEt6ywyckgIlySL0VF7CAjWNjDwGmEKFz
# LW1Iw2Bwgst9V4xHw6dL5b9UYPoY6jLNXUqhTwYCgKKsV8Bg0vy3ZJNE7y2w7aXv
# ehdahqs+TbX8Aq+sR5S53A8=

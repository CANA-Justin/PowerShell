<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyElectricianApprentice2.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyElectricianApprentice2
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyElectricianApprentice2 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyElectricianApprentice2
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCChUtK6luYatytK
# WH97lN1h+UMKxMapK7jKU7SzffbyBKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCC8tXj+xKigkN5wYO4CEtvtwVbf1hjK
# iatLNr7Odp+mUzANBgkqhkiG9w0BAQEFAASCAQA39AYA/sKCP+sJGtnR0RRdpmoR
# 9AkhY8UC60MnZ/G3JzK93s2CN7fWgQY2DgDAi0l+YY2L223CUAvxlyYyr4lGMAMo
# 8149iaJurzkq3YvIHi+76pK4WKlzg5U1jshsPtcSB5QrH8KQaJEDVH5JkikJnqox
# vVLKwfx5hXsqEZwCP+Ls2NnIM4kcTnYjg6SEtOpthZ2orWRMO/PjwgadrJSZjVEB
# Tj81glwKbTsA921mBCCsB6YOCUV36KBh3eiN4lwzTivIe4fh5ZbmabhkDO+Vt8KY
# E9KPOmAQOX8WlaaVwb+nV0kCdSF0e10skr1H+gbVcfmOd6c7Kl/Cd38uGV91oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjcxMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgKCwp7+OCQDwN
# m7EVbMMb6i9kB9yhn2dIP2lFB19Ajg4wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYApxz0OKP/S6VwPQ+nQjzK3fuRYNoAgUA9FSpK8bZdv
# YfaDCTMdMLMixJDimjlK4PSUCC4tqSEg4J8zniJXI7cGAfNn+16v7L2SYql6QHfD
# aKUQ2qZmiK1Ybo8mmi/+ywOTTaxaBveiiR5jKc0e833Klw7bMM01ohnFgfgRHAwK
# w1IqbU6ZA5voene4mfH9b3+qMEvK3BGMoqCJP1FYhvlVVO4VnlQ7hDeh+w8SHsZM
# Nr0k3kLwFIFa97HPeYcJ+A+l6slVJ9jprdRzRFXrN0c/1J6uwh2Wrtq7MFQ6DPZr
# A7yXIiOj+eFcyXtZmyMj6HD2j5vMeFt/wDfQwPdr5ruap1lj7DE8FGi7FhFU6Du1
# O/ot0QdirDSyHXukQiAslSjlJcqDrSP2ppcmazdpvr2roIo2NT3gWGGGOm7lDJW4
# AiqudjvT3wvuNfa4wVcmiHaYUA/D1QUMzlMKVQ1flnxH8q57l7Bj0ewbgejLTUsY
# xXrOWSCnKQxsAdXkUAplCIg=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyCivilForeman.ps1
	===========================================================================
	.SYNOPSIS
...
function Add-EnergyCivilForeman
{
<#
	.SYNOPSIS
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCDtjNWeiysk83I
# DVn2N82l4wQU6oWiYM+9cR1LDdBwWqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCicMnqrrGZ2EIh3VdsKg01bZ6ct9FD
# aw2CXUTZL8B/7zANBgkqhkiG9w0BAQEFAASCAQCsVd/6UEFdm2V2L06hjq+wBKht
# sYO7L4+TprLvX4ghEDxu6RFIZC505C4OeDoLdQq10tzhRebBL5deid97oE+PrTa4
# 0heLgFflrCNC4J+ODwzRsuPmQ1BqTkPqtJhbqyTxh0wbG11ahgPdW2gY5u/QOGcd
# H0nloM0s/7YaUqjDWIcidTNLGd+K1nWjdZlF5+wVyXCcOTLd4fJyCY68raZsqYRs
# zN4RoNwIGX0yBiHOMEjJTlCWGL+lVKUdNYDI/4eKbPOAqyY4lngGi1m2ZI9LdqjV
# TgA+k144frb8023WI2MHBO7xsr3yyFP5KMzKDHOCuIntiybaHnYd98NzFlsXoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MTg1NVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgnPiOlxcFNOwq
# V9wDML98sPID2kv8FrrsARvt5plZ1aowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCn9wKxepgrbejxcvE7cMMqZ7kOJmANTSWJbts3nojv
# mSNx0y36QPQE/Y638J5E6ZdtqCdy2jo/zFT2PoQ2yNIWEVCYJOHvWPPA+jmDeZhP
# cycQL/KFCKz+PuFUvk0ca96wZNvXjejksp2tktoFdLI71ZV0xZEX4T/o1xxXfhbm
# f38kMivpTZazhlOTAsLku7+z8bxBEcNP44IeY43UucLur7vrOHH3AMVxkrJOZKyA
# 7u/ZaGyaK0CDfQR3nlXk+OMgk2wUxMAord2dJov22roRICeoRax5RpQ1Djr5DXnD
# ZQ9T5wAmeBJ6S3SDHdzoeUxDDFcIYyw/0j8LjcVcsBwRZsF4Kt5+dbLhsuYe1Cep
# 1c4Fgosutt5euwfwLKZjD8HzTlyRoQtJb7kET9Px4KrI+TrzIVoutC/xlwwLjYwi
# NTSdaVO3DjBMIR/FJ0ZbkeotgCQB/DGuvPqzTTVXGcqFgqUJ4PwcnhCKtwQQF6+g
# 44zs8grA0gLp5K3s4qROtuA=

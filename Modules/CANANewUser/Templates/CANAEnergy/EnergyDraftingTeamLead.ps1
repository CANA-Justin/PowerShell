<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyDraftingTeamLead.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyDraftingTeamLead
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyDraftingTeamLead $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyDraftingTeamLead
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAOmLEI0YEKaMDD
# 1DayOA8HCN38tfmFC8yHFmb/zKSab6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBO3nrxM6y6bjvNZ91RLALx22wlSXOC
# QuRjY6pav8kgpjANBgkqhkiG9w0BAQEFAASCAQAtmJ3QethqSDNuQGw4WqRVJ2jo
# c/aze8wSK43CFdp/GxFt6Kbva2Ha/aAQolx9dnECRoWFVb6mNabOl54c9Sp7got+
# /bPxP9gokm5BWt1qz49z0fq1f1bVM7hC87hhfxICVgXdRB7E+Ac/bA6QZjZ+eJRS
# nCW3FuAcdigvBNX+WtZkLb4ZtXjcpDTnI6V5XtVJY6hvfxC4/UgZ/wego5KfOMC5
# UR9Zyeyl7eIFTwzvCc32K5diBvlGUhq7AQOkSzSFwuravB/VTSK6KAujYp+CxWgs
# ELu8txVju8tVxx3hPKYQlC+0dlgVd4A2EYPwy2Gla08GkkfqxG3phvNjPvqNoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjYwNFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgDT90KzUk/Uft
# KzFj25crqERaz2BZN0OCJyR7KCJIk0swgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCz2MWoXJgoBMqyMMYqW4z6sSgEr/EqAMUu5r4HTCgG
# GFkWo9+uFI8tbScXX4wXooYICSBKYYvhP/2WRHuqG9YPaw+VQVmR0ncPj7uCvHXV
# aDH9I2dW42ZOB2w0yVhDCheUtT8M+KXwRz3j777lzpCa7Y4YeUUFqaACtbGUSRLw
# WGmlBSV8ETWwe4i2Czr6dZP64k2Ch408BU94ejN2dx38yUlDWtlwqkW7GAnTJ7ny
# YuKhzr96YZ8kJdU4w9Mx9DM+tF+959iFINLvVmdE8kC0bXTm4AAKWmiEQEUA9jhL
# 0DI2byzeia9UEFvQZo9ExHvfxREB9DJDXjZ2jF7oNidhRXBcqaGlILWsGkvEdKzv
# 5BEtr6FPnhPvb0ZkX7GRafdyo5+Oc9tQkKcG0QboA+qGI17RssMNO92AcTc6YV0f
# OCEXFXsXM5MXUywgyePyRe1BRZkTDgRFVI5US0YzGbWEdYrp/ZxTrDeqkekKt17K
# +5CRVEHoVym4I/ejoi0xd6U=

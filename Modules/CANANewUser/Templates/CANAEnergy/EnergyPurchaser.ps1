<#	
	...
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPurchaser
.DESCRIPTION
Adds the user to the groups defined in this function Add-EnergyPurchaser
#>
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPurchaser $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBuZCZ60BPRvDHw
# Vr61hu17zZ/HLCmzm69lNoT+1OeMF6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCHhRrHrXKkGn6+sm2gnuXSHBJTWUXO
# yZlzHOaDBgZcJTANBgkqhkiG9w0BAQEFAASCAQBHJfgex80Gr194tzL6Zn5KVKIy
# UJoQ+pd7Po0T8ByRpaGNI/v2m8fL/1A52/odQe/aLGdvDtYPMlSqzh6ogbJ1hki3
# aVeT5f2QarttIuAtc7NEOC95aN3Perlxgf9g//aAAucCAeUIidHdGmR8hvGOZ2M8
# 3QS9VluNQZm9Ximy7uHDizfuFen4WvhyAmtBqwa2gqZQJXDC7n29oLJnv9HubW0P
# jxjBRX+EC2CnEm0bqvdtrIQVl5cNlXlPhdtDlj9MYhy2Y1gSRlN3CYjt8TtbP207
# EYyoIL6zN9mVEEuxkWsOuu+5nBd1k1h9PHjNEA+xy7EgwHSTu3dL+QmrBM95oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTgyN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg21cWBgK1AFbL
# Mj9UMqDI0HxNm6eT3PL2ELx5V+jwS6EwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYACzalesxx60L3z3D3pIGqHzKGuC44ARUTs3viiX4s4
# TlnAR8B4nX5VIAlaXgH/aFo8OrOVF1d6Emgavw1u0nb2kh+yQmgk7InDDISmq2kP
# 0LlDXs7rvtPseex8HS8jhjuOo+dywO4phmLY3wxwXkxWA8wEtMtSt4Zs7XdpcFXG
# quMsFezwwuqdFYCCK0ca1N4yZuXLtVco5BrDFe4vrFpcW/nwLuD9KJuVdx4ntXM5
# DT+FamkWeUl1wA3cOThp0DziQdUu5nU2K7+5rdqYkgzak3kkvSDrXTZJehPsb97j
# 1E1rVF05e1GsVZ0meIjP/ZSv0I5d4jI5ePyqqzXuc6tnunDFgBmP8i5YFIw6UaiJ
# fDGv5YvqlmdBLEcnfxybKmPebw8m1SvgdM4Ee/B1tH0TPd8Pr1c8zbjJRaL5y644
# vQR80VOIb5oVKNbDsO0e0RPTD00iQCQpqfU2tHcTFYKri5PyPbBz39n1EuIy//rJ
# RlW8BTrPvyX72rSmRjMT3m0=

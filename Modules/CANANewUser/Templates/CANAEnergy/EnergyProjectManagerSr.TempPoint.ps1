<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyProjectManagerSr.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProjectManagerSr
.DESCRIPTION
Adds the user to the groups defined in this function Add-EnergyProjectManagerSr
#>
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyProjectManagerSr $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyProjectManagerSr
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCgEPIWxHfwePaD
# gb2trNxAQkvfZXqpDaFcqnSpDMTZW6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBH4Dw/9Z/GvjmLcqMRjkLYCHfa0NaD
# b2s1fs40N9G9VTANBgkqhkiG9w0BAQEFAASCAQAjxLASeuCXfR8bOBTJJnYCGHUa
# FsN2hrBe0wQrZaNYrN0M/atUVJOKjd/o213spF7XTgHCoAubuKlPOts9j75JGnro
# 88cLsup+yPfNbQXQfuDIVVHvVOtATbvyst3FzMd+NjY/XllSSU/MrVWaJh51uGFz
# 044GO/fojJEoCEiKX8tWQxK5v3LWs6DxRA9L2BDdEnVKKIRb6hGZMSb6Oryjro8u
# /bwDlfaUI4mqnwxLP58yZx8AUZ+kYye4F/8qP5PTnrvhUKHq34HhxV0SVJKjnkoH
# 508mbSVRFe6+xqWMkXVGEyoFYPm0GvUXuUxKBuBvVT69Cr4LXhV7AHBTt3kEoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTYxMVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg1KKwIoVv38+n
# jaPmlON5sr1vxP+ORmQ/mSxyKggE7p8wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCawZRzeAoyYyjhQW1ucVW50Hg2MIoZvYg1KbkiqwCp
# t+Svku1igVThOGk8mDqfmMdlZBJUCQ2AssVmbEMnsDqFX4+QnxyR7D1bJUNsH+9m
# CCItNG5vluN7CyygqPY7Z11AXvbs20a99WUzxHYYzXVc+ldWSr0vd3qpXxT23iQ7
# 89r9m3pJQic3aBzuSi6yTO4dRg5dUZMTgQF487jbuGCSMEq5pjX/FYM6ET2ocjsA
# lESB1hC6Ap4OkDG2sCqoRm+LmeWoDzFbgW5WbNcgplwPsqZyxQccRSpq4XqCbtzL
# HA8RQUs5zzGEikbS6hD4nY+04Xrbb/y5TMKbPQVXeuZyXxaGr0ZQTDZJYWSqQU9g
# OkOX99KyexW+I8zEE7J7G6WXCIAN/6YU6XiYKQrSZWN5dnxRSwSO0nSy7MCXwtZ+
# uSKQx1b9+epyBuLyh8KvtvR1+qbPGujU3UuKIPCHd2wVKIPijNwzo0aXc5USeBCF
# EZXVV3nyk5ZirvwYuI8c9tw=

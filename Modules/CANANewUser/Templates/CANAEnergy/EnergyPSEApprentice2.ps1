<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPSEApprentice2.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyPSEApprentice2 
...
function Add-EnergyPSEApprentice2
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyPSEApprentice2 $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC8Dkl7Zavlqehz
# sich+tsmubukCy5zX+lDxf1hFL3RsaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDVWGHRupENMZf5M9Wm5uQk2t1vM9I6
# D5+etMfjXLsuyTANBgkqhkiG9w0BAQEFAASCAQCypmnrowGFUZs5BLRiDcMBYuo/
# dvj0v8m9SWT3W7u7efhBaAX0f4BVvNafbgCTi7BlyFnU4l4IVIkXjL03xWgpp9E0
# 6PngAyuk2W60q936O22ZRaHPqrw3MKPvttbTtQXMH0leROnn6pdrqlNGBhLc3kmD
# y0MtRk2rVoYB7oMCkegtuszvYeT9/Kx2hRrsjoJL08I7zymAkENUnMJLAaEFb8nv
# rPTwHnAK7ZpFjU+VLgv38pezeobL8TXUZ/Lq2Cg8tKd5rT3nRkKpxeycKa4qsiDZ
# CaBi/mvDYoeRuWqPiS69jXpvY8NIksMx4wovmcZCPtFsYm4oxv460iDKOPoHoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTY1OFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgOnneDuLvVvi6
# HN6EGMPLqSNNWHqQI9w23ZzT2EBr7K0wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYALs+zwJ/kDQ1vt72cFiufjdzwyP4j7nljRYlt9Zug8
# cHCYR+XKcUe6C2fnxqDFBQ4QO6Khn5BNkz0h2EPlTTX6sHG6cBuiTnf6PQzHxbOo
# 1MUSVORohMS3AAPuWNrKF5B34HOq0wuhWsBhTpruw4Rp4gUXz5RsOoIkplaBnRTM
# 2FGNfeMqTd5CC+E+1MJThtWefhR00RbqIxGOoigMposD4rXkriLT/Pcnx5zKe0JQ
# zHrUxw3K8bmRqLDsDJrZblpGRpfo0mDYv6Gw5t6wLFXQ0WbmWvWtg7NsJ51+ah3r
# cerPuZvCbouiKQQG5SrjD2/3SG3o1NH3niKwmJwbhykNgsdRrs9aEa/7xzLp22L9
# RS9RA3MfgSxq8deoKTOqAplIZvVD3F/dzznfVl1HzRZByyjZlYpF970LdGUGt0uG
# tXwFSyNENHD7RoOweFp50YWF5CUNi1k65Rgjj71hS1mXDj3Hj+wd2MqLMW51hYt0
# WOwUAhaTub9g5VMwgblfzrs=

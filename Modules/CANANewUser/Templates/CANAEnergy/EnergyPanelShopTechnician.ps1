<#	
	...
	===========================================================================
	 ...
	 Created on:   	08/28/2019 10:25 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergyPanelShopTechnician.ps1
	===========================================================================
	.DESCRIPTION
...
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPanelShopTechnician
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPanelShopTechnician $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPanelShopTechnician
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBmBVsjrLeVyZwf
# 7clVvD/nOF/BOF8qtscdBoszRHBY6aCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCB9yWGXZc0G+26gWZd158cnfouwn2JN
# QCwwVsAQjZ2RsjANBgkqhkiG9w0BAQEFAASCAQAEGU0ObKx1d5IfPVtXy9+TxMhA
# rFE7Lt74olMvqQfftgU/p+tRGcuZ50W342BOZdw61SJMeh1jAtR0+XAz9C40uhvz
# ytE3FHWLS7ZHG6uH7bEiqqaOpDerfwWz0E3kDVl7tbGNNMX+Y2B6R5HajGlEgOUn
# l5l7o04jJE7AvyXJdqrd7GLr1NQJQHdwKzTnH22cucu5fzb+XhGowEW39JHEWMMw
# 0+msv7cEKosWWbNTkGj9gpZEIkJZXRaqJuyiAE2c3jZPlItu1NEVSeBym4awhwd6
# rWSZyxT9JPSEGDcOs3+0FK71r/snOPQD2GbvyFpAkSENbOAQQbHqcgrBKwmioYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDkyNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgQJckOO/Pf1K9
# QwZwS7BmUu606akBB4k15xkPSYb145YwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBk4Qydq90iWv+F5ohtUnxbnKlj+ly0R6QxCnpwr5Au
# j6BmpTWVvNCwnMaeFyJerCjrov9dpPuVxLOezczLO+7HQxpVbFDOAw64hLR9fexl
# /mfNqBK1SCSOYxO5QgAAm+U+R/z7HeTDphQk5jB9LtM1APgtQ2O1MA9bOIdta+vx
# BSGVgTR5OYo6DbBiJScJ5137aK39h7DKXXfHGXknEkXd3+wPgbLbl4TXtMQpI8UX
# EM91JGlA3r0ZPE7VoGMji4v89D6RpYDujsxvK60VFBJ4OLoBSONj2Ir0CYFHSXiW
# pcd5EDu4IkyGzoH6ABtWOMp1qLGzqdgAkQBVuODDrth/GfKyI/xgB3+KgkYnGzTo
# gtO5vxpvlVlZ6PPyE25Sbi5mnf9ZLSmv926FoE1Nzh2HlK2nwqJFLcLMxlwK9mIF
# ipgPe0jsAqtlm7nmQe5pVTisCQag1YSPYOfw+b+cN4P+faiRBvcMAWQSA4aM53Dk
# dnwI8U34QsMPQparuOen2hA=

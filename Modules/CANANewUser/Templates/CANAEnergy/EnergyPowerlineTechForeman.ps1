<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechForeman.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechForeman
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechForeman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechForeman
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('CANA Energy - Commissioning') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCChc6ROx22teBSi
# cCDzYspoFwLkzLQL79qPQCM0p+M+YqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDd8mxeGpSGk17P+AFuRzzcDUQ1pGFm
# siWg8bOBcx8KcDANBgkqhkiG9w0BAQEFAASCAQCWZCb/snMP1iJsXzGp7Qm2GSuI
# xjdiAQNPNfJjY+mkasGzMTSTsdwB25tlt1Q0akp3df4rcBNbdO8ELvu3pTI/PjKp
# yGOsXpze5RV+AVeQfhANRT2V5iGtndrKub7isw7vKwF8j91ymJrJIgKGSPAxjqtn
# aCawx15TaTZmdYrk8yH3VN/wC1lexwGz79FNUds5FXSDKsTAXryy9sGsFLpJpaPp
# /CtFyQYLx48xzQ2ss/L4kQIpGCSgM4tkw0MplfwQffd6+DCvRYrULoHotii+Y89g
# nv693eZ6Q1GnYQbXMa2p9yYrAPSMg/IW9/4t3bHUihPEOq42uJswpRzBrHG7oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTAzNVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgbHNK/jop2WLk
# ibuFj3KXKpBkh4WSLXgL5+SxS8na4HUwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBEbHdJiTbkC0LX0pnidnlC5sKjSOh9Le9VBCmS3OJh
# yjnTJFM3IJJSyABm4oxbvK+i28zxedRcPILdQyeWOUmdf6QBQI4xYwDhf1e4Zdcq
# Iujtvi9I0u4PcG2BI7+3x6QcD2R8cAPeRTT6CKAGUCOp+6lIf235XmD/Ese1M0l2
# Hp+pnq4ilb00NEcY+Qx8HAml/Rd4LyV4b5z3BldxkYpAfn5jQaXRVsApc1j3FhZV
# ZLD5m0fx65d5mQjlQTURdEcqTgFXBHCRhTz0OgDJ7mafTpPXcjGi5StdxWHklX6z
# 2WV0+6otjFEa8n0mXbOAd99Q158wvc+5q4eoW5CpD19aE5r20GPqQz2u6HE6g4TW
# DuaPNA7KdqmHT/6xVXwfSjdZTIRqLfGeKqxcWW/EzKt6TbhdbOYnBerS7PE9xSId
# +aITXYoaGcZ+xyoNq2dmoK9jUgw6vmDcn/GQl10ERJM1eWh/ErWu+nSEgxNSfYiw
# ztUkD9THbA25ilMI5B6keaM=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	08/28/2019 10:18 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergyDirectorofEngineering.ps1
	===========================================================================

	
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyDirectorofEngineering
...
function Add-EnergyDirectorofEngineering
{
	<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		CANA Energy - Management-1-1263135012
		...
		tfa.CHVManagement.TDGManagementData.RWED
		tfa.CHVManagement.TDGProjectControls.RWED
	...
	.EXAMPLE
				PS C:\> Add-EnergyDirectorofEngineering $Username
...
#>
	...
	$ADGroups.add('CANA Energy - Management-1-1263135012') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxXLp6VLnaGuxE
# QXy9KhM7iWlx3byDoY7pP10jaXi+RaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCHNmvSzazz5nZIqnPMobS6wqhMnybE
# meCgWdbJ0lH+czANBgkqhkiG9w0BAQEFAASCAQB+hnuIvmAOs4QO//TKVo4npR3Z
# r14u29OSbsKViX4m//HSt1iTeCBKRgGHGazciGcBORT0Su1vZhbwQgSy4HAzgr5C
# JZytSOpx74Ny3sfAplaC2Pahfoxyp9UktIbSv8n5KP2H4MXQzP5qlBgEpfGs/w2f
# 1xlnLeUvhgmGCuF83pA6gJdMF9Hwa6rPlM/eQ1hbEeNkPZDOYBESNrd6EQpNHF9f
# BTNCdnOF8sWa5MKMX3oo9jud0OMRFjATiMutQ2SyAbxQEC3T6JX3SUK27RdKsc7l
# BKch9BRLWzzECBzTCD2zH1IwRfPQMQofxxPqe1JZ/MkrZH0qNCDNgSFBaVNqoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjUwM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgPlmuEprp9IRS
# DLQJjSIuNfIFj7vahWcPLNihMUZeuAUwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAjJKc1JGfWrb3qifSefIG1YyYjJnoo9NAwp3GLsEx6
# 0dQwQpsACxhDjusWFVON3yRdY3CPWSxSHKz+sdv5Yhze+1DjPwIlntYIjd/UN6Fe
# T7sTHjmOQaShNt6J/raGWVCkaHaMYAO0pMALjuZ3uzeb+m/8ZMca9ybUeVLT/Wa5
# 6mt2sKacmY97u1QumTwY+KkogNbRl24iYtwThLFxgntqzsw/xyH1h0irg0ITKcFU
# 9JXl0p2QKQfHR7Ww2xfdUN85bZSkyXeykflq1P4l+x0T2HlUVL3gINsznQV8K5tC
# Bhrs0zJsQCaWjCBxzHmxUybAYdrSQu79lo4cEd3t/XtKnsNMALcUngP/9a96tkpA
# igcKd46A/FdwAAJn8dffDbCm6v+L8m7kGOkHoaXjmRqFMZ5daZfpfvAhA5MvlOF6
# L2LJm86DXXOzr3D4pNzVc2r7OKxezj6eyK93wilKZ0Ip7txXe3TZgU5T/6K++wTm
# QirE7yBk6W41CrAPmf2oHUw=

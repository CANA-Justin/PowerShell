<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyFleetServicesManager.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyFleetServicesManager 
...
function Add-EnergyFleetServicesManager
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyFleetServicesManager $Username
...
#>	
	...
	$ADGroups.add('tfa.fleet.administration.RWED') | Out-Null
	$ADGroups.add('tfa.fleet.drivermanagment.RWED') | Out-Null
	$ADGroups.add('tfa.fleet.shopwarehouse.RWED') | Out-Null
	$ADGroups.add('tfa.Safety.Read') | Out-Null
	$ADGroups.add('tfa.Shared.CHVCUSharedFolder.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.Administration.Read') | Out-Null
	...
	$ADGroups.add('tfa.Utilities.EstimatingInfo.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.FortMacMurrayFiles.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.Management.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.Material&Equipment.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.MonthlyReporting.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.Prequalifications.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.Project.2012.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.Project.BirdProtection.Read') | Out-Null
	...
	$ADGroups.add('tfa.Utilities.Proposals.Read') | Out-Null
	...
	$ADGroups.add('tfa.Utilities.SeniorManagement.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.SimpsonProjects.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.StrategySessions.Read') | Out-Null
	...
	$ADGroups.add('tfa.Utilities.VPEA.Read') | Out-Null
	$ADGroups.add('tfa.Utilities.VPFiles.Read') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBe/GWwLicZRwq+
# m9Aa3WaMznAJfbKpVKeBsi/k8rdUZKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBW6E+Sj52qBV5+o+wxrgn5WOuSgK4I
# gypXCalsF+7kZzANBgkqhkiG9w0BAQEFAASCAQB5OP4RiFiGa54UKcmjgkojLVmK
# Te3m+0OsmkQ4livzgAgre1du2bnRNi5jo52ZEyJ/FA/DpS5Coy1cLTXLR4z24X8n
# SQwixq/fZ+clzIC/LsHBxYRMgyDMHcYp/ieKy3GuFLj6aaxit70Pm4OihXksppem
# hCPsdgtj3wnqn6hGKPKIQuCB2DGESYm9C3XYeZGCHDL/ZhHMlD+V0eF6Kr11LEXq
# PDbYBiMJqpiBuA1W3O8sEmdIWdxFqu0zSso2MISQ5joFP78au8M6RYLIwYPMiy79
# Yna8F7Yf/uSNHow6zjYMiwxEahl7NhmUJyuGuqQvuiPzE2pIqgIif6OuD4DzoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDM1NVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgK6Pm4pPLdamj
# zN14tQhZ15AVdy2/rEznIH7xcbvOYU8wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDY9GCC4K/nfeJh48pRiShlQM/b+1XOomAZd1XG9+aL
# hM9ZQkghfJWyY4hgQwmuKBu8rSuoiWpbZ9fzYjM9+ECNy+hdJHpxzy6uPNe0AlrV
# XjkRF3IpGnme8vFatMS/j4Xux4St3bdo/kANMzdrvZmDyC3eETssVV/pQK2O5Lis
# 0YW9SWSauPeb+MiGOAQeGeZTrZAcnpxoj6IrGdNwRgFr46DAhlWejXvya8zIq5Of
# Ja1MTGchvBeU84lfFlYq3o/+U6iSyYPRT4a07rBYhmXIVdJ5zig2p9ue7mU9gG7k
# flCHGOOlEq96lNyDib8gJJWoZaeBnauGKl+p6F7K6N7GVaqPKy0g677OsxjlLC9R
# h2CuRFTJdqMtGXmB70ugEHrn1vkcQTa1Q6xoVd3eITRRh80UYS90SIdB9pJQv5Z0
# FBIOMM45bx2pKnhFpI+RZ4WfRJgNauMkhXFAjIuw7FTlBzVzDrJMsk6ZAXEzTqrJ
# 1j3biQOQ4ejBuvD1e/VXWuE=

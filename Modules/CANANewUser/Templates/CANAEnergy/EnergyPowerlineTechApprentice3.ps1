<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechApprentice3.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechApprentice3
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechApprentice3 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechApprentice3
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBSvA3F+WK4FHwU
# 4++iR9jTkea5b2j55UkPoDp+p3XhEaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDx3z4BkUYdbFQ8emvplzw8DZcgRwwg
# 43QJiLqryJNrrjANBgkqhkiG9w0BAQEFAASCAQCebLHSf5nJ6zOYapgGh5Grr2+g
# Yb1amLdZId2QIbOxU4d8hA1omxfCZRs6i4JoU20fbsQpzlV3PuvfZ4nBQCZDcyxd
# HBVjv0hYRKl85NjkRzrNoZsYMHVbweN/7KqOsslBkNU+u1R+mRZhcHeXY6TmW+xk
# 5pE1nzL51NkBIv7gxl+QkX2//OsSJ6EjAUplGgIhtPIMLpqCe6x2rJC0qHwSXyG8
# QonpHHWBzHqybdSZqL2wGIqTzc5ecmYbqxW5YalfzKmELwxC1o4zIK1wN7YdkCyR
# G9eJfxcqO43JUCM/Vq8zXSGbk/vFHgKft3GKEsJBOHj9tFhq1PxGoH3Hn36ZoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDk1MlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgjbW4Dto7GcRE
# J2e/aAko0LY1DlChE/7MINn1YtcY48UwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCL2LpFK3b0cbttg/AUgGp3LFyuTvTRm86bTvrE1I+H
# QEGPYG2rIRMD99bVReBfVcdj4+/nMWbTlav66xxcNym5plvHiu0SXxOi7EEJkPL2
# 6LHy5vsu1jOq59NhYmi2o3sygA0sUyMAb8OOOG/xNnUdHLz+emoeVq6uoyOB1PjE
# S1MTIQioHestfBB0lklMIcU4dXWcVreE2tpGp6okSxEiluJbweEgyZgGlnudalYW
# 8JNfKGELx+pwcEEYNvBWzdekV2s+XsH+2LTkogdKChMMxEI8eEXo+yMP2icSAxC5
# Hl6geXuJXaqIH0H3Tbu0v9WZBRCU/DeEOLQohjxcUTCAB5qnLPLDOWlrm5WGjrKc
# FRNNjTYyotdyCUz7jL6w+kjphaCVlCK0ATkNcwkpBQP66EkVJNx8oU0Kxj3lfkrE
# u+nKkgmSbPD57KMVPJLh+bslpkD6UZqC8TBugAFEbhRqr+JuEZBS4g7vza3sW5XA
# A/gc/1qNxtz1KEHoa2j5QXM=

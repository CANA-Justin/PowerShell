...
function Add-EnergyConstructionManager
{
	<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		FWC52Approvers
		Safety_Sec
		SP.Energy.Construction.Managers
		...
		tfa.Utilities.LessonsLearned.RWED
	...
	.EXAMPLE
				PS C:\> Add-EnergyConstructionManager $Username
...
#>
	...
	$ADGroups.add('PBI_CE162') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC0WR6n+vP2Y3vB
# 3Q4i7KoMjSenYekNZkIs+ci1qPjJoKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBtKarjKiQ8dz6SL8hCnB6OZVqMXopZ
# mWMHZr+A1sq5hTANBgkqhkiG9w0BAQEFAASCAQAO2d9T9RY5dT8U+ywUCQ5WGe3r
# OaBqzkcklCnIMPMdrpuy8Pl3vn+f4N6Lm49CuoCkSoyOj3jW7pbxlDgTgNddCQ9M
# A3/FnZGcsMoU728ZZhXWWJUg0Xjh0+yN+q6lZR3S7oak3W51VgUb7j87CDeGxzJq
# 6RWOU1SV+lqCUxfByVDojYKOdywul3S751jJiX8m2Mv+7uyk/Qbv0HgWWHnDe5rG
# 5c+1wPp40utotLAQfOd8+Uvqkf0LudJeiftXPiRrWyxwLTb+Mn1jshVqyEBr+BvD
# aX3JxbdSPKZJNuhUEGV1wa485rxrzEqMRDmFbD8L9E37kWNwt9DYPe06l7/WoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjE1N1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg4/quxHrsswRG
# E7GpCsUakSgTazaYpHq0eRe8Spu2DWYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBFX6j5n30PkV3lMWa8WCjyLEO060btUB6hEnv+twvV
# KjdxSQbhuY1+w1BCVINiNaRgAi4ZA75FM4psLN9kUhRvHTLJW0a1Pl1Ia82sgKMX
# Cu4EfAHAPKQqmQ+rq6aiowgrp9co+1oe/z2BY2rTu7iATXPDjr2Z6rxNEmHLgqIe
# 5YXp/5j29y8uMu9lumHjCp4Ov+/rCP4tlacwEgIInmeryjX+C7m4wd4vb6z29nCb
# zaN8ShSDuZxMr0NavIEFrurQ1l4vkDBzDjlN2SD0Ih4yL3moJkok0n1KF6QWzIQJ
# zcaR2hA749B2AFWnfQ443bDFwRAy3n+5x89c7NLFVazgwIFSBbpnOGaKS0pfAP1N
# r30xW5BSbHesUYPCEdtrUVXPT4mBMlQGNu1eCA7FNGPoCan8iAn5vGivwzCbBctW
# L3K1RsIHSoTnZ9swp4Ad9PrbAi+Vvyt4/NIyQCIEcopi9+FV8eWCK1xcbTJR4FI4
# Boh5ukNhRYgRxWRfojUZkGg=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergySRSupervisor.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergySRSupervisor
...
<#
	...
	.EXAMPLE
				PS C:\> Add-Add-EnergySRSupervisor $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergySRSupervisor
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCEX7kvjswEj42s
# cg45THs97lk70JoPvyKXQ+d1aA574qCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCChf6EdNgp3UCytBfMQvh9waanJcOAY
# Jz49AKL+wkjBWTANBgkqhkiG9w0BAQEFAASCAQCnN7rOsHg7MQNatJhXNSZxWdXl
# QVByGdmKk7mGx8r+dFGfko4CPs8C9cmYf0/szrdYeR7YGJP7pMWH5CvsOrWP2HGS
# azh1wfFzhgoNW8r2COVG6G6H5lNFPlKWs++6d9JgVUNLzl1n3Eo2ms5tMlalhkur
# 0wOrQJONgkujmCgCvRh+r0IDpy054G2mGFuWHWBeCjNlQlBfQ9I2Zyt+xaoMfjEr
# S4Z4dADZQ4c4lJOEdEXulPIWFCFSSpSyLuavHxtTcZueQcl3KMOfxmbLDCYHF2uC
# lNOrTtzxAvdFkMX0HhtWsXDcQxQLgACzoTzdkZPhj8BK3iGTY2eC+6+D0d4DoYID
...
# hvcNAQkFMQ8XDTIxMTExMjE1MzIwNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg3+OnTHmfDt54
# D2EdMVPYtjxF6r3qAt4RcND4m+3pPRwwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCmQcHCMC1LjlY925WprUt+bmvqU+w2QuRFJlVEC9eA
# 7hQbDCEUoDsBBnKrpGCkMTE3RYqcS6DhCP3Vi4dM0fyBiOM1k6c90uwkXepx5lIh
# 77wdLeCyQaeO1YqKFcXV9CdYdO5D0unUOzdyHREY9oeTJuZk3Wy5jaaRH2ChWs43
# ObHwOJebTsLgfCAlZvpIahf0kGPRcgTkoCD1iylljF3GLlAQr5LN0DTXA/91UGCL
# KpLdrPMHP11k3dIE1QOVxL7YYmg1g1QpxlMbWzzYzc0F21U2Tv/ka2ZrGA9QQoAf
# C5/kp0JXg18IrRITIzDQlU7veXSHKifdHXyfqJJGrZcZEwATMf2JCTaTV7+dWM17
# 0YUFz5zsZO+uO8Has2RFdtc76v6bMRn+yCWY16mXlXpSiPhKj0pf7/UPx6PNQobu
# cPlk6tAMz0Y5CpxEBurLfjV205NOcxqX40KzPMEptveTlzyvE6WEYzp8TnV4wuJ8
# kpwskf4bEwj0hFkHs+8r68w=

<#	
	...
	===========================================================================
	 ...
	 Filename:    EnergyDirectorEnergyServices.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyDirectorEnergyServices
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyDirectorEnergyServices $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyDirectorEnergyServices
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('tfa.Energy.TestingAndCommissioning.READ') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAsGJl3ANenljxx
# FPAHm6MnD0VYjy8CbqRPwVa+zyhRhqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAg2U+9POT5GqeD+LJGdDuGScGxzovL
# CneqCCnjFpDSjjANBgkqhkiG9w0BAQEFAASCAQBXUqF2O3ix0Q+2tK1VlZ/0GEty
# TNfuopXUFJXv+kq3EPEZ9Y9pFmKpwoxXEcy1DPjd6Y0N47EDKH04HiFqfAvb6TPd
# 36OOwrrZ9HkqAcsYWbiX7gJfVHJ9IPq03zGbhMYvqXmzQXh0zhMEDLuOQoGAGw7L
# xeHUyQG6vFsd0Wy8jDRXVHaVFRQhcF7tO/Jviphav6rcW6ssWtw0btsYyca7ZkO6
# 06BYyzuxh+yj9OpziWJZOUl5mAs1VuBBTTUp5g8GMry/H+k7O6Wf9XDlxcTgKggX
# HdY99Ysk7995Jm+38SzYIlea4lKRTwVO8vkZ88bR+SaxYyys2sV1U+E0fS08oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjQwNVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgerVi87OzAor6
# VelX/9fIM1YXQc6WFRoOQBLq5MX9yeowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDVNiMptgIkoV4w1+QP+zyaAqQNiaL/8QgTb3/iaqgZ
# RK3De0HQRrxbMbsgkGv6ock8m1oppVAjYhS4GInYIIVSvTHqKmPN9h1fpFVUGQFq
# h/vv9dGA4wj9kebZQ/rF4isvqWcdvgRHHAuzNQk6fGu3MScaAj/HjUM3zWRprdO9
# AftUToUBR1gx2vX2GWPjNHj5iD2VQGqjD8sOgUtJSPsJHB1Nto5P0G6Z71y+Ve46
# klqpv3dPlXd5T83ZnObynmIhf7s4upQpdQ5kLTgjYxICRvTmbBv1r0V4Oqv5H/c+
# GMv61p+Q8rPkKVZ/HpXyCZPaf6g1VDPfvQ126+/t3Tc5aEVlT6T5dfPvzPK9gJoB
# VHv8hwcgE2KCfi0UrVg5lSSdGy39g3FGDHWwzf0kSi1LZZdT/ccavC0tT/bmcjw/
# nye97TLgiKkbfEov4czv6QkmKzYYeB9WkHDXs0wXkltlp+Vq/l++U3F/JohdtHdt
# ehGNUCvtOSKq2+WdArdYTWY=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	04/04/2019 10:13 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergyEngineerSenior.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyEngineerSr
...
<#
	...
	.DESCRIPTION
		...
		GSG.TDC.AllUsers
		GSG.TDC.Drawing Management.RO
		GSG.TDC.Engineering.RO
		GSG.TDC.Engineering.RW
		SP.All.CHV.R
		SP_CHV_Managers
		SP_Energy_Staff
	...
	.EXAMPLE
				PS C:\> Add-EnergyEngineerSenior $Username
...
#>	
	...
	$ADGroups.add('GSG.TDC.AllUsers') | Out-Null
	$ADGroups.add('GSG.TDC.Drawing Management.RO') | Out-Null
	$ADGroups.add('GSG.TDC.Engineering.RO') | Out-Null
	$ADGroups.add('GSG.TDC.Engineering.RW') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDFcDzazVqsgUCe
# uiO579Peuy977dAXUNd48lJKHfL3qKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCQmpscZQCsYX5Ai3l4/Y9N4gnNAPSO
# Hzxjs01+PEz7MzANBgkqhkiG9w0BAQEFAASCAQAsw92ck4//5sm3DWTGQ+kWeaYY
# tusL/T1tYNYIXdnyxZDDw6gY/v0vxqaAIdAXN0oLTKJXs2RPQdh0J0G1lZkkuNgi
# Uy0bzqtt6mLG+K3hIf2kjbec+uypGJifr4YXh40XPIFAX+8mGQdC8u5sro9nqFX9
# nYt2jOYKusorsuLJ+OlOZL2vGeQ9Aw2OxcHJXQ8ZUqgQN1vu/XUx1sjVR72CY+OD
# 2lnP1CyOF3SBSjl1FsTPLJ9pWeKH9wKkaEZup779gwRW/4ypcMfazOKRGKi+ROFj
# QGIV8pTpXPPsU28XoIVcQVEy99SCJLNv1rKBqYp9NkHSUDZNknCet3PJGu5moYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MzEyOVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQge9+Gm0wqWSXG
# sfQ799boHEaPs5/WBJvElvhlfocF62UwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYA0+1q9Q4yD7zCoL/AA6clTmaJ1mVvh5bkhXzvFleIh
# LvxuaVqCiE4tsqkr5z6yai+qT8bQV6aLhSI2LTScXhp4enMtTAop3zPNNZYgyIQs
# F4DEAapLdZAw8x0Rna/bPuY2i/Dw9+T1KLRbF0QzryKvDHvqa0giuT6uHV18hH8/
# V0OAvO8+GZCjgo7k+CD9Ox2RiUwK69f2P5WSNNLMXyW1ywTqXX8xegThP1jJb9Mx
# bGL/naWP7gUdtHRVv5dZxWF6d40bCLTQZPOhHpmyPjZ+/1cogmQ6o/PUK8J3DjTi
# 8BpqOwrEjUumH4eJnf9qEBv6TUZ0ukzjQQk5Rl6I9Qxy84jMQGwY0eEqKqBVNJbN
# C2MYFZXLDtSlYq2utRzXUN8pry1r/0JvdfPjRvs/0FLAnzM6+98AJUPzNzSPaN0z
# JTp8jd0T9OTFKXey20hUOa9McdOUQGYraOAByKSdjQ330sOIp0mRnwTGec2Nerv1
# 84JVJl2nJB9T0kf5DPGewK8=

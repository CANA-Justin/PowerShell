<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyDirectorInfrastructure.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyDirectorInfrastructure 
...
function Add-EnergyDirectorInfrastructure
{
<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		FWC52Approvers
		Senior Management
		Energy Lead Daily Summary
		Energy Opportunity Daily Summary
		SP.Announcements
		SP_Managers_All
		SP_Energy_Staff
		SP.Energy.Senior.Management
...
#>	
	...
	$ADGroups.add('Energy Lead Daily Summary') | Out-Null
	$ADGroups.add('Energy Opportunity Daily Summary') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDZrTZBaXXxn21G
# 0qyuh1pLLbSWjhqs+/Gim7gH9cmWSKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCgP7tdVVAHLHYPh5OXRjNysl5tAQ+g
# zUNuJb/dNvXmfjANBgkqhkiG9w0BAQEFAASCAQC8ByX2DF1e3f19nghIdVhnGY1G
# dhot1OayCVXF0icaxVeJ7fUu38Z+EeboKYB3cgk4bjOkdQshXOZxZSB9RlWkP2DP
# kKX3FSCwq7u4PREi46iT3+O8hiuCV37CZDT7zQC1rIHWPTHZQLb5PxDbmeEC5wCs
# dF3/Y0NTUzgb/yLyoTaqMo5jDA+Dx7wrE/Citg5uaVDaAu4QeGWvdx/aV1Z0Cth4
# qR/W+ftYs8eI3mNAbj+h9K7kVIy8Pt3kyjNa+JIdtteCW+6+2pfG8LTbEHx0v2y1
# tZafQrGkG1t1XIkgeYLI2FbK5mEAaPLJtnmbiP0QHKHBU/T+P1KLVS8WsvdboYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjQzOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgnvM+H6GkhkjI
# aMhJJE7BhBRrwgOjm59cYAsxY711wLwwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYATa6bEx/5U2ObYCgmlmK6eWGUk9ENizAsK8HspAQPN
# xLa6UKiezg3gJiMGnen8qAkcgpzzTe3M2A8OIe2SYZJ3SsKuSpsOGJmQQf/fPH1Q
# VJJQ93G87xzmtES3yizisZSRvnFuwyK3THjZtIkyOj3Trc5s6xgO2yHTF0dOs7DN
# ie38Bx9DOrTqhLKxb3vi999sF8JHt+8cQXdjr2NTt9VNLSncIhgPNubjPG8yCepp
# 5DgzxA26DbdjQxb6nBkOnxbZaK6seNkoYRWtIX1U1RpN6Md2+N5xJ4itlHqyihto
# +qIdOsyX87B38uBEA6V2Eak2uRRwrFtSqf3bsuuUEFfauaopEf5y/wK5i9Eg2Je6
# vPFljCjYPogvEVM0dbck+w3K4QHkkaouNJhn7EKPOskNgJcnuZcYown7DxKdpSsd
# QrxzHQWjlRmoKbPamFt+ZdmkDo07WbtWKf7V1yMUIYryYmvKjNIPc9Qqejiuqm/H
# BhRO/0E+GoPBpaUx2gTQE5c=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyOperatorRadialBoom.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyOperatorRadialBoom
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyOperatorRadialBoom $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyOperatorRadialBoom
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAb64E1fJDNF9OC
# upo3+Lk/8GyItTa7FXLiqOh448RbyaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCmQpkTq5a1UJO1P8SF+vmqeMrrUqZ5
# PXLRchmduw4cPTANBgkqhkiG9w0BAQEFAASCAQBz4fC3dNsOB8biPJUTZdyH3gpQ
# aEpi30ZbWK+5pjuH1Z9lbfu1xnNR5Ui5XOJXcEQ+UTtyOOuy13hVyGsOUiVMzjIJ
# 1WtAcy5U1HfW4jjEqVBzNPE2mB1E7Iqbtl9ePJuB1tAI+Bpsb3HpzsETAQ9L6Lih
# kc/arHffhRSlFh0OJV235IH+NJJ06A+1PHJPACXCv5SrfY1xEIv1yvWkr02/V2uQ
# ma6LTokNlO0jK1ZRvV+GhV5F/K7H2wVUflCfS5QiDcnB8SWTF0mnZD/f+Y6lcg2g
# RKIlpKfY2QrjukSjhgZ9+kqra2QkXh7361PgJLNzNQuTiE9dO0wGOBBLGUuroYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDgzMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgpMyVXxZqPPbl
# 9fok6XFIz+2FRBGSNYiROe6YbnjN9oQwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAmqJ6kDT7lRZhuPZr8BFUHL8DPPYfR+2PyxEEqtf51
# 9eGJ5Bxo5bvrsKSKCz/tuvm15Fzo9hoWCgIbdhoXdtXe2D4vSlCSb3JFRJyEPjMd
# 75PdlXQLKI8vW1s/LlyOLiPTG/Gk+cbnvzOw5+TzyxgvJ3Rz3qGF0QlJ7cP9nyjv
# tN+dY5OnYmvUz8dt+7gH0/SVLIHcoEmza1xtaaIzoV/12Bkpi7PlCOH1vPB0cptt
# rnqW4NSAbt2pjkQedCQ+qtGiqE0AK2bXUARySvTE/0cBU64Fp7gc4cnGL/Ns3X8s
# 6o2AXITcxLvah+Gdu/pdsYrDCV1xdyzMVij9AiJPn7lJDz76dLEyqo06UdyZh/Ch
# pelIW+ZmlKZT33QmXaa/xM2MI2yns1/d0xd3P7/9ZAqNXtluXU7CMq0tDcRf5Fc0
# fUOz1BAZAaun+IQB9zuE3+zHNaW2JPl6+IL4MmJ92yUfuMzfIV0flGtMSd/7XmO3
# V2qRfrQ0c1yoUgQ3ZufFA6Q=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyOperatorGeneral.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyOperatorGeneral
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyOperatorGeneral $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyOperatorGeneral
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVy6jtuim90hWw
# 5afOT03aI2zavL1YmbXWha9fuT6gkKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAXufDoD8sBJ9CjkBgKuzakCelZpphD
# DPl9BnTpFBbgFTANBgkqhkiG9w0BAQEFAASCAQAtNRAGQfkBtykog9JRIGnkKKNx
# 6Y+ALtp1vyAiaY1twztpU1cUfH0PXpGV9E3evejqo5rTJ1kHPZ++Xtabh9SLZOhK
# 0IHKVGQ9oSBSUXwOD08QIMFVhcjYBuA6qBdLc82o0/GUKA0IO2OSDm698LTcWk9j
# YmlEz3NCD7wj4tHAwAZCW9rWhN2akAGbrqW+QWwcnSwSanQqMqgADWlBjki0d6xL
# GXx+lq4u5mTt2vDl85OvlhTfkj/DJtsAOPnMqdOPIVZzLz7OtyZA8NrocpM5SptP
# ZeAIApLdz8Z6zj3hhcf7ZS1i9uzsmCvMCPTUxlbJMUy6v/G1TDr7egaVuFKloYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDc0NVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgz4l0ccNrXod1
# 8ZciKw+7IJB9FeN+tsPupM5nvaJzhtgwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBx0ZzgzgvqxC8AxOc04U/fL7MW4+bdxb3l77LTL41f
# hjxFQLwj/qhNK3YyoW7nEK6AV6pb+TSYUfmxaIZDFKq4lINtZ9zUtjr0l3SWAiFk
# pjPyYuepbCLKeXiHAOqQxF8NhhLGLnyMPZ74jWR1VlirU6YrZs9L6t5cNK0qHe7z
# KXhlrtXCXRXshjTXBXxFCX9h424+Pj2AyPVqEZvygH/iKiU6k8su49JVeXPZ8bfq
# SHTUTKjk73v3PFrqYsj4fGLj8pMy5rwayPTSmJ4tm9c1ZgZtV3nKOZHd9ywLhEzg
# 2SGsVS3rxHikha+AZ45v+UdVJ6A5Kq4Iwa4eyQ4wMfKuV/8MfqLo7y6gT3aPtHDM
# 7liDKw9i9vdwt+4P++5lp3MjYO+ZT90kUsp+2Jc2WM5/PltaoVn8+XaLeo3qm1iy
# dIj1lgXHsM+xeFbwnA/SvO15Rm3Y+Nd3mJ0MXcoyyKbkhiEUv6WdjXMwRqdNGige
# 52+u499Lh1nDtObHM0JkqGU=

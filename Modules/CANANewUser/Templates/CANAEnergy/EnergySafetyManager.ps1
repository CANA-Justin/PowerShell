<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergySafetyManager.ps1
	===========================================================================
	.SYNOPSIS
...
function Add-EnergySafetyManager
{
<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		VPN_Access
		Drive J - Business
		Password.Policy.NonExp
	
	
	.EXAMPLE
				PS C:\> Add-EnergySafetyManager $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAe1ReL4U5TjEeB
# U2fMOdhDhe6gk98WhNrXRTRAPM1aB6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCC35HQBWAGM/3CSAyQ8If54JSzctZ9p
# oMXpYpK/4TDZAjANBgkqhkiG9w0BAQEFAASCAQDAlIf+XXxtivbHVkGdhHK7cUCy
# DpGBLjVOapDfTvsNnMDqvlcEpcAH6fULnR0TH8c/n0mhOmhfZ2NIzbbwiVZl7Md8
# liRkHNFosuh1hNhlpjOEMlmB6GjSu1SPWMLuNCpCc4L26KJ6CWpAhdDTjUbN2SMS
# aaErHCnacCIOgzslBcMZhngfPzXzTvQwk9P2uP5IhfZ7wZ04EcZD0PfqxmOf71MC
# D5qt17W2L9jzhFFWolBAiM+oPQi00qTk4DM2/lwaZ3xMvRnWewIpO6knHXXDX9az
# GMRz0dFI5sPrPag4MuzsYdiecHk9a2EddHUT+PjKuj2nAUumpFbebeEbQpkgoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE3MDAxMFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgBD8cSH29DOoq
# rtKpShArHjM6idZw9uAjW3WNwrMXeAowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCYAd7ymLnbXgnkKEOJAPtAfTIt9QbEQvEjF/V4Cymy
# OJ2+pwZT1WnwsLtWcmJboNvEX/O+GpjqlTakgPxWw3sSsUkjpU9khXGh6xToOFCJ
# NW2S9XdZ5GwDkBiJo9kUy/plr0fnC9QWDpOagfB1SfST4aTofHpRyq3hNeMCrs9u
# hjJKiX9QY3sOSPHVXRrdGRvWkuDyyjmtI9iLtiWcG0uYCLI1ZEYoCeJ61zysTHzK
# OsQs7EjTlfQk/Di+4G6pcyqf9ytZB9Up/M4y4wmkPFyLitJFzNZZpTm99x9ZJ/d9
# yNxz8wW5EgNcQalW87t7KZa3mSoptuAgsaBNCVamJ88fU33BnwCiShUatjlg7OvE
# OkYsMMFqr1q9FBjduH+a12bTKGGxrx7+9n6vytexDtF6qejTBScEac74bt90ELeL
# XyXk1BlYNUSegQbH3mrwAf6EGXbRk+hjKNxmhMcIxDIZZWNHDprT6VL/yIdxzy2c
# M9YrSBFapI0mw0fCu9J5XeA=

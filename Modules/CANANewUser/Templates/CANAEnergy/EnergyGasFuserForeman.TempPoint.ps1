<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyGasFuserForeman.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyGasFuserForeman
...
function Add-EnergyGasFuserForeman
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyGasFuserForeman $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2lYJz77R0mdZP
# onzqsGqNYq9ViuKRkTf9mcsvqVdC5KCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCJKz3xNR/zZvkX5fs2VAmvSzFGJIFP
# JnbMc1WQj5t9tjANBgkqhkiG9w0BAQEFAASCAQB6z+Yi3a44UW7zla/EJwcYjfaE
# YdJiLDxO68WrF2bkhIZV/hWtNcZCHsPeeIrAxlfEKh5d1J8rPjVGqcrVurFm4Nnc
# aijqJNok8ZZugp0F5oERiJZ2AehwGNWnGTsv3N5zDuULcI8eVQ50W+UP35zcxHtX
# lyi0DYGicVkC/vyd4U5fn+hCMnR0BKksEZA3diQdPvc7aDWE4aNpHzGjb1yU3VpA
# 3rtC75eDCkOscuZCR01FaiDBL7nUCktTbgbcthSo9whUjdBUEV/AjShsAYrbO7Re
# nMZFdZ9AZjSZwzUZ0uk744czGpmuzOvWJZltY7oezmqR+a2zb9t8oKPqJQS/oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDUxNFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgM0/bJwRzQgYd
# lIDwqBzgrk/atihn1kcnaYz6ZEJOwIgwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBhnBX/DelyJ7pO/oRL4nlqRwtipFMcquBCSxgbtv8R
# fMGWeBphdnt6PuXHZqf2FElQd/etKn1Tu8wtqYAPrfIEMOvi+7LpFuNdkwVjmfCi
# brnOvjVZdcrF5Je2G7102oxVUsuNrUy5+tDgtcPvZmF8MWECqD1Ar/kyuOQZJwmY
# mBNeODVpG/93Pcbh3GiFtwPpyLAmY+ln6CXl477NgD0b3D7jh1ZRoVsbWfyyBic9
# dgf+M4TBL71EZJzyp1oJJf7oQwWK1vy3XRh01dYi40gcfCcPNqDbtnbvziGoRWYN
# pvRnEvqtZrpGItmek388TrENwHHrbCrcr7M7KJt/kibl7lhH+EDAZTIEPtOYHlrD
# qKZPPhrTiactR6PoOlwTIiVce9CRGCJRvYnP9hEJPZUsHChAh8aN9VobswhbpIl4
# RhS91D/4EedmpRFX4S2HUVAh3dUuV3YhfJKEBnaBSnze3kZd0dygGowjobjwwMIs
# OEgT5eXGcmvgcw8bEEuSjms=

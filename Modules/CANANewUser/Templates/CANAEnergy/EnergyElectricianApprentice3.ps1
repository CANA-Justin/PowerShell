<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyElectricianApprentice3.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyElectricianApprentice3
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyElectricianApprentice3 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyElectricianApprentice3
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA/d9zql8mH5syO
# /t+I5efH8oFDh32j3EM1V006SQ1u6KCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAzU/FJ4SrClSQ/yd6gVv2kT8sRhx4k
# n4gldxDU4x5B9zANBgkqhkiG9w0BAQEFAASCAQAac26PAvc1WKME1Kreo5HFU3N+
# Glxptt/6Os2lX1lQGW+2cHLfmGqpD7/OFFFZFVIBEzkAfxDMVUyzBukTI5Jyjt4a
# cRz8xPW2RzzqaOkX/NYmMzHhMxVTjcrXTn8zZixQYKhBO1aKaNhvFUW/bt9dqloq
# xyknU2j03s0RCavKPHD/mNF6CB5ns/Nj6Z6VxAUlNeOu9HvBJF3PCXWMEVar0qrk
# kLyY1IN04ypXXe+hbnsqsdoLMSsrS9bN9OCpyhkCNlwRmr+E1N4hUz1oFkSCViIu
# yiS1cXj9JHq+8jb3wCuCc8P8vFoOOtHlM84FLe6/RM+iMRkf6sqNA0vytdW9oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjcxOVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgCmOSTYxDhNV8
# 624bCi84sWE03hGiCc1Uiv9M/bqsZjYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBRzy0CoSuTCMPH7mJqkhsolcqT+yFiBg6dEPX3xTqg
# dtYdsjVHns43d6qm0eZqmGU1WQHqzSxwDYBK3erWPYBDnS7G1ceFA3pgZ361QwMl
# l7LIjVgiwGWU1FPMDXlnY0hZLv1rnqBaRpIkpeoBAcdSENYN8YGQf8qXA34lgJ4m
# 83xCRJiYi+dvFH1/gQlg089xToFlaIXvcuzFjSEXJseIKh89wR3qt7SpiI2ZQd0r
# ofj3vWxMWhLU7cMN4wvSvKixLHtK3ydb/xa6l0mpeTV3VChCXhLEMI/CexVew+1n
# 54MKN2/L2UBE+01kW9B8Uq7ND54pNIEzeJ96UCtIbqMmiy6zePNAHCZ3zjvcad1S
# JOdJn6oNhO/qNP497oM+Azeikf0qu/donybNqApdnP5qZ5x7t4Qg/VaHHaq7PQQB
# jOQM6XAzpPga6Et6dUgVhovuQJ0n50Ok4k29Otw+5+ESueG7V8lbEMeF2qNVpIvD
# 0D/ovRm/oH8l4svglaYvINI=

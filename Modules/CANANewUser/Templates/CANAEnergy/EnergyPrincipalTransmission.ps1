<#	
	...
	===========================================================================
	 ...
	 Filename:     EnergyPrincipalTransmission	
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPrincipalTransmission
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPrincipalTransmission $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPrincipalTransmission
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD8vBZX5ZXwguO3
# O2nUv+tKxPQsGefs8VI6wxhoD7ZlWqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAvpSOikRNELSQS1X1kMFXhhBIeYKbW
# x12BADc8TjEdHDANBgkqhkiG9w0BAQEFAASCAQB9KEn/Rq2o27QPX8+QGDEx231s
# S2goiQprQKOGJiWBojs74oBBSg5qLvUHIk14f7bRs9R02FUvppEmRTfn/bNLkuxC
# avYjTBSTamNHpkzaw1LAqobscsGQft54aBUhYmbg2ADKkpI7DeU/Q65FeQaMD/4R
# Fcv4j/GJtaXvxmdp7ANpolMzvMe72ynWGXbXOn0PlSIoD+oqg02fWvsEDh/3+r+R
# LdQiJnQjoBxKsgFbE/hV0tDUm5R44GpUNeA02qNNXhqSpgdVLAkY5BfzkeHaamec
# rsFkvqeypy9weIohygSn+5WLnR/3/M1v1Lkd4uWKJYhU/0LaRQd+u49eEw5AoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTMyNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgPX3XJ/GpHamd
# Yh/mNRPXSdXngPjfgtDoUxV0uBAUGKowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDLfxNk+96JJkXOIXjneriKiQGrU5Utv4s2fZsi7USQ
# FMm7sMFHL+xkzYcxyMeyy903aSsVHXsOlTszGIF8kSm9ddhGIw70X01mQwKq/i+y
# M6fY2ruAuH8bODI9eXSPS9Gs17pn3gUq+C3eoFwSGVrsw6L4CiF4GZlSNuS4nj2l
# oJk+pxoUbRGM9WO7mrfQMfVvS0djcaJoTa5U7+6KDX8vVCWkzB19+NZsFNh60Rlp
# dew4yWPsmLCC6tGZhEbcymtbGyzlS8i4udDe+WOq8liL6eQVOeopoYdh/NtMJEer
# Yf0EPtwyuq7zkU61dqJGG0sUm30KH6PLhN/R26rvdot4PWdKQHW6aDRdplZFyQIo
# jTSN+Ict0yV8RmM8AVXjp+Q64nvk1B3KnO2aXJfF69r7gx3/6TqSvb34HqLD49dY
# NwZvAynuMrMxisUBNrCO2YkuHWI69mJgp1emkqfCpTo8FKI6Sfgzxju4r0vmsGyz
# u9cmIah62vlThEdBzwhaY00=

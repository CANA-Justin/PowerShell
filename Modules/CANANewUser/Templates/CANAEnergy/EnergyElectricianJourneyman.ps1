<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyElectricanJourneyman.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyElectricanJourneyman
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyElectricanJourneyman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyElectricanJourneyman
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCN3F8+oWnd6JYP
# 6Hnd2OkbdKGzhtIiu2sVAhWqqUq4FaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCD9ggmuDGAR2UmxpU0WPNCL0PJ+c/ng
# roLoG9jYrJ5y3jANBgkqhkiG9w0BAQEFAASCAQC11r54dqoenz/bNFWTwF5qsZgZ
# dnFAgMVofDo7AoRWZSx5vZpwaA4xk/CjaszDE03xneQTmL0sUuuMiwTcRPk9kRNI
# MW7HSonEiGq/I8N0tCYkYI3o2ZHL53jVhufOOwrNLcgh05ww4n1BYzp4mBFPhVR/
# Ct9XXiqfw6oQVimTmiMAWbUs/4jpyCh6bAHp2umnsOnHwh6FDRN7NsWnyo+ofiFW
# GFNyYGUdKVXoejWxhtw1lrSYW2ogBg0mCFLSfsY52Zvv1718wrR2VN4AJktI9czw
# AJJK/drEcBjcVnQwHom9KsFxwtjPaZCKYr1bbxTignqqCEsWHxC2YbmyFNQIoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2Mjc1NlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgLIECClV/GuRM
# glk+b0c9lV4vFvbl7Xexk9bxHHdKEyIwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYC51LfME/ucMFgwbNugbciHADsb/Lkkx3PLQp3i9FXx
# hxcw5Rap1VLUxcX1ET1FrnXAUqQK/KQolhcK8eZKlRI/KIPAQsGfhaTXClaXmWnB
# VrAtPdj2DQGhBtn/tK5zrwrqWsEZM19hoPAMrNaI8h7esz2jUZ8SUZ1f/I2NbI0C
# KgRrJS9hk/cONDvYPKC9xz2v5mIJk8/j2RIIzNPh6xyxpBxHUAU0MqYWccZnmD9h
# iVr9pozsYWTcWxycANPCF7zBWVg48hmsQ+WMyrwtaR8qfyGVfRxWLpzbqgIaqreG
# tlPQ2ru2M08M3xhLt6eVj3u+TBt5gyyNGw9ky5TD+Slf3mH4UdrjAV1su0jYq03m
# 5nQL4uduS+jIfACblHHsKUxRnVG5lM0y6wJzkSPIWT/h7b8vxirvL3JloHLkgUD/
# zSDYG97F7BsI5BPyIsNfO/4w0Y/TulAY3lqf7TAhRJn84/Oqs0FouYWlmTAR12hy
# dKVKO9dQ7N3A8FDr6aOnOvg=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyCommisioningTechnologistSr.ps1
	===========================================================================
	.SYNOPSIS
...
function Add-EnergyCommisioningTechnologistSr
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyCommisioningTechnologistSr $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCyCmVRDmCce0NB
# Z5hKuomcr41zo2zrSaWMXasA8alESqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCB50ze4OqlzGzEYwhIa8azsJbPMFQWs
# 4txMbW2SqBvOCDANBgkqhkiG9w0BAQEFAASCAQDW4ZLwaghQg7q+E51bmX51vxu8
# 9F8yJmBh6yoZAxdSqN7mtT3JhA6sOqIl5q2E2xIFBnUXZ5MQHfldwny2KRd8MDT4
# LKlvJ5DdbZeqIWcM68SCKyJhuJPdBVaZTBokF9X/U47rB6ynGmeRGwKTqbjQOWDL
# CFKhIzqrDwNVe7LYp+tJuUIUpIOfI2WJxD/l1WCGfia5TUjnezdieEYGCE/ValCz
# DMDTYz/e886ARXk23Z9UwhCvYVWDO66OTM6GRF6Ey4Jt8z1p2TCy+nqVgxa0f+ZO
# YiCMYtGdQJcrtRESCaoXU14xr5PjxEh4ZIqPDvPQNC7vOGEnR4bzs9DVQvi5oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjExN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgWoB4zT7FhMZs
# WfWwtvosbrZAAohENxj8fetd7zu0P+4wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCC1uFsA16GYuC+4CIKEjDKU5jZoVj/FVH2MgWpsdQT
# VM3eqMb2mYRMqMCGIWoXQqqXfF6ffKNVzmpRMsKNOGTvmnS9Qt7MWVi1Ni1/pUXs
# lL0siPGReXcP3v92rP7hQ3ly9+wo22IPpYGsZO6wBE8/vDZrzJRXU2b41hlVpnTY
# hPGdt96CWI03Hof2dabJGfA7j4I3EY1bsjI5NNln5+yVh0Z/ez533NP8BcluGYur
# u3i103BNN9hVXSxXunxFJHbuN71m6NGTLNPQAqzRuaZ5m8oZ9FHx3UABNYduogrf
# iNYN81N5gZ3HmAEeaEt1zOELNzx1JLs9J4bEopq1B9KqvCMgyHgfizT9JQuJ0H1c
# pxqsBxirWpkV/aJ0zIoBIYfm+duAmmTvGv5MynK79Rz6+iQobQ1MmeBffoHE09kF
# Rl4CelPhCz1I+ePEQOxKbNXiPJr7xGpjA/ksNB3Sp4yamVNvJWDXwkCMlaSLepQ1
# N/sigP5sauv3jBL9vtl3358=

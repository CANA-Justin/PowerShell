<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyDraftsmanSr.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyDraftsmanSr
...
function Add-EnergyDraftsmanSr
{
	...
	.EXAMPLE
				PS C:\> Add-EnergyDraftsmanSr $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCdF/GgX6FjbZMl
# ryfecRpazBxxkY+r3fnjqW1c7iqjd6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCA6/NZI644JgGI1pYKlNrLC8LrRtDse
# LMoziDUiUa8F7zANBgkqhkiG9w0BAQEFAASCAQAtaxk/uJCKYeFS0WhlG8DEdP6k
# s51Rnncca1bAEeA6R0J7F0sXjpJuoZp1l4z83EpWpoFiIWvUVkHIQzbl8+2c6yHW
# YucDTBzxrl2jXAv3R3yAJp0xte+3ZBeGP5FYKRgYvch927cLbXQ9S6K9FBpkpOue
# 3JyjCW48bkMo96WvOxkGnlzK9lWQ/KDliaxvn6Qcl/ImYxPbVoXsPG7n6FPLWYR4
# e2n95JIHIIyv9mCUnk3Di5WxwengO7AlqoSo+z4FFsRMqYaJKfI/buNLDroYX+fv
# HRHxmyXsfkvvwmZmtQufpvGVocr2MLJ8DsdhG56sifXCf6p/oLWqSuaK48TuoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjYyNVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgxQ0Zpsbe1Sgv
# ErUk4XzUKPK7Sfb7fzBN7wny/jaQViAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCh9dXgWXEkGJHL7fx/fawS1whiHL7Jhtr7XV7bFTG/
# Oyzke7mkcAzLq2wPACt9bAd8WVCdO3o/yD67oJ6J6AbOSdxbb6mKwv4qUDtIfOcb
# efhY2RhzjsOVNpBNqSOnlxk8hBzj5j5VMp54qOShMAqd2yYC9T0NyfIi+8in/X75
# 3vhaJm3mn9D0qKT+PSvcAisUyeYbQINeCby2jiOFbR03YeUIJ6G1wu52u+SJcYgV
# sVfGWC/WblK7lHke/RLnYk5CmrK2FitS+yM6X8EBkAMUMph3u+Nrzmu7arBaBIZS
# wSD1aEFAZwcFdvYotZpSk4X3uryaHerAGfYk4KVmoBK0xl3dmk0SOuaIWcdLoX2S
# x4QEy7jyQS5eAChULsGixyctdu6JMggf7+v7AzsHpJzoSXm6to2waCbQYq4t2gFS
# q8gxDbutHnHAKgQoY5gHHe9DEv/P9Xl62Yjn9RQVAhYLatt3k4NsZOcdj0FmULKu
# r76NupLDl1J19RW7JyOVTM8=

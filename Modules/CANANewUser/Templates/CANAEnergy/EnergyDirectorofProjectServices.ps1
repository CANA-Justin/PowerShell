<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyDirectorofProjectServices.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyDirectorofProjectServices
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyDirectorofProjectServices $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyDirectorofProjectServices
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB7kzsmmJYrRJVt
# vJ7jxezsCNB+ued8UYb16zfzyytWAKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDFT4VlIavB+gQe48qFBa9nzxi94+52
# yLDx7a7l14NCgzANBgkqhkiG9w0BAQEFAASCAQCdbrNCP20JhB3mjJLHPnhIH8Wa
# LN9+1AvHHeea9XpMJkLoCNkcMUfe4iXL8510qB1NzifWfce+L5KPQOoVnPpsIXK3
# c28phAQbjPWyx8yT7Ppg+dRyMBEPHfzOOGiYC9pB+vEf5gkO2uTLOHLkRwIMdRxN
# jpfA+6Tj1zrogHtfp+ZvjseCD9x/O3FV7sIXfvcQMjxtcupIRXxRH/fB29feDJnW
# EEg/DU86ZQYXLJeRX8zOptvqSzaHjE7yeoHz/ZrZKZDsSUuy6ltFaQrzs8oy9cA4
# kU1iuamNRaFZCdB94scgPXUb7Dir8xPW2WIy6fzjpuV7csptlim32Ev/OkZgoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjUyM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgtsZbqxXvuToh
# X38nJ4fj4uRXVb7rjM0PvVC2XPnqIJYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCzpWpsyou++vJuH7TBL7UZq7GZKJmvhDazzxyN1nf7
# bGYMA+h626dVwKeF7TembANmc1P3Mrxx+7UMojPoU88WcnlDy2fSwW7DxRsmmohp
# XeRkPRfcE2Qa3tOcPWafv7xLtszMNX2oppYEuoEywogYRAd609LcwSU3fuCPEIx4
# k+TOIbq4hVwwLamYB6PqsgrZql8ndxptoGda2tHXIIlSdkmf0ZIM1QoMGLlQHQJA
# AWwhfX6EOognn+RqjhgX8Jv/dVe2Wwev9iQuEo5qehzL4fUNNVQBde1gzP7OBTlz
# oww5TyBysmtSYW6TnE11Tzd3flJaxm7WLWQWQp4Kgv6xdk9VIg1N+qjrWMsp1nZt
# Et8F0aXSsR4FkqIF//HCTW5k0dWa2IdRgzsK07Nh4HbIjVgMJU27jfNmqNZhoewT
# jJIkt63r9xOZBKNQ3vlg5prIE56sYtJ+dcUWqkoNDRsCJBcS6+AflwWO3lgDrx4R
# w5QU+7DgmBTQo7w1pAaAIX4=

<#	
	...
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProjectCoordinator
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyProjectCoordinator $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyProjectCoordinator
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB+S/DHcgZhKOhT
# c8n0ThOnTtDa5xIJ6/FSqGTbdmsfVaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAfQ+NRWA/KGOrjBBayub778YISoc25
# 6MjSo2cKVAbMojANBgkqhkiG9w0BAQEFAASCAQDbfZ8+7bllTtrt3KmJDj/QYtHW
# 5z6FNvKvaiBNAskMjpx/7RQBJk2PAg4rnbZ8Aium5oTn1ARAbxbZK61FNK9q6YFI
# QYVAkJZBwMzvJSN2WWcllZa56kcTGCfFI2nk+QOGOFCs73uQAlk2KPHDDvHBxg+L
# EWdq7wEJBhJinX2+5OIaKOzmq31QCt4cMCxVojK0+PYtoY3qlG2NY554MByBtbT6
# fQ8IADXW053qFixTH3W+BNK15UCIYlqCAjMfgISCEj08mbF4S/ImVuvQb71zeTDm
# 0r0IUIE5IqDWqk1AMiLEoXmRknHxImsxgr4HIyuDJAFRIQrOE/EE1vRL559coYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTU0MFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg20jiR7dkCggD
# 3uuqQnUo02NNiWEHOimmEDDTRSw0mJAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDNZitbN0zf8YkNFUUTgBEQW5VpGo0CQ7RIawnC/Mev
# i4/f7PlBftTVXQuIKe6jv4zw4zBGqPKp3YEkRcISvCzBXhYV+C0Tf6gSU66siGeC
# QQvb0Oa+RJUy/21al67kxaqAySa2/MJx+d6bi+nI55OWFGQ3eVG40YJSkzQ90zv0
# K5K7TXH5BDvLGd/71K/IBKoVpBHrN8JfIFqVhiSRXspe8ZNtZW74CmoBWB5Dy8qD
# dCJ0JWhCvY3qoWCoVe1Byo8PIq8dNlZrW2G5fWojr38kOIJ1v+cj0Z6+zKFemC5z
# m1xZ4x6g+MZp/dTT4L0fvn+1u8h+tKnU/OSupFGfn9yHBvuZImsxvV2QE0stLRaL
# rPNgCyjexYjTqwSMy1oNAYeCfpk7E8oyVtVYHFhLmDKwDykNYD4KYlNIv/6UgxoE
# CcLcGOj7ZtwE8EfV4K+TLksX4U/L/WtgDVdn2B+N8E8Ms/OEpycLa7vWPCVMO+Mt
# pKPPHVChykAe++rhzSmdYGg=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyEquipmentOperatorBackhoe.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyEquipmentOperatorBackhoe
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyEquipmentOperatorBackhoe $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyEquipmentOperatorBackhoe
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBa6ut9+bwxTX07
# l131E2T6olW0sLCBbz1vGxhW0Raah6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDojWo6v8xALE/tNjm0JtUgDUuXLGJ8
# 4QJ9nEw4Ups4ATANBgkqhkiG9w0BAQEFAASCAQB/t/pZ3G9j47kDlpF7V+rmb2QR
# 7csbi+kKBAfMpnijSVL/xXhxs3zelypIaFafnP+ZpYmcRkSzW2dZIyNdsGXzLXHf
# k6WePRJhA7PDfrMjCxK2GZSuu2GxwRmJf9a2Y/i5PKQZjHb74HqTQVMxj/Q51xbI
# bceTpbfWfGy0C72TbscK4mAWDUtBO+udXp5VvWZMj7p7NHlRv83T9220qE79OUn3
# RQeAtcBkUlcteNkjW3CO2KJUsTFbybdbOpSqoPh8g5GygtSPxvDsx8k3bQ+ZIQw8
# Uxc0dzMBVZXlyhdthoCmSqzUw0ZWEp3S3+DWQqp7j13dJRt6RTqDrtjTKrpWoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MzIzN1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgvKGIQ/T3XE2K
# AL5KD6pP68SezszJn/lA5jndBUBMSbYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAqs6/86SyTDeoJbWnHO3E4axdWF75NMQQ2hgFNhnDp
# lR6uZHiSFCVj+Mk/mWcUrqBKQHgtQnjOCgu8JzB5GRaHZYbiPuh2RDJfuQe4BemM
# wtui6C1ywHrh3VBCbw9YNkSrmpIdtJiFfDTAuKsBMDIV2YGDMGE7ZAzd6A6hnTHr
# 8M62M/DQGz1MMBhIMA7FHJ/9ogxSeT0yOedxGjmpkrt3yNZ2FrM32rsOBGQWCxpC
# gYvTO4M7MYR6Nv70tDa0rNx91WR5veEVz+BWLgxkjblzDlw27KOcexVT7EA5ADL5
# F22Qw03M0TE1ZMe7JpGfQvlw2iRhf9S4f/bRLSYog7IfaFzWlY7fI82+Y3BKRoS3
# pJKIKnvWz1aiEChNMpcF0uu7iVsqh2Yt7EU6wovcYnwOihVXDSBHghN+7q4ddo7M
# 21BkAzOhzoDEvAMzDAdOzxYuZhVf5/jHSxAi2oc1b/g6vRpWJYcaaBc25v0Tt3Md
# mestdRzlSPWFBhU7BD8/gUM=

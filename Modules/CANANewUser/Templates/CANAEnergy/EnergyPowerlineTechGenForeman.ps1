<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechGenForeman.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechGenForeman
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechGenForeman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechGenForeman
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC+HLLr9Bnwr6Yp
# rBPQg7PDf7IwBj4Nhxi8s/7zRjmLLKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAk5DgWFFh8yj8b1Cj+UljQ8izizcGH
# k26xowB19naW+TANBgkqhkiG9w0BAQEFAASCAQAgzYj9UNUQOWRvklggj3EX5s/D
# Eyuefb+Qj2JyYVheoptIniIxTs62pwRpjsJ/YmN6bFaNYya0IQWoo7p7wJP3wrYO
# d5Xily858ka1TiMQta0Vj2iOVJWpQnjZ2U7erCZXU5QsqrPztQNZUOPLaur8sFMd
# kJ7R7A7fZRWXehwJOtgN9+8fk3xntLiFEy3/uWWTEtuxILLD10r4GWWwvULskSQU
# Jx6eHSa2xZu8YG3GGxeZh73wo5HMh0bOLNsXFQ/7Ege685FZDXi6j653eK7NGYib
# 2nK/uxCDVGAUwM2CeDFuTYjnQSLaQRXREVCp7E3AXia1W715Shgz/A49Tqn/oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTA1N1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgVa0nQD5dFhfR
# XdvTowEeIjJVv6Y4EkW70ezQrnnxq4QwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBdw6DGZ9z4iyrCw/wfQ86u6weziUapw5VO9j1gtXiI
# pQT0Umzln/BMH2Ut3Nrs1usRkfxkpM0h9Z1srPyBzT7ylg7MD7OHLYYF+GR5KuPA
# MpVTAOLejoSjmG1pGmCaQgWDHyi5OFz3NL69YvKJ0ReoouS+eUPI8MBaZ07lpzjc
# ba94cXo2pAFVIweydlvpcFaDOjSOnrgY4Cx4Nje3PA/OJrh9Az2w1TPxcOaxYZAG
# Fgwr0Z4LB75y9NR0EGDGnXNtKlwhgLj1BaHlCMCjN6dNXokR/4XNIIdJNuCtI5Ai
# e/4TImlGoVVEfCC1qVWgjxzH+P4qT8nm2vJ30RrLpaPvc0/JFdXuIO2/P9nR8MrG
# I9kMt2vyjse7uFfCluzifJhVlVbu0SEihxH5dpj8C8ht1dy5YWQRpD8TMOdkcEt6
# 58OTdnN6pmKXjzt3+BGh0FvZudQkMNJJcuKNB/o1qe43GuOJRFDUx+0Ts6OFe05L
# fQTEJk2Zvft0CpHoU8MhW6Q=

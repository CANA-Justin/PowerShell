<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyFleetSummerStudent.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyFleetSummerStudent
...
function Add-EnergyFleetSummerStudent
{
<#
	.SYNOPSIS
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB1yTxBcFli83cm
# B8Jp4zeoP5WmD6gyAR8eN4EukYVSOKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDGcI2W5CedrxA18Zg1N1AHs+h9HPPS
# Aly/vwp3bcSOoTANBgkqhkiG9w0BAQEFAASCAQCscncGV2M1k/QkoZo4dOUMYs0f
# kJ5ntS+cR2jYebMWtIukYWRYOuAuvDYrgL2cZViTJZl5FNlkKkU8aQdtjwvCd8BK
# aW9sKdNrSFojyPjljf5JdPyIVtr2Nn/pQ6U+5AZ1L8TIXt2PaCXS32D7BahM0NG/
# MbSNE3oLDMdxshTKLeZB8LFSIugl5MOTAuDA5tUCiaus74FnCjO2ZmEYrWdDRSo8
# M8KmnOex48MuAJXy4uCWqeT/C9fSghuCfawDUZ/n/eWpNDAOnvP6xuJ+0jsPc8/O
# qB+rY4l6VlElrJnHxy8BFRQO+W9cwGh0uojy6xyvbIXm8/gsfsNc6FxcpI3hoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDQxMVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgqLSZQ97B6DvI
# 9omp0m8cP4mqc0Fm31pgLlJE8gcSTKswgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAWSQ/+QoekBN34lFVwoh+5HQ+wK/pbgOTFtCfwimyu
# 5z6JnhM4elVLiscgxhGGzP7QHqlHPDjEXOf1d5LENa5KHhVgnvQig529CmdWVo12
# 0gpJiXn4UM3//xPwBVg4ZsgkVpXRBA4XFDeINTxJmeqk3jKYOL4P2V4MbImJ0iGc
# El1SThwVV31oHzpQTO3bhiwbsn3irogcNBSkqcgVt0EM9i8FLL70LCMF9eVXWF9z
# eHP/a6w6ybyXkQkLhaTTUuSxt4tOvLMa2bUaTGfsHM626SCRNOfmnt4SXBW0HDrp
# n4OshylgNmWgvh5p2HXTcIHHXe3qx8h/4erMRi3CDzOf9o9jxKpHxkNRdWualLQ8
# riWFXDv0Lj0aRwRWKEwz9yeeshxKPuvGHZeuONbZZP7hRLfqUVnO7vLogIEQOIDg
# KiMuCRJeMtMJDhnn1Nj949vQ+zY3fWQq3ostx20DDGZZocjaNa/d6ZIXng6yJbSS
# n9MKlVCW4F0iKOm0wrrn3xo=

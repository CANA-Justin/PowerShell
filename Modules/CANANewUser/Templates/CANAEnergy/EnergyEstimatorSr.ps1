<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyEstimatorSr.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyEstimatorSr
...
function Add-EnergyEstimatorSr
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyEstimatorSr $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCo2IICZX2/SKrF
# 7DvWVNB0hXd3p2UIqRpCppsyGABF3aCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDjv+RxBUEA/QykzcGgSWO2ynm1pW/A
# yJ+hzqUxOHno9DANBgkqhkiG9w0BAQEFAASCAQAjsInNoSZ4n2AOJC+olpwTxbqq
# BgY6tzEB1EQAP5QWGehJKzFs33tSz+KPN0GjEjrnLSz21UFcKdFTIUpVFjK1BUg0
# 7cIzdOwp4yERUuq0yYeBb/wCOHsI53Xpl9/yxWEPyxIM6oerp47a/AWIHX79Y2lx
# LnzJyiHQp7d9ngxdfuMoYQAa+G6HFiPP2pRbDYzrP7S3P0WTqSOamk05gnDDuO7D
# CbG+hKebbJtPKb6nzZeYTYsY/K087eBNqfYbHNKoWYSG5WbeNDVQ45QeL7CW+NUs
# oMlOgY2wEW7V3R9MfWcGAZWdZI5c5TPgXwICcm2NnxdbwNLGDI8Fu12iE+eDoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MzM1NFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgGdkmAS+6g7uk
# 2JqWP7t0fV7uYZBTfBKixnwg+wdigpEwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBehm6pHQrh1BcOx/8yZN+UiGu7xS6VOq1cSIvorbq/
# WcqXfxUiw3oEXJYNaLZAw2tHWDLKcAZBqKdEYQIzHIya+UZEMl89rG0M+GcXIBWb
# 6+kjisK581PSc8fB45zYm3GQ3B5L0uFO/gTDIxzr546ndXPjgAeItmO2GCvUGkdG
# tKCPXUGldML9Gq8EwYox5d/+dxba9rBhg6TLh3KxIK/kblv3MJL+PDnzYUdRRjA4
# KjYwcY5YVLY1ffBZM8OAE3zmdYfiLnoUbbsFkoPUcOBWpiahkNQtnAHoUPuR11Kq
# L1So716jKYI8lgG6YQH4wTbhCQU9J5uPN2UxHu3KsUnWItzBJSeyKgCWBGWlVch9
# VuNL6wdN4ycI/FFwsyYaLgzb5EaZdEp2FmjZlHLJ7R4WK3Mie34/L2Gz2GEpzfAY
# vMBM209EAVoIiwwPADbWEEHVH+mwo2eQKqe4eeESf6eBYVlR5HzmwNhy1nZfhhat
# tG0Su+nucT7eJKcqABxxrnU=

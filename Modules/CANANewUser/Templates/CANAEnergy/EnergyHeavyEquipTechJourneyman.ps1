<#	
	...
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyHeavyEquipTechJourneyman
...
function Add-EnergyHeavyEquipTechJourneyman
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyHeavyEquipTechJourneyman $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAtA+eae0pb6NO4
# NXOWT1TwNZqAsuodu3vLExAXxZh2XqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAOlDEDSjq41EniIupVS2Ns7YKMkHKW
# 54LofugjSXFAZTANBgkqhkiG9w0BAQEFAASCAQBiHPdE+0aNZrM1JDTK3o1h3kon
# nzifZdFTHPNFb3/92QxeJgYeZmEyDZTTQPinyvT0nP0Y0fzO5SJ4V+Raxc19r2tu
# db0yjNhdan9P1ZkFOjQkBW9aR/D0dnkzcODztodLq4c8oKeQ45ZjL2U0I2b5uSK/
# QbUKPHS2NclgF/oMFQtHHZzfEkK+IxTD8oWptzX6DvHQO1hH2/LhJZqorxdc6O95
# /kM2TLEId2WyJiHka+Or/DZaKA9GxujEj/MQf97zY6GpvVZHzkG1Wnl79lXQrYY7
# urQYN01eEBbWzLmcE9scHvbQzVvxOVEP7AQ+8sJZrUlXCTSZkgasSodYWr0goYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDUzMVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgnv5TQmrDNm/l
# C+gIG/MqohPIdvqhc0Vrls3QdzX3rv0wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAZbdA0+ecUpMVpGtLUBDhLKCOxhHdgdLKzuSDuMCh4
# aaUmnblFN2Rg0FyPKyVM+Ygsqjbm2PVf+sOrL69ws866whDPo4WlIEgGvgds5k3k
# qLd6jEFOpbIYeVGfSTOwClbacwqDyb7UIUVBnqFBasGEq/Ngx1qRvxERxoH+57wC
# 9aih/JHWWevjKGbaOYm/8Y7cCqOs+hjBg4lmRjmlzUMz3C06iaQkJewwOmWuLhXt
# 7Q5XeM9KC0tZKJ4cRHPq9hL1YYTvHCQYoQ8qtQwIN79WTrLJKzql3lNvjkTIy2dU
# a9EdpfnrgAO7JI1pS9zglR/8UgNF/QrZr0rqk2bDDHtR3H3KljJ9SrMn4NZkV/ke
# q0cecV2l7ygKOH5NHCydSxRULJFy2Py75ZcypIgEeCyAlo19hvKOiE4c8BEfL9Mq
# c+Stjq7g55FHdGzt5BwtDZ/6lCFhqo10n58BOc2GyC+ZvJNsR+lP7hdF6Yz2m/JR
# 6Z2vyCGaMPQmnN75iofstoM=

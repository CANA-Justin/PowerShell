<#	
	...
	===========================================================================
	 ...
	 Created on:   	08/28/2019 10:23 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergyEngineeringTeamLead.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyEngineeringTeamLead
...
<#
	...
	.EXAMPLE
				PS C:\> Add-Add-EnergyEngineeringTeamLead $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyEngineeringTeamLead
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDh8azqh2785Gi+
# 0mB31UkHqkj16jZxlOn7pwV5Vb6PTaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBwIs/QlQlEQpbBZ6z4qlkU8TVqkoY1
# 43QShVcGBqNOADANBgkqhkiG9w0BAQEFAASCAQCKXNPux2g1khOmNllG8M77aTci
# WAOJaPxs30etPL1bPVMKQCiC3LZVKjCsnxGiAelOOYffVQFi5T2GVOz2HgNXgoGT
# sfrYzLrHDEuuLSKdALcliKRQs0KA/9eOQUD3zrsZVT0I2s/WHGyXGcikMi11AN/P
# qlYjvYcH6oxkkg5rjMpRm8xRkJf2R34jFtrqSNe6mW06G+owJxr+NAmKF6KW4JYQ
# MJKE+wF8BgI7mDiULhl+WyMlqJpLhpPwss4M7Bl7+2+uP+kDVrOo0zVfXG9Y67zy
# 82+tGVyQKaRzleKIKGF3OSbV7UD1vBdFp2xTe2fhLWSlu7Ax/msiXSl8V/CkoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MzEwM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgZ693MSbIRIp3
# VzfXIMNYOmpnRliKZmQnAfvhRmJiRuwwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYC8QIqJWF6N/OarGkYGsQtLpMzPMhMjH8pNGK7A9MYC
# uvfL3gVmTlvX7MjlxNR5CYOYemdyxwpEUDFnc2hm35N43IdOOop4yfyb4jaj8864
# 5fTqMhlDEzs+rTRffRg+fFUJ65tfoNLlvFB6H0VSHXXetloOn5uDLo/Lx00KQ8yl
# H8/Z8u7luAvFwN89R10fiduRAGlixLW29F7jhicKRFIYBYzFxW74UuEOG0y9Udin
# hJ7UtsIHQ263+oVLgzKowK8/qqxNbX0EkKRE0xzOlbhHbMmHHzyB2reQEVg0+IcM
# VkS2zGy91s6yZhEkB9YR4E67sGGw9jdzVozju+um9/yIC0y/3wP4oltSmllVStji
# zRT5Y2Q09z4S6YLc12VT1tkfkbjAi4O1YsbaHG67YEhqBbcPtr5jzq37NU3OZcte
# /x3E6I03nZmqnNqr7/33KOhqbGW/O5gpw7QmuJcVEBjd58jEzMHPfZTo2kmnHV6X
# znwejFMWqzVps6KXuIDim1Y=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyElectricianAssistantSupervisor.ps1
	
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyElectricianAssistantSupervisor
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyElectricianAssistantSupervisor $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyElectricianAssistantSupervisor
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDHyZ5ZpIY5+b42
# A2DMUgABcWEAlurA9Dp90UZNSpGw26CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBOQkUL2GzRDFZIBXpS/Xt8Whrp3raa
# di3qRPfksCJfcTANBgkqhkiG9w0BAQEFAASCAQDEJ+RILb0PLR6rEObqC36xcmBs
# HJWG171xu6Ze/GWvCrC0YmGxZrLoFMaN2gpUuUrc4kPwI/MdHOIFlp6G6gZKGkJU
# U53ICoZVI2YI1gOHVdIzdd8kRK6VjkZiIHJLbziUhjwbujzpkRBLDavuai54frbw
# vv0v+YaTlrB11fAQGhfeO7oJgQBq7PDDCSHedxvlMtSJQCTYtWTkLfdAgu5H91yP
# r3r3QYaPQfG6N2Me6l1DSUhjijGnS/k78LuhYEC4iv9QpZedMIV5HHjfHnBKkJcJ
# EFvPoYRNoMXYcOV1RosNx0vKI+uBZBV5jBudE2lNBc9AJnSU3K4m4SMN3IRCoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjczOVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg+DhpnvpA2qoJ
# Qyu9NQEwyfLczDwbT7O91kXnmTm8p2swgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBRZ5wvtGw5ubw0HIj7bBg0xLBp2PEFwdSOPfMFI3hi
# lMvJ8svD/zOTqggj3EBZ+/ipFJhGeDBbc1JNHcSZ48yeOVvAPeRm41ebgiXU0yx+
# cCcnAuVj5RNG/Ee4y343YK74g549/G6K2aGO0KpK0FSNuqv6bOqmgEOt1x1IZhMP
# 08m/Suh5m39UC1X/UO1+pV9XzzNRRnhQBzkLGqsyVrudYPqOdHx7m04upPepsv8d
# 3KU/zaPopOfKL7LP8Rh+nDguuyJYtClxwXfBylD0IspuOHqRqDrAGjhyxKkkCIC8
# xdagUjtsJg6iY1qvv3TeGsbMpRu4E0wF5KlFp7GdMqu0CD/SISKuiOXkWRq3fKSl
# GjbX6W9sG6kdfZFSrizMHROxWA0OxWdYn0EpB5g3xnbWDWYBBSk4vOhIp+i86UMT
# Gw2xLh8dfVGbjjrkTFtwEhiy8UgU2QxHw1DYF9lI5CyNTzGNJpomNESgZrBa8wyk
# KdNkhDOpjl8Mw2YwYp81Iik=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPSEApprentice1.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyPSEApprentice1 
...
function Add-EnergyPSEApprentice1
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyPSEApprentice1 $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCgVjFJ6NJJigvw
# +Mfmd6heUbjgqbJ6eGVAzlRot6jcVqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDEXAYFs3ALahwG9fDLj2aomgqU+TKd
# h5Pmn4zxRyMMuzANBgkqhkiG9w0BAQEFAASCAQB7g6/gWSU5qcYS7RjcnUsDkSL6
# YKOOrGLOmIp/EBev1/tdR0ePXjosA8yPODC2+AThuRscBVutFQzyPG8s4oZB8w5R
# YNcDr7YxtchEZB2cHmZkmyenjEPQn56v/H5paL6Y76I+YwKvtf3eWxMAOyOu/hwN
# fQ/FionQKDk1/nsXOxvsBCRPfqdYDMlRDwEfKxcvmYAbfOzj6K1Mc1yFccCLAmFh
# 6UmtaPs2CgYiQLIlEImrhXnfKnsB/z28inbyGPKJaYcrkZ5ebGRGOueQBPLWj7np
# s9v5wJ/p9McEkOu85otBOQN+KnjTMV1Smb0/yFaeNs15hlXsv88dItqdRXwOoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTY0MVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgoTqjDaUfFR/C
# aakzk5Hqc4BSW8SFyDy8qi9HnVu8Re0wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDFWskkGvwzfoyNujK0W7Q5yxV+6e3Sgy8EnYbxsUPZ
# aA2Y+c+FWbxqxHjJZ+xQhFsUkiYUycUK1emPoQeSLEQPjqTLeCjKN4oW93TixKGg
# GGF+kcSPYCKnYxd+4ctLgnYgUqDCBfQIABLurbiG+D+7/S24dIhq1J601wNiejz4
# idPRL8jeGaypxLaNWsacz94QFC3lwJEuaDgMLZyhqJaTR/agIzz/mdwAzxmymW3b
# xnwhKkSzYI+sAYE6n/M4rx7l8xHTG6O7KE5cf03xS2Z8hO0/ZqJ25XKObb3aJze/
# E0rvddWBaY0FgIGnDL9HG5UwKT6EIHT6iUj1J7fucCHBAPs3SkGs4Ap1lBq5QAyf
# YCXz3O39YQX5wMbe9w0+UysgSlUHUQnoGya7NojTd4WBTQqvUNqxXH15yQsYi6K+
# EcGVIpLmuiLHhofHbip/8rHhWWyzM0Sd/xPJAZResDiQyIR5Zl/r1i59mcg9JlYp
# 5XHgx2+4/rV4S2rfLDYxQkY=

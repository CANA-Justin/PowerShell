<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechLead.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechLead
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechLead $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechLead
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAWdOWhW3ND8uwm
# QmTqC3EIg1cMeYtdh3vjq8a3Oc64QqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCnKwQMZ0rAmyhRcv4q/LMHgT7/Lc3e
# qi4SDEOnrfFxJTANBgkqhkiG9w0BAQEFAASCAQB5KGiNu9M+KWxBzXVWKH1e2zF8
# S+mzmnLbdeDao6QuUs4MyBcrHTeSXJEp5hw0Re+D58bGunNf00pJjRI0V7wI95fz
# 84DHdh7T4p1Ex1pLq5HGc+bEa3xZwQ/2UhdmtE1/ZlXu3DJw2fQnMzvJyaX4pSxa
# 4fKNZ6ypP8iSJWS1rOMC1AATPBhNC8wHcwi4Bxdb+McJnKRO/e7o734iDSwWSkZe
# y9+wGed/6LF9Iaq2qK1zzTf8FKzvzbf1nuFrwRJM5t/frqyDhsovmCVPTHvILRw/
# wLY8xflpB223pHaEglOrbLuk/i/XxCE0eJiUNWAQrMqjGMf+TO1M0OZV9ik1oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTEyOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgEZx66dRu8ZAU
# sos1VBm7t+3KjZe5zkuAQxjUvUraM1YwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYB1Rr6Jc0CQRsTSd07R+a5Q5CycAbaVqPuuxBbdrRlW
# BWZi5MxY5A5H4nHsQ6JFvRcCSrqjCsSBYpyoi9fNa1LCB8AycDMV9sLYB9IgGB+l
# b6J0FyvT4lDOb4MXFTTBTuYt5pCPdzMSWychkYXR1GDgSNCDKij/ACrHT00xjmKY
# ///MrY6YgZBvB3Bn5XLXqBj0TsIs7m/KK+fCavwiAJPwCaZbTFh42sMWSKF4RALu
# UsW7BNaDgVDInq7nmoQ8OogRK+fh/sjZMshqkCrc4i9mBbjBQlbqTnyLg7KM525N
# 6dZG7eKKFqpbgTrbOZguZFUkE1q/dRoqpIzjSqwFphJFJKsM8Qja2j3Zc8Gw1W5v
# Ky4dDtCf9N/11+gYua2jyYSYpepGhpOSyPkSzJOl61KkEj/y0/IRn7aoQYfrjUSx
# VRcRKxTJUV412kJGkFQNkFCF9htoyq64cvs/NExIamf4+bUtPf8ttub26VvEM50x
# VMkYNYoXf0fxqaG7APSOKFI=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyAssistantProjectManager.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyAssistantProjectManager
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyAssistantProjectManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyAssistantProjectManager
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('SP_Energy_project_managers') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8BrwibnnwP3ft
# lefoVs+cRhac3UGLvZ2+WkzMQoiobKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCxlM+FRAzse4Bn0oJLzbtgH6vId+lr
# L6YlYS5QUgev6TANBgkqhkiG9w0BAQEFAASCAQBzLl20Rz7d4ZtZOaC9Yf9NsQnp
# eCAWmmTs53Q739FTbMajArFBATC5r11c4bZAQWQFbtL4UBYKx3SOlDr/C8lN3ydS
# 35Ey6ofm6drUsgbBM59plHqtAP6NnzNNfNJKnjNcwnuJSTJqQDwNyXcMsHAA/R9+
# 6tmQrzGeoCQ6GRLhAEjF70s8qmKxyI02dTp7RYU/drM0EWafxvUuVdBwCMUQ99Ob
# LReO7x4wZ7fTMbfHQMmEYSu8LFxGo2PqKJiIiB97Fo0jaJtDdOFCkNInRgSzH9Ag
# 2gNM+HuoHC7Fmh4/R3rgQrmHiKGChmDH7oyitCzgeTtz5M7x5S8JOjuqi8QgoYID
...
# hvcNAQkFMQ8XDTIyMDEwNjIyMTA0NFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgd0oLucAlnG18
# 1FwDhfe6JjOJXdx+c2atMp4OIeCK+KowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCK3qBUV6o7B+TnrFup7/xeQqcRsU+mp2CP7Ae1sKbk
# FXwGT43QSs9wlOrJamdusk2cc5KtIXlaR+f8hATLHcXH0E9rUN4ERGyCkHO0wsmr
# TgZguDH1KYUwcJkKMesia//bFSyolrxGd8E42E9yF6h52t6/PHuz4BXBGgpU/BeY
# NFQ4Emc5Bn+qCDhy3ETa/hkSJ8Bj/dClnGOY8MWyRI1O5NKxZkFlL3a6WIorp6Az
# f3GddYnOEr6f+VH+HJNKvzIGxifTZNTUGYVDsVlYrLEMOtftBdgAyngNmXYv9pqa
# Wj/VbL+YlruQNEomXAxfZLBHz49fl1wl6MxISnubSvUmUvc6YS3oeFlxAd+Ucgh+
# ncg0I77OUSDRfaKuyMhWX1WPCKY8O+y+x7vR4V+dln9g9r8GLaZh59Moddx31GEy
# 8GGSkzApylJ8PbqvJjWQmocLUYZ9Ki31Hx1AZzoENWVn9RzeLadoqP8gZm95Z82o
# XouI0gdWDsHmQu0pavMh3jQ=

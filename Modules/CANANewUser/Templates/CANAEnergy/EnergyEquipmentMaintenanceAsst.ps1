<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyEquipmentMaintenanceAsst.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyEquipmentMaintenanceAsst
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyEquipmentMaintenanceAsst $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyEquipmentMaintenanceAsst
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCYmtWGdHsiMMmF
# tUVQlgZVXKTRr8G1VueKr1PsbHTowqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCA2R4bLkvV9hwjt/GJzT7t2/pJZqsZo
# cYlAlo0oLm3zSTANBgkqhkiG9w0BAQEFAASCAQBtqXhiUMHvS/XlLqwrelviKyr0
# 8NnmC6KhTGWP1WgthpIdfwIww7GK8T1wqMWfCBZGeSG3BDfmCENwU5b9p+6zATyi
# Qd4s8l8xCimPf9KCUBCZFBtFxtYtk0v55MqnVil2TU04wgpDosnHGUTJW5jatetA
# kyIEBXICMqhs67hVYOPnm0Or2n0ZxYTX98Tv3CGM+uy+cs0lxnpP8ZkmTNCmr98I
# 2wyj2RsX6EEbCp1vhO9trYQr13lG/Fy8UhHpfQ1Rf52BhqZCNRfuCMm+d13/ODj9
# 3L88Fh7xNsuSSxkCKgTiW6ShkU3eHhex6cMl+ZZNRqx9ddUDcLVwUAhlyEztoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MzE1MFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgYWRtXbnYDQSv
# LdYaEaf7cmW92GFS5B1jYtJEyu82umowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBIUdsSE0HCkVO/Ya5S3GAlYQddcRgafU9WqjAit5Ly
# /Uu5PUMWvJntlL64udiJHsut7mUWn7XNEcfC2jojD/Vrjk10ehT946ENX4P6TweY
# jffVWtfF8Eu+D2A3Y4bowSf8qqYlEAEIGFNjim1x28PzYm/FY1hXBnRIWRVxm0Rt
# CbP8sqqLLSomaac/EQDjptOkvIl3shncGqFocZCRcHfj0svCIm4X3T2orsz2a+1V
# MhwM47zdf1Qj2q75thkcUmmUBXIp00gWBw/6kZipZVyAbn3OFtobcj7y+Gm2tov5
# Tkdbjs8k4s845b+QTnTfJtXjlML//TL3yoGXreq+ePLpfM29D8yhXKx3eC+m0Pc2
# XVomg1lbYEuflKQb1khun0QibLsLJw2vnX8ObanWw6DggmMGjZtioeQgPDwi1cQT
# goTSuadFdvb7SzQtUc+6ziFDUNfkh9J02bUz+zmH5hFmItaKKEfi0LUQtyA9ELcb
# qHzngZY/NUaR9SRbDs/OIsE=

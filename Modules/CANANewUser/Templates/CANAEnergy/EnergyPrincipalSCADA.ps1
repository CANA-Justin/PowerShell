<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPrincipalPC.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPrincipalPC

.DESCRIPTION
Adds the user to the groups defined in this function Add-EnergyPrincipalPC
#>

function Add-EnergyPrincipalSCADA
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyPrincipalPC $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAD67CJYhicnPMj
# fFR9O+gNFxKWRrrWyu16BfIua5FzEqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCB1r1K50/Zbcaq8XClM+a/7zQM/gtQP
# MlLiL3XsQmKyqzANBgkqhkiG9w0BAQEFAASCAQCqE1DpGXQhaJ7SSltzSHCG1es2
# D9ft+3/AyTbn3E67+oYmMQePzviIV0VjN+0XBSWXkElgp7vPjPQA6NJzm9uzrqCF
# WQNDDmTgCi4iBCNW6h5hN84Mg8C0focPr1ZDxZ9R+v6+4emWK/TLlxeX8aAvzJ23
# 8PFTqSeSYYbm6jv1BGU5pnWwxLwV607PJkXbj6hK/DHe8UGH5Hc+nnt8gE6ENlfE
# bco9duK6pE2raPADVpKJiRN96G6OC14pexlSUu/RSw/u0byaPUCRtRmdaJLaI7Mq
# ltBYNIsxwfvRvsYFDsumrP+ZgBfxJY2FWdK/u0tinSRdMtbuDy1PCdsIo98yoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTI1M1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgbF9H7G+nuHhG
# nwiPOzs4JWJepQ0Ssddrh1j040Cms8kwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBan879InbacakkGehi7a3JPAFyZhzm54WZuQ72tmk/
# o/VTMOcYJ3Rfjf/kBBNJxVoP3fDzbHkWmNj87+XTu2qi0oulgDGTgEqEkPUSF5X0
# s5eMBZHkpTAi2PboAI3NN/gMiKoLlL4oxRbj2C+zPRkA1CHW6AJTLaghV8ojbtzf
# EiLGkvL1gHuj+lXjViRJp3l4m/VGGePJv35XUooeDFz1PSVqllNk9Qq8vSPCgRoV
# U+WylVihAj2lfCMYEdAGj/VW9lLyNobMgkviqPu7689phh59APuaT0pQek4lC++4
# SCu+TRbwuoCW1abJdF0SI1NC9A0rLSw3h8Q8p+MdwFrmIACp9gAlZNPbzfvJX+hv
# Gcz/z570m1T2pwmJUOU9MjHu2pY9IYJP+4I+MInGg37yEMOBZSi4zWbt3NvrI0u6
# 3N1Mhmg1sujTfQUgI13Wzpb+A2X/3rZKPPcOZJuVPFFDSHQx1ZjzVHvGgyMuQhUR
# FKyu5E8a/pwlFqWE4x6o3d4=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyTrafficSignalTechnician.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyTrafficSignalTechnician
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyTrafficSignalTechnician $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyTrafficSignalTechnician
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBuCrkeLZavZG+4
# TF0a/9c44nSeb/mdlAAf96gIDoY+4qCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAk5aDAVJlru4sotF26xCRIbgR/8E+I
# gGzjMRRfhZBeETANBgkqhkiG9w0BAQEFAASCAQCl0mpSsJtNJ885eFI946p7lp0u
# naXVOQ4zIpniK1Ia7GCvjcTDUEyhyH3x/MTDsyGqnxG8F/NXWvrcF65epq90cwh9
# aVBbT5eznLDjbJdWAZBddagCcUDE97iOvq7uvoXpxTzg0Z7EQyjjQ5DWh9KsEPpE
# o8PzRv0TCadgrB5jXn+0jg1296tLx6FBhMGCmrknphQLSFv7AhKAvpCyhRiavKx4
# dVIkzkFs1duWTlsbt0dr9WIaqSzhy3A4Cu0HZ6HHGaNQfPhTO0VVhRjsMIC7e5cF
# 7jSZW64cQJTPXFsZ9n2G/UkasiUmFx1Al/s+KthiBGULZdEA3PymbRWdYWtzoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE3MDExM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQghVkFt14CIPPK
# ZT5VAbPAnaEfakJnzaZSpF6r8QCp8nkwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBk8VOflAixy/oeYCFz9RIbq9zBH/b7Q9YXusA+Rb8n
# uoANFOiTG8aeJcSE7JBSepkiy/S/ssHDxiySAkxEmY0b0Sn3ESFcnzVoooQsvKCt
# uwU3a/n+2jt2NNdky8Y2jly3DYXokPCEtxb2r+RZqbgTj7+ueF8NwwwhJOJv9Bba
# oLUSJGvvJw6FYuvruTU1GM6qOwYiJLNb+V9utn1JffAorjn/6kki5uONePMUgqqw
# cXkh2ncEpQwTbq+1Je3qWaqdQ2Ss5t9c8aTT0uwHKAx3FF+vQu1jDUT1sNYujHa+
# XjuVF0JN+2fInxIZDvg5YpgHrHirxDMkZdhbpaPHA/DXk6BSAYIVdgKZvwvslN3D
# lB2LGwFo46w+L32fVy6QzKtKRB1lm4L0WJNeuRDIFcMlGZIL5IvgN4AC1yYO4dfn
# PD1/t913pi0a+Ur90Y4youMTMrlB1yLcWWYx9uMvvglosnwdebJlsmZxKtxEgeII
# dR/76EnME+ypoHP121i7eFQ=

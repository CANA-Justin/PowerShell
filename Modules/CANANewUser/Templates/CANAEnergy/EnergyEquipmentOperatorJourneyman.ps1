<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyEquipmentOperatorJourneyman.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyEquipmentOperatorJourneyman
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyEquipmentOperatorJourneyman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyEquipmentOperatorJourneyman
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDaPo/5LTCt1KKO
# f+aa58vpalp9tfoNIcbFVhvV4LEyZaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDeIxGzRLimck5cKhnhoA9ST4/EwVqk
# LcCJ7/lFZCYwEDANBgkqhkiG9w0BAQEFAASCAQAOa+MdUx8UkYq+yllbR0R4jiBa
# TYgQarbvYdPR8l8oi+j/UFkw1H3k+gymllenn33gQDXqloC7GYFJzd9GOT8DU4ji
# 4gpcRNQopXtxL203DxEXug93KMHY6vQukVNAYJh2mSPLRD7eK9FzVHaQXXnnRQ6f
# Sexx0nepWjgVc5WB8xe14qasUvxSpDb51DWygU79WNDGjQhlnhTuZqL1AMofsh/k
# DO1PYoBSQE5abWAFV4HlnP4TU478YvmK0VeA5vR4DGzdlt8RQnoBfkPuUiAuS4J6
# iub1DBdiGn+3KWBPtRPX4hXXfNOjiHOoQBASCsupDiEGa1Xh2XBUq8pQ3Z5koYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MzI1MVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgKNEBysEGhcr0
# 2d0Q2ER9oIMSzh1LUl9si0uALCV1kvkwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCKfE63drd+AGaqgDaEhUcyOKpFAduseCMfRjuLaBZf
# KFV6p+zOTpID1ebCzBD5JKe4Ysnqt6UUXw6eMxIf7oIQhMS6ksFmQqJWs6v5jNDQ
# 8YnxcGwCOdU7JBSNyIzf81jOy09OQzWVpzONR7DDSxC73FOQHLrrUO9flun/3tPq
# ayoEz3+qOgqrh2CrbKrtpESPUU5vgYky3uUE0LQvZ6Oigu+xmzuZ/e9JNgMJw/GI
# Z8lYL+SBenJxQpDB4SJOxCoZZcYGywGSX6SxoipOPK5hMGSxTYwMzJBx5bP2c7UF
# /ZlE22fd7XqaCqS7w85n6u/uQOgoazgSM64O8+A9/7KCoZNdO51R7/0e8frUTGP6
# 83BS4n9U0smjtYYx/Sno3XypJXd7KpvSP+zDn8xN8D4/3NhZrviRUTsEd1eu7lCj
# CGf3DWHSH0GUclL7hpdGCegoFvox20Rbb3CPBviyYBAAILcqsypyZzrPBcztsCks
# LBhWwafGVFo5vAPfK1xyl94=

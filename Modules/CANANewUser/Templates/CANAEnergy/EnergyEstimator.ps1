<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyEstimator.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyEstimator
.DESCRIPTION
Adds the user to the groups defined in this function Add-EnergyEstimator
#>
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyEstimator $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyEstimator
{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAppT3hScuFY2M8
# JSDLooZwUzIvyZG/IpEA0V8bY+RbaaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCD84JNhqtfZzxz/d4eGluBzFjkym2Va
# MWcOz0ZYUeh+IzANBgkqhkiG9w0BAQEFAASCAQAHxJmKhPARncb7RkuYQZDFZOBT
# 8tScw3PA7EfRQh8yYfIVp0dTVuInGBdjcGTgehrKm/tIv36MNRwM7iBLiTmYvqD+
# htpUQjVPml1YzfVevqDqkEr3giPhTHTNpuxQZ9PUTKoQGDCE1VZOiShQk6z2F6vH
# VdtqFCTMUFs3EhMKFwQYUmITjUJauwzsqddwqRQc4GNRHCbPHZg//ghY3dhz0aNr
# CpzMcItLAQx7mkgm2dBpONYMWUoQoN0BcITc7poku3/uL/G1LedDtVbcZSd2dy7r
# hCSLWy/aMPdcU55umN9uMiqdwA+KvsbahjqVFTr7NUBbV8AYK+nkoUbjb9auoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MzMzMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgACgCHIci5Ja5
# Kc57JKU/JD/YioULXoCgYO5j2YD8dakwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBh4teb1fFFUXzHzwY4bEkISiv92TSl/fCgODU2wgh3
# I0zq2z9mg6Pajt1gdU0EmDfKbee1ozlH3AS5qmohSwTWa5xNVZBL7xaPlf6iJw3K
# hhFxYBms2kxok6Fl9QpBqXk4n2QLPlzuNIheSUu1wRxmkY+WEVex03lfFdAeXf+s
# lOTbPP5LrdfQ8AEi+tgOw583/4cI6isYPCuMXxQH9N5JUnu3XtiKOqaDhHmR6nqa
# vOup5387xDpijWL1WGc9Gon4A0BiUB0fTU6J7AByoyYOLsRowIGNJrT10zSicFL6
# mxzM0blQLxVqD0vnjUmjv4IfIpbL6Zw6eGd7JaAwF+BCWbEZYifr7K7SVyqHJpeh
# sCAbJixXovykpp7MT0T1oDFonek5Isr8BTePJRTJbqNwdhzKjWCr2x2uEnQwuMAm
# zIuuH7HNiqPTMQ3Nhd2rTD7xsCo4p2ZVvnE0OwuYDL0JkIvPKyu2rLQmM+JG9Wgc
# lzFNc1Ozy1RWPrXJzqt8hnM=

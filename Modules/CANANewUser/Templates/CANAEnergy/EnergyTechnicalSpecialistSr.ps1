<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyTechnicalSpecialistSr.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyTechnicalSpecialistSr
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyTechnicalSpecialistSr $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyTechnicalSpecialistSr
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCARMq7jgJEaKmIm
# Pssy0+fvbAntYZcHPTqyQDX3A4A5l6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAj4DSA/PlvI5v9/SZvoouchprArklJ
# qjj4AGabIViILTANBgkqhkiG9w0BAQEFAASCAQB+KUC5/uAMhaUojaC7izCiWR+I
# 01BB6o/JOUJujjf+lHGNPoGyDjL42AWKaGPIYhXaC2A9I6PcMQlR7KdZ2RZh8u7m
# KhvXxsm8L27KnJMicISJ3f+Jfl8E7SFzcn35joWOLJ6srN4j5j+0itVVBXStB/O1
# k0J/aa6X06a07X/y3lgNwP1nm22QWks11KftcVUdM1bg9oSWVXywZa1ssAIHiosh
# 9+wPYQtMDY7cbYu82VVCnQ8ERVIH9qjKOnGoEGT9QNSNWmTjqxiWvekSHULCyiql
# Fe/JiefGCg9lYsvGm8yTxGj0ampE39uawDJyKjz7xDM97/1UAq6ku3rwofPHoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE3MDA1OFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgGZ0UdSvUFkPN
# lZrsPAJkH8SQnsAYxElRBsl2cZISmg4wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBx+IoBTj6W38p97DSfkGZWxLRNhnimMHMFrw3OzsPS
# nDtGx5bz2tzbnC3+8zebOdl0S1lBendUvYRUd0hyqnrNH8NVIWR+moB+xRF1c4N5
# EpCzXmxBHpwDiUVGrF8z+xJe7uZnayIVKbRdFHlFh909LaoSLt7xl+tNUSYnGJLg
# DUNq7eyNlD90TL4k580vBoc5yS92zEjdN+aS4cJqly63qMzKJLnMd2A6A+QFip9E
# 9T4/BAZCpTsSpXWexAZNjzUEMw4fBPtl92Vm2u+4m/a00BFJusaE79yIL/OAZrx7
# /VnT1hNJsb8Gdz9WKuWVHdPzzxgTP1VZ+hc+4F4/XWvoqjYjhRTpBsP5T4u7IDbG
# wpnQKYyCg3QyThqF19gty4+GdDaywYbf3LoCjq9zMkuDPJcEWxYEosNYKm3JLxDO
# PxPyy+bUV97Vy9BWIxiPFkImPjz1iVuVw37f+7kcK1baEnTGrCsYSM1e8bhhvttR
# 52Y6E5N/zwH9kOc+ejZ55Hk=

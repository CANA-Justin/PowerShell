<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPSEApprentice3.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyPSEApprentice3
...
function Add-EnergyPSEApprentice3
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyPSEApprentice3 $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCpL7PPO6BdiusO
# 5DPaifsFBG1xRrNXKXh+622gOE+hV6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCk10Eo8RZczGhcerSrrX2G+90ze4xv
# z6U7japhDL8yOzANBgkqhkiG9w0BAQEFAASCAQANLYwo7MYGbUh881px/E0YmJMh
# Zh5FoWGrn4SGCnnxmUILaqkgAmXlPnl0bOmY6qQDhPO0IXpuXI/jNw5zEtwwRA3k
# enLcRadcriDyiGOFRahxQH10BVlUzNLiJIzmYv7wItmQNpMMPxhpBFZ4V+bZ/5Fl
# 080EigEVrx6X/DYvE2lDaTpjNYWVpmvQB72ql7RHiiDWFdhS7Ae8OxE9qezqVf9u
# pvoSPM0lfHYq7iRlWNqcDLkUXaPRfwiP6R0/b2RoD5lC7feLTJsmFkU3MQcfSPT7
# vrlSJZdeYyUGJNOLc0XWo3F48KczpCZUaRkfPHNFXaSa0QON5dI7F566HXPJoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTcxNFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgFpKpa/PpNakH
# ZN7QzGXan7p6k54doMJsoopgjZwc4FQwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYA6B9d+UbudopVoJta0ghdvtRR1j5IqJWSwILtD3MDE
# lbjaF9BAxw8RjojxOS9xd0NodZAGEQdaoIuGbqAZHoARO9u22oN/FKUI/IlJg5k4
# 8LyqiTw57NRxS6wHFEu/jxlR53RsjU28ey7dfT7dT4JMMseqaL+crCNugJ2RhWt0
# TlAsqg5ovvtKKVsvUtMF4qkPOeci1QHIchoCb5KFmHZRFr9ss/0nRvF4RPbzifMy
# nLSnDz+/yF8/6NMCYEkwEVbtAYZnPX2ljP0RmDWUF3UDcVl/dQldNW3p3FNZztkP
# EFrJO04x1MlMO9WROHfz9D/G4Dcic8UWycoCpRTHV3LDXFqBBgcJ/Uc8OywLdqhz
# 0nSoWIUKeYzg/BrXwnppzw3tDW1qQ5LxSGigXQaUb27qJJ7qqrwDSSwaJboFxH9h
# pA+YizTIGRBc/pgUy88Xb+DiCt9yv2E0pCPWhh9JbRSG3tavZAg3THoBkDNKzBrL
# naF1XzwyId51x2gin2F4XNk=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPurchaserSr.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPurchaserSr
...
function Add-EnergyPurchaserSr
{
	<#
	.SYNOPSIS
	...
	.DESCRIPTION
		...
		CANA Energy Procurement
		CANA FWC Users
		SP_Energy_Staff
		stfa.CHVProjectJobs.JobNumber.RWED
		stfa.Utilities.Project.05Procurement.RWED
		SW_Viewpoint_Test
		SW_Viewpoint_Users
	...
	.EXAMPLE
				PS C:\> Add-EnergyPurchaserSr $Username
...
#>
	...
	$ADGroups.add('stfa.Utilities.Project.05Procurement.Read') | Out-Null
	...
	$ADGroups.add('tfa.Shared.Read') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC0w9VhfNBlVWzm
# GcsDv1GbdId+8jKiLwo5crUsNAptVaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCAi4FSOIxt23rDDTCpRqHLXMT6PCXa
# vhMTlIojuGCxXzANBgkqhkiG9w0BAQEFAASCAQC2KAlZf05wGudAVkhtwfoTocX6
# LdAW9SvJ6u+zETWU8ZHjQezYvzt3exVTZl8qf9XaToc9KdfPGPdW6RfULbw8oOXK
# edGgIFaEA1InDacE7FaHwqi1KXhKDsGF9Qsyyz4/Oy3QD7J0FoFDHP6xOoMRxl8M
# V0VeUTPjKJrwv+5nfRw2xFU0dRY9TGU981pXCbccTkwDuGMDN/pm7r43e9kFlcZX
# XF2DCG56TfFlpSeA7AH4+HsHWaqcEUx5DC8piaCJ1PxaXYJCyG6BzfDkCPPQnK54
# BCfl93JxLjeQX/YguPD1JHvRT6Lin9anY4U1KlYWIIlLr7uM0C75BN1oU8xroYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTg1MlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgbMe224PhZuU8
# oH7LnswaYsh/nrmByMA021uv3B6mZxowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDBdeyFsNYPL2ApSEcZd/pxJaGGXdQa/3DOspLktOeh
# u8U5zTK4fqwcw3WluYGUNRE2mO32htUhppz6Nz7Xe2BU2AN9epjEsNxawAQmKEg4
# K/ZGO58lmOW24cREhgJSFNH2MDnLmq/XZ/YN+UumjvJTmkqZcjlgYt/sXVEyEENr
# 8pd99paHs6AY/dsZWakWzPpwbHHSll+PORS+A7684bw1lRZcQFHPiVSDpCW2jVOy
# CyiIEHuoJGxKftMU7c01X+FFgWIlKxF3zoTKZ+CLYi4bauDk9JWhgU8/nVaMFVDA
# Ws2xSKvsG9XzcCBFtwC8acIinWOwhAYN+VaaJCOLxXq7bfibf4Qp8q69UUh4x7tF
# H72QrzcwlslgECtMOIu7hHVbKRyYurtWvNMfNpytP78jCfLEfuhshmKyxY9Evi/H
# dBNVMTk9pw4OmABYYhn5qdTyp05Syi9dq2ZuAcKL8N09T5CLosXRLj2MxRpLdg2F
# yK+ukij9pQsvw0mqgnPanxU=

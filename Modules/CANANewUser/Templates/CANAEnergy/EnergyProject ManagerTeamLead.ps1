<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyProjectManagerTeamLead.ps1
	===========================================================================
	.DESCRIPTION
...
<#
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProjectManagerTeamLead
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyProjectManagerTeamLead $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyProjectManagerTeamLead
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('XenApp75_Bid2Win') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBahcLomZ2dk9tc
# q5vyJFHOcDVQVYCn1XFNJreWBVdRTKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCedznK6mF6tvTfFHnFb46PgJISkXe/
# tM9ZJIHh2HNfezANBgkqhkiG9w0BAQEFAASCAQDInEB/zWDW7Rfvxt0xBPZ6pN6K
# +RFTAhkhgz4oh9M7gfX7GSswdusNLT77SxZw6RlmIohmOKY4pFeWwoEWhBZlg0PY
# 0AQEWkKACp53aBOig5ixJvDgN3IDRRcjr4JMy1Ue6vaJZiZbUcIbqcH0ad2x8I3A
# TPibUZl23+cCaQ+/sgxZSDTku8NdWSjRsKQq1SoaekznWUMbMdJOWSatW6expMOL
# ighROBWhCtaOrETxyO2dBdkNVe+CnOOyiKpcBSrIqp7vR+eMgOIhg7w9xyTJQM0R
# emy/+HyQo86OI5B21oSYfgjck7SgDZVgo2XEMn3LrW3Dq+2Y61mpeavFbFWPoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTQwMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgoe+q7WpwGTYX
# LemqqmP2Mm3fzhJFEFgtOiIRhISfkEMwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCDn0z+09GqSugHwKQKYcih57S8xj9HiUr+dfSgvHyv
# ZRrIiEsAnGmxThzKLDWiWkmW+QDms7jREnplQEA8by0hxku3hUTvTysKY7aDsSJo
# eaV5+Ds7LP/MdqG+NbfVAvi9tovd3Mdnx2+z3efP8rjt8o1jtslLM1ZZ1SiZdfe7
# +LVghxBNO81lG3pCXNmQZLs6QVTVTF8Plycer5eDSihNIaAL2jMpGOj4ZftDLCM7
# h972PBERACmSryY6xHc70dnIOi8zbWMYB1nCx7ZogDm06JO+MI523pduTb2v4uTi
# Oy5rJrZC5sCAL4XW7FggpOX7xtEfhQWlzP6JUVFmHOv9gpyUelUTrUpdtj7tA+9L
# 05P5YTRrYKW4smZb71GWaS3u15qrF0qauiFz7cpl3fQAKCPvgXbPEyDMNkf0PL9A
# PDsIN4iS0m4clUoRnieWnt4RdQ4zZOwsTWlfyyZgRMDQM5/btOPx/jGwZIr4j4nI
# +oYfTGYUIJZRpGAFDw021bY=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	05/29/2020 9:07 AM
	 Created by:   	Justin Holmes
	 Organization: 	CANA IT
	 Filename:     	EnergyProcurementAdministrator.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProcurementAdministrator
...
<#
	...
	.DESCRIPTION
		...
		Domain Users                                          
		PF_Accounting_POReceiving_Permission                  
		Printer Access RM111-Panel Shop - Ricoh 2503 Secondary
		...
		tfa.Energy.READ                                       
		tfa.fleet.administration.RWED                         
		tfa.fleet.drivermanagment.RWED                        
		tfa.fleet.shopwarehouse.RWED   
		VPN_Access
		Drive J - Business
	...
	.EXAMPLE
				PS C:\> Add-EnergyProcurementAdministrator $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyProcurementAdministrator
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBab+tR19Rf44Qp
# 6Kq9GyjskSgjZDYza+HYdvtNd0hgyaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBBx1k7emUk/IBZmPdAQHdjIszSuAl5
# w7DrAS3gtNSqOTANBgkqhkiG9w0BAQEFAASCAQAwLEqgO10dHQLMebAtOnX6lVhc
# rrTw3RS1C6yxzmswDIjDdzLHn4DhnzUtGd3tpza7GUVCwWP8399wwlYc9R5jlaN5
# PyxbQFt+8zX3bGtCbKy06Kaa7Kee+6SUXfJ7incYhb/k3QvnqmnrZ/GLv/kR6bgr
# o6mpJGCWyCNd+Qw0w5qo8o/MPR3k8AAKndFVleYftUbuNlhYO4bxpgBW9ROrpYnU
# 8tOMHLTsrLHEqd0cb9s4f0Efa2Fe1HooEvmFIcz5MUl/cWWqKDqckLPd1FxYLcTr
# GJdQZTvV/63to++81XI+zJVXMKSFhR7BUrXFZ4PeNa52MvvM+Hwq0L9z21cgoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTM0MlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgBJsgD97qOb7W
# YkuPNL1/qlYnm0OfbIOzuT2CiS1WryowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBdIH5FugHNnGGhIHKTgLy0ZqRxj/hYVDramXuJXRtk
# K2+Gqy0Eld69rlsB+LNkqo4FogME2KM58tIpj+ToW3yJ/J6sshRhM0WMn3BLLWyU
# CYupoPs8Jp6D5zdZrTuzjpnttLxXl5dTPYBwSCS7uVlCZLNAF+ZatMQS4IfGQtyE
# xAFcOqI8aUDe1VlDfR41Bof8/JpyQdtzHoe6jZwtmqNJsiIsFc7aVeWzcbbtTzlD
# sg4Rn5vUFaksjqqw8zyeSxBDzEgqx8ESTv0RG5sqA7/osqObmuFDpcYX8v3Hxyln
# 5WwQca8tP5edypDlPS8Cg9tGXSaAeBtRN2WWuJpYv2WMzNgJiORNfL5zXX0HMxpl
# UOp9Jtn+yXWi+FndpX/FtpX7+jYFn4U8nftMJ3rLi93VPzPxppRy1yPPZVEWjs+r
# GeDAXXuHuOOxiKOflanoUPmCUXlNeD7WiDAkgn8cy3h5jwPUFdivPBwyUGVU+4UK
# zf3esbOHAFi06uzygPnb0h0=

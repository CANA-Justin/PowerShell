<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyWelderJourneyman.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyWelderJourneyman
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyWelderJourneyman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyWelderJourneyman
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD24zS4Pa4mir+h
# j9f1dNv6529fYoiyX8jzU37dYSq+oKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDLrruk7AA6Rk5aSWQr+mLVcTmU+yPU
# di2oMKda6Hhc0jANBgkqhkiG9w0BAQEFAASCAQCUxGK5BSX04hOg8VEpZ3zuVisN
# 7KYtzlwSs6hYYya/9tQYhQ8yAy9JrZr5IU4pvIN8Yj7QgbJ2l4inuCZwjDy5S5Zf
# +LcjIEFSzYn1AItElgLC3sg4Ke4IatshKcisos/ihGgB25S2n3B4znFXBgMtkqtc
# LW4TRKBKDVc5TV4yHnacH7nbpBcA5pB60Qpa1SoZlckcxz11R7Y3sfDEl9Oe9ral
# MnN3REdY2Z9tPRfAuw2/buaRX8gMx22u1wqfoaIXF8XcDtl4VwEF+9cEuYQT79xH
# Ax1PtIGEbxu1GPo/6uYrSMKRzmuRChV88gFwjODal41Zct3dmPuY9WVtLuruoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE3MDIwMVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgzK+N9hFllz9Z
# BtKu8bggTC18xE/zcvdJIfOTJ7XVuVEwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCROFjKDM2znDLGqzMDGnajZ+NzK7GbEwpP5tAUIkTr
# 0bOmhH/A1CujCLneGyX44cK5h8lTuRcTIRQbv88A2ZHDGTE9L8AuQozURJ0gAyjN
# 76/jm8PO3h+ayQ5w0s0zGu2XuQjLk79HUMKw8OyuxI6cCYM0yZjtZ+T0P/3STapl
# 2T9Vd4fnOZ6MxfNZJ/CtBw9ok4sapu65G2/YA31i/jv1yaXMWuYjVGJLO7XZ++00
# M33pPpD3nFZXvBg0TDtWFsEvDTvH25TRR+gu9VSoFoDyRVBbn76iwjaRrEOeJzuQ
# 8vBIx9AEZ5IMY2vrL2kV17iGTViBD6016pTwNYdwxb2uDiZqUB3Lj5iZv5R734mP
# 6057Tp/fJXLPNCgM/YU1uFL5rRffHvV4amE7nu+RT44YOFR3QqT5j8UY9cB3Omrb
# No7Cn3C2dINIvezGwnLcGSjiF0JKtRu5uAXwcIJpkeR39otlnmd7hrDOjhPK11Mi
# kNQlsO4vvH4F4kgpDvIvJRM=

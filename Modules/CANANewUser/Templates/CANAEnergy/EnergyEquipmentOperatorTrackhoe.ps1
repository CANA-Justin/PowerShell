<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyEquipmentOperatorTrackhoe.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyEquipmentOperatorTrackhoe
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyEquipmentOperatorTrackhoe $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyEquipmentOperatorTrackhoe
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD1538Pdy6WjVg4
# Kna+4Z3QrRxnd7S0hDkW2Wmb+bZkLKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCC9YeYvYhtpYzuZu3jA30O5GaZ6Az9P
# Iw6hOJX78WmQsTANBgkqhkiG9w0BAQEFAASCAQDLDsCMojP9FTRmvDN5L9UF24Pr
# 3Nz2FGSlRJVpaqx2/Hgkyn+TTLUM1BGatdLXw1hZnrWS+YHCTxveDip/nXLXsO+y
# rS8nR16ffwameFy7nGBxWKKRemQMl81Vp/Ecm/8XvHYcznj45vO0pczEuDbKxj/W
# /WEkUR913gniOFbtu9CVRTfkWxjVj+Wm2b4DzKWrhYjLVthDC2boHy8TaOcrtseB
# +D5vFUVzJpa8LHLfsT5KMxHvzdtNvSlW3moSht5UrT1GW1DCAvgmg9cEOkuGEYtL
# 6lKhUgVfOXwqWvkqMLlslkoNxAvP9fTMYwaTUsYrHOiZvozH70PETonioRWWoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MzMxNFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg0H57DnmQFArH
# BcHFzkRT9kJ/ANCMlLlojIhUI1crP/EwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAzwapbgjSjntSMeoGHb7G39qf06u0ZqBotuWd5624N
# /RX/VMGEXiBLoasI3/jZReIrNFf3UuWTvUbhdRZgmbVJVRVpXyuZHqzDif0nA7Y9
# mqpZe447L07HIWI1ndf5qAeCrIK4/jb6pVmyNQKtzs4b0eqh0CZZ4sIVsfxGkPza
# kEa/cSEYLWNRO60HHivrsvcV/FSxqn0FM4IzDVwGCf/sitsBHR1+Vk4j6Rn+/EhR
# mEVBHryRKr/rdyadfKaLnZoRpBq6EqYlIm9rV9NM8kTUjuVFOvjeYQD/M3Qyb42Z
# qaVkvj9I4hMMOpNPBnQrfDofLf3p9Cr9K9JQN8AMqbJrUkpJADzDoPAmXtWvxhzi
# nVymncejjatud//tA8JKeDemQXzI0rJdstsZQUXDiz4m56raITW0X3hYbM6mcTjc
# 2959el3Hfn/g2QXrFsYC+awARhocuiE4Ubhui7kFvku9pyqFiUR1nUcbcD+hUBj8
# GJbvfe7G+39n3dnQ5Pmvad0=

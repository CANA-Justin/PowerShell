<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyProjectManager.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProjectManager
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyProjectManager $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyProjectManager
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvVzvZHK9bEFiV
# o6XEWJxk4EJLQLC3++eCxhqg0O2c9qCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCA/FbAxXvqCcG+nQN4pg7OkuyVo03wF
# BxL+z7oNAOzObjANBgkqhkiG9w0BAQEFAASCAQDG4jG842bflRve52J4WAlEqGzd
# 4iwtZBFTjQ7i939l3ZlJLK0FB+eEjAEVoPWZ56KadQ1xy9cIQo2waREH3GBVHyxK
# Tu6yf4TrLz/1ZE5IDIzDLHhDCRBsZjZOGigt5FvBY1K5qVXa7jwLKxUO6tMJy5f8
# Mq+6knAL99qAxfpxU067j/llYKDhedZIVY9R5G6mF0VPxuF7w5cZMdNpQ1dRyUBX
# cbxI5pS0hiNuFWwj31KqOcEPw98wJuVDOgqkWG0YLNBdcpd1M02L8y7ypdV5hpe9
# cpFJubpIK7vHNXx7DAusc/t1algE+PvyCs2RMdUpfeDSvfdERVqsWLzjHHqDoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTU1NVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgiU4NxJ+6S50Y
# 7EgwKdERAxMeIgRcW+XknFO1NvD/GmswgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDDxJ7+NT0z5PItAcvSp15w8WpFY6GdRtKtCib3NvJe
# M60HqvHg59SuGZ4QjW7ff4fsSVZnbptZ6owiJdBZyAMmtcewZBL0Wfx+TjibRfFk
# fEh2yH8tywtLXhDFjGwxRDiIh2tkDVYpGVssz52lDkXqwf7RCayhn/ZU71g4MsH6
# j33pBYRRwYLjv16GfGJloeg3mvdXoSny+Ru1tKG9L6yzbqm82WSI7cdgei8uEZXn
# r2ltUNXr4pxet50OsL3AfOAkGdB5zaS1rojWvPojH4+XOsrRA2BJASp0Eu0axkyS
# WLP9O+LAekq/GyFuZdz3IirVuIKdzRcNs9FKnRxkV+To9lvOoRfbnfmzDTPSe6zG
# BtP1F3CstUaeH23tRDwNEHR8gN7Jf6fsHylhh1zKRDjzUZod/1XG9XDsxZF20fM5
# 7asxF0uIPE1HWzkAzdcKMsrc6IMdwUTPaDeCZ0u3QQSXD3hrduaE0wgqkhk8cZSI
# ucU5S/Sd6iyhL/lOZtcZ/eQ=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyProjectAssistant.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProjectAssistant
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyProjectAssistant $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyProjectAssistant
{
	[CmdletBinding()]
	param (
	...
	$ADGroups.add('SW_Viewpoint_Users') | Out-Null
	$ADGroups.add('SW_VPT_SSRS_Publish') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAXonCIiF0FfFsn
# +tz7+FSNDdiKnJChIt3h4H8sfjYuraCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDovMq4FWX9QWmPmaesL0L0oWLXmeYz
# ebQciixH+Hc4JjANBgkqhkiG9w0BAQEFAASCAQCjQYKqtdpWzXBMtaBClV4rQBP7
# ebD4dQq9QwCwUekuy9ddIWFPNLdMYYTkPrgkSxYoMpAQoC9pSI8Z9EGVaiIYIOvD
# 8IY8nkY2Nh9v6V+JVPXUPI2RkkYCnRyrAp6cNPcLSxoPuk9ox4nQRgvV/0vAFPY2
# XKxQCITS1fm0e9RoIPDX1B1deUkN4r2E6KIC6NHfwY++oa9Sw5P/LA8idNTpzMN3
# U0P1g9aq+apowkombZYbPHEfJljYJdDir3oAZvM7+2fGwH8YGfTq0PbpCBw35V5a
# BOMQNmbPYHIIsB5yazoWpK0YL3mr7E8XUaEvMIWyZe1qheXgQkBrrsMN9OuMoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTQ1MVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgn/6uSayDSB2A
# NT63mQ9dJJIKMksy/Pn9blrVJB4pxEswgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCfIXe8J2kUTUxsxHDPr0fTBJzXQ4TX3PUfGgC1xE1y
# qNt3YoN8ZyKLIDsZqiFNLGvkR+ea6Q5uk7GwrKkN+smj7YYv86yrzhAUTtsDFSv7
# nA4f5DshJScC0LQFLy+Qo0QM61E+svUIj0wmgxNk8CN9b0jPdWnhla6ihOrIDvbA
# Xy4A5ec5TFYcenakNuf3/wI+cjSarq7Pv52pxCDQBfJeyAVyxrAPksnVP048lnW3
# 1nBnY01g55f5FlaH9uuHvgoelIsTg5YjjJL+9GWZdNiOIDFDWTTEdW2oYMfuqXnw
# F1JV1cB9PqYecjOgXiBTYArvW5Lh5YFZ8buGsY41g8j2Eo6g5rh+EvlAtkRemGkt
# GZDpxS8414B1buWW3tpvn7ANws2vUwZjOtzZxq+i8amJyxW3PNcRQ0nm7Q5yskC0
# Qv8+9H8oU8L6d0ANqZmHbN7yASDOdDzMs+hks4b6PKFgbFTYyECB0WSiHFiIRJIF
# a5VpxCV29QrnmWFjcihVWEY=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyElectricianLead.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyElectricianLead
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyElectricianLead $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyElectricianLead
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCXyiZuVOsyCUNY
# jt6seGPehkZNwV5wJL2+gPHSGpHQwaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDsN6rOT8k+XBOhNWQe7HiXpzuU5SyU
# ppfo/3DThfkIyTANBgkqhkiG9w0BAQEFAASCAQCEhGPgqZcHRfdclGh5ZNwcCm25
# uGly9F7WGg9FofY++WgBF5uGluKvy5Tw9vvX2E0pVdaxr0TDFWsphCWJvjQtCmSk
# fHpEH9UWKAXx6SDbaNUk0HDNb4xthXWfrK576ddQ94hjOzGf6Vkfk0z8LL+1O8H/
# Z1nzHjGWzyjj0DGHYBo9pq42x2O1hEmRvNR/CHs8BP6qerg5E0Yy9me7bqWjuelD
# Ib+9rrW8Iqwd8FHrqDVlo97nMTjZI6WSP3NCGoCIgx6xzN8LoCI4GEmVKs2ZZESY
# P9SPFUl8suY8y9GUM5DXcusLXIATXf1/uGIycMImbKxUedM9jgXaL+8hB/FroYID
...
# hvcNAQkFMQ8XDTIyMDExODIwMDkyOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgickD5yU8+A8v
# o9hrHK193IWKn9YfU1qpZBhE59iPbJ4wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBQHsKhjuLigCm5f9GJauz3NyW3oQHCp3DqEgU1/LrP
# b1E3qYeEebO51Ca8w9Vz7IMpoxyvB+27sNZ1gBCGtRvoB88NuloZlAdg2yJMJ7cj
# BNVdgOvOHR/q7643iGUFrtFX268inMYKIKWJlJ5f5my3MS0O49/2EQ2jLQuuyijt
# /vOM9wWuxayItJtzZP7wkyf8j5HECDNczqIuYLKrr24WLM8PSyTWA8HFopE1lLZ8
# ojB2I/VVx90zTvumae7nT2vWJ1HhiXQl4/th/SxI4yayxiF/YXeERWbKrg1VrinR
# PWVeuaTPZJnVuU8iC0jN5XKm+1Koke33ByMz490ZGsk17jTpAOE+a8Qz8z88JbRs
# aV2MwBYQ1XkHQGkq0sMSHqOJB9YDYqLNp/XIpTbAwdF1R0qIufPeXBEKfzBoBbvW
# AKEI/Xwdb3TzXF7oTXGpnPBJ/NoCdoSLuD+bekL5l0Frxr4F4m7SjZ/pAAF5SIy7
# T+zmxdgonzNH/7mhyPMw5gE=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyCommisioningTechnologistWorkLead.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyCommisioningTechnologistSr
...
function Add-EnergyCommisioningTechnologistWorkLlead
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyCommisioningTechnologistWorkLead $Username
...
#>
	...
	$ADGroups.add('GSG.HTI.Shared.RO') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBk3PSYrPTcQB2I
# NTRlXYVNUNzzF3/4ivE5D4wNg3zm5aCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCxWNP/AJGSm7VnqoqAhhZUnFn6MbtC
# bRreukTxKjy8HjANBgkqhkiG9w0BAQEFAASCAQBkgXyNlaFUR4KfxJADQtaLsLmG
# DiKx/zS1SyshCQL8dZhjDlJfY7fqeWoELOoPiOQK9T+Ai9+tKR7XoKd58LZMzJA+
# 3rJ5JPrMPDqhiG+fShifJSjiE26PWUN7bMd2rc8FmvlozVsTLNPxtaz2izZ+ckj7
# dcWAHPtESrD/+cm3yDobJuIrhR+ZRYafonGf60hz2J4RwSor0fnXEcPzUEF8T/1f
# a3UZ7E4vB2uFnP3NyPVGZPlJfIBBfvzN0QFpYba5Wkj2fuFy5WL7Y5CRD+b0Idmn
# pi+pb0nKPG/suG94YtlXP0XLZX3vUlKAWc30Tk14A/v3zZOwDJbhwyvdyEO9oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MjEzNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg/K+Ks3qfjryo
# 4ECmBRKixAETdLt6Iw3zi3tOmqMyAkMwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYC48d/U+zV4N/I0YpOtxtDjJNPDPYhjfw6Xl0C6qlCm
# 3v13JBk9wJ1Ei2ilC77J0vZPTj/MTr32NBi8Awhhiw4RHSNniiHNIXfIaFPMAw+h
# ZSeQVUrUejislA7X/8+KGupHCctRkxLKcWqZzoDS0YdpBFxIIxcp026ORJY5s3T4
# ec8iXHUe67IkUVqUS0pDb4aSAFhnTxBfZJU+jxlpxWC7TX6D7mC44GO73zIi8ULm
# W+pCCegmHSzKe5rT1Pc9pCeglo7VSRsYs+AD0QVbPoAgNYDV7GGUfk7nrv/9KsDz
# Q5iGVySeZQ22LVC+YRnpCkJxuJaNRcdOZ3inHhwiedQBuxexada80iLvUP/MVsos
# 3J5n1DxgEhQPmNqaIRptpNeKmam9YtvO/aviSvmqLCVJtA+yJennpVU4po/MorjU
# IdBaTJ2XUXcGCyTS4rnz4bpi4uk3AsrZhiksEQ1qJiryXs5IotOJauNUFePqrUbw
# NuhH6LtyXaxNpc7IYByRAVU=

...
<#
	...
	.DESCRIPTION
		...
		SW_Viewpoint_Users
		tfa.CHVArchive.Read   #Legacy security groups
		tfa.CHVCommon.RWED #Legacy security groups
		tfa.CHVDrawingManagement.RWED #Legacy security groups
		tfa.CHVDWGScans.RWED #Legacy security groups
		tfa.CHVEngineering.RWED #Legacy security groups
		tfa.CHVPanelShop.Read #Legacy security groups
		tfa.CHVPivot9.RWED #Legacy security groups
		tfa.CHVProjectJobs.JobNumber.RWED #Legacy security groups
		tfa.CHVProjectJobs.RWED #Legacy security groups
		tfa.Energy.Administrative.RWED	#Legacy security groups
		tfa.Shared.RWED		#Legacy security groups
		Viewpoint Users
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCPewUSc8+GyVrt
# RdR44qybTk6iFCalDknoayZG/ivPIaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBpN5a64UflU9Z3X+bxlv8NS/Ls057e
# dtf9j190rd77bDANBgkqhkiG9w0BAQEFAASCAQCLcG3UkDDU2dur1t7fNieMfEb8
# JnE0cVKzsRbSI+3fVD88KisZAoHHW+sOhaMnYITZPjFy9Swb3+3lpQRXMC/Tm4Dz
# Zw9DYCOLf+MnbUgUSvS3BSgpGawrOgSd4L1Up2lA9ASdcHc3FWBJ0hyYc/RS73ZM
# jkmTm53321W0LMTaNU1BVZd1bviS3tUTrhQvs/oAOhm9446QG6qzLRKeKkSe3c+d
# urhPJ2eWjXBkv4xGFwOBzfQfJOY9I6S3lU/L4V/GaBFhz+wg86MgKjILpTWwOnfz
# VsUBb8u3IjBTBrOhHGz0oWk01JfJT4vtX9XAaOPfMLbT37CWB3FKqZveO4GnoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MDQwNFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgs8y23ILKUrvH
# eN4gmUAjJQHBcV+1YLbZd5Z2ePUyjWYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCPCFCFY0TatFztv1bkxjsTSAfTfvyEEk672CBeVLTm
# kBk7gFjIG7fR0I8XWh8lhAewNxYzuW620bLRAHeGeK38/3aCBPLtLESeKUWw8Ggj
# uThTyOpYWiA/ZikfA8BTeyx76u6jEE0ZCJoX26CGEHDE70hlu2+4KN86Lg0/SvFN
# tQ9aPbrWiGgoQh1SPd4HwCwg5XSQ0qTqJ//g1n3ypv0G1nXGng2bj822vpra7sRe
# 7Vm1oVUh/50d+gLGybdC8i8gBioukTDKCdPynCVtkId7e+iGNBzL65nI5KBdl7VC
# nQlelv2j8YExECzI2VDfUpVOy1AtDc11CNDJAFXlaoPce5tmcbxQ4yOubiHd62dT
# GYo21m5KBPsfExyd0dkruzNz9qpxzckR+/cF59oKbqqslKfoJkQV8TFaDg96yy7p
# pjF9r4bSNJUKMzFIX1qyYdyd/ot/42hiT2/r9PyaAKFm8pOr9pTpB3J83Gz1a9Ok
# cuAVC1LsmAWeu7v8s7pWvms=

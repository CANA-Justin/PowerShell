<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPanelShopCoordinator.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPanelShopCoordinator
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPanelShopCoordinator $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPanelShopCoordinator
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAjI+nLPdNp2Ioz
# XvQ8e1vUPCkNVMvmGNw5jPdPAwYxRaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBWapJ3dOUhvGcgA8yaw534MwnA716D
# 0RtQfmS7BsjG/TANBgkqhkiG9w0BAQEFAASCAQAFjfuLKH687H1Q70ZWRSZrPLa0
# JIpCRugol8W1NCTMS/KWpZ9ZpFHPTMZyxWh/og4hnpMDgqornAVkmTZLU0Fj69OY
# eFnhNHFehptR6xgZaPi7cZJYqhi5eLLnlqw56ad4ad4zHpO0FBXnxS/SbAZ+i+lg
# pZvXyEe8Ot+5F+VXwIcEz1lAlqcNKlleN4SInUvBBSdHuZERd7zY/rY92DX+oTZU
# WVdC0EVtG9KJ0GLRDKV7mCGq66t17m+r4rgSnsYAi6CzXHod2zK+0i/Vmx0ljvv5
# csbrLVOFm8d3Wa+ZB2yYshfZfzDKuoR0NPiD9ejQZWbrqxiGLYxyEA8ut6tkoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDkxMFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgRUV62L0+7FIq
# VvVg60vR14D66wDV95QWvmezyQP5IcIwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBCJD1r3q7Tlo0AWFydjQciLZ0HCVGn3kqJgOfwzsSg
# l6y1+m/muG7wyyGvKCu73ZoSuqM1FujKxI69b6JpPmrChOwZIOJnmiMmgpA12htQ
# gd5h/FF+5ust9I4rc+JGjdccw6LqPGvCLkXMNqH+oXJlafmxbwL0ACeVWqdY/+Y6
# zqDJAhqsolPCXwGVJocYD67wlBsr1SowOMB9HM+clKFo6R7fcif/mCOn7wqZjFN/
# d3b7u6pIDJ0pWkP6K4/1aPLDgn9d8DkwviDU+BBiFlieirbp9MEFGYbZXMqzuHvb
# x8lyd7JMSDeOPf8aIM0QftZCZ0TNMIn/2z5D1h6vQJm3UjaSQ/19GcGWGOB1kThR
# y9tQPAKpEAuzjwhrutpAROEygB9uoyYsDVCT36j81COnypXJSfWSc/fKP7Rx+vSG
# 1fgj4RZS8c7eIjfmmB+3W1EgQFdwenkUcjkwuz7jr1zRqI4LUHvoBvGhXOg/KpZr
# zuMQ49Jwb/DisLq4TOxaBdA=

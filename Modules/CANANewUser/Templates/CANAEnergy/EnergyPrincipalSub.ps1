<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPrincipalSub.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPrincipalSub

.DESCRIPTION
Adds the user to the groups defined in this function Add-EnergyPrincipalSub
#>

function Add-EnergyPrincipalSub
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyPrincipalSub $Username
...
#>
	...
	$ADGroups.add('XenApp75_RDPClient') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAq8QlH5oz7Pbab
# u9sEReEJ6m05PAq/QWuMUiivCt8Dm6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDcpcR4dg0wl/uqVciOVhn8B3/pHxWb
# OuRNvM+YQBax3jANBgkqhkiG9w0BAQEFAASCAQBHiGaL7pFtX4+FZTYK5oIoDMuv
# Y1GaP/EBDCUXW0WU7V0ipCPk8by15unjPF59c/a8AdC9y3isQRqtFu5ldgxVSxCd
# 0Pyj7GdICs8OpgrCz3CEuB0uxtoTsu+zeiOeDEIvBl4+2Mebn68waBsf7WzBj2i3
# 0P0JpSyt+rNbnjZ6jahxdI50QbV9AOZS0vwhbnAF9uYIUE+Tm0CPlWi/7Chqspae
# b1Q34r9844/FSxWaKWDlsCmQRTvd65SrXsvCuKJ9lHo9eDYdAO+QOs/CQ4w01jSU
# RNmuL9u/U9Dp8qfbdU8kE4+9IW36Qffgn+bwx/mSxyK8Pv3V7xCpnFPdDi9aoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTMwNlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQggFJOG0CD5SYL
# qrLnBlddjeQ/aZv5d33O8umoL5sj7aAwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDMCLEoqoW/wLtEVI9V8vYbc4Pia1ijIH6TnJj8dCwd
# hQ2WNIySiZ0RD6/ITZ2mhaX6HEtM33G542A2+8z+9bIt6LeT7FCOfaE77TZ6iW0o
# ChhjWUZdRBIEWY+/12cuWx6rTRuJCBQYQ5x3tLliOomzswLL5czJeSqj60tATOUt
# rYVzcjhMCHf1DmAMmCOgS+bNpALlT1js2FK7B2mVVLuDM9AmJuwNe3Enaac7XIdF
# 7H+VNwK//Tu4rUqR2/FJqeQlfYSB0tSbZuSqsoJAcybdcbTI1ajukOULcxFio0yP
# kR2Bc0VQMQEVrPlrARpX6kArqdd0mSPpY/qXoz8eAkRcBV6OPLERD6msRDncVMFC
# xkisteNP5jwQM9Go8C8sNGAhfnQL/ffajiTQXP9knCs2a1kAD9X/o1TW0GplfGPp
# 6VM47HlrsUcsz8yf7xpyBVfo70FgbF69qnwpRG1D7JffpO8uxayPExhtn73Xh6tP
# 3cTad/kIWIS5XiVlWkMAWHg=

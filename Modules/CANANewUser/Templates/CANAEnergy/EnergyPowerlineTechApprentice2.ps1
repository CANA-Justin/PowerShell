<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechApprentice2.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechApprentice2
.DESCRIPTION
Adds the user to the groups defined in this function Add-EnergyPowerlineTechApprentice2
#>
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechApprentice2 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechApprentice2
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAPsbWCMm3UiOM8
# 7RFcnFVI62edjBginAMpDWoHACG576CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCD6Si+FFnCMj39BQzeJAyOtXW1l4QX2
# cxg87wcEEgesmzANBgkqhkiG9w0BAQEFAASCAQDSFVLSbrjhV6s6yR+JymaGmxmG
# RYve6sdkwpNEWOwFJt6jv3y5WDRQhW5UgRWjaMFaqRWM2fyG42awIEQ00l/rlfl+
# JLM7d894i4jCr5+lZP2TrRB3JaKqaiwUf8F9hSSZ6Jg7gpfejgNxZaMCOG/vo1wx
# cTCDSkmlWpyXr3PPLhHhAOxadX/d7Xv3XftsJ6//+hl6wXWhnIp1mUGDp2ZKo/bo
# LnvTemJbZgIinLVAo7u4uwJI8NOJJzqApSRR7Yrrj/g7a0MTUwVuNwSQwq8xiUjI
# FNizbDkE1O+7Q9n5V5xyJcPveUN8Z8wScwPbVsn8kdNYhvqranpUoZTgQC3ooYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDk0NlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg8hNFWYS6VqdL
# 2SQ0YSgylN94DsZVw3xnsbZhNbi1tTowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBgSwLwacbkrKFS2cWG1J/2oJevqgt1IGtw5Ng9Jyd1
# EVHRmMryZtTv5UpJfHX8+bq/Besf1xN52ouFQFJWV5HDVO6SfVtjiOnN5MPkrJjx
# VPamjTAIFVEEwlRTbHSlZV5+H9gUIHOFOH4wX8dhu3roaT8Xo0G3oZ3cqggdG5yi
# YBDvVhd83mygKzkelhJY47aCGqI0YJf1CcOHbRXBm0rCyvp8mMBazxCYSz6Js3hO
# 08e77XLlq8YPSapjCafBCXMyojXBdEy0SKwRmt6wVSFRnqntPUQxCNFZ/1jU32Bh
# vCrFkgF39lPOoja3jDsNaoeeiPjcvaeBApwIPgb2N1Wincjjrg0PwS93KtgcSK+l
# JfCun2MVHWdQd3PzZchQNvj+mfAPUbJMNBhoyxjfbR3CkZGMi1AxdimOpkTJRJSN
# SYkvptVlnVLntDLfXLf2u9nylCqXD9njhEGNwzOcWBz7IEySDeiStBT4L4HjNH/m
# up49dLYeXBm/9cReHjUJ/TY=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPSEApprentice4.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyPSEApprentice4 
...
function Add-EnergyPSEApprentice4
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCByM0gr+b8quIMM
# ZtcqZZiJ9nKZKOrhDywmLENli0u4WaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCgUZ4Kj1PiwZeiXOR7t0HdIzfpcgmJ
# ToID8CQqSjSDdjANBgkqhkiG9w0BAQEFAASCAQCkOiyMSi+KwRKHV1/6LG9MQ+99
# rjbYDMVbxnoPV3wJRFAkiMNmp1dGtPYi+N11/tJrzn1s6BFUKf3o6uxBI3K7Rmmm
# FhOADc6H22JKEr6nV3VMp66pp0fz4PEb8pTUBhIXuKlnn7B5yjGUsTcVgzqctYtw
# Oe94+kiqQT8N2qrhJe5SnDS1cOfv1RwAaDqvQFdaGxvoss2p/ToAYTi5i0hTS5nC
# VhJExkBA265BDcctu1sTbtlVkRFJQKlH8LtrILUO/10bMXv9pzXYjBJAdZbuJ2ad
# QpR5GlmKwb/8zhC6b5YLtePPLFJ6al+Dl8aMzBsvt4fHwx3973FrefNAuZ02oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTcyMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg3QDl26N1Tm9+
# 529Zhbvr1tp16ZuZ4hmjxyI3umQXp6YwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCkTz5uUr6lbcK4qmE97dfDMOV0PfpIXRAssOhPOGZS
# m2krHc62tcD3hKTg+G6d6RIsjLKz3XqWUTB3RXCqezcRWWcMTBINi1xvuW/Oi5+5
# bhxtWjpPINf0pUkYMaBc2o2BzhgqcnCkzeXY8S6csx+FQPYKKgq2ZK0hNQv/n9wq
# wzzcrd6CCCTu2cmx9WpYs9ICIikMEotU+fQhyeWRuqDGF7PQy6y5TAbuBQEXW+Kr
# 9QoG9Na3DXHLBG5AvgdtktQoR0M5xvbdi7ZwiPkzRFCD8tyWZZdxSHaAkl8q6QfD
# wfFXJ9neS/yY+WGOK6Pxpl+kC6ncPKN4KsIAW2wygc+TY2nS/aj2p6gDmoV7uutK
# RdBriFbhGAOv4/EJVUmnSMfVcTNBqaeljsew2QWWUYF4pouRUj4eteLN98SjeP/1
# SCKkDmu7ua+oHBHHULuBZSv+0YJS54Qce1rqgv7q7Gv5zQgmMUbHdDCnP0K7wbli
# Bq0LslsLPoStUT1n8WZkRls=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyBusinessProcessSpecialist.ps1
	===========================================================================

.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyBusinessProcessSpecialist
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyBusinessProcessSpecialist $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyBusinessProcessSpecialist
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDpoR8dIwES0xYp
# Glol6clR5FcyLD0wtnajTNf2L7AArqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCAEMxAofxtCHdHZc2oBPgEQP0hbvo2x
# bury1r6Qz7tLfjANBgkqhkiG9w0BAQEFAASCAQCneBfWEOJBNX4rx3aTSaqb/4yq
# WRWbw7/TOMdIHxCZPT5I9AVffUzkT4HGHMdR3WbKN+Ie0gsEJVhiDp26RGCBPBnp
# zyA/9CikW5M/aXU7ShMXSR1xYuO5GFvOJCmu+J4KkiNPfNseFGGqVZU+Mmsfid9u
# v2+03B9Ede4oVERwLoqtKanRnTX6JTUgYXuN/SN3AbtSZkp0pwxHrh0Fgx/CQQ02
# 8ij17mJphVstg3Z2j1PWYBFXC1TTpF45t7h+dbNLzC2Tm2qrptN81vxgcgbA3JaO
# SyKZqaS7sbE9OvFSyGSQJ8E8IEQ95HrwR6pjvy5OEtkRnzFmq2ARLE5bQtd7oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MTcxOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgkGrN3DC+5dEA
# YoSRRChBPUuaKFOAZk1wl5X+Uq8pk9AwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYALhLZpEtz64QYsHdLW7yCUEvsmMibkHezEPz7VH0Gv
# xKj85Ik1Lm9ry6FVxhX/Z8BDk2WNbziOWLrHi7icHqgFh121WkN/hJJRVLRJuQtc
# 65Kn0+neY9FXGe5a69u9+ijSu9kMFj6e/2ao1bBoEKDLImjZUgGDHtAd0YcoN7R/
# 8dLsjoFi8Pk1LrTOoaT1FvuNpn5SadFnHyEeRjGfUSF/T6iPRDByqGbg7BuB4Qu4
# ug5JRQYhGT8MOo0K08MenvtzBksQeIPSHAGQ+eCmdAkgnRZlHvsPibkRnY6wjkgM
# IdM/20Ub8LeM0u6lWeg01Fn81gmV62TQ+rjrk+zHgcaMK6yCcKOBtUGG7FgZX4f2
# XZY4PHb8lQ9T0VWcRpeJHGONtu2WY3Ri8YTvyFr9rAnFDscF0oZe5ZK/qJqj/mwV
# rESCdl4jfafikbRZtAkflenveW3p6vHQyWhz7uzEcMNuRXx09THQdEPbOrGfsRrG
# FQs8RHX8ZOth3aNOjTFUHIU=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyProjectAdministrator.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProjectAdministrator
...
function Add-EnergyProjectAdministrator
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyProjectAdministrator $Username
...
#>
	...
	$ADGroups.add('tfa.Shared.CSEA.Read') | Out-Null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDbJwzuV84gBWk2
# Koxa9ZcN6RNSIBagYezRK4gc+rtb2KCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDuFJFN7bz3kTn6nsSZob9gX8+v/qa/
# xNAc/ojDhbc/KTANBgkqhkiG9w0BAQEFAASCAQCErMKMGz3pTbN/1Le50L5aNCHA
# lTYq0r2XH9otqL/SFnEF77F0mx5eGdJ+UuPMjR+d/23LSWhwkkkpkalwwO9FzwDn
# xFJBMafnetu6KtRIzvQToT15j3suELQbvnYHHQqOGw+KEn5VAjfIh2RKBoH+4u+M
# Qb+7Uqtj33Y3pf9Zaa6elmMfo4xP+UDjFzVdXQfMdkF/x+G+vzkXiwAAYjPoiezc
# FfgibshjdDBFW5J+mnKNCdeeX94qhCvv+wjaLhgDm6vB9bt/Gp+HJxUO8MLq69Qo
# 7PC1vFLE3GI6v7z3Z7N7qde17hr8LsPJ49lEH1GZfLmHUAqtgaSFe65JjLcyoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTQzMlowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg0dJh12aq6Npl
# UHQhR4aPLLnkwvxU3HLG8E+r8EV27IswgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBgYtEVy72t+xt5SGk22ek50R/dHU/JffCWcUFpT3G1
# GSSkojvwMMVdO2+Jc+TuVr1T8nc6Px5hGd6vKqTvaTY6bYYvdzCMhg2V3gBvxYjV
# BMkHoFhFabDrrq1JxyVHe06ji9HX1cMBnLutC5rv8GAILPeQeFZu6gkv8Pk3R+Kn
# MXS9fdj2EWu4ym6BxiV3rrCbWIgVr99y4p10WAwcEutdWy+K2r0kp6yGac1aqe3I
# Zt1YCClA142ogK7sS1etbqRvNF6f42oaKoWy94HyWCnUio8dJ1R1fpqzihYIcoRF
# EUOfgNWmrmR8FXTCuk2XZCLH9dvWJUqODPiY79C5kEHgkUMHn8sdpEAofAcD6gJW
# 4HsbrKRQQPL6PAzkPmg31IiW7JJKYePHr8kJ21RcxO/n/slmZsu7dxA5ebZK6Dec
# R+oTQntVlTWntuWcv0b12xRwwJkUMt+l/WtUE3dmOXhtB9JrzkaeXQG0hF5znZjW
# rvUXuCAKXeY+NchDx4rIJ8c=

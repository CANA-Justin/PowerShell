<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyProjectControlsSpecialist.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyProjectControlsSpecialist
...
function Add-EnergyProjectControlsSpecialist
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyProjectControlsSpecialist $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBbSijPIU+NlcGE
# TWAqQgAN5LXXP3Pje8e+DDZlrMadgKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCD/9jNwJd4saCxDX1FvsWK1b2guCACP
# f1ng/xCmOiF6dzANBgkqhkiG9w0BAQEFAASCAQBYo7m2dgOIaOyPwbzlgL+THXxq
# 9r9wMKVKPL298CghqACY/Tf1WQijj+lSGFD9MfVMkkokewhi0mWiSRQ10N/z5cJ9
# Xta+KXSr5dtF1sK5v9FIcQ+zOEfRdZI9KNapaDNCdh6E0FKMa/iCidgph8SNF9MU
# +z+lFodNn+74pVSlHHDUNaPG9IHaeNS5gHzU5O5Mqzz73K5lx4FeMWSjhCYnC4l3
# 71+IG0pHrh3L0nLKZm2MBKpzOduFLprfKq5qMYLZfsRiZ4S6MFFRSDmAcF/3f1gP
# KuHgQHl8CNpcmU1ysKgTFeWLsm6ynAjMAJ09FMy77UWf5X3nW4zUr9uMMYetoYID
...
# hvcNAQkFMQ8XDTIxMTIyOTE0NTgzOVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgkV5+sG3B//ur
# cPyFhT1a9LGMyc104OMZuL7tDKGAU84wgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYAvHT5D/+oWRIsvd/qVqPCj0R3cV06o+AsTc+GX/n9T
# vHjK9Pg14DNrnnkYu+Iwm5zOyBAn8zanrXBR0VNOgTPuQB7L0fhENlyBjATr5iq6
# Q+mtR4OZLnYcW67tS8njHTB5bbrSj1Cs2ADIkL7xrEPSRbNhybo/RO0ihb4lgnbQ
# hPVnYcfnx4w0W0FD3LE7CwdawL+0CERqHxJK1ympPzDo5miiHqTORMGPhasXVdDc
# HIQr0js3DsUgtIUtT2t89YaNkt3E2PIJbo1Uy60OMXMiAkJRdL5p2Q0NqMaQq112
# bkZt3NtKYPdewrwAHNgZUkWgmClbyzQB7+UnGvnTQ2bfVVI2Vw4A/451U03dfmQU
# bJidoTtPTYLO+YDoMyp38PA9vBOA2/lcDkwwapEEYjjWecq3tkizNC0XR85nt022
# jxVY20m+3SVfL9Ih+AodgSWV41w8PoGDpBsP2RGw5ktfTG8VIUOJyc3K5dhL2Ufn
# +91bWZ3JDN6bqc78O1X+v/s=

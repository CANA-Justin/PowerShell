<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechJourneyman.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechJourneyman
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechJourneyman $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechJourneyman
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCk3RiqgKWkrXBl
# M4Ai7he5YPXEkQY67L4Og8DnNzxXKaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCABhrZX+7z97QR4PYYIfrnjDrE0XBN3
# pKxzWieLJX8VlDANBgkqhkiG9w0BAQEFAASCAQCnpqrrlfHBYLoIrbfahp/0mcJ9
# iURSJ8dZ/cQ3ERpzni8zMLGpi6dp4VImAF8hQdSd92uB25c9YkOCWOgq9p2QuLUP
# sdKZWfH8vrLbOwRzr5WjNAtoRYhwRwV6MbRCUETZOqL6eucVgk0qpGLTOH7u0pmm
# CktpuvTjCIKpkqbFkMbpCUBQfu9Fw3rFVxE9+YmZtzvm1tGzStiB3W4DRHVdi8IN
# RKTfdJ5ViqgoJLMgz6ylOGaGTy0NyB2nIo1O5fWyJKJrWzxTcaDb9So86PObeP/D
# QBnqPiASrsb/JvTGO0dUf5C4odAAXg9ELZTdpzJ9fkYhI0adDkNdsa167LkMoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTExM1owLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgTVjjHAGDm9DR
# VPppTUV4kT4lKBvH6LkEEZK2KtdKzikwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBkVZM+I+DcvAlY29hcBJXVDGAvvcYei7057eOfz4UV
# 1AQW3BuaKk6c2nNO2WD4sZPPxNRR48JxVZNlInKzUIjv0r12yrDHMCwAB0/B2H8c
# +llQegAzbYEz5QVcloFnGhd4UyFKK9X2DYyWc0FlCzk5iQ2xF6Yu9hmEMgsM/QCp
# 9xWnYsCHfOiazh3vpgvezMO3Ebt9GFSjMeg7fHGHpgygsFvgC0puuUPZ5+5AeQYu
# 5/9qVeIbWVJFbjYe/qjyRz1EQrTfgeJmdSxdgSiWprRQqnpODvzPXjgSORhg1rn2
# 5ffrauMfu9wJa1o6dZaST8orMJyJ924HN3SjAIBCuqtMLLg00nJokVbLWuEAn2Os
# i+EvFZHqZMBtq0ArywF2KPOxhJ1r2sNui6sr5VbfqNvdSZC9tE91XoZMgWLhGV2o
# Y56cEh67OWdD5toLbo5ecGa5jG2FAO43PeE8spMxD3+Ln64c1dmp52TdoXJpjWxx
# A/ogw1ENWXzuvxjJE/Yugcc=

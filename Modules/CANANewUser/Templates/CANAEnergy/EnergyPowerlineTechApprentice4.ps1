<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechApprentice4.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechApprentice4
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechApprentice4 $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechApprentice4
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBo4wUeQIZCrCor
# AyEjauK0JMvP94jSzzKOT8ZXEhsduKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDa9CcSGrJZ+OufxOGLz2bCCDrz6M63
# 9Y4trvDt2TRyNTANBgkqhkiG9w0BAQEFAASCAQAEqu5AQ+PCEiMhKJ19XiCmCVDg
# /68VoO0L2N6x4HLBoHBiyE1stBCvThra9mUu1IgIgtlcIGVDsfVZZCDTKHpF/HF0
# cZ/eiseFVVbnMDqTYj29a/NS5pcNGM5K3pUw4syACUVsy+j6YifFZE2788QA0Evd
# uhBDBCZ00ECc//Wa39JF6ht8PrHTuyipL7hNwS8P2umxeR+sCQogxSsQKHSERZfI
# Qwg11lq7aCdL/itcgl+UMgltC4VDFOoAY6IOcN7r7C/Sj/Y5KX5ckEYuam+W3X71
# MZBLF4nKOKAuffTUzzSPG1Q4kC1/tpEUz1OHm3IOFDOgLI4I/4+uVeM+hLS5oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDk1OFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgauDEXw90w/TK
# IQG9kyLyhdn09kX1bk10fA+uexzemoEwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBf6luK+8KXaeuHm0YYyntz8DeK0I9fiNYJ0TtlBZU8
# FyJcPmSTW6g3gOn0flPLm82cIIGGVvrha/R2n9orrsi+wdERo8cYz9/ew53eUKHK
# o4Z8cho8PBhV9NmBq/eXeTPWe6ieniIJJgTYYZwdrs6Sx2eUhnaPuHa0iaUC2r65
# /K9jgDcx7wMuDpNU/uNxqIgxNsVmH8MzkGHiTNSerOv27rJVPY/sGjrveJpVEdb+
# XjBOKTlUuFSaligte4xV5D9fXRWyAAEPH1IHSpwYn8us6dQPJSRaNRgKRrfTA/5h
# s9MMPTtRBfwFqonu4HivErLgg+SQO16EqWPd1T3/FzarTKP3BXrsSmGPxtjV44wG
# a9hXZDMP/ZIKCau+wwz70gcs37xg+Z69OOvmYZ3dhnu6aqZ/ym/+PkqoZQFARPYi
# VB9OxziR4lJnO7i7sy4CoK6usZeh63JoHY4EZjx639xY2CQSgZ8yRHA9ZeuaA3PF
# wUMRb87R4eKPFU4quFFp0wU=

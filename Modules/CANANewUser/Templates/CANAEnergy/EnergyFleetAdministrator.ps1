<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyFleetAdministrator.ps1
	===========================================================================
	.SYNOPSIS
		Adds the user to the groups defined in this function Add-EnergyFleetAdministrator
...
function Add-EnergyFleetAdministrator
{
<#
	.SYNOPSIS
	...
	.EXAMPLE
				PS C:\> Add-EnergyFleetAdministrator $Username
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCw0uBFzzeBacbF
# K4s4lEd+nWooi1Ry5AJFAA9Frb7XTaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCmhx32D7VSNcRlDQg9Bgz4Mz2pntzF
# yoYhbpKjdk6etjANBgkqhkiG9w0BAQEFAASCAQDaYWYdiDe+RN+vvxtbelUla8Da
# AIfU+yWdrfKwSwuJ9OM30taJzI8zY8pY8woxYmhE2bDw1ZFEge3nge1XPoO3tm6E
# HxAVvemPGjQ/JBtWzKInYUtnDYKGqpMyRSFADmHepCHnUnvb8JKLG/UE9kqdnq/S
# tYhFzT4vXtqk5+o+Te8L9Fr7zcR+jE63cWhQnvRSZncdORUoAwNQwHhXbmOv3yhW
# Lij/ExGQTyoO7Lj4cWaTxU4UaZeYA/4u8zu6pDs23gdKGwt0ajcbaPKQlxl12aLV
# 025vYpm3vymWAOpQy6DPUyHq3yUVew3gWvT+8m3BGWkmPli1Ch6cwD9nALCSoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDMxNVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgcefs/WmUJEz4
# SyC7rAI8kHLoUXdgTT2BMdmKIYJFUNEwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDfwU84yVMfxcrlSlkK7kqCrXpKBJM89JCGw+tUztrL
# rtSgUY93IC2DUu+/S0/LYiXsGnmwJAdJ8MfM78aARys5GIK4F5r0h9r7aSm+2Wht
# j9OIfhFErcW0+lMrmEeYL/M7YR+NKEGXm2ic5au+7q70JzcxEKC0GhHVcLfwmJle
# Lyc3d7IDq/1cdhzi1q5qgELju63idRn97g3VBrVi8YTSU8lqY97CMmVY7rpHHpwv
# 1I69llHLTUNySPa+UhnBA/fPBKPqpsCTwLqOvV9AEe2fYY58OzmH54ZayP+itbaG
# w1l7lr/xOq+k2VMoRMn09Tq9HqNFhXNbrLwl0lY7EOS/PDV/XuMasEFlWK6mwwBF
# 4M+iTiWzriKjMioi/t3euI0CzJYdeZr8BYIQFRlKgAs79p8b2NIB5HKPIZDYUa07
# y0xA/NStenoapSvm4yiRA3iNUTe4aehO+PoEIldqYPX65eoxhPEvnb7LQ/5bsqh6
# WoAYA9j9fzJTieEw9HwNy/I=

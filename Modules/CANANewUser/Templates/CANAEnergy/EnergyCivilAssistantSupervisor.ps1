<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyEnergyCivilssistantSupervisor.ps1
	
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyCivilssistantSupervisor

.DESCRIPTION
Adds the user to the groups defined in this function Add-EnergyCivilAssistantSupervisor
#>
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyCivilAssistantSupervisor $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyCivilAssistantSupervisor
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVppXnQNl9MWxH
# winzph1vir4TeUFt6QleHHrGV8kHyaCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCNcAQzdpqYM9Pc4DQbxYTJyJ6m8Esf
# lbxtdIY72MgVyjANBgkqhkiG9w0BAQEFAASCAQC4Nx+xUq6c3EjHiKKiYmicP6+x
# WmQJZ19CornVXJAXs9yvWfjKm9rU8AJjCZ6PJFQHVYW0Vu1lHhhj7jX4ObXFDUCU
# NC0D3BP7slAJ2sVCL8m1XkiTG0x8whez6VKUcEJd1JHVc6Khq8w4Al+u8rtdrRaA
# 8X3lBUBajnKf5ycR9TJnrWsCr6FZ80pifpQh9ZSvxiBIodSN+0NeBw9a5XhliM6L
# cb7RPT8liBdGKxaxINnlFPDbeVynQOzgVzCEH22ZmZWznjp8tfVktp/oG4Fq/dT4
# NmU2EwwZYq9O7SDg5EHSUrwvE+Cgl6+1cL9FWD/J57bU8PDbfN2Gk0M6K5l/oYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2MTgzOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgpjhZuwVGlRJ4
# QMWiAapoxpBauf1EB1tL+EscsQL+1tcwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYBTs1p591hb99CkNBlCFUjVzPvIv5+IVDKf0Y0bWYI9
# Xb4EG5V7xqprs6ZOseFHcm3lnoVlmmghbTYSg4N+Py6ydypK/hOtSA99ksAPo7pS
# hJBdYn6XJUd405mLa0FPxFrCN6bKs33O5nlf5mdQwaEi8oHaoq+M7/TE14UR/CVQ
# d++a4ALM4G7yp78bD0RxrZnyZ8x3D+oBt4dH+ubvFqdqHM/3ZmWVivZsfdg2YVUW
# aTFqbkDjzr5c8Enosh2+AJJ4oY1n6kicepuSUkYiFqbj4OIXgozhi4uX9+1E/MlY
# Mb2xk2G/ORm5m2G90hg9kpDuZVdb67fCFUNUcSVTXMqwal/sJtGpsBQsKJ4eAHQs
# kz21BexE4+wRgHq8uTZPIdeHWab8rSNv9O9oUinRuQL57y2X6qhF7GB4VbDFYDT1
# Vz0Lge2RnqpUf92DLx6IPWr8xaLTBQMPwxGlO7frHfLFPz4xESRt+JW9CeVsznR9
# GvK75s+eH694TOSDYqADC/A=

<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechSupervisor.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechSupervisor
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechSupervisor $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechSupervisor
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB63BEY7riMRh6u
# EzCpcJe/rZFyVmQX371fMECC4cbJv6CCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCeli698rVr4PAuQvk+ozAA1q2w70R+
# qxcxpzfpemTOOzANBgkqhkiG9w0BAQEFAASCAQAMbzoAXnNUnJv0kcaRZ2hj2ckt
# L9+2s1SabftG8+XpmennR67E/As1QDPTBDQJjBSEoqzX1aoDjtFjjva22Efd9XlD
# CVzZNCs1jAlBKfIZN9hQ8B2UUuGdj2YXHMQSHY6AifiLSxo2XXzPjZrIHDhCH3Xl
# BXA5SITUPUwG7w4c6uUlRybpIdQVMynzS0QN/POh2sY0lWComYbnAjRHST5YUR5s
# QqrTLIIsERRFntWR123dWDUJVmeT5aFCkk9qDpBJGtFbnY3C6nQdtzZR6Z3UZtSJ
# Ms35Rj813VnT1wVDGbU6aoyEXqpMwdOmJQQ9OW0099/pXx/PslFx1HRfRS/aoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NTE1MFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgL/HJWsgcy93Z
# UkkSxb+7udxtyi50AHx5afGPXv0XjTowgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYANOJpcCkWHxUCEVJ3e6AsNHn6E6xDu5mwFw/FGH2iz
# YtEA1xhIQHfb93hp8YblmfbPFR2oQPkMKMX/+NHc9wkUddRttGXr3px7oNquL/Nn
# Hgr0ScMkVTg0qLkA59c9mIAVpKPI88qkBTTD2LpATgGjquuaW8H8Fs3QxNoHqYIx
# T4ATB/Zshf7suQcFUyNmWwSy3cBxyLHXzcaoah3SY6tC7hEzIWReMhPQctNT9UKB
# iwmR9yyZIEdpwQs2m/8kzxs69uruvMDMp+FqNI8v0p6VVeHIR4EBP3TWvaNQ42wG
# JzOi7lvB5Ha4ig9WiGCPqwlghFTUgyXBYP3ATAWUGCIbm8SNLpc8OwX4yrZHP3NB
# 7RPMNLNxZVW6QK5brz32a8EYDQaxxMioUqv+ggTv1cffIcKCslpu24/TkTP/2zCk
# Y66F9EgBMFS60p+vavMwH7C60y2zhxOVlx+qtCA56bkwO9jTGcrvBnG8BAx+Abbp
# oI/bTg8eYtUMbuTj0uLP4j0=

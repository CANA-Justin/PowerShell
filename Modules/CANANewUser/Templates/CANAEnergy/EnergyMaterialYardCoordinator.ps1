<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyMaterialYardCoordinator.ps1
	===========================================================================
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyMaterialYardCoordinator
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyMaterialYardCoordinator $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyMaterialYardCoordinator
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDLXep6cZY2spaT
# 5kGFAElVoH7N8ogtRhzUX4gFel92aKCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCDljY+G4hO6Ner0B1lTbI07ZE5e6/Nv
# UHGa1f7/j+V8wDANBgkqhkiG9w0BAQEFAASCAQARWfhjWVn3hEw9UklXXpA8A8qy
# geI00nQbEdwIoyr4Puz74C2C5Y14Milfu44nABwTiA8Lr2vV6Hnxxf1T1nSwC/WF
# aeAq9TIjauF4Qwa4NiZd4/CCKqErINRsaeGIpQAf93vWjfr8GquQmjduHypaXUI8
# ZdAilrFQXipDQlfi76+91JyuIrnNOxUQElPSjoOU4LxgAIhHQ7Uz91Z2aF3Zt5Nb
# o59yJkRdAvrV2J8A3OmjlMqXVpLE2oaEdNco7NSAZgEWcEXGZHu2xemD+a5E1x9Z
# XwG71R9OnRI0mB1PiEVnk8+dMRfcIw7EiSsDx71p+jry7g2+8KNH+qzDsreGoYID
...
# hvcNAQkFMQ8XDTIxMTAyNjE2NDcxOVowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgx2bnAMQaSzat
# CIbf/vSwxEsZPEfAQ1Oz3t6g387GhxYwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYByC5ZNI52UDDIECogaqq9kZYpy1yAsxdP/603IJMv0
# /apufFWDZOYoz1UDhhe4x2P7p/oEhCRWVa14tHcUOwjqHzP1wEidk3IuF4WZuxf9
# yiDypto0sDk2qHhR6lG57Wk4zBMZQPHTvjADIm0Dn5Y/uJRJAj9VOglwb6i2+PJy
# gAkmxKkGb0vnIktEGjY13+eE9xUYdokvxwUGOS1DgIL2b61jVSGsc+i0zvO9DvLV
# djjN45jfzuMIge7n2erg3uk38rLUwyrQSJ+a+OmMGoyIL3tKOAJx/Aie19u1+OIw
# 0puI4VdE2C1GCMVe3QnvANqXqd5GreJvUoP+TMrZKIgZegP+Ap+rAnSDzbzuGNRj
# GYnhbDfDkh931pTJ3oAZ5zjKGNA9v0RXEOwkkcUpN8Z2jfWB1L1kbG18V/j8upTg
# mU9+BI+mCVw+c3pQSTrjZRw8e6SPj9ZAuUVcMbwIRGrLKNVTnfqXGUKH+vDirgxO
# 7eI+EEvwRWrrBgWnqliagOk=

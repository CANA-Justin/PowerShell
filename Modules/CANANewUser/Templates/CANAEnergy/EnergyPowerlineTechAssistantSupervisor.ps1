<#	
	...
	===========================================================================
	 ...
	 Filename:     	EnergyPowerlineTechAssistantSupervisor.ps1
	
.SYNOPSIS
Adds the user to the groups defined in this function Add-EnergyPowerlineTechAssistantSupervisor
...
<#
	...
	.EXAMPLE
				PS C:\> Add-EnergyPowerlineTechAssistantSupervisor $Username
	
	.NOTES
		Using an array and a foreach loop, the listed AD groups are added to the users group membership.  This file is expected to be imported in to the overall module to allow flexibility for adding new rolls, or modifying existing ones without having to modify the core script or module.
#>
function Add-EnergyPowerlineTechAssistantSupervisor
{
	[CmdletBinding()]
	param (
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDTz1LKVsI29P9d
# tTl3MJ0KW7Unvu8JXq7FrGzR4NtIZqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCASkrZTmkCDX3BskVo7hllaAUV98vM9
# EbVv//ox57aUXTANBgkqhkiG9w0BAQEFAASCAQAbycfkf594gMSLOelkOTbDKp77
# AVXu5keBF+brFU611QS1LLKFPChRn1HpLVjndWyCtS9pJU+/cwjBcXRYpfNCtrgT
# 53yqp6NcPOagyg9v39/j8iNCkHQOeCVXi6q/X8VeHEXaVCXT2Gw9ZwORKmVf+YAk
# zdEr0iZT11CaTHlJnGWwQ7J1tsgh2HKDLVCa9ngDXoQWVXUc5QV8l1ZxbHXzCL89
# Asgys/lmd4p2I1u+iHWM40jkMmGj3wiieAPwpqO+2h1mfh+94R/NGMxMvT+mA55l
# bs7st+N6tICFcQsrCnOKlZ0g8JeZpX7+qdgn44pebnNxJ8qQNaBPHxIREOZ8oYID
...
# hvcNAQkFMQ8XDTIxMTIxNTE2MDMyOFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQgc357Gvf8D84Z
# 7HY11BW5qDhYTPeRiCsn5MGxcIJQSIgwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYCeRu4dawovwzZjLErhRXRL0mz/l3LZ10H09kdjFafs
# 2v07b89mlVhuHaZrWrIsnLN2yXGpLOQ76rBcAHNVxGmgQjf39LdNjwl0OMmVITLM
# a+uhrvLAK/DNfxmIw5/pSNlzeT0KtZcG0jivsGM3x2joqQwd42B0h9IDl7OQ1irL
# rG3+IlDkF1cyTJ5DOX/ySCre57V9Z+1A4/tUSVh4aP/cUpQGlF4f/72t0K6qLGvF
# /AQnwJ23jPzXoPvr0BfnNFVDxV3MrlbfpKriACAbebSXvMJPNgHytQtPWmRkERk0
# XT/j2drTAM0S5dyKdTycmESx2ap8r2r+F98YGj4WDrP4hHjLNHQq9u+ye7OUozla
# BrYHii3W+U75bOqEwK4qB0UpEwLr0NhDCwl/MIA/rVA9AwNehE9pnn3svxckYz84
# Axm/NuB4Qrzcn8/3wkNHfk2btCLU4Doy3cHFcMjyrPi0qhh9aka1AiF5TqG/gjEH
# RKezP3ssh2PG50wh0F26UB0=

...
Get-ChildItem -Path "R:\Energy-MP\Energy-Shared\Temporary" -Recurse | Where-Object { ($_.LastWriteTime -lt (Get-Date).AddDays(-180)) } | Remove-Item -Recurse -Force

# SIG # Begin signature block
# MIIcugYJKoZIhvcNAQcCoIIcqzCCHKcCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDCZtuan8PLtun5
# O4ah9/EXfHnnRrkcsgezQxwMzVlDiaCCF2owggOwMIICmKADAgECAhBz0HdolQdJ
...
# CSqGSIb3DQEJBDEiBCDxlfKQcGBZEBeLjGrJbUZFgiuOBdw1b9wr5dh0C/ghFDAN
# BgkqhkiG9w0BAQEFAASCAQCLxTatFoLVSHAe5hmSTPuo/HQ9q7QsyC4c4dB3cA+X
# rg16O0GZ+mv9KciJWvNCFsRwDxJLCLF8yr3yolmgcLk2vxBgSKWo826bsgdbKaO3
# 9GzTvbqvf+vr8OWjk+3IpnDuobMkF7n4+coRXlpAd9XxcFQMYhSxmYLFLVnyeXU3
# BXlNbOSCII/3fVlGA3Sr85O5M94FuambHD4xTAz5wxDZYlF+OR5OiUdY0gH9ko6D
# rqELzVs5e5zFaFtktfEA9e020D22bWwcwFYtAdZWHAN1ExZexLbn71MItSNJfok2
# 1goKmMaPEpEcAGqw9h04XxWX7BLG4gnU6mQto92pdkVPoYICuTCCArUGCSqGSIb3
...
# MjAwNDAxWjAvBgkqhkiG9w0BCQQxIgQgY4NL+izi0ay/3OwVI3auCP/eO3RwlZGb
# lOM0G2R5+WIwgaAGCyqGSIb3DQEJEAIMMYGQMIGNMIGKMIGHBBQ+x2bV1NRy4hsf
...
# LSBTSEEyNTYgLSBHMgIMJFS4fx4UU603+qF4MA0GCSqGSIb3DQEBAQUABIIBALMU
# oKLqjhD6y4DkFKZX5Cf4iZQ2V5Xc5IxFZQRxjivQBfl2Joy2Pe/jMXDz9g/frQ7l
# lT6W1RoKbzzNcfAA9L6ENjqMGzF1R5UZdOw9WvuRpXp6/ONE7fOjJQ2a1RftHsSa
# Sv8VxogKZq3IK3/Ir20fs068RaBQNOsR6Wora+Sk8z15cGuxEjReAioaRXA3OEJX
# rZrUqKEegd0l6K8ZSavz+UP5ikZMhllayONLF6K951nsFLZlDeIoKeg6AJP2LQc5
# 4mTcqsvfcy9jljUGWXf7LrxUQ5vqRx2f6cgRn49xWoYWZr0HwM4qVcwPpeQ41ydJ
# GexxP4N+XAeskc2WPeY=

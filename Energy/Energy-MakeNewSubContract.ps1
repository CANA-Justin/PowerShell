<#	
	...
	===========================================================================
	 ...
	 Created on:   	10/24/2019 10:12 AM
...
function Start-MainScript
{
	...
	$ProjectName = @(Get-ChildItem \\canagroup.cana-group\business\Energy\Clients\$ClientName\"Active Project"\ | Out-GridView -Title 'Choose a file' -PassThru)
	$SubContractName = Read-host -message "Please enter the Subcontract name"
	
	Set-Location -Path "\\canagroup.cana-group\business\Energy\Clients\$ClientName\Active Projects\$ProjectName\Procurement\Subcontracts"
	
	Write-Verbose "Creating the PO directory $SubContractName"
	mkdir $SubContractName
	mkdir $SubContractName\"Change Order"
	mkdir $SubContractName\Contracts
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCS4BZ7w39Q1RXp
# Xzji3r0BO0V4WX/2JKAwCyzW8EDRQKCCFsUwggMLMIIB86ADAgECAhAdBzYmM16G
...
# CSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCyKOCv8UU8
# EAuOrcPD0DZDnlE/JjexoBzeWem935TiNDANBgkqhkiG9w0BAQEFAASCAQB/OHjR
# CYWhzVKY1TeeMW9Ec+xmqNHsTxWJxj/2l/6h5dAFPsqAyt4RNpQtdNvupa//WUre
# 04rJJSA/BaWqvVXSg9HrSfI93RTwCziw+LzpNOCxzDYSe1SLqPBcZBT/27og+vf5
# WUFzMpcAOP0+dHT3FAAeh531L6KLmMllmGLGzw3oNDK9LJadtS5w4BnAQouPgGWq
# LMRUOrsFn2Y50OuWLsLCm5lbJVOhhIhol0b6uGNb7+wXHbI8aVo5keZufwixW4t6
# JkRvzFngY/zEuYwLU6CEceNFan6M07KmOd++/qAZyVbPRIY5Lw2Nd9hgU1rdj7Oi
# W7NRg3mx+kiVrELXoYICuTCCArUGCSqGSIb3DQEJBjGCAqYwggKiAgEBMGswWzEL
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMTEyMjMxMzU0WjAvBgkqhkiG9w0BCQQx
# IgQgT4M2geMxnZwfd/SYvM7F3PkBbmjqVY5kXG61mwJ3vUwwgaAGCyqGSIb3DQEJ
...
# U603+qF4MA0GCSqGSIb3DQEBAQUABIIBAJPTiexlwKFGbm5fswKmgROC2hYl7BvI
# lx3CNt2CWdTLaaw3HqQvW87DN7Ar3x3Kca2Gjch9sMKYzvz/4yR+BdNYHefgqvR7
# eG2YCVi7T6HxHiwDAF4ZiiphK5j0z5h03k+b3DaCwe1QIRh8WvQeKI6txBT2D4j4
# IdiO/+FY69oSywfeGl3jwOthRoo7NfEclcmpl4Z/S1ggfbeYa+KdYBbK56OyU1K/
# RxLgHkZ148zOMcXWZc6I55I2wuuwHoHkULuAN88AtZVBrBIi5qLh7tAtQ1LouDHJ
# aEFTaTcu0qp2Z5Rdj4ak/cZrUzQtKqQUkcKt+IaB+GimpnNr0ONp+Wg=

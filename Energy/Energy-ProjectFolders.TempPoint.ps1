...
function Start-MainScript
{
	...
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Procurement\Expediting with (OI)(CI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Procurement\Expediting /GRANT "tfa.Energy.REWD:(OI)(CI)(RX)"
	...
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Procurement\Purchase Orders\RFQ with (OI)(CI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Procurement\"Purchase Orders"\RFQ /GRANT "tfa.Energy.READ:(OI)(CI)(RX)"
	...
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Procurement\Purchase Orders\RFPO with (OI)(CI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Procurement\"Purchase Orders"\RFPO /GRANT "tfa.Energy.READ:(OI)(CI)(RX)"
	...
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Procurement\Subcontracts\RFQ with (OI)(CI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Procurement\Subcontracts\RFQ /GRANT "tfa.Energy.READ:(OI)(CI)(RX)"
	...
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Procurement\Subcontracts\RFPO with (OI)(CI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Procurement\Subcontracts\RFPO /GRANT "tfa.Energy.READ:(OI)(CI)(RX)"
	...
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Document Control\Transmittals with (OI)(CI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\"Document Control"\Transmittals /GRANT "tfa.Energy.READ:(OI)(CI)(RX)"
	...
	Write-Verbose "Creating $ProjectName\Engineering\Disciplines\Protechtion and Control"
	mkdir $ProjectName\Engineering\Disciplines\"Protechtion and Control"
	...
	Write-Verbose "Removing Inheritance from $ProjectName\Engineering\Disciplines\Protechtion and Control"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Engineering\Disciplines\"Protechtion and Control" /inheritance:r
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Engineering\Disciplines\Protechtion and Control with (OI)(CI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Engineering\Disciplines\"Protechtion and Control" /GRANT "tfa.Energy.RWED:(OI)(CI)(M)"
	...
	Write-Verbose "Creating $ProjectName\Drafting\Drawing List"
	mkdir $ProjectName\Drafting\"Drawing List"
	...
	Write-Verbose "Removing Inheritance from $ProjectName\Drafting\Drawing List"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Drafting\"Drawing List" /inheritance:r
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Drafting\Drawing List with (OI)(CI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Drafting\"Drawing List" /GRANT "tfa.Energy.READ:(OI)(CI)(RX)"
	Write-Verbose "Granting permission for stfa.Energy.Drafting.READ to $ProjectName\Drafting\Drawing List with (OI)(CI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Drafting\"Drawing List" /GRANT "stfa.Energy.Drafting.READ:(OI)(CI)(RX)"
	Write-Verbose "Granting permission for stfa.Energy.Drafting.RWED to $ProjectName\Drafting\Drawing List with (OI)(CI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Active Projects\"$ProjectName\Drafting\"Drawing List" /GRANT "stfa.Energy.Drafting.RWED:(OI)(CI)(M)"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC0QsvcfZKrN6iH
# Ns1fVcUVSWbJcnBcFus9ONrKazyx9KCCFsUwggMLMIIB86ADAgECAhAdBzYmM16G
...
# CSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBnOO1mFzU2
# EZYA0mLcNJaXQs1+oeb+Y4oAAL4QR7RJNjANBgkqhkiG9w0BAQEFAASCAQAYmdEA
# EKbJR6kGZXBZ/qK+j0Yh6sWxP9bG/YI1boklB9KHU7PXxUV7DguFPcsgOfY4mBqw
# bvyvZPb9uwc0jNC4j5Ohn4ZhDycqchkdVLgAT/TGgKf4hxo6Y80IZxHFftdR47hV
# SxfkaC0bD33OIEOTfttn8l5w0jBI95wGNtNxcoFQEqlxQrajxWqdaK1t3WJQEnyI
# 3U69rGqh8t2g4KVHGGxHTtvBX2L9VFZ6oai/kZw2ndd+pyZGczOcS/oAfPon9sPT
# 9iGmuInQDD4Yh3+hAoTR6vRg68VEN1K7WOQBzfdzGialWm5lF76dmOVmCtJsliFP
# STvkJ9d9x7+Jd370oYICuTCCArUGCSqGSIb3DQEJBjGCAqYwggKiAgEBMGswWzEL
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMTE5MTc0ODQ1WjAvBgkqhkiG9w0BCQQx
# IgQgDmU4q6ZCG5AlmFUtCPrC8NRPsP7OPqVTFcGcqcrsHPQwgaAGCyqGSIb3DQEJ
...
# U603+qF4MA0GCSqGSIb3DQEBAQUABIIBAJ8wv8C82KTpkq6uqE/6G8AoCIVCwXZJ
# myucHK53ysTmzYDyUKS5WjFWhsey8XPQYRweJssYxC8MHtapdyC33GWtPDM3U8Jc
# yox6+dgi2kiqEk9+4V3Kqca5dDR3wB1vYun0JdCyWNkOsoYjnojxTRc3BK7jyUPO
# bP03TNaekFbA03mfyvexqc31OXUNkpFIbq3Y22l/+K7azvoziUgMUWRT3yHfgHdY
# +pHX9onor7kuDIdsesxBqkdaB1jKbfZNdR5OUoShC67vWpCIQeEiKtkOCSpnr/Tc
# sP8tTNEk14nvPrf8nia8D5YTgyI5PjCDNzIV1gijDlZPYPDQaDQkNeY=

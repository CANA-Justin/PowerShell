...
function Start-MainScript
{
	...
	$ProjectName = $ProjectDiscription
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName /T /GRANT "tfa.Energy.RWED:(CI)(OI)(RX)"
	#-----
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Submission with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Submission with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Submission with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission /T /GRANT "tfa.Energy.RWED:(CI)(OI)(RX)"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Draft /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Submission\Draft with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Draft /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Submission\Draft with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Draft /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Submission\Draft with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Draft /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Final /inheritance:r
	Write-Verbose "Granting permission for mfa.AllFolders.Full to $ProjectName\Submission\Final with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Final /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Submission\Final with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Final /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Submission\Final with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Final /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Submission\Final with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Submission\Final /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Estimate"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Estimate with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Estimate with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Estimate with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate /T /GRANT "tfa.Energy.RWED:(CI)(OI)(RX)"
	Write-Verbose "Creating $ProjectName\Estimate\Materials"
	mkdir $ProjectName\Estimate\Materials
	Write-Verbose "Removing Inheritance from $ProjectName\Estimate\Materials"
	...
	Write-Verbose "Granting permission for mfa.AllFolders.Full to $ProjectName\Estimate\Materials with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Materials /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Estimate\Materials with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Materials /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Estimate\Materials with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Materials /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Estimate\Materials with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Materials /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Estimate\Subcontractors"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Subcontractors /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Estimate\Subcontractors with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Subcontractors /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Estimate\Subcontractors with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Subcontractors /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Estimate\Subcontractors with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Subcontractors /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Estimate\Engineering"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Engineering /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Estimate\Engineering with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Engineering /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Estimate\Engineering with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Engineering /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Estimate\Engineering with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\Engineering /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Estimate\Construction and Commissioning"
	mkdir $ProjectName\Estimate\"Construction and Commissioning"
	Write-Verbose "Removing Inheritance from $ProjectName\Estimate\Construction and Commissioning"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Construction and Commissioning" /inheritance:r
	Write-Verbose "Granting permission for mfa.AllFolders.Full to $ProjectName\Estimate\Construction and Commissioning with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Construction and Commissioning" /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Estimate\Construction and Commissioning with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Construction and Commissioning" /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Estimate\Construction and Commissioning with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Construction and Commissioning" /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Estimate\Construction and Commissioning with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Construction and Commissioning" /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Estimate\Panel Shop"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Panel Shop" /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Estimate\Panel Shop with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Panel Shop" /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Estimate\Panel Shop with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Panel Shop" /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Estimate\Panel Shop with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Estimate\"Panel Shop" /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Bid Documents"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\"Bid Documents" /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Bid Documents with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\"Bid Documents" /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Bid Documents with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\"Bid Documents" /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Bid Documents with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\"Bid Documents" /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Commercials"
	mkdir $ProjectName\Commercials
	Write-Verbose "Removing Inheritance from $ProjectName\Commercials"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Commercials /inheritance:r
	Write-Verbose "Granting permission for mfa.AllFolders.Full to $ProjectName\Commercials with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Commercials /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Commercials with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Commercials /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Commercials with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Commercials /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Commercials with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Commercials /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Site Visit"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\"Site Visit" /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Site Visit with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\"Site Visit" /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Site Visit with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\"Site Visit" /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Site Visit with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\"Site Visit" /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
	Write-Verbose "Creating $ProjectName\Administration"
	...
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Administration /T /GRANT "mfa.AllFolders.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for mfa.Energy.Full to $ProjectName\Administration with (CI)(OI)(F)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Administration /T /GRANT "mfa.Energy.Full:(CI)(OI)(F)"
	Write-Verbose "Granting permission for tfa.Energy.READ to $ProjectName\Administration with (CI)(OI)(RX)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Administration /T /GRANT "tfa.Energy.READ:(CI)(OI)(RX)"
	Write-Verbose "Granting permission for tfa.Energy.RWED to $ProjectName\Administration with (CI)(OI)(M)"
	& icacls.exe \\canagroup.cana-group\business\Energy\Clients\$ClientName"\Proposals\Active\"$ProjectName\Administration /T /GRANT "tfa.Energy.RWED:(CI)(OI)(M)"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBTfPO0RrEMy1Ss
# UBsC0bPdJPJE8hzXfDxXN2Nd7Lyz8aCCFsUwggMLMIIB86ADAgECAhAdBzYmM16G
...
# CSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCBA6ynZ3JF
# mAYj7JYHRw3b51IwBh2jyxxEW+uvCoMwwjANBgkqhkiG9w0BAQEFAASCAQBytgsq
# gVRswVzfXqpRUy5bWmai9Z6ZWize9OfdSsOS7V0F1HPImqAMkbsfeoqNyTLgkqfk
# 069dS7Afri6lLXIXBqiIijwAkYnx9x9t92mVHP+62lbUrwBLdppXjlAmdRfk6WYS
# fzJ0G4dPMhI44fCXmj+Y0qtzCzkWfwCiJlI3XWsaI6SDVJ2qnbGRbxo/vWxTkjxs
# HCBy3biwdttgNS7JL9OC4ritp5r3EMDSGQYqImfHTmY1DY2n5PC2tWD1IFPiodms
# VHNzHZP3mafccBOU+fiI40g/CgJFCuj6B/6zvGOrn0PVf7YztrWveaNXja9JZvF6
# 7nH0qn6I9jxALSweoYICuTCCArUGCSqGSIb3DQEJBjGCAqYwggKiAgEBMGswWzEL
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMjA1MTYzODA4WjAvBgkqhkiG9w0BCQQx
# IgQgVzNpm86N7pTnezDDAK4mEdFdPtGDwAGLtNyS1tj4H1QwgaAGCyqGSIb3DQEJ
...
# U603+qF4MA0GCSqGSIb3DQEBAQUABIIBACSmqRLszdh+M5h+zAg03qCtuV6jDJvy
# GkMOCCG4Qz9E6COpJHjgDVPEU56h5qqvc/Y9zYyxDvsWkxlUFA3WYnOG1+u3yXpN
# 66t5U5axJ9vuWyQOhzj2oq2iw5siETmxa4t1SJvD03PjdMsQMmCyfWJLU650Z9j7
# ikTablJkhc3MUCWXHtRV0tCBaZ12GpjXp4n+m0VCbp75BLNTvr9uzVz9bFjFsaeq
# 19K9B8imE0Zah8zSIFhK0UeilgOE9QJYuP2hW6Tp2ZUhDzrqKL3ZHeNXboFdLPGC
# pi/wLky9mTaTRJnjHnfCZo0o0FYiIpBSLZgngQC9VnAZcel7HTcDeYM=

...
function Start-MainScript
{
	...
	$arguments = ".'\\canagroup.cana-group\SYSVOL\canagroup.cana-group\scripts\Powershell\Energy\Energy-MakeClient.ps1'"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBUT0UPdgPN2UXi
# fER4YA1SYltJR+ngDescFp2wDJVT66CCFsUwggMLMIIB86ADAgECAhAdBzYmM16G
...
# CSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBfz36m291K
# 5spEQE3rpOiOZkPPLiWgxxx5bgAdDSIIBjANBgkqhkiG9w0BAQEFAASCAQCexvKX
# bW1LErow88bqXKFRIXaVYMGN3H5IHsRuTICemO/FXyCMEqu3OaEP1uZ4Uc+G2ZsH
# g62BezImfMSjLuQNQDJfxdEBrlGdwlzE1OJcXYHDJuNQWlUFvQEkb6VQ3+98lvXy
# 37Qd+wFq3Ik1S4BuSQ+OyP2IE3TiGdPhxVOk9DT2/0MUjpIqrbZgbnD/ClTOTnda
# tcyFb5um8bt5OC1+jm/ab1bDQjJ8AS2ow8d5ifUVi+RTOciUoFUbmvU3NAbQyXjd
# 5zJNe0FceEOF+CuwU0NYOgau7/f4LgrXhUEuikPnjhOVRhKI2VbFSQRJgg3V+KMD
# S7J5Qw8ShevbUm0voYICuTCCArUGCSqGSIb3DQEJBjGCAqYwggKiAgEBMGswWzEL
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMTA4MTYzMDU2WjAvBgkqhkiG9w0BCQQx
# IgQgrVdEtyZq0COf958oJOxf+hRyRoXJgO2tMJqJJcmrXoMwgaAGCyqGSIb3DQEJ
...
# U603+qF4MA0GCSqGSIb3DQEBAQUABIIBAKJNGP14kqlyfuMaExysFaNom4deF8rZ
# 0SZSpkvrhJ7lrA3nnaSTfDlQyqdx1m3av9bUElsRF07bUtP37oG4G4NZxT/Y9PcG
# LPI4kxWTzxRHubaY40W2Y4+GOey1vCIJ/4OIqr5Awq2urkSpIXgn+7O/d7hw9SX2
# 2822okd+QZ/AY/bsB3yIflHM8P7crnXfVCE2ynXvQCajMZT8Un9vRjBEkjPSoheL
# QKPKi7K+Tp1ZdUo/6m4Z5dmZCR9u0w8qHG8rSLMBv1qSOFrsn0Xcj0WwKGOI9kCK
# 99u80foTuixNgWru18b2M7pQ4syzJSkazB8/yZonYC/HP5AVKQMejQk=

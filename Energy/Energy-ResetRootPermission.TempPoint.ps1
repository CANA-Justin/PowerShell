...
Write-Verbose "Granting permission for tfa.Energy.Drafting.READ to R:\Energy-MP\Energy-Shared\Drafting with (CI)(OI)(RX)"
& icacls.exe R:\Energy-MP\Energy-Shared\Drafting /T /Q /Grant "tfa.Energy.Drafting.READ:(CI)(OI)(RX)"

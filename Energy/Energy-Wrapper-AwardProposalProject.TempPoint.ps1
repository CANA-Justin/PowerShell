<#	
	...
	===========================================================================
	 ...
	 Organization: 	
	 Filename:     	Energy-Wrapper-AwardEnergyProject.ps1
	===========================================================================
	.DESCRIPTION
...
function Start-MainScript
{
	...
	$arguments = ".'\\canagroup.cana-group\SYSVOL\canagroup.cana-group\scripts\Powershell\Energy\Energy-AwardProposalProject.ps1'"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA9ZZOJtSB01WaR
# QEIUDONOuw9cqDJE+TffAz9cc85x96CCFsUwggMLMIIB86ADAgECAhAdBzYmM16G
...
# CSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCB0HBq84boe
# 36Hsb7yEC/qwjuGcm4wYgEMXPr/wMgGBOzANBgkqhkiG9w0BAQEFAASCAQBXAwtL
# wRc8obpHrbTxfh8/v353iN0BMJhZ7+x7YLVprLN3tIR5wwbcSu3uZVE5e4ytmqBD
# WrMnbgzOL9YLftG8DZ1iZhrU1uS0cQzWDE2412Mv/OFeNOlHmLc+FM0gKVYxptYn
# L/upcua4nPlH49FmmzJUUqpK28SUPs1Eu4sZQUuUb7qkcEFwm5ZqPo3s5ANk3DUY
# KFqnNRV5NwmMYF9AWldMTPMuKArg4qMvtmRafYZDZPB1kQ5+xkL6sQm8V3rALDAX
# GZdJS7pSDDiAzsNhmtpgcTRVqime3hpQxy8rzFbS4zN3W7KYaaqL8l9KOdOmztpF
# XTlL5MOWmK8LJsQxoYICuTCCArUGCSqGSIb3DQEJBjGCAqYwggKiAgEBMGswWzEL
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMTEyMjI0MzMwWjAvBgkqhkiG9w0BCQQx
# IgQgHQeBdDUMKrrFTM+nKo26hj4PQeQisj28vxTyD63+9lwwgaAGCyqGSIb3DQEJ
...
# U603+qF4MA0GCSqGSIb3DQEBAQUABIIBAJBHr6sTy00lkLJfJuiI70xXn+XG9rbw
# qbzUxWw+Bj344XhJHSx27gFvvaBqN/I7zsMp9igJzz/OohHbT0cb0ctcpsZFdb9c
# Tjar/Fb9OgSW7mkFFY/zXKoRa4IIzYJOQ8OEHCu84uXg2OhbiGLXhHI3teXOwVHH
# ceQPJu82Bn7nsVqLh8sWY89qNId1khA/C+dxTxiI6cI/6ByxE5ZAlMXEnBeiGKVJ
# YmhuZeFVTjBa/KjqTN+KVJ23s915vkpIfzVcATyrgi9xboUbIdvLtqck+MF6TvlW
# YcaTJ/DqAu+yIpx5YAybLseliHX+lQV/MVb023hxT1KcS2LhDEq5ZZw=

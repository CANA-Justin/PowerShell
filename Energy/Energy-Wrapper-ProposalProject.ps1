<#	
	...
	===========================================================================
	 ...
	 Organization: 	
	 Filename:     	Energy-Wrapper-MakeClient.ps1
	===========================================================================
	.DESCRIPTION
...
function Start-MainScript
{
	...
	$arguments = ".'\\canagroup.cana-group\SYSVOL\canagroup.cana-group\scripts\Powershell\Energy\Energy-MakeProposalProject.ps1'"
	...
	Start-Process powershell.exe -Credential $credentials -ArgumentList $arguments
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCzHh7RYcAZ6O8W
# JPlaM8r178jeN8Akk00JP3AwfYVuj6CCFsUwggMLMIIB86ADAgECAhAdBzYmM16G
...
# CSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBgTmyYjoL+
# vF/ej22enukgGV2srUt6yPLD5gqfI5cidjANBgkqhkiG9w0BAQEFAASCAQARt0Jx
# o9mc2rmvUcrKPn1u80j8vv27RrXAsWVAzM9e6LYL0dZvlQ7oww39HHhPnncFn2Hq
# L+0K4LdCt6BxCOqe2gGEXK6rzekVPDZ2HSSpFwLGPtyZdiJM6UiO7vA9QjEvWWVV
# 4qmyR1UARMJ15MqN0bbMFv0v5f36YKSZLXZLpJshp1SdmmZeEDpMo1lIvC6hO7s8
# avBzbWQU6UfgtDHyd7GwlwMOygNvJzyF8FGq0r1ciRDOQOpPfTg2Cp5kdq3UU5Qo
# gRO//HGVVNUv3iz9xR3rjPZpcGFZJMCzeIG5RL6Oi3RvmnWu5Oja7ZUV72voXkI9
# xfFvuUm2+oQ1IQp3oYICuTCCArUGCSqGSIb3DQEJBjGCAqYwggKiAgEBMGswWzEL
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMjA1MTYzMjA0WjAvBgkqhkiG9w0BCQQx
# IgQg/Be9hh8BPynT79q/9GD+XBmc5HMaLB+oRZk9tGrtkkwwgaAGCyqGSIb3DQEJ
...
# U603+qF4MA0GCSqGSIb3DQEBAQUABIIBAKzgYQhXhQgiT8rSczHkmG/u6WmBLUMn
# rg2FGtr6qhvv8TaPMC0dY4bUBzGHFuzPE70LP1UazFN7KrCeyS2fDj0GKtfxB2dz
# g+giiADThUBtFuBzM1a9zLAOWmolTy+AOG7Arggj0bPfwPOQmEie/uhiuGYI3Q2G
# X85u/lloe3OUUsIOIxYtkTkIvrFYziRhRe0R0qoDxadUnA3QNpISgB1BAlUCATrh
# 2ydmaJeyFH+LyY8ez43ZkM/KzPOx7yLrltXZSY81c+nfdguNinprPW15kGvFK6xY
# GpOLATnOSSjSV0TCK1FZsGXCGm3PNKTggPXIDvDPHUyiwbT9nNPHGvI=

...
function Start-MainScript
{
	...
	$POName = Read-host -message "Please enter the PO name"
	
	Set-Location -Path "\\canagroup.cana-group\business\Energy\Clients\$ClientName\Active Projects\$ProjectName\Procurement\Purchase Orders"
	
	Write-Verbose "Creating the PO directory $POName"
	mkdir $POName
	mkdir $POName\"Change Order"
	mkdir $POName\Contracts
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBEvvlKA2RL+w45
# jaQhgaEq0RAz15lVhf1lpuLcJXWl8KCCFsUwggMLMIIB86ADAgECAhAdBzYmM16G
...
# CSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCsfH4OtDFj
# vNmRXUkZuSyAUisqZy3WveYrlLUKgJQsOjANBgkqhkiG9w0BAQEFAASCAQBTB9yJ
# XqXq8Fv/jcLWbUcweBIUfew2gkbg/gl8Z52e7HKtWVM1iWG+57MoGkBIB3w9m/ht
# N4nRllDB0Wb4SN5fpbCWdrbuhjgfw0GwV3SgT4Mre57M8DvQJOyZdrh65hZf3S74
# Sg8/khgIw6klwqufKYNUDEyhlglDauaYEoQ5a4driB/bYILp7WNJO+pLXhOVt7e/
# /7oZ8RAm/FsWAUWi9p7U/V8mRbmhkf6NlQFhOCSM+2Yr+TkVMB/8+/hMVagM7zfC
# jcQyhStUoHJRFBQeK/OyiqPCoZ5Hzw+RN6oGBM9t9J8wGpOR+QLj8GoXE8dCTrSl
# qcRKj8ZGzLcjxekToYICuTCCArUGCSqGSIb3DQEJBjGCAqYwggKiAgEBMGswWzEL
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMTEyMjMxMzIyWjAvBgkqhkiG9w0BCQQx
# IgQgNiHE6iggLLRz9e8idNt8nWnxtwcN+VjB4tstxyDMPmwwgaAGCyqGSIb3DQEJ
...
# U603+qF4MA0GCSqGSIb3DQEBAQUABIIBAJ2aaCvIxp/ogtmQxYhOMk+lS+Hq2uzJ
# GDhOIkCwuSwkFN96k0JRKHzPpsvk15abxhm0x2Uit2J4Sv/7Op85zaYNpEzFSbCY
# eIktEdsqTrqefEhaQpNx/ss9J3u4rRZISDFt/Ww9TiGFgtsqyIiQZBqN5i3vPiy8
# yDtN/eDWxn+f6bamVyJzUw/q+RlX5MnJX0Yq2Xs6MDO1xLG706MXsoFn5mpWSHBc
# J8zGPrHOHhaUk99Pn3ddIrhj2xv/aNEQ1ppwjW0Bp10YtRXIfmDtJ+4slp7HMsb9
# GUG+N5NdCGIwXiGmKhihCveObjtcjE4UL7fd5fjEcumHxFcDGv10j5A=

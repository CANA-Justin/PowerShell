...
function Start-MainScript
{
	...
	Copy-Item -Path \\canagroup.cana-group\sysVOL\canagroup.cana-group\scripts\Powershell\Energy\MakeProposalProject.lnk -Destination $ClientName\Proposals
	Write-Verbose "Copies MakeProposalProject shortcut to $ClientName\Proposals\Active"
	Copy-Item -Path \\canagroup.cana-group\sysVOL\canagroup.cana-group\scripts\Powershell\Energy\ArchiveProposalProject.lnk -Destination $ClientName\Proposals
	Write-Verbose "Copies MakeProposalProject shortcut to $ClientName\Proposals\Active"
	Copy-Item -Path \\canagroup.cana-group\sysVOL\canagroup.cana-group\scripts\Powershell\Energy\AwardedProposalProject.lnk -Destination $ClientName\Proposals
	...
	Write-Verbose "Copies MakeProposalProject shortcut to $ClientName\Proposals\Active"
	Copy-Item -Path \\canagroup.cana-group\sysVOL\canagroup.cana-group\scripts\Powershell\Energy\ArchiveProjectFolder.lnk -Destination $ClientName\"Active Projects"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2Rw0JoocQT1LA
# 37XFfNkWR9VWdV7dyrP1B4F6LFv2iKCCFsUwggMLMIIB86ADAgECAhAdBzYmM16G
...
# CSqGSIb3DQEJAzEMBgorBgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCCD+yrhcpk/
# rBHCtaBdLUiqLu7G+XG3xrfB3aNlwTjnFjANBgkqhkiG9w0BAQEFAASCAQAvhfgq
# HOpUnyRp/UZkboI53eMSEGmObYwMKpTeq7muRh3rRINXw77Y8VfB8e0m1LN42rpL
# xLfuagxAp7F+krRPH+SlhlBlttKGKHfYI6Sw26pfmJAgYDpfbzlEz1VZLIkut9vb
# XuVbtFROndlwjwe13z8CpDfALk6H32V0i6wHBuughXNdGBCWMLDZPJp41q3Mpcoi
# l/RM4DHIGlpUBrF4sHYPD6QCXd8bLycH3qJV77B2i8nBL5tioQzbxr5PXJTdaJjg
# A8kbGbqOroPr0P9q9Si/0/WU7YRr6Z4toE+xJMP8yj4l7h4vb0k+Rcc/qw+7l0KX
# xdnABbdBO3hJXVxyoYICuTCCArUGCSqGSIb3DQEJBjGCAqYwggKiAgEBMGswWzEL
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTkxMTE0MjEzMDM0WjAvBgkqhkiG9w0BCQQx
# IgQgYDRfI27Kkt7XTDW8al3WKnr0Nbet0iLxciFZelCFAB4wgaAGCyqGSIb3DQEJ
...
# U603+qF4MA0GCSqGSIb3DQEBAQUABIIBAMVzaCUkOHYGR0MRW0OCj2JT6aJD4d9X
# 8cK1QnuY5nV4d3EFZQO5S9uw9kMq31MX1o87R8+MJqKyNk2NGxOTu79F5hQ9CsHr
# UqRaDps03aM4hdD67ASJVfgl4ouo62eiRnPoQeDKipuk+wqzJ7S+HICSEhcK7n2B
# hBKdl77587Vn4c+4UoILNu+fRRm8Fns/PoHdEBsbRfYUlnW/9sHoJKVqkYTWDKuF
# Qezqo649va/4fTEAdLutdI+Vaqgrw4cZ8aJbHIoYFEx0EZ5Mfu0xUIg4U3pFabWn
# 0dEc/wNs/V16dFYk6NfhUeahnkvb6VWG9afE0OrF8aXyCu2CVXOUekw=

<#	
	...
	===========================================================================
	 ...
	 Created on:   	10/28/2021 2:36 PM
	 Created by:   	admJustin
	 Organization: 	
	 Filename:     	UPSShutdown.ps1
	===========================================================================
	.DESCRIPTION
		A description of the file.
#>

$From = "shutdown-server@cana.ca"
$To = "itsupport@cana.ca"
#$Cc = "tyrion-lannister@westerlands.com"
#$Attachment = "C:\Temp\Drogon.jpg"
$Subject = "[URGENT] UPS has envoked shutdown of $env:computername"
$Body = "<h2>UPS has envoked shutdown of $env:computername on "
$Body += Get-Date -Format "dddd MM/dd/yyyy HH:mm K"
$Body += "</h2>"
$Body += "The UPS supporting $env:computername has envoked a shutdown.<br>"
$Body += "All guest VM's on $env:computername are being saved.<br>"
$Body += "$env:computername will need to be turned back on manually once the power event has ended."
...
#$Cc = "tyrion-lannister@westerlands.com"
#$Attachment = "C:\Temp\Drogon.jpg"
$Subject = "[ALERT] ALL VM's on $env:computername saved"
$Body = "<h2>All VM's on $env:computername are saved at "
$Body += Get-Date -Format "dddd MM/dd/yyyy HH:mm K"
$Body += "</h2>"
$Body += "The UPS supporting $env:computername has envoked a shutdown.<br>"
$Body += "All guest VM's on $env:computername have been saved.<br><br>"
#$Body += $vms
$SMTPServer = "mail.cana.ca"
$SMTPPort = "587"
...
shutdown -f -s -t 60 -d U:6:12 -c "UPS has envoked shutdown"

# SIG # Begin signature block
# MIIqDQYJKoZIhvcNAQcCoIIp/jCCKfoCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDYW+acvRZI4D5U
# y314mPvyq7oUEKvMKm1jJeIQ6V9qZqCCJAYwggNfMIICR6ADAgECAgsEAAAAAAEh
...
# BgEEAYI3AgEEMC8GCSqGSIb3DQEJBDEiBCBYqVV0VP1DCSqagEvfEBs/FwtApnag
# y3Ed5svk1/jrXTANBgkqhkiG9w0BAQEFAASCAQDVL0JEyU8Sn1zY015FDqi9Hs3b
# /c7o85XHiTx3ZeGX25YA+bN2MkSR9JbLh3twXcBtJTjzrTZ5+RJxUTItdpB334PI
# v7fUK3v1opOwz6zWGytozB38HFI/DYckii41Qb7j2IHC9OpmUVrMfE0UHvYZzl39
# LWOQqSsBzt/H/JVHu4Lwm0MaJL9Q5/a3feVttPszwm9cOXpfDV6GiqjEMNqA67u2
# YJv3Fh7a17zjkwm8Xq7OsFNECjWC7SkhgdITfda3+FR/BpqwF5C8mJ8mO71Vxcek
# FA+YEtNmPc4aMFLcbFMN/O/CMEieIkYnTj29W5RGj2Ze2/ASMBenIzZZVOploYID
...
# hvcNAQkFMQ8XDTIxMTAyODIxMjg0OFowLQYJKoZIhvcNAQk0MSAwHjANBglghkgB
# ZQMEAgEFAKENBgkqhkiG9w0BAQsFADAvBgkqhkiG9w0BCQQxIgQg9MQpN1kjh07v
# fInwnbGFI9lyfSNxHJwcB7A6NTJ2SekwgaQGCyqGSIb3DQEJEAIMMYGUMIGRMIGO
...
# BgkqhkiG9w0BAQsFAASCAYDCMjtQouvFozSMzNyWS9/crVPHeHJKyP9eVUGde75n
# eVp3e5jak/Jp3ABiIDhv4h/bvHWbviSU6Khhans5uOu+mL2Xnn1t5tD9O1GVbG4g
# Oqb8tqRiQp8BUmRM5yKjgKD9sOSs01UvzO+BFou3hXDAZsaqyKsFxC7TCq7psXvR
# OwxJvSUqRyB1dh00H5YTfv0Kw/4IgzcKO5WUxuyPgMXCzLRLWuiyxF1r17OUwQDU
# 9+hPyjSVfvkrmpqjac8sQ4Aipp5JeV/eRStztZ4uf7rEYh/DCTVH1EwkKo3d35FE
# K4te40d2ti7x8OlAVO7tl+f9lYXJiujP1KYRem6fY3dFPCwiacBz2Fn8T8knVJAt
# 8h2HjcyAkaoWjkXZL/cglad/LHPoBg4uTuM7awnuTe4ghvcbdgebbjJsHjMMqI51
# ElvCTQ8XAmgUGt13yz4W7vD7kLHj4gbvkDQIQu2F+xJQUKzy1vvD5/+rx4qvWyko
# biG2H4NX+wjDeo/qVpDnJSo=
